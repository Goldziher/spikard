...
// alef:hash:0eebab88b9e7fd4f873d825e63e8b697d087ce9aa8963ea91c4c90a1a289f5d8
...
describe('upload', () => {
  it('upload_file_as_bytes: Tests file upload read as byte array', async () => {
    ...
    const mockUrl = `${baseUrl}/fixtures/upload_file_as_bytes`;
  ...
  it('upload_file_basic_success: Tests basic file upload with single file', async () => {
    const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
    const mockUrl = `${baseUrl}/fixtures/upload_file_basic_success`;
    const response = await fetch(mockUrl, { method: 'POST', redirect: 'manual', headers: {
      "Content-Type": "multipart/form-data",
  ...
  it('upload_file_content_type_or_default: Tests file upload uses provided content_type or defaults', async () => {
    const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
    const mockUrl = `${baseUrl}/fixtures/upload_file_content_type_or_default`;
    const response = await fetch(mockUrl, { method: 'POST', redirect: 'manual', headers: {
      "Content-Type": "multipart/form-data",
  ...
  it('upload_file_read_to_string: Tests file upload read as string', async () => {
    const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
    const mockUrl = `${baseUrl}/fixtures/upload_file_read_to_string`;
    const response = await fetch(mockUrl, { method: 'POST', redirect: 'manual', headers: {
      "Content-Type": "multipart/form-data",
  ...
  it('upload_file_with_custom_content_type: Tests file upload preserves custom Content-Type', async () => {
    const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
    const mockUrl = `${baseUrl}/fixtures/upload_file_with_custom_content_type`;
    const response = await fetch(mockUrl, { method: 'POST', redirect: 'manual', headers: {
      "Content-Type": "multipart/form-data",
  ...
  it('upload_file_with_form_fields: Tests file upload with additional form fields', async () => {
    const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
    const mockUrl = `${baseUrl}/fixtures/upload_file_with_form_fields`;
    const response = await fetch(mockUrl, { method: 'POST', redirect: 'manual', headers: {
      "Content-Type": "multipart/form-data",
  ...
  it('upload_file_with_gzip_content_encoding: Tests file upload with gzip content encoding', async () => {
    const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
    const mockUrl = `${baseUrl}/fixtures/upload_file_with_gzip_content_encoding`;
    const response = await fetch(mockUrl, { method: 'POST', redirect: 'manual', headers: {
      "Content-Type": "multipart/form-data",
  ...
  it('upload_multiple_files: Tests uploading multiple files at once', async () => {
    const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
    const mockUrl = `${baseUrl}/fixtures/upload_multiple_files`;
    const response = await fetch(mockUrl, { method: 'POST', redirect: 'manual', headers: {
      "Content-Type": "multipart/form-data",
