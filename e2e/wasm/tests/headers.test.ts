...
// alef:hash:b084112010932ab23fbe54486466d318788f36444557970724692befeee39b54
...
describe("headers", () => {
	it("_bearer_token_format_valid: Authorization header with valid Bearer token format should be accepted", async () => {
		...
		const mockUrl = `${baseUrl}/fixtures/30_bearer_token_format_valid`;
	...
	it("_bearer_token_format_invalid: Authorization header with invalid Bearer token format should fail validation", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/31_bearer_token_format_invalid`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("_bearer_token_missing_prefix: Authorization header without Bearer prefix should fail validation", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/32_bearer_token_missing_prefix`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("_api_key_header_valid: X-API-Key header with valid format should be accepted", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/33_api_key_header_valid`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("_api_key_header_invalid: X-API-Key header with invalid format should fail validation", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/34_api_key_header_invalid`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("accept_encoding_header: Tests Accept-Encoding header for compression negotiation", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/accept_encoding_header`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("accept_header_json: Tests Accept header for content negotiation", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/accept_header_json`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("accept_language_header: Tests Accept-Language header for locale/i18n", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/accept_language_header`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("authorization_header_missing: Tests missing Authorization header returns 403", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/authorization_header_missing`;
	...
	it("authorization_header_success: Tests Authorization header with valid Digest scheme", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/authorization_header_success`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("authorization_header_wrong_scheme: Tests Authorization header with incorrect scheme returns 403", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/authorization_header_wrong_scheme`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("basic_authentication_success: Tests Authorization header with Basic auth scheme", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/basic_authentication_success`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("bearer_token_authentication_missing: Tests missing Bearer token returns 401 Unauthorized", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/bearer_token_authentication_missing`;
		const response = await fetch(mockUrl, { method: "GET", redirect: "manual" });
		expect(response.status).toBe(422);
		const data = await response.json();
		expect(data).toEqual({
	...
	it("bearer_token_authentication_success: Tests Authorization header with Bearer token scheme", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/bearer_token_authentication_success`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("content_type_header_application_json: Tests Content-Type header with JSON media type", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/content_type_header_application_json`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("header_case_insensitivity_access: Tests case-insensitive header access (Content-Type vs content-type)", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/header_case_insensitivity_access`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("header_regex_validation_fail: Tests header with regex pattern validation failure", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/header_regex_validation_fail`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("header_regex_validation_success: Tests header with regex pattern validation success", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/header_regex_validation_success`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("header_validation_max_length_constraint_fail: Tests header validation with max_length constraint failure", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/header_validation_max_length_constraint_fail`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("header_validation_min_length_constraint: Tests header validation with min_length constraint", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/header_validation_min_length_constraint`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("header_with_underscore_conversion_explicit: Tests X-Token header converted to x_token parameter", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/header_with_underscore_conversion_explicit`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("host_header: Tests Host header (standard HTTP header)", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/host_header`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("multiple_custom_headers: Tests multiple custom headers in single request", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/multiple_custom_headers`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("multiple_header_values_x_token: Tests multiple values for same header name (X-Token)", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/multiple_header_values_x_token`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("optional_header_with_none_default_missing: Tests optional header parameter with None default when not provided", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/optional_header_with_none_default_missing`;
		const response = await fetch(mockUrl, { method: "GET", redirect: "manual" });
		expect(response.status).toBe(200);
		const data = await response.json();
	...
	it("origin_header: Tests Origin header for CORS", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/origin_header`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("referer_header: Tests Referer header (standard misspelling)", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/referer_header`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("user_agent_header_custom_value: Tests User-Agent header with custom value", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/user_agent_header_custom_value`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("user_agent_header_default_value: Tests optional User-Agent header when not provided, uses testclient default", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/user_agent_header_default_value`;
		const response = await fetch(mockUrl, { method: "GET", redirect: "manual" });
		expect(response.status).toBe(200);
		const data = await response.json();
	...
	it("x_api_key_optional_header_missing: Tests optional X-API-Key header when not provided, returns fallback message", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/x_api_key_optional_header_missing`;
		const response = await fetch(mockUrl, { method: "GET", redirect: "manual" });
		expect(response.status).toBe(200);
		const data = await response.json();
	...
	it("x_api_key_optional_header_success: Tests optional X-API-Key header with valid value", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/x_api_key_optional_header_success`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
	...
	it("x_api_key_required_header_missing: Tests required X-API-Key header when not provided, returns 403", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/x_api_key_required_header_missing`;
		const response = await fetch(mockUrl, { method: "GET", redirect: "manual" });
		expect(response.status).toBe(422);
		const data = await response.json();
		expect(data).toEqual({
	...
	it("x_api_key_required_header_success: Tests required X-API-Key header with valid value", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/x_api_key_required_header_success`;
		const response = await fetch(mockUrl, {
			method: "GET",
			redirect: "manual",
			headers: {
