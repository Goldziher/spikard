...
// alef:hash:34a7d8b9baf8430b7c35b6abb1737ef37446b07e092af4ad52439b8df71937d4
...
describe("jsonrpc", () => {
	it("jsonrpc_batch_request: Tests JSON-RPC batch request with multiple calls", async () => {
		...
		const mockUrl = `${baseUrl}/fixtures/jsonrpc_batch_request`;
	...
	it("jsonrpc_call_with_positional_params: Tests JSON-RPC call with positional array parameters", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/jsonrpc_call_with_positional_params`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("jsonrpc_config_batch_disabled: Tests JSON-RPC batch requests disabled returns error", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/jsonrpc_config_batch_disabled`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("jsonrpc_config_custom_endpoint_path: Tests JSON-RPC server at custom endpoint path", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/jsonrpc_config_custom_endpoint_path`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("jsonrpc_config_max_batch_size: Tests JSON-RPC batch request respects maximum batch size", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/jsonrpc_config_max_batch_size`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("jsonrpc_deprecated_method_flag: Tests JSON-RPC method marked as deprecated", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/jsonrpc_deprecated_method_flag`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("jsonrpc_error_response: Tests JSON-RPC error response with error object", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/jsonrpc_error_response`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("jsonrpc_invalid_params: Tests JSON-RPC error for invalid parameters", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/jsonrpc_invalid_params`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("jsonrpc_method_not_found: Tests JSON-RPC error when method does not exist", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/jsonrpc_method_not_found`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("jsonrpc_method_parameter_validation: Tests JSON-RPC validates parameter types and values", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/jsonrpc_method_parameter_validation`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("jsonrpc_method_with_params_schema: Tests JSON-RPC method params validated against schema", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/jsonrpc_method_with_params_schema`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("jsonrpc_method_with_result_schema: Tests JSON-RPC method result schema validation", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/jsonrpc_method_with_result_schema`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("jsonrpc_notification_no_id: Tests JSON-RPC notification (no response expected)", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/jsonrpc_notification_no_id`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("jsonrpc_notification_no_response: Tests JSON-RPC notification (no id) doesn't return response", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/jsonrpc_notification_no_response`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("jsonrpc_single_call_success: Tests single JSON-RPC 2.0 call with successful response", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/jsonrpc_single_call_success`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
