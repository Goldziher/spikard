...
// alef:hash:2e64cfed9576e688e58a7e6922d3faa4668e0dca380cec956861b78ab908045a
...
describe("graphql_schema", () => {
	it("graphql_authentication_error_variant: Tests GraphQL authentication error when auth fails", async () => {
		...
		const mockUrl = `${baseUrl}/fixtures/graphql_authentication_error_variant`;
	...
	it("graphql_authorization_error_variant: Tests GraphQL authorization error when access denied", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/graphql_authorization_error_variant`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("graphql_complexity_limit_exceeded: Tests GraphQL query complexity validation rejects overly complex queries", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/graphql_complexity_limit_exceeded`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("graphql_custom_endpoint_configuration: Tests GraphQL route configured at custom endpoint", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/graphql_custom_endpoint_configuration`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("graphql_depth_limit_exceeded: Tests GraphQL query depth validation rejects deeply nested queries", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/graphql_depth_limit_exceeded`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("graphql_error_response_format: Tests GraphQL error response format with correct structure", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/graphql_error_response_format`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("graphql_execution_error_variant: Tests GraphQL execution error response", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/graphql_execution_error_variant`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("graphql_full_schema_with_subscriptions: Tests GraphQL schema with queries, mutations, and subscriptions", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/graphql_full_schema_with_subscriptions`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("graphql_introspection_disabled: Tests GraphQL introspection returns error when disabled", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/graphql_introspection_disabled`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("graphql_introspection_enabled: Tests GraphQL introspection is available", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/graphql_introspection_enabled`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("graphql_invalid_input_error_variant: Tests GraphQL invalid input error", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/graphql_invalid_input_error_variant`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("graphql_not_found_error_variant: Tests GraphQL not found error for missing resource", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/graphql_not_found_error_variant`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("graphql_query_and_mutation_schema: Tests GraphQL schema with queries and mutations", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/graphql_query_and_mutation_schema`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("graphql_query_only_schema: Tests GraphQL schema configured with queries only", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/graphql_query_only_schema`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("graphql_rate_limit_error_variant: Tests GraphQL rate limit exceeded error", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/graphql_rate_limit_error_variant`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("graphql_schema_build_error_variant: Tests GraphQL schema build error", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/graphql_schema_build_error_variant`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
	...
	it("graphql_serialization_error_variant: Tests GraphQL serialization error for invalid response", async () => {
		const baseUrl = process.env.MOCK_SERVER_URL ?? "http://localhost:8080";
		const mockUrl = `${baseUrl}/fixtures/graphql_serialization_error_variant`;
		const response = await fetch(mockUrl, {
			method: "POST",
			redirect: "manual",
			headers: {
