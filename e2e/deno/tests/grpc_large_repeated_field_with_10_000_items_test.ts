it("should handle gRPC request: Large repeated field with 10 000 items", async () => {
  ...
  expect(response.payload).toEqual(Buffer.from(JSON.stringify({ series_id: "metrics-large-series", point_count: 10000, min_value: 10.5, max_value: 99.9 })));
