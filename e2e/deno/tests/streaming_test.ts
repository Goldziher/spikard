...
import { createAppStreamingBinaryLogDownload, createAppStreamingChunkedCsvExport, createAppStreamingStreamJsonLines } from "../app/main.ts";
	...
	Deno.test("streaming: Stream JSON lines", async () => {
		...
		const expected = Buffer.from("eyJpbmRleCI6MCwicGF5bG9hZCI6ImFscGhhIn1cbnsiaW5kZXgiOjEsInBheWxvYWQiOiJiZXRhIn1cbnsiaW5kZXgiOjIsInBheWxvYWQiOiJnYW1tYSJ9XG4=", "base64");
