...
public class MinimalCrashTest {
  public static void main(String[] args) throws Throwable {
    ...
    App app = new App();
    System.err.println(
        "2. Testing spikard_server_config_from_json directly...");
    ...
    System.err.println(
        "   Invoked C function, result: " +
        (result == null ? "NULL" : "0x" + Long.toHexString(result.address())));
    ...
    MemorySegment msgAddr =
        lookup.find("spikard_last_error_context")
    ...
    System.err.println("   Error message segment: " + errMsg + ", address: 0x" +
                       Long.toHexString(errMsg == null ? 0 : errMsg.address()));

    // Try to manually read the string
    if (errMsg != null && errMsg.address() != 0) {
      try {
        byte first = errMsg.get(ValueLayout.JAVA_BYTE, 0);
        System.err.println("   First byte at offset 0: " + first + " (0x" +
