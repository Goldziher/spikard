...
// alef:hash:405b552fb832e47dedb3b270bd5208fb43e8342bc2ba207711cb808f0f36ea15
...
class CookiesTest {
    ...
    @Test    void test24CookieSamesiteStrict() throws Exception {
        ...
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/24_cookie_samesite_strict");
    ...
    @Test    void test25CookieSamesiteLax() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/25_cookie_samesite_lax");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void test26CookieSecureFlag() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/26_cookie_secure_flag");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void test27CookieHttponlyFlag() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/27_cookie_httponly_flag");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testApikeyCookieAuthenticationMissing() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/apikey_cookie_authentication_missing");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testApikeyCookieAuthenticationSuccess() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/apikey_cookie_authentication_success");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testCookieRegexPatternValidationFail() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/cookie_regex_pattern_validation_fail");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testCookieRegexPatternValidationSuccess() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/cookie_regex_pattern_validation_success");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testCookieValidationMaxLengthConstraintFail() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/cookie_validation_max_length_constraint_fail");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testCookieValidationMinLengthConstraintSuccess() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/cookie_validation_min_length_constraint_success");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testCookieValidationMinLengthFailure() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/cookie_validation_min_length_failure");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testMultipleCookiesSuccess() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/multiple_cookies_success");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testOptionalApikeyCookieMissing() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/optional_apikey_cookie_missing");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
            .method("GET", java.net.http.HttpRequest.BodyPublishers.noBody());        var response = java.net.http.HttpClient.newHttpClient()
            .send(builder.build(), java.net.http.HttpResponse.BodyHandlers.ofString());
        assertEquals(200, response.statusCode(), "status code mismatch");        var bodyJson = MAPPER.readTree(response.body());
    ...
    @Test    void testOptionalCookieParameterMissing() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/optional_cookie_parameter_missing");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
            .method("GET", java.net.http.HttpRequest.BodyPublishers.noBody());        var response = java.net.http.HttpClient.newHttpClient()
            .send(builder.build(), java.net.http.HttpResponse.BodyHandlers.ofString());
        assertEquals(200, response.statusCode(), "status code mismatch");        var bodyJson = MAPPER.readTree(response.body());
    ...
    @Test    void testOptionalCookieParameterSuccess() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/optional_cookie_parameter_success");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testRequiredCookieMissing() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/required_cookie_missing");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testResponseCookieWithDomainAttribute() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/response_cookie_with_domain_attribute");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testResponseCookieWithPathAttribute() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/response_cookie_with_path_attribute");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testResponseCookieWithSamesiteLax() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/response_cookie_with_samesite_lax");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testResponseCookieWithSamesiteNone() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/response_cookie_with_samesite_none");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testResponseCookieWithSamesiteStrict() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/response_cookie_with_samesite_strict");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testResponseDeleteCookie() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/response_delete_cookie");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testResponseMultipleCookies() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/response_multiple_cookies");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testResponseSessionCookieNoMaxAge() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/response_session_cookie_no_max_age");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testResponseSetCookieBasic() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/response_set_cookie_basic");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
