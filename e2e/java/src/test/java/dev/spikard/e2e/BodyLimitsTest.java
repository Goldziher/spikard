...
// alef:hash:2b253a74f3232c4fa0a86d226959193ecbc232dfc3c6d5c8058980db3434a8a9
...
public class BodyLimitsTest {
    ...
    void testBodyOverLimitReturns413() throws Exception {
        ...
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/body_over_limit_returns_413/body-limit/over");
    ...
    void testBodyUnderLimitSucceeds() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/body_under_limit_succeeds/body-limit/under");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
