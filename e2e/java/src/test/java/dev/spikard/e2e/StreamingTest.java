...
// alef:hash:766406872b425105ff31af493311406a52f93d7ea3798a18bbe7443b58c5a5fa
...
public class StreamingTest {
    ...
    void testBinaryLogDownload() throws Exception {
        ...
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/binary_log_download/stream/logfile");
    ...
    void testChunkedCsvExport() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/chunked_csv_export/stream/csv-report");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
            .method("GET", java.net.http.HttpRequest.BodyPublishers.noBody());
        var response = java.net.http.HttpClient.newHttpClient()
            .send(builder.build(), java.net.http.HttpResponse.BodyHandlers.ofString());
    ...
    void testStreamJsonLines() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/stream_json_lines/stream/json-lines");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
            .method("GET", java.net.http.HttpRequest.BodyPublishers.noBody());
        var response = java.net.http.HttpClient.newHttpClient()
            .send(builder.build(), java.net.http.HttpResponse.BodyHandlers.ofString());
