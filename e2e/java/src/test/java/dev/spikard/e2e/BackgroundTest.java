...
// alef:hash:f3e5da2accb90b7236c17c4e799e36020db3b01b08fd17422a98daf5c7457cd6
...
public class BackgroundTest {
    ...
    void testBackgroundEventLogging() throws Exception {
        ...
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/background_event_logging/background/events");
    ...
    void testBackgroundEventLoggingSecondPayload() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/background_event_logging_second_payload/background/events");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
