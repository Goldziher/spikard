...
// alef:hash:2c947b52f172c46fe352990adba5b1636a8987a6784c9665ec764157d330603b
...
public class RateLimitTest {
    ...
    void testRateLimitBelowThresholdSucceeds() throws Exception {
        ...
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/rate_limit_below_threshold_succeeds/rate-limit/basic");
    ...
    void testRateLimitBurstSettingAllowsSpike() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/rate_limit_burst_setting_allows_spike/rate-limit/burst");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
            .method("GET", java.net.http.HttpRequest.BodyPublishers.noBody());
        var response = java.net.http.HttpClient.newHttpClient()
            .send(builder.build(), java.net.http.HttpResponse.BodyHandlers.ofString());
    ...
    void testRateLimitExceededReturns429() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/rate_limit_exceeded_returns_429/rate-limit/exceeded");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
            .method("GET", java.net.http.HttpRequest.BodyPublishers.noBody());
        var response = java.net.http.HttpClient.newHttpClient()
            .send(builder.build(), java.net.http.HttpResponse.BodyHandlers.ofString());
    ...
    void testRateLimitIpBasedTracking() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/rate_limit_ip_based_tracking/rate-limit/ip-based");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
            .method("GET", java.net.http.HttpRequest.BodyPublishers.noBody());
    ...
    void testRateLimitPerSecondSetting10Requests() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/rate_limit_per_second_setting_10_requests/rate-limit/per-second");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
            .method("GET", java.net.http.HttpRequest.BodyPublishers.noBody());
        var response = java.net.http.HttpClient.newHttpClient()
            .send(builder.build(), java.net.http.HttpResponse.BodyHandlers.ofString());
