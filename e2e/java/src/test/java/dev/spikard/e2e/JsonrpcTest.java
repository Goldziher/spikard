...
class JsonrpcTest {
    ...
    @Test    void testJsonrpcBatchRequest() throws Exception {
        ...
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/jsonrpc_batch_request");
    ...
    @Test    void testJsonrpcCallWithPositionalParams() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/jsonrpc_call_with_positional_params");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testJsonrpcConfigBatchDisabled() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/jsonrpc_config_batch_disabled");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
            .method("POST", java.net.http.HttpRequest.BodyPublishers.ofString("[{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"add\",\"params\":[1,2]},{\"id\":2,\"jsonrpc\":\"2.0\",\"method\":\"subtract\",\"params\":[5,3]}]"));        builder = builder.header("Content-Type", "application/json");        var response = java.net.http.HttpClient.newHttpClient()
            .send(builder.build(), java.net.http.HttpResponse.BodyHandlers.ofString());
    ...
    @Test    void testJsonrpcConfigCustomEndpointPath() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/jsonrpc_config_custom_endpoint_path");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testJsonrpcConfigMaxBatchSize() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/jsonrpc_config_max_batch_size");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testJsonrpcDeprecatedMethodFlag() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/jsonrpc_deprecated_method_flag");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testJsonrpcErrorResponse() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/jsonrpc_error_response");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testJsonrpcInvalidParams() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/jsonrpc_invalid_params");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testJsonrpcMethodNotFound() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/jsonrpc_method_not_found");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testJsonrpcMethodParameterValidation() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/jsonrpc_method_parameter_validation");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testJsonrpcMethodWithParamsSchema() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/jsonrpc_method_with_params_schema");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testJsonrpcMethodWithResultSchema() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/jsonrpc_method_with_result_schema");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testJsonrpcNotificationNoId() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/jsonrpc_notification_no_id");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testJsonrpcNotificationNoResponse() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/jsonrpc_notification_no_response");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    @Test    void testJsonrpcSingleCallSuccess() throws Exception {
        ...
        // then an externally exported MOCK_SERVER_URL, then the default dev port.
        String baseUrl = System.getProperty("mockServerUrl", System.getenv("MOCK_SERVER_URL"));
        if (baseUrl == null) baseUrl = "http://localhost:8080";        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/jsonrpc_single_call_success");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
