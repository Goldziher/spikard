...
import { createAppJsonBodiesUuidFieldInvalidFormat, createAppJsonBodies44ConstValidationFailure, createAppJsonBodiesBooleanFieldSuccess, createAppJsonBodiesNumericLeValidationSuccess, createAppJsonBodiesDeeplyNestedObjects, createAppJsonBodiesOptionalFieldsOmitted, createAppJsonBodiesUuidFieldSuccess, createAppJsonBodiesDateFieldSuccess, createAppJsonBodies47MaxpropertiesValidationFailure, createAppJsonBodies46MinpropertiesValidationFailure, createAppJsonBodiesStringMinLengthValidationFail, createAppJsonBodiesFieldTypeValidationInvalidType, createAppJsonBodies36OneofSchemaMultipleMatchFailure, createAppJsonBodiesNestedObjectSuccess, createAppJsonBodies41NotSchemaSuccess, createAppJsonBodiesStringMaxLengthValidationFail, createAppJsonBodies50DeepNesting4Levels, createAppJsonBodies48DependenciesValidationSuccess, createAppJsonBodiesPatchPartialUpdate, createAppJsonBodies30NestedObjectMissingField, createAppJsonBodiesDatetimeFieldSuccess, createAppJsonBodiesStringPatternValidationSuccess, createAppJsonBodiesExtraFieldsIgnoredNoAdditionalproperties, createAppJsonBodies40AnyofSchemaFailure, createAppJsonBodies39AnyofSchemaMultipleMatchSuccess, createAppJsonBodiesArrayOfPrimitiveValues, createAppJsonBodiesNumericGeValidationFail, createAppJsonBodies37OneofSchemaNoMatchFailure, createAppJsonBodiesEmptyArrayValidationFail, createAppJsonBodies38AnyofSchemaSuccess, createAppJsonBodiesEmptyJsonObject, createAppJsonBodiesStringPatternValidationFail, createAppJsonBodies49DependenciesValidationFailure, createAppJsonBodiesSimpleJsonObjectSuccess, createAppJsonBodiesRequiredFieldMissingValidationError, createAppJsonBodies35OneofSchemaSuccess, createAppJsonBodiesEnumFieldInvalidValue, createAppJsonBodiesEnumFieldSuccess, createAppJsonBodies33AllofSchemaComposition, createAppJsonBodies45MinpropertiesValidationSuccess, createAppJsonBodiesBodyWithQueryParameters, createAppJsonBodies42NotSchemaFailure, createAppJsonBodies43ConstValidationSuccess, createAppJsonBodies32SchemaRefDefinitions, createAppJsonBodies29NestedObjectValidationSuccess, createAppJsonBodies34AdditionalPropertiesFalse, createAppJsonBodiesNullValueForOptionalField, createAppJsonBodies31NullablePropertyNullValue, createAppJsonBodiesArrayOfObjectsSuccess } from "../app/main.js";
...
describe("json_bodies", () => {
	...
	test("Deeply nested objects", async () => {
		...
		const json = {"name":"Product","price":100.0,"seller":{"address":{"city":"Springfield","country":{"code":"US","name":"USA"},"street":"123 Main St"},"name":"John Doe"}};
	...
	test("Array of objects - success", async () => {
		...
		const json = {"images":[{"name":"Front","url":"https://example.com/img1.jpg"},{"name":"Back","url":"https://example.com/img2.jpg"}],"name":"Product Bundle","tags":["electronics","gadget"]};
