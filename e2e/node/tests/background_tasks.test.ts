...
// alef:hash:e2c7846f7a747f2b0d2155f42c204d2aa6c0a88862c731bd95c5d747b76461d1
...
describe("background_tasks", () => {
  ...
  it("background_task_error_handling: Tests that a background task which errors during execution does not crash the executor or block the response", async () => {
    const sutUrl = process.env.SUT_URL || "http://127.0.0.1:8001";
