...
// alef:hash:3cfe851fc04b5dca852e4c0b63925d74c39bc777e7af3e134d68e168f7dc66ee
...
describe('status_codes', () => {
  ...
  it('_501_not_implemented: Unsupported HTTP method should return 501', async () => {
    const mockUrl = `${process.env.MOCK_SERVER_URL}/fixtures/22_501_not_implemented`;
    const response = await fetch(mockUrl, { method: 'TRACE' });
  ...
  it('_503_service_unavailable: Service temporarily unavailable should return 503 with Retry-After', async () => {
    ...
    const data = await response.json();
    expect(data).toEqual({ error: "Service Unavailable", message: "The service is temporarily unavailable. Please try again later." });
