...
import { handleGrpcWellKnownWrapperTypesStringvalueInt32valueEtc } from "../app/main.ts";

describe("grpc", () => {
	test("should handle gRPC request: Well-known wrapper types StringValue Int32Value etc", async () => {
