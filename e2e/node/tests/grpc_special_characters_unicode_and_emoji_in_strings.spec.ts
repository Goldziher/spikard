...
import { handleGrpcSpecialCharactersUnicodeAndEmojiInStrings } from "../app/main.ts";

describe("grpc", () => {
	test("should handle gRPC request: Special characters unicode and emoji in strings", async () => {
