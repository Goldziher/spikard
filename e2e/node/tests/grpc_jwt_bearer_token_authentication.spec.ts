...
import { handleGrpcJwtBearerTokenAuthentication } from "../app/main.ts";

describe("grpc", () => {
	test("should handle gRPC request: JWT Bearer token authentication", async () => {
		...
		const metadata: Record<string, string> = {
			...
			authorization:
				"Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1c2VyLTEyMyIsImlhdCI6MTUxNjIzOTAyMn0.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c",
		};
