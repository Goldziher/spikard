...
import { handleGrpcValidationErrorInvalidArgumentWithDetails } from "../app/main.ts";

describe("grpc", () => {
	test("should handle gRPC request: Validation error - INVALID_ARGUMENT with details", async () => {
