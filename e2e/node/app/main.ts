 ...
 */
async function openapiRedocServing(requestJson: string): Promise<string> {
	const request = JSON.parse(requestJson);
	const _body = request.body ?? null;
	const _params = request.params ?? {};
	const response: any = {};
...
export function createAppOpenapiRedocServing(): SpikardApp {
	...
	const route: RouteMetadata = {
		method: "GET",
		path: "/status",
		handler_name: "openapi_redoc_serving",
	...
	return {
		routes: [route],
		handlers: {
			openapi_redoc_serving: openapiRedocServing,
		},
		config,
	};
}
 ...
 */
async function openapiOpenapiSpecWithJwtSecurityScheme(requestJson: string): Promise<string> {
	const request = JSON.parse(requestJson);
	const _body = request.body ?? null;
...
export function createAppOpenapiOpenapiSpecWithJwtSecurityScheme(): SpikardApp {
	const config: ServerConfig = {
		jwtAuth: {
	...
	const route: RouteMetadata = {
		method: "GET",
		path: "/protected/data",
		handler_name: "openapi_openapi_spec_with_jwt_security_scheme",
		request_schema: undefined,
		response_schema: undefined,
		parameter_schema: {
	...
	return {
		routes: [route],
		handlers: {
			openapi_openapi_spec_with_jwt_security_scheme: openapiOpenapiSpecWithJwtSecurityScheme,
		},
		config,
	};
}
 ...
 */
async function openapiSwaggerUiServing(requestJson: string): Promise<string> {
	const request = JSON.parse(requestJson);
	const _body = request.body ?? null;
	const _params = request.params ?? {};
	const response: any = {};
...
export function createAppOpenapiSwaggerUiServing(): SpikardApp {
	const config: ServerConfig = {
		openapi: {
			enabled: true,
			title: "Health API",
	...
	const route: RouteMetadata = {
		method: "GET",
		path: "/health",
		handler_name: "openapi_swagger_ui_serving",
		request_schema: undefined,
		response_schema: undefined,
		parameter_schema: undefined,
		file_params: undefined,
	...
	return {
		routes: [route],
		handlers: {
			openapi_swagger_ui_serving: openapiSwaggerUiServing,
		},
		config,
	};
}
 ...
 */
async function openapiOpenapiSpecWithApiKeySecurityScheme(requestJson: string): Promise<string> {
	const request = JSON.parse(requestJson);
	const _body = request.body ?? null;
	const params = request.params ?? {};
	const response: any = {};
...
export function createAppOpenapiOpenapiSpecWithApiKeySecurityScheme(): SpikardApp {
	const config: ServerConfig = {
		apiKeyAuth: {
			keys: ["test-key-123"],
	...
	const route: RouteMetadata = {
		method: "GET",
		path: "/api/data",
		handler_name: "openapi_openapi_spec_with_api_key_security_scheme",
		request_schema: undefined,
		response_schema: undefined,
		parameter_schema: {
	...
	return {
		routes: [route],
		handlers: {
			openapi_openapi_spec_with_api_key_security_scheme: openapiOpenapiSpecWithApiKeySecurityScheme,
		},
		config,
	};
}
 ...
 */
async function openapiOpenapiSpecWithCustomMetadata(requestJson: string): Promise<string> {
	const request = JSON.parse(requestJson);
	const _body = request.body ?? null;
	const _params = request.params ?? {};
	const response: any = {};
...
export function createAppOpenapiOpenapiSpecWithCustomMetadata(): SpikardApp {
	const config: ServerConfig = {
		openapi: {
			enabled: true,
			title: "Complete API",
	...
	const route: RouteMetadata = {
		method: "GET",
		path: "/info",
		handler_name: "openapi_openapi_spec_with_custom_metadata",
		request_schema: undefined,
		response_schema: undefined,
		parameter_schema: undefined,
		file_params: undefined,
	...
	return {
		routes: [route],
		handlers: {
			openapi_openapi_spec_with_custom_metadata: openapiOpenapiSpecWithCustomMetadata,
		},
		config,
	};
}
 ...
 */
async function openapiOpenapiSpecGenerationBasic(requestJson: string): Promise<string> {
	const request = JSON.parse(requestJson);
	const _body = request.body ?? null;
	const params = request.params ?? {};
	const response: any = {};
...
export function createAppOpenapiOpenapiSpecGenerationBasic(): SpikardApp {
	const config: ServerConfig = {
		openapi: {
			enabled: true,
			title: "Test API",
	...
	const route: RouteMetadata = {
		method: "GET",
		path: "/users",
		handler_name: "openapi_openapi_spec_generation_basic",
		request_schema: undefined,
		response_schema: undefined,
		parameter_schema: {
			properties: {
	...
	return {
		routes: [route],
		handlers: {
			openapi_openapi_spec_generation_basic: openapiOpenapiSpecGenerationBasic,
		},
		config,
	};
}
...
// - createAppOpenapiRedocServing() for openapi / Redoc serving
// - createAppOpenapiOpenapiSpecWithJwtSecurityScheme() for openapi / OpenAPI spec with JWT security scheme
// - createAppOpenapiSwaggerUiServing() for openapi / Swagger UI serving
// - createAppOpenapiOpenapiSpecWithApiKeySecurityScheme() for openapi / OpenAPI spec with API key security scheme
// - createAppOpenapiOpenapiSpecWithCustomMetadata() for openapi / OpenAPI spec with custom metadata
// - createAppOpenapiOpenapiSpecGenerationBasic() for openapi / OpenAPI spec generation - basic
