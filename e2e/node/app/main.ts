...
import { Provide, StreamingResponse } from "@spikard/node";
import { z } from "zod";
...
export function createAppDiFactoryDependencySuccess(): SpikardApp {
	app.provide("timestampGenerator", Provide(diFactoryDependencySuccessTimestampGenerator));
...
export function createAppDiNestedDependencies3LevelsSuccess(): SpikardApp {
	...
	app.provide("cache", Provide(diNestedDependencies3LevelsSuccessCache, { cacheable: true }));
	app.provide("dbPool", Provide(diNestedDependencies3LevelsSuccessDbPool, { cacheable: true }));
	app.provide("authService", Provide(diNestedDependencies3LevelsSuccessAuthService, { cacheable: true }));
...
export function createAppDiMultipleDependenciesWithCleanupSuccess(): SpikardApp {
	app.provide("cacheConnection", Provide(diMultipleDependenciesWithCleanupSuccessCacheConnection, { cacheable: true }));
	app.provide("dbConnection", Provide(diMultipleDependenciesWithCleanupSuccessDbConnection, { cacheable: true }));
	app.provide("session", Provide(diMultipleDependenciesWithCleanupSuccessSession, { cacheable: true }));
	...
	return {
		routes: [route, backgroundRoute, cleanupRoute],
		handlers: {
...
export function createAppDiMixedSingletonAndPerRequestCachingSuccess(): SpikardApp {
	...
	app.provide("dbPool", Provide(diMixedSingletonAndPerRequestCachingSuccessDbPool, { singleton: true }));
	app.provide(
		"requestContext",
		Provide(diMixedSingletonAndPerRequestCachingSuccessRequestContext, { cacheable: true }),
	);
...
export function createAppDiResourceCleanupAfterRequestSuccess(): SpikardApp {
	app.provide("dbSession", Provide(diResourceCleanupAfterRequestSuccessDbSession, { cacheable: true }));
...
export function createAppDiPerRequestDependencyCachingSuccess(): SpikardApp {
	app.provide(
		"requestIdGenerator",
		Provide(diPerRequestDependencyCachingSuccessRequestIdGenerator, { cacheable: true }),
	);
...
export function createAppDiSingletonDependencyCachingSuccess(): SpikardApp {
	app.provide("appCounter", Provide(diSingletonDependencyCachingSuccessAppCounter, { singleton: true }));
...
export function createAppDiAsyncFactoryDependencySuccess(): SpikardApp {
	app.provide("dbPool", Provide(diAsyncFactoryDependencySuccessDbPool, { cacheable: true }));
