...
module E2ERubyApp
  ...
  def create_app_validation_errors_15_multiple_validation_errors
    app = Spikard::App.new
    app.post("/items/", handler_name: "validation_errors_15_multiple_validation_errors", request_schema: {"additionalProperties" => false, "properties" => {"name" => {"type" => "string"}, "price" => {"type" => "integer"}, "quantity" => {"type" => "integer"}}, "required" => ["name", "price", "quantity"], "type" => "object"}) do |_request|
