...
# alef:hash:e35f2b06f2a44694b2c368eed1f4a31af04b8dd7907ca30288efd90cfbb3a60a
  ...
  describe 'POST /api/form' do
    it 'Tests that safelisted headers (Content-Type: text/plain, Accept, Accept-Language) don\'t require preflight' do
      response = client.post('/api/form',
        headers: { 'Content-Type' => 'text/plain', 'Origin' => 'https://app.example.com', 'Accept-Language' => 'en-US', 'Accept' => 'application/json' }
      )
      expect(response.status).to eq(200)
      expect(response.body).to eq({ 'message' => 'Success' })
