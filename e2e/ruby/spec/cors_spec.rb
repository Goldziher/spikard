...
# alef:hash:e86c3ec6d79ec4e2b92630dfa238ea512b2140da9115b418eefbe97878ccc8e1
  ...
  describe 'POST /api/form' do
    it 'Tests that safelisted headers (Content-Type: text/plain, Accept, Accept-Language) don\'t require preflight' do
      response = client.post('/api/form',
        headers: { 'Accept-Language' => 'en-US', 'Origin' => 'https://app.example.com', 'Accept' => 'application/json', 'Content-Type' => 'text/plain' }
      )
      expect(response.status).to eq(200)
      expect(response.body).to eq({ 'message' => 'Success' })
