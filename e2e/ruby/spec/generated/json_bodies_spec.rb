...
RSpec.describe "json_bodies" do
  it "29_nested_object_validation_success" do
    ...
    response = client.post(path, json: {"profile" => {"email" => "john@example.com", "name" => "John Doe"}})
  ...
  it "30_nested_object_missing_field" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, json: {"profile" => {"name" => "John Doe"}})
  ...
  it "31_nullable_property_null_value" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, json: {"description" => nil, "name" => "Test User"})
    expect(response.status_code).to eq(201)
    expect(response.body_text).to be_nil
    client.close
  end
  ...
  it "32_schema_ref_definitions" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, json: {"product" => {"name" => "Widget", "price" => 9.99}})
    expect(response.status_code).to eq(201)
    expect(response.body_text).to be_nil
    client.close
  end
  ...
  it "33_allof_schema_composition" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, json: {"name" => "Product", "price" => 29.99})
    expect(response.status_code).to eq(201)
    expect(response.body_text).to be_nil
    client.close
  end
  ...
  it "34_additional_properties_false" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, json: {"email" => "john@example.com", "extra_field" => "should fail", "name" => "John"})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "35_oneof_schema_success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, json: {"credit_card" => "1234567812345678"})
    expect(response.status_code).to eq(201)
    expect(response.body_text).to be_nil
    client.close
  end
  ...
  it "36_oneof_schema_multiple_match_failure" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, json: {"credit_card" => "1234567812345678", "paypal_email" => "user@example.com"})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "37_oneof_schema_no_match_failure" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, json: {"bitcoin_address" => "1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa"})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "38_anyof_schema_success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, json: {"email" => "john@example.com", "name" => "John Doe"})
    expect(response.status_code).to eq(201)
    expect(response.body_text).to be_nil
    client.close
  end
  ...
  it "39_anyof_schema_multiple_match_success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, json: {"email" => "john@example.com", "name" => "John Doe", "phone" => "+1-555-0100"})
    expect(response.status_code).to eq(201)
    expect(response.body_text).to be_nil
    client.close
  end
  ...
  it "40_anyof_schema_failure" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, json: {"name" => "John Doe"})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "41_not_schema_success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, json: {"username" => "john_doe"})
    expect(response.status_code).to eq(201)
    expect(response.body_text).to be_nil
    client.close
  end
  ...
  it "42_not_schema_failure" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, json: {"username" => "admin"})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "43_const_validation_success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, json: {"data" => "test", "version" => "1.0"})
    expect(response.status_code).to eq(201)
    expect(response.body_text).to be_nil
    client.close
  end
  ...
  it "44_const_validation_failure" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, json: {"data" => "test", "version" => "2.0"})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "45_minproperties_validation_success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, json: {"host" => "localhost", "port" => 8080})
    expect(response.status_code).to eq(201)
    expect(response.body_text).to be_nil
    client.close
  end
  ...
  it "46_minproperties_validation_failure" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, json: {"host" => "localhost"})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "47_maxproperties_validation_failure" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, json: {"debug" => false, "host" => "localhost", "port" => 8080, "ssl" => true})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "48_dependencies_validation_success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, json: {"billing_address" => "123 Main St", "credit_card" => "1234567812345678", "name" => "John Doe"})
    expect(response.status_code).to eq(201)
    expect(response.body_text).to be_nil
    client.close
  end
  ...
  it "49_dependencies_validation_failure" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, json: {"credit_card" => "1234567812345678", "name" => "John Doe"})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "50_deep_nesting_4_levels" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, json: {"user" => {"profile" => {"contact" => {"address" => {"street" => "123 Main St"}}}}})
    expect(response.status_code).to eq(201)
    expect(response.body_text).to be_nil
    client.close
  end
  ...
  it "Array of objects - success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"images" => [{"name" => "Front", "url" => "https://example.com/img1.jpg"}, {"name" => "Back", "url" => "https://example.com/img2.jpg"}], "name" => "Product Bundle", "tags" => ["electronics", "gadget"]})
  ...
  it "Array of primitive values" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"name" => "Product", "ratings" => [4.5, 4.8, 5.0, 4.2], "tags" => ["electronics", "gadget", "new"]})
    expect(response.status_code).to eq(200)
  ...
  it "Body with query parameters" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, query: {"limit" => 10}, headers: {"Content-Type" => "application/json"}, json: {"name" => "Item", "price" => 42.0})
    expect(response.status_code).to eq(200)
  ...
  it "Boolean field - success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"in_stock" => true, "name" => "Item", "price" => 42.0})
    expect(response.status_code).to eq(200)
  ...
  it "Date field - success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"event_date" => "2024-03-15", "name" => "Conference"})
    expect(response.status_code).to eq(200)
  ...
  it "Datetime field - success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"created_at" => "2024-03-15T10:30:00Z", "name" => "Meeting"})
    expect(response.status_code).to eq(200)
  ...
  it "Deeply nested objects" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"name" => "Product", "price" => 100.0, "seller" => {"address" => {"city" => "Springfield", "country" => {"code" => "US", "name" => "USA"}, "street" => "123 Main St"}, "name" => "John Doe"}})
    expect(response.status_code).to eq(200)
  ...
  it "Empty array validation - fail" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"name" => "Product", "tags" => []})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "Enum field - invalid value" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"category" => "furniture", "name" => "Item"})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "Enum field - success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"category" => "electronics", "name" => "Item"})
    expect(response.status_code).to eq(200)
  ...
  it "Extra fields ignored (no additionalProperties)" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"another_extra" => 123, "extra_field" => "this should be ignored", "name" => "Item", "price" => 42.0})
    expect(response.status_code).to eq(200)
  ...
  it "Field type validation - invalid type" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"description" => "A very nice Item", "name" => "Foo", "price" => "not a number", "tax" => 3.2})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "Nested object - success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"image" => {"name" => "Product Image", "url" => "https://example.com/image.jpg"}, "name" => "Foo", "price" => 42.0})
    expect(response.status_code).to eq(200)
  ...
  it "Null value for optional field" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"description" => nil, "name" => "Item", "price" => 42.0, "tax" => nil})
    expect(response.status_code).to eq(200)
  ...
  it "Numeric ge validation - fail" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"name" => "Item", "price" => 0.5})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "Numeric le validation - success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"name" => "Item", "price" => 100.0})
    expect(response.status_code).to eq(200)
  ...
  it "Optional fields - omitted" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"name" => "Foo", "price" => 35.4})
    expect(response.status_code).to eq(200)
  ...
  it "PATCH partial update" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.patch(path, headers: {"Content-Type" => "application/json"}, json: {"price" => 45.0})
    expect(response.status_code).to eq(200)
  ...
  it "Required field missing - validation error" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"description" => "A very nice Item", "price" => 35.4})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "Simple JSON object - success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"description" => "A very nice Item", "name" => "Foo", "price" => 35.4, "tax" => 3.2})
    expect(response.status_code).to eq(200)
  ...
  it "String max_length validation - fail" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"name" => "This is a very long name that exceeds the maximum length", "price" => 35.4})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "String min_length validation - fail" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"name" => "ab", "price" => 35.4})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "String pattern validation - fail" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"name" => "Item", "sku" => "ABC-123"})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "String pattern validation - success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"name" => "Item", "sku" => "ABC1234"})
    expect(response.status_code).to eq(200)
  ...
  it "UUID field - invalid format" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"item_id" => "not-a-valid-uuid", "name" => "Item"})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "UUID field - success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/json"}, json: {"item_id" => "c892496f-b1fd-4b91-bdb8-b46f92df1716", "name" => "Item"})
    expect(response.status_code).to eq(200)
