...
RSpec.describe "asyncapi_websocket" do
  it "echoes WebSocket message 1 on /chat" do
    ...
    message = JSON.parse("{\"text\":\"example_text\",\"timestamp\":\"2024-01-15T10:30:00Z\",\"type\":\"message\",\"user\":\"example_user\"}")
  ...
  it "echoes WebSocket message 2 on /chat" do
    ...
    message = JSON.parse("{\"timestamp\":\"2024-01-15T10:30:00Z\",\"type\":\"userLeft\",\"user\":\"example_user\"}")
    ws.send_json(message)
    response = ws.receive_json
  ...
  it "echoes WebSocket message 3 on /chat" do
    ...
    message = JSON.parse("{\"timestamp\":\"2024-01-15T10:30:00Z\",\"type\":\"userJoined\",\"user\":\"example_user\"}")
    ws.send_json(message)
    response = ws.receive_json
