...
RSpec.describe "url_encoded" do
  ...
  it "Boolean field conversion" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/x-www-form-urlencoded"}, data: {"subscribe" => "true", "username" => "johndoe"})
  ...
  it "Empty string value" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/x-www-form-urlencoded"}, data: {"description" => "", "username" => "johndoe"})
    expect(response.status_code).to eq(200)
  ...
  it "Multiple values for same field" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/x-www-form-urlencoded"}, data: {"tags" => ["python", "fastapi", "web"]})
    expect(response.status_code).to eq(200)
  ...
  it "Numeric field type conversion" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/x-www-form-urlencoded"}, data: {"age" => "30", "username" => "johndoe"})
    expect(response.status_code).to eq(200)
  ...
  it "OAuth2 password grant flow" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/x-www-form-urlencoded"}, data: {"grant_type" => "password", "password" => "secret", "scope" => "", "username" => "johndoe"})
    expect(response.status_code).to eq(200)
  ...
  it "Optional field missing - success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/x-www-form-urlencoded"}, data: {"password" => "secret", "username" => "johndoe"})
    expect(response.status_code).to eq(200)
  ...
  it "Pattern validation - fail" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/x-www-form-urlencoded"}, data: {"username" => "john doe"})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "Required field missing - validation error" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/x-www-form-urlencoded"}, data: {"password" => "secret"})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "Special characters encoding" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/x-www-form-urlencoded"}, data: {"description" => "Test & Development", "name" => "John Doe"})
    expect(response.status_code).to eq(200)
  ...
  it "String max_length validation - fail" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/x-www-form-urlencoded"}, data: {"username" => "this_is_a_very_long_username_that_exceeds_limit"})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "String min_length validation - fail" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"Content-Type" => "application/x-www-form-urlencoded"}, data: {"username" => "ab"})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
