...
RSpec.describe "headers" do
  it "30_bearer_token_format_valid" do
    ...
    response = client.get(path, headers: {"Authorization" => "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIn0.dozjgNryP4J3jVmNHl0w5N_XgL0n3I9PlFUP0THsR8U"})
  ...
  it "31_bearer_token_format_invalid" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.get(path, headers: {"Authorization" => "Bearer invalid token with spaces"})
  ...
  it "32_bearer_token_missing_prefix" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.get(path, headers: {"Authorization" => "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9"})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "33_api_key_header_valid" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.get(path, headers: {"X-API-Key" => "a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4"})
    expect(response.status_code).to eq(200)
    expect(response.body_text).to be_nil
    client.close
  end
  ...
  it "34_api_key_header_invalid" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.get(path, headers: {"X-API-Key" => "invalid-key"})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "Authorization header - success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.get(path, headers: {"Authorization" => "Digest foobar"})
    expect(response.status_code).to eq(200)
  ...
  it "Authorization header - wrong scheme" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.get(path, headers: {"Authorization" => "Other invalidauthorization"})
    expect(response.status_code).to eq(422)
  ...
  it "Basic authentication - success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.get(path, headers: {"Authorization" => "Basic dXNlcm5hbWU6cGFzc3dvcmQ="})
    expect(response.status_code).to eq(200)
  ...
  it "Bearer token authentication - success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.get(path, headers: {"Authorization" => "Bearer valid_token_123"})
    expect(response.status_code).to eq(200)
  ...
  it "Header case insensitivity - access" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.post(path, headers: {"content-type" => "application/json"}, json: {"test" => "data"})
    expect(response.status_code).to eq(200)
  ...
  it "Header regex validation - fail" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.get(path, headers: {"X-Request-Id" => "invalid-format"})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "Header regex validation - success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.get(path, headers: {"X-Request-Id" => "12345"})
    expect(response.status_code).to eq(200)
  ...
  it "Header validation - max_length constraint fail" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.get(path, headers: {"X-Session-Id" => "this_is_way_too_long_for_validation"})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "Header validation - min_length constraint" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.get(path, headers: {"X-Token" => "ab"})
    expect(response.status_code).to eq(422)
    body = response.json
    expect(body).to be_a(Hash)
    expect(body['errors']).to be_an(Array)
  ...
  it "Header with underscore conversion - explicit" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.get(path, headers: {"X-Token" => "secret123"})
    expect(response.status_code).to eq(200)
  ...
  it "Host header" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.get(path, headers: {"Host" => "example.com:8080"})
    expect(response.status_code).to eq(200)
  ...
  it "Multiple custom headers" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.get(path, headers: {"X-Client-Version" => "1.2.3", "X-Request-Id" => "req-12345", "X-Trace-Id" => "trace-abc"})
    expect(response.status_code).to eq(200)
  ...
  it "Referer header" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.get(path, headers: {"Referer" => "https://example.com/page"})
    expect(response.status_code).to eq(200)
  ...
  it "User-Agent header - custom value" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.get(path, headers: {"User-Agent" => "Mozilla/5.0 Custom Browser"})
    expect(response.status_code).to eq(200)
  ...
  it "X-API-Key optional header - success" do
    ...
    client = Spikard::Testing.create_test_client(app)
    path = app.route_metadata.first[:path]
    response = client.get(path, headers: {"key" => "secret"})
    expect(response.status_code).to eq(200)
