...
defmodule E2e.ProblemDetailsTest do
  ...
  describe "problem_details_400_bad_request" do
    test "Tests ProblemDetails for 400 Bad Request status" do
      {:ok, response} = Req.post(url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/problem_details_400_bad_request", connect_options: [protocols: [:http1]], finch: AlefE2EFinch, json: %{"data" => "example"}, headers: [{"Content-Type", "application/json"}])
  ...
  describe "problem_details_401_unauthorized" do
    test "Tests ProblemDetails for 401 Unauthorized status" do
      {:ok, response} = Req.get(url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/problem_details_401_unauthorized", connect_options: [protocols: [:http1]], finch: AlefE2EFinch)
  ...
  describe "problem_details_403_forbidden" do
    test "Tests ProblemDetails for 403 Forbidden status" do
      {:ok, response} = Req.get(url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/problem_details_403_forbidden", connect_options: [protocols: [:http1]], finch: AlefE2EFinch)
  ...
  describe "problem_details_500_internal_error" do
    test "Tests ProblemDetails for 500 Internal Server Error status" do
      {:ok, response} = Req.get(url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/problem_details_500_internal_error", connect_options: [protocols: [:http1]], finch: AlefE2EFinch)
  ...
  describe "problem_details_standard_all_fields" do
    test "Tests RFC 9457 ProblemDetails response with all standard fields" do
      {:ok, response} = Req.get(url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/problem_details_standard_all_fields", connect_options: [protocols: [:http1]], finch: AlefE2EFinch)
  ...
  describe "problem_details_with_extensions" do
    test "Tests ProblemDetails includes custom extensions for additional context" do
      {:ok, response} = Req.post(url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/problem_details_with_extensions", connect_options: [protocols: [:http1]], finch: AlefE2EFinch, json: %{"data" => "invalid"}, headers: [{"Content-Type", "application/json"}])
  ...
  describe "problem_details_with_instance" do
    test "Tests ProblemDetails includes instance URI for context" do
      {:ok, response} = Req.get(url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/problem_details_with_instance", connect_options: [protocols: [:http1]], finch: AlefE2EFinch)
      assert response.status == 404
      body_decoded = if is_binary(response.body), do: Jason.decode!(response.body), else: response.body
  ...
  describe "problem_details_with_type_uri" do
    test "Tests ProblemDetails includes type URI for error classification" do
      {:ok, response} = Req.post(url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/problem_details_with_type_uri", connect_options: [protocols: [:http1]], finch: AlefE2EFinch, json: %{"value" => -5}, headers: [{"Content-Type", "application/json"}])
      assert response.status == 422
      body_decoded = if is_binary(response.body), do: Jason.decode!(response.body), else: response.body
