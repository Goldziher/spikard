...
# alef:hash:f6e48a313b3e22c9ad56918c8a995e2d459d3c232d07e8bf6c481c2e9231ad7c
...
defmodule E2e.JsonrpcTest do
  ...
  describe "jsonrpc_batch_request" do
    test "Tests JSON-RPC batch request with multiple calls" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jsonrpc_batch_request",
          finch: AlefE2EFinch,
          json: [
  ...
  describe "jsonrpc_call_with_positional_params" do
    test "Tests JSON-RPC call with positional array parameters" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jsonrpc_call_with_positional_params",
          finch: AlefE2EFinch,
  ...
  describe "jsonrpc_config_batch_disabled" do
    test "Tests JSON-RPC batch requests disabled returns error" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jsonrpc_config_batch_disabled",
          finch: AlefE2EFinch,
          json: [
            %{"id" => 1, "jsonrpc" => "2.0", "method" => "add", "params" => [1, 2]},
            %{"id" => 2, "jsonrpc" => "2.0", "method" => "subtract", "params" => [5, 3]}
  ...
  describe "jsonrpc_config_custom_endpoint_path" do
    test "Tests JSON-RPC server at custom endpoint path" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jsonrpc_config_custom_endpoint_path",
          finch: AlefE2EFinch,
  ...
  describe "jsonrpc_config_max_batch_size" do
    test "Tests JSON-RPC batch request respects maximum batch size" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jsonrpc_config_max_batch_size",
          finch: AlefE2EFinch,
          json: [
  ...
  describe "jsonrpc_deprecated_method_flag" do
    test "Tests JSON-RPC method marked as deprecated" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jsonrpc_deprecated_method_flag",
          finch: AlefE2EFinch,
      ...
      assert Enum.find_value(response.headers, fn {k, v} -> if String.downcase(k) == "deprecation", do: List.first(List.wrap(v)) end) ==
               "true"
  ...
  describe "jsonrpc_error_response" do
    test "Tests JSON-RPC error response with error object" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jsonrpc_error_response",
          finch: AlefE2EFinch,
  ...
  describe "jsonrpc_invalid_params" do
    test "Tests JSON-RPC error for invalid parameters" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jsonrpc_invalid_params",
          finch: AlefE2EFinch,
  ...
  describe "jsonrpc_method_not_found" do
    test "Tests JSON-RPC error when method does not exist" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jsonrpc_method_not_found",
          finch: AlefE2EFinch,
  ...
  describe "jsonrpc_method_parameter_validation" do
    test "Tests JSON-RPC validates parameter types and values" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jsonrpc_method_parameter_validation",
          finch: AlefE2EFinch,
          json: %{
            "id" => 6,
            "jsonrpc" => "2.0",
  ...
  describe "jsonrpc_method_with_params_schema" do
    test "Tests JSON-RPC method params validated against schema" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jsonrpc_method_with_params_schema",
          finch: AlefE2EFinch,
  ...
  describe "jsonrpc_method_with_result_schema" do
    test "Tests JSON-RPC method result schema validation" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jsonrpc_method_with_result_schema",
          finch: AlefE2EFinch,
  ...
  describe "jsonrpc_notification_no_id" do
    test "Tests JSON-RPC notification (no response expected)" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jsonrpc_notification_no_id",
          finch: AlefE2EFinch,
  ...
  describe "jsonrpc_notification_no_response" do
    test "Tests JSON-RPC notification (no id) doesn't return response" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jsonrpc_notification_no_response",
          finch: AlefE2EFinch,
  ...
  describe "jsonrpc_single_call_success" do
    test "Tests single JSON-RPC 2.0 call with successful response" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jsonrpc_single_call_success",
          finch: AlefE2EFinch,
