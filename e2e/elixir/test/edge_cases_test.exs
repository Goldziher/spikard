...
# alef:hash:8d4d70b8df12f7a601c56cd86e4723b8fcabacaacc4f25a9875228fd792bf0a1
...
defmodule E2e.EdgeCasesTest do
  ...
  describe "utf8_query_parameter" do
    test "Query parameter with UTF-8 characters should be handled correctly" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/11_utf8_query_parameter",
          finch: AlefE2EFinch,
          params: [{"term", "café"}]
        )
  ...
  describe "percent_encoded_special_chars" do
    test "Percent-encoded special characters should be decoded correctly" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/12_percent_encoded_special_chars",
          finch: AlefE2EFinch,
          params: [{"term", "hi there"}]
        )
  ...
  describe "empty_string_query_param_preserved" do
    test "Empty string query parameter should be preserved, not treated as missing" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/13_empty_string_query_param_preserved",
          finch: AlefE2EFinch,
          params: [{"filter", ""}]
        )
  ...
  describe "large_integer_boundary" do
    test "Very large integer at JavaScript MAX_SAFE_INTEGER boundary should be handled" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/14_large_integer_boundary",
          finch: AlefE2EFinch,
      ...
      assert response.status == 200
      body_decoded = if is_binary(response.body), do: Jason.decode!(response.body), else: response.body
      assert body_decoded == %{"id" => 9_007_199_254_740_991}
    end
  end
  ...
  describe "float_precision_preservation" do
    test "High-precision floating point numbers should be preserved without loss" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/15_float_precision_preservation",
          finch: AlefE2EFinch,
  ...
  describe "negative_zero_handling" do
    test "Negative zero (-0.0) should be handled correctly in numeric fields" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/16_negative_zero_handling",
          finch: AlefE2EFinch,
          json: %{"offset" => -0.0}
        )
  ...
  describe "extremely_long_string" do
    test "Very long string values should be validated against maxLength" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/17_extremely_long_string",
          finch: AlefE2EFinch,
          json: %{
            "content" =>
  ...
  describe "unicode_normalization" do
    test "Unicode characters with combining diacritics should be handled correctly" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/18_unicode_normalization",
          finch: AlefE2EFinch,
          json: %{"name" => "café"}
        )
  ...
  describe "emoji_in_strings" do
    test "Emoji characters should be handled correctly in string fields" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/19_emoji_in_strings",
          finch: AlefE2EFinch,
  ...
  describe "scientific_notation_number" do
    test "Numbers in scientific notation should be parsed correctly" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/21_scientific_notation_number",
          finch: AlefE2EFinch,
          json: %{"value" => 123_000.0}
        )

      assert response.status == 201
      body_decoded = if is_binary(response.body), do: Jason.decode!(response.body), else: response.body
      assert body_decoded == %{"value" => 123_000}
    end
  end
  ...
  describe "leading_zeros_integer" do
    test "Integer values with leading zeros should be parsed as decimal (not octal)" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/22_leading_zeros_integer",
          finch: AlefE2EFinch,
          params: [{"value", "0123"}]
        )
  ...
  describe "deeply_nested_json_limit" do
    test "Extremely deeply nested JSON should be rejected to prevent DoS" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/23_deeply_nested_json_limit",
          finch: AlefE2EFinch,
          json: %{
            "nested" => %{
              "nested" => %{
  ...
  describe "array_with_holes" do
    test "Array indices with gaps should be rejected in form data" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/24_array_with_holes",
          finch: AlefE2EFinch,
  ...
  describe "deeply_nested_structure_10_levels" do
    test "Tests handling of deeply nested JSON objects" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/deeply_nested_structure_10_levels",
          finch: AlefE2EFinch,
          json: %{
            "level1" => %{
              "level2" => %{
  ...
  describe "empty_and_null_value_handling" do
    test "Tests distinction between null, empty, and missing values" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/empty_and_null_value_handling",
          finch: AlefE2EFinch,
          json: %{
            "empty_array" => [],
            "empty_object" => %{},
  ...
  describe "float_precision_and_rounding" do
    test "Tests floating point precision and rounding behavior" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/float_precision_and_rounding",
          finch: AlefE2EFinch,
          json: %{
            "expected_sum" => 0.3,
  ...
  describe "large_integer_boundary_values" do
    test "Tests handling of very large integer values near system limits" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/large_integer_boundary_values",
          finch: AlefE2EFinch,
          json: %{
  ...
  describe "special_string_values_and_escaping" do
    test "Tests handling of special characters, null bytes, and escape sequences" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/special_string_values_and_escaping",
          finch: AlefE2EFinch,
          json: %{
  ...
  describe "unicode_and_emoji_handling" do
    test "Tests proper handling of Unicode characters and emojis" do
      {:ok, response} =
        Req.post(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/unicode_and_emoji_handling",
          finch: AlefE2EFinch,
          json: %{
