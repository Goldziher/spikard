...
// alef:hash:5efff875cda8c995c12621c9d927ed5aa58aea62fee2f6d67e9c338c9216ef89
...
final class AuthTest extends TestCase
{
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/api_key_authentication_invalid_key/api/data', [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/api_key_authentication_missing_header/api/data');
        $this->assertEquals(401, $response->getStatusCode());
        $body = json_decode((string) $response->getBody(), true, 512, JSON_THROW_ON_ERROR);
        $this->assertEquals(
            [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/api_key_authentication_valid_key/api/data', [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/api_key_custom_header_x_api_token/api/resource', [
    ...
    public function test_api_key_in_query_parameter(): void
    {
        $response = $this->httpClient->request(
            'GET',
            '/fixtures/api_key_in_query_parameter/api/data?api_key=sk_test_123456',
        );
        $this->assertEquals(200, $response->getStatusCode());
        $body = json_decode((string) $response->getBody(), true, 512, JSON_THROW_ON_ERROR);
        $this->assertEquals(['data' => 'sensitive information', 'message' => 'Access granted'], $body);
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/api_key_multiple_valid_keys/api/endpoint', [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/api_key_rotation_old_key_still_valid/api/data', [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/api_key_with_custom_header_name/api/data', [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/bearer_token_without_prefix/api/protected', [
            'headers' => [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/jwt_audience_claim_aud_field/api/protected', [
            'headers' => [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/jwt_authentication_expired_token/protected/user', [
            'headers' => [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/jwt_authentication_invalid_audience/protected/user', [
            'headers' => [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/jwt_authentication_invalid_signature/protected/user', [
            'headers' => [
    ...
    public function test_jwt_authentication_missing_authorization_header(): void
    {
        $response = $this->httpClient->request(
            'GET',
            '/fixtures/jwt_authentication_missing_authorization_header/protected/user',
        );
        $this->assertEquals(401, $response->getStatusCode());
        $body = json_decode((string) $response->getBody(), true, 512, JSON_THROW_ON_ERROR);
        $this->assertEquals(
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/jwt_authentication_valid_token/protected/user', [
            'headers' => [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/jwt_config_algorithm_rs256/api/secure', [
            'headers' => [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/jwt_config_leeway_seconds/api/protected', [
            'headers' => [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/jwt_expiration_claim_exp_field/api/protected', [
            'headers' => [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/jwt_invalid_issuer/api/protected', [
            'headers' => [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/jwt_issuer_claim_iss_field/api/protected', [
            'headers' => [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/jwt_malformed_token_format/api/protected', [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/jwt_missing_required_custom_claims/api/admin', [
            'headers' => [
                'Authorization' => 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1c2VyMTIzIiwiZXhwIjoyNjI2NzgzOTQ2LCJpYXQiOjE3NjI3ODM5NDYsImF1ZCI6WyJodHRwczovL2FwaS5leGFtcGxlLmNvbSJdLCJpc3MiOiJodHRwczovL2F1dGguZXhhbXBsZS5jb20ifQ.TpRpCJeXROQ12-ehRCVZm6EgN7Dn6QpfoekxJvnzgQg',
            ],
        ]);
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/jwt_not_before_claim_in_future/api/protected', [
            'headers' => [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/jwt_subject_claim_sub_field/api/user', [
            'headers' => [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/jwt_with_multiple_audiences/api/protected', [
            'headers' => [
