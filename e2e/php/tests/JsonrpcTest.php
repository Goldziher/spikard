...
// alef:hash:6af22624a0c53cf834b37a46ca6dc498c18ce9d08a004d8cac2b860f9877bad2
...
final class JsonrpcTest extends TestCase
{
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/jsonrpc_batch_request", [
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/jsonrpc_call_with_positional_params", [
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/jsonrpc_config_batch_disabled", [
            'json' => [["id" => 1, "jsonrpc" => "2.0", "method" => "add", "params" => [1, 2]], ["id" => 2, "jsonrpc" => "2.0", "method" => "subtract", "params" => [5, 3]]],
            'headers' => ["Content-Type" => "application/json"],
        ]);
        $body = json_decode((string) $response->getBody(), true, 512, JSON_THROW_ON_ERROR);
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/jsonrpc_config_custom_endpoint_path", [
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/jsonrpc_deprecated_method_flag", [
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/jsonrpc_error_response", [
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/jsonrpc_invalid_params", [
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/jsonrpc_method_not_found", [
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/jsonrpc_method_parameter_validation", [
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/jsonrpc_method_with_result_schema", [
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/jsonrpc_notification_no_id", [
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/jsonrpc_notification_no_response", [
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/jsonrpc_single_call_success", [
