...
final class JsonrpcTest extends TestCase
{
    ...
    {
        $response = $this->httpClient->request('POST', '/fixtures/jsonrpc_batch_request/rpc', [
            'json' => [
        ...
        $this->assertEquals(
            [['id' => 1, 'jsonrpc' => '2.0', 'result' => 3], ['id' => 2, 'jsonrpc' => '2.0', 'result' => 2]],
            $body,
        );
    }
    ...
    {
        $response = $this->httpClient->request('POST', '/fixtures/jsonrpc_call_with_positional_params/rpc', [
    ...
    {
        $response = $this->httpClient->request('POST', '/fixtures/jsonrpc_config_batch_disabled/rpc', [
            'json' => [
                ['id' => 1, 'jsonrpc' => '2.0', 'method' => 'add', 'params' => [1, 2]],
                ['id' => 2, 'jsonrpc' => '2.0', 'method' => 'subtract', 'params' => [5, 3]],
            ],
        ...
        $body = json_decode((string) $response->getBody(), true, 512, JSON_THROW_ON_ERROR);
        $this->assertEquals(
            ['error' => ['code' => -32600, 'message' => 'Batch requests not enabled'], 'jsonrpc' => '2.0'],
            $body,
        );
    }
    ...
    {
        $response = $this->httpClient->request('POST', '/fixtures/jsonrpc_config_custom_endpoint_path/api/rpc', [
    ...
    {
        $response = $this->httpClient->request('POST', '/fixtures/jsonrpc_config_max_batch_size/rpc', [
            'json' => [
    ...
    {
        $response = $this->httpClient->request('POST', '/fixtures/jsonrpc_deprecated_method_flag/rpc', [
    ...
    {
        $response = $this->httpClient->request('POST', '/fixtures/jsonrpc_error_response/rpc', [
            'json' => [
                'id' => 3,
                'jsonrpc' => '2.0',
                'method' => 'divide',
    ...
    {
        $response = $this->httpClient->request('POST', '/fixtures/jsonrpc_invalid_params/rpc', [
        ...
        $body = json_decode((string) $response->getBody(), true, 512, JSON_THROW_ON_ERROR);
        $this->assertEquals(
            ['error' => ['code' => -32602, 'message' => 'Invalid params'], 'id' => 5, 'jsonrpc' => '2.0'],
            $body,
        );
    }
    ...
    {
        $response = $this->httpClient->request('POST', '/fixtures/jsonrpc_method_not_found/rpc', [
    ...
    {
        $response = $this->httpClient->request('POST', '/fixtures/jsonrpc_method_parameter_validation/rpc', [
            'json' => [
                'id' => 6,
                'jsonrpc' => '2.0',
                'method' => 'update_user',
    ...
    {
        $response = $this->httpClient->request('POST', '/fixtures/jsonrpc_method_with_params_schema/rpc', [
            'json' => [
                'id' => 1,
                'jsonrpc' => '2.0',
                'method' => 'createUser',
        ...
        $body = json_decode((string) $response->getBody(), true, 512, JSON_THROW_ON_ERROR);
        $this->assertEquals(
            ['id' => 1, 'jsonrpc' => '2.0', 'result' => ['age' => 30, 'id' => 1, 'name' => 'Alice']],
            $body,
        );
    }
    ...
    {
        $response = $this->httpClient->request('POST', '/fixtures/jsonrpc_method_with_result_schema/rpc', [
        ...
        $body = json_decode((string) $response->getBody(), true, 512, JSON_THROW_ON_ERROR);
        $this->assertEquals(
            ['id' => 1, 'jsonrpc' => '2.0', 'result' => ['email' => 'john@example.com', 'id' => 1, 'name' => 'John']],
            $body,
        );
    }
    ...
    {
        $response = $this->httpClient->request('POST', '/fixtures/jsonrpc_notification_no_id/rpc', [
    ...
    {
        $response = $this->httpClient->request('POST', '/fixtures/jsonrpc_notification_no_response/rpc', [
    ...
    {
        $response = $this->httpClient->request('POST', '/fixtures/jsonrpc_single_call_success/rpc', [
