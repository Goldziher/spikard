...
// alef:hash:65d2ab649db9b02de97283e3ef9fca0863757851b1ef6a463aa002616a2992f2
...
final class RateLimitTest extends TestCase
{
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/rate_limit_ip_based_tracking/rate-limit/ip-based', [
