...
// alef:hash:9e1ca6f95f3c4c69d17617512578e03d170455fc893ddc07e5bbdb85c61ab4b2
...
final class GrpcTest extends TestCase
{
    ...
    public function test_grpc_call_with_metadata(): void
    {
        $response = $this->httpClient->request('POST', "/fixtures/grpc_call_with_metadata", [
            'json' => ["id" => "resource-1"],
            'headers' => ["Content-Type" => "application/grpc", "te" => "trailers", "x-custom-metadata" => "value123", "authorization" => "Bearer token123"],
        ]);
    ...
    public function test_grpc_config_compression_enabled(): void
    {
        $response = $this->httpClient->request('POST', "/fixtures/grpc_config_compression_enabled", [
            ...
            'headers' => ["te" => "trailers", "Content-Type" => "application/grpc", "grpc-encoding" => "gzip"],
        ]);
        $this->assertEquals(200, $response->getStatusCode());
    ...
    public function test_grpc_config_request_timeout(): void
    {
        $response = $this->httpClient->request('POST', "/fixtures/grpc_config_request_timeout", [
            ...
            'headers' => ["te" => "trailers", "grpc-timeout" => "5000m", "Content-Type" => "application/grpc"],
        ]);
        $this->assertEquals(200, $response->getStatusCode());
        $this->assertEquals("application/grpc", $response->getHeaderLine("content-type"));
        $this->assertEquals("0", $response->getHeaderLine("grpc-status"));
    ...
    public function test_grpc_request_with_custom_metadata(): void
    {
        $response = $this->httpClient->request('POST', "/fixtures/grpc_request_with_custom_metadata", [
            ...
            'headers' => ["Content-Type" => "application/grpc", "x-trace-id" => "trace-abc123", "x-request-id" => "req-12345", "x-user-id" => "user-42", "te" => "trailers"],
        ]);
        $body = json_decode((string) $response->getBody(), true, 512, JSON_THROW_ON_ERROR);
        $this->assertEquals(200, $response->getStatusCode());
