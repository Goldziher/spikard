...
// alef:hash:c2118a9d836366f65bb2eb81de5b1e02e59d4795cb77e37c828b6903a88142e0
...
final class GrpcTest extends TestCase
{
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/grpc_call_with_metadata", [
            'json' => ["id" => "resource-1"],
            'headers' => ["x-custom-metadata" => "value123", "Content-Type" => "application/grpc", "authorization" => "Bearer token123", "te" => "trailers"],
        ]);
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/grpc_config_compression_enabled", [
            'json' => ["request" => "get_data"],
            'headers' => ["Content-Type" => "application/grpc", "te" => "trailers", "grpc-encoding" => "gzip"],
        ]);
        $this->assertEquals(200, $response->getStatusCode());
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/grpc_config_max_message_size", [
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/grpc_config_request_timeout", [
            'json' => ["operation" => "process"],
            'headers' => ["grpc-timeout" => "5000m", "Content-Type" => "application/grpc", "te" => "trailers"],
        ]);
        $this->assertEquals(200, $response->getStatusCode());
        $this->assertEquals("application/grpc", $response->getHeaderLine("content-type"));
        $this->assertEquals("0", $response->getHeaderLine("grpc-status"));
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/grpc_deadline_exceeded", [
            'json' => ["duration_ms" => 60000],
            'headers' => ["te" => "trailers", "Content-Type" => "application/grpc", "grpc-timeout" => "100m"],
        ]);
        $body = json_decode((string) $response->getBody(), true, 512, JSON_THROW_ON_ERROR);
        $this->assertEquals(200, $response->getStatusCode());
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/grpc_error_invalid_argument", [
            'json' => ["value" => -100],
            'headers' => ["Content-Type" => "application/grpc", "te" => "trailers"],
        ]);
        $body = json_decode((string) $response->getBody(), true, 512, JSON_THROW_ON_ERROR);
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/grpc_error_not_found", [
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/grpc_request_method_name_field", [
            'json' => ["id" => "resource-1"],
            'headers' => ["te" => "trailers", "Content-Type" => "application/grpc"],
        ]);
        $body = json_decode((string) $response->getBody(), true, 512, JSON_THROW_ON_ERROR);
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/grpc_request_service_name_field", [
            'json' => ["name" => "World"],
            'headers' => ["te" => "trailers", "Content-Type" => "application/grpc"],
        ]);
        $body = json_decode((string) $response->getBody(), true, 512, JSON_THROW_ON_ERROR);
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/grpc_request_with_custom_metadata", [
            'json' => ["data" => ["key" => "value"], "request_id" => "req-12345"],
            'headers' => ["te" => "trailers", "x-user-id" => "user-42", "x-trace-id" => "trace-abc123", "Content-Type" => "application/grpc", "x-request-id" => "req-12345"],
        ]);
        $body = json_decode((string) $response->getBody(), true, 512, JSON_THROW_ON_ERROR);
        $this->assertEquals(200, $response->getStatusCode());
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/grpc_response_with_metadata_trailers", [
            'json' => ["request" => "test"],
            'headers' => ["te" => "trailers", "Content-Type" => "application/grpc"],
        ]);
        $body = json_decode((string) $response->getBody(), true, 512, JSON_THROW_ON_ERROR);
    ...
    {
        $response = $this->httpClient->request('POST', "/fixtures/grpc_unary_call_success", [
            'json' => ["name" => "World"],
            'headers' => ["Content-Type" => "application/grpc", "te" => "trailers"],
        ]);
        $body = json_decode((string) $response->getBody(), true, 512, JSON_THROW_ON_ERROR);
