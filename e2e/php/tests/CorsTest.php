...
// alef:hash:69ee7f12f6bea547641ba2243c71b05c5047f1661190e5623706cfd95102d977
...
final class CorsTest extends TestCase
{
    ...
    {
        $response = $this->httpClient->request('OPTIONS', '/fixtures/06_cors_preflight_method_not_allowed/api/data', [
            'headers' => [
    ...
    {
        $response = $this->httpClient->request('OPTIONS', '/fixtures/07_cors_preflight_header_not_allowed/api/data', [
            'headers' => [
    ...
    {
        $response = $this->httpClient->request('OPTIONS', '/fixtures/08_cors_max_age/api/data', [
            'headers' => [
                'Access-Control-Request-Headers' => 'Content-Type',
                'Access-Control-Request-Method' => 'POST',
                'Origin' => 'https://example.com',
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/09_cors_expose_headers/api/data', [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/10_cors_origin_null/api/data', [
            'headers' => ['Origin' => 'null'],
        ]);
        $this->assertEquals(403, $response->getStatusCode());
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/cors_allow_credentials_flag/api/secure', [
            'headers' => ['Origin' => 'https://example.com'],
        ]);
        $this->assertEquals(200, $response->getStatusCode());
    ...
    {
        $response = $this->httpClient->request('OPTIONS', '/fixtures/cors_custom_allowed_headers_x_custom/api/data', [
            'headers' => [
                'Access-Control-Request-Headers' => 'X-Custom-Header',
                'Access-Control-Request-Method' => 'POST',
                'Origin' => 'https://example.com',
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/cors_request_blocked/items/', [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/cors_restricted_methods_post_get_only/api/data', [
            'headers' => ['Origin' => 'https://example.com'],
        ]);
        $this->assertEquals(200, $response->getStatusCode());
    ...
    {
        $response = $this->httpClient->request('POST', '/fixtures/cors_safelisted_headers_without_preflight/api/form', [
            'headers' => [
