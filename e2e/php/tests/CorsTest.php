...
// alef:hash:484b744e72e6feac184ccd9907810c58451a574feec03687e97b2ec751d05b88
...
final class CorsTest extends TestCase
{
    ...
    public function test_06_cors_preflight_method_not_allowed(): void
    {
        $response = $this->httpClient->request('OPTIONS', "/fixtures/06_cors_preflight_method_not_allowed", [
            'headers' => ["Access-Control-Request-Method" => "DELETE", "Access-Control-Request-Headers" => "Content-Type", "Origin" => "https://example.com"],
        ]);
    ...
    public function test_cors_custom_allowed_headers_x_custom(): void
    {
        $response = $this->httpClient->request('OPTIONS', "/fixtures/cors_custom_allowed_headers_x_custom", [
            'headers' => ["Origin" => "https://example.com", "Access-Control-Request-Headers" => "X-Custom-Header", "Access-Control-Request-Method" => "POST"],
        ]);
        $this->assertEquals(204, $response->getStatusCode());
    ...
    public function test_cors_safelisted_headers_without_preflight(): void
    {
        $response = $this->httpClient->request('POST', "/fixtures/cors_safelisted_headers_without_preflight", [
            'headers' => ["Accept-Language" => "en-US", "Origin" => "https://app.example.com", "Content-Type" => "text/plain", "Accept" => "application/json"],
        ]);
        $body = json_decode((string) $response->getBody(), true, 512, JSON_THROW_ON_ERROR);
        $this->assertEquals(200, $response->getStatusCode());
        $this->assertEquals(["message" => "Success"], $body);
