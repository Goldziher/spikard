...
final class CorsTest extends TestCase
{
    ...
    public function test_06_cors_preflight_method_not_allowed(): void
    {
        $response = $this->httpClient->request(
            'OPTIONS',
            '/fixtures/06_cors_preflight_method_not_allowed/api/data',
            ['headers' => [
    ...
    public function test_07_cors_preflight_header_not_allowed(): void
    {
        $response = $this->httpClient->request(
            'OPTIONS',
            '/fixtures/07_cors_preflight_header_not_allowed/api/data',
            ['headers' => [
    ...
    {
        $response = $this->httpClient->request('OPTIONS', '/fixtures/08_cors_max_age/api/data', ['headers' => [
            'Access-Control-Request-Headers' => 'Content-Type',
            'Access-Control-Request-Method' => 'POST',
            'Origin' => 'https://example.com',
        ]]);
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/09_cors_expose_headers/api/data', ['headers' => [
            'Origin' => 'https://example.com',
        ]]);
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/10_cors_origin_null/api/data', ['headers' => [
            'Origin' => 'null',
        ]]);
        $this->assertEquals(403, $response->getStatusCode());
    ...
    public function test_cors_allow_credentials_flag(): void
    {
        $response = $this->httpClient->request(
            'GET',
            '/fixtures/cors_allow_credentials_flag/api/secure',
    ...
    public function test_cors_custom_allowed_headers_x_custom(): void
    {
        $response = $this->httpClient->request(
            'OPTIONS',
            '/fixtures/cors_custom_allowed_headers_x_custom/api/data',
            ['headers' => [
                'Access-Control-Request-Headers' => 'X-Custom-Header',
                'Access-Control-Request-Method' => 'POST',
                'Origin' => 'https://example.com',
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/cors_request_blocked/items/', ['headers' => [
    ...
    public function test_cors_restricted_methods_post_get_only(): void
    {
        $response = $this->httpClient->request(
            'GET',
            '/fixtures/cors_restricted_methods_post_get_only/api/data',
            ['headers' => ['Origin' => 'https://example.com']],
        );
        $this->assertEquals(200, $response->getStatusCode());
