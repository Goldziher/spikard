...
final class GeneratedTest extends TestCase
{
    ...
    public function test_edge_cases_20_null_byte_in_string(): void
    {
        ...
        $this->assertSame(422, $response->statusCode);
        $this->assertEquals(["detail" => "1 validation error in request", "errors" => [["ctx" => ["pattern" => "^[^\\x00]+\$"], "input" => "file\x00.txt", "loc" => ["body", "filename"], "msg" => "String should match pattern '^[^\\x00]+\$'", "type" => "string_pattern_mismatch"]], "status" => 422, "title" => "Request Validation Failed", "type" => "https://spikard.dev/errors/validation-error"], $response->body);
    }
    ...
    public function test_edge_cases_empty_and_null_value_handling(): void
    {
        ...
        $client = TestClient::create($app);
        $response = $client->request('POST', '/nulls/', ['headers' => ["Content-Type" => "application/json"], 'body' => ["empty_array" => [], "empty_object" => (object)[], "empty_string" => "", "explicit_null" => null, "false_boolean" => false, "zero_number" => 0]]);
    ...
    public function test_edge_cases_float_precision_and_rounding(): void
    {
        ...
        $client = TestClient::create($app);
        $response = $client->request('POST', '/calculations/', ['headers' => ["Content-Type" => "application/json"], 'body' => ["expected_sum" => 0.3, "precise_value" => 3.141592653589793, "value1" => 0.1, "value2" => 0.2, "very_large" => 1.7976931348623157e+308, "very_small" => 1e-10]]);

        $this->assertSame(200, $response->statusCode);
        $this->assertEquals(["precise_value" => 3.141592653589793, "sum" => 0.30000000000000004, "very_large" => 1.7976931348623157e+308, "very_small" => 1e-10], $response->body);
    }
    ...
    public function test_http_methods_put_missing_required_field(): void
    {
        ...
        $this->assertSame(422, $response->statusCode);
        $this->assertEquals(["detail" => "1 validation error in request", "errors" => [["input" => ["id" => 1, "name" => "Item Name"], "loc" => ["body", "price"], "msg" => "Field required", "type" => "missing"]], "status" => 422, "title" => "Request Validation Failed", "type" => "https://spikard.dev/errors/validation-error"], $response->body);
    }
    ...
    public function test_json_bodies_30_nested_object_missing_field(): void
    {
        ...
        $this->assertSame(422, $response->statusCode);
        $this->assertEquals(["detail" => "1 validation error in request", "errors" => [["input" => ["name" => "John Doe"], "loc" => ["body", "profile", "email"], "msg" => "Field required", "type" => "missing"]], "status" => 422, "title" => "Request Validation Failed", "type" => "https://spikard.dev/errors/validation-error"], $response->body);
    }
    ...
    public function test_json_bodies_40_anyof_schema_failure(): void
    {
        ...
        $this->assertSame(422, $response->statusCode);
        $this->assertEquals(["detail" => "1 validation error in request", "errors" => [["input" => ["name" => "John Doe"], "loc" => ["body"], "msg" => "{\"name\":\"John Doe\"} is not valid under any of the schemas listed in the 'anyOf' keyword", "type" => "validation_error"]], "status" => 422, "title" => "Request Validation Failed", "type" => "https://spikard.dev/errors/validation-error"], $response->body);
    }
    ...
    public function test_json_bodies_42_not_schema_failure(): void
    {
        ...
        $this->assertSame(422, $response->statusCode);
        $this->assertEquals(["detail" => "1 validation error in request", "errors" => [["input" => "admin", "loc" => ["body", "username"], "msg" => "{\"enum\":[\"admin\",\"root\",\"system\"]} is not allowed for \"admin\"", "type" => "validation_error"]], "status" => 422, "title" => "Request Validation Failed", "type" => "https://spikard.dev/errors/validation-error"], $response->body);
    }
    ...
    public function test_json_bodies_44_const_validation_failure(): void
    {
        ...
        $this->assertSame(422, $response->statusCode);
        $this->assertEquals(["detail" => "1 validation error in request", "errors" => [["input" => "2.0", "loc" => ["body", "version"], "msg" => "\"1.0\" was expected", "type" => "validation_error"]], "status" => 422, "title" => "Request Validation Failed", "type" => "https://spikard.dev/errors/validation-error"], $response->body);
    }
    ...
    public function test_json_bodies_46_minproperties_validation_failure(): void
    {
        ...
        $this->assertSame(422, $response->statusCode);
        $this->assertEquals(["detail" => "1 validation error in request", "errors" => [["input" => ["host" => "localhost"], "loc" => ["body"], "msg" => "{\"host\":\"localhost\"} has less than 2 properties", "type" => "validation_error"]], "status" => 422, "title" => "Request Validation Failed", "type" => "https://spikard.dev/errors/validation-error"], $response->body);
    }
    ...
    public function test_json_bodies_49_dependencies_validation_failure(): void
    {
        ...
        $this->assertSame(422, $response->statusCode);
        $this->assertEquals(["detail" => "1 validation error in request", "errors" => [["input" => ["credit_card" => "1234567812345678", "name" => "John Doe"], "loc" => ["body"], "msg" => "\"billing_address\" is a required property", "type" => "validation_error"]], "status" => 422, "title" => "Request Validation Failed", "type" => "https://spikard.dev/errors/validation-error"], $response->body);
    }
    ...
    public function test_json_bodies_field_type_validation_invalid_type(): void
    {
        ...
        $this->assertSame(422, $response->statusCode);
        $this->assertEquals(["detail" => "1 validation error in request", "errors" => [["input" => "not a number", "loc" => ["body", "price"], "msg" => "Input should be a valid number, unable to parse string as a number", "type" => "float_parsing"]], "status" => 422, "title" => "Request Validation Failed", "type" => "https://spikard.dev/errors/validation-error"], $response->body);
    }
    ...
    public function test_json_bodies_required_field_missing_validation_error(): void
    {
        ...
        $this->assertSame(422, $response->statusCode);
        $this->assertEquals(["detail" => "1 validation error in request", "errors" => [["input" => ["description" => "A very nice Item", "price" => 35.4], "loc" => ["body", "name"], "msg" => "Field required", "type" => "missing"]], "status" => 422, "title" => "Request Validation Failed", "type" => "https://spikard.dev/errors/validation-error"], $response->body);
    }
    ...
    public function test_multipart_file_upload_with_custom_headers(): void
    {
        ...
        $client = TestClient::create($app);
        $response = $client->request('POST', '/', ['headers' => ["Content-Type" => "multipart/form-data"], 'files' => [["content" => "<file2 content>", "content_encoding" => "text", "content_type" => "text/plain", "field_name" => "test2", "filename" => "test2.txt"]]]);
    ...
    public function test_multipart_file_upload_without_filename(): void
    {
        ...
        $client = TestClient::create($app);
        $response = $client->request('POST', '/', ['headers' => ["Content-Type" => "multipart/form-data"], 'files' => [["content" => "<file1 content>", "content_encoding" => "text", "field_name" => "test1"]]]);
    ...
    public function test_multipart_mixed_files_and_form_data(): void
    {
        ...
        $client = TestClient::create($app);
        $response = $client->request('POST', '/', ['headers' => ["Content-Type" => "multipart/form-data"], 'files' => [["content" => "file data here", "content_encoding" => "text", "content_type" => "text/plain", "field_name" => "file", "filename" => "upload.txt"]], 'data' => ["active" => "true", "age" => "25", "username" => "testuser"]]);
    ...
    public function test_multipart_multiple_file_uploads(): void
    {
        ...
        $client = TestClient::create($app);
        $response = $client->request('POST', '/', ['headers' => ["Content-Type" => "multipart/form-data"], 'files' => [["content" => "<file1 content>", "content_encoding" => "text", "content_type" => "text/plain", "field_name" => "test1", "filename" => "test1.txt"], ["content" => "<file2 content>", "content_encoding" => "text", "content_type" => "text/plain", "field_name" => "test2", "filename" => "test2.txt"]]]);
    ...
    public function test_multipart_multiple_values_for_same_field_name(): void
    {
        ...
        $client = TestClient::create($app);
        $response = $client->request('POST', '/', ['headers' => ["Content-Type" => "multipart/form-data"], 'files' => [["content" => "first file", "content_encoding" => "text", "content_type" => "text/plain", "field_name" => "files", "filename" => "file1.txt"], ["content" => "second file", "content_encoding" => "text", "content_type" => "text/plain", "field_name" => "files", "filename" => "file2.txt"]], 'data' => ["tags" => ["python", "rust", "web"]]]);
    ...
    public function test_multipart_required_file_upload_missing(): void
    {
        ...
        $this->assertSame(422, $response->statusCode);
        $this->assertEquals(["detail" => "1 validation error in request", "errors" => [["input" => [], "loc" => ["body", "file"], "msg" => "Field required", "type" => "missing"]], "status" => 422, "title" => "Request Validation Failed", "type" => "https://spikard.dev/errors/validation-error"], $response->body);
    }
    ...
    public function test_multipart_simple_file_upload(): void
    {
        ...
        $client = TestClient::create($app);
        $response = $client->request('POST', '/', ['headers' => ["Content-Type" => "multipart/form-data"], 'files' => [["content" => "<file content>", "content_encoding" => "text", "content_type" => "text/plain", "field_name" => "test", "filename" => "test.txt"]]]);
    ...
    public function test_status_codes_422_unprocessable_entity_validation_error(): void
    {
        ...
        $this->assertSame(422, $response->statusCode);
        $this->assertEquals(["detail" => "1 validation error in request", "errors" => [["input" => ["price" => "not a number"], "loc" => ["body", "name"], "msg" => "Field required", "type" => "missing"]], "status" => 422, "title" => "Request Validation Failed", "type" => "https://spikard.dev/errors/validation-error"], $response->body);
    }
    ...
    public function test_url_encoded_17_pattern_validation_failure(): void
    {
        ...
        $this->assertSame(422, $response->statusCode);
        $this->assertEquals(["detail" => "1 validation error in request", "errors" => [["ctx" => ["pattern" => "^ACC-[0-9]{6}\$"], "input" => "INVALID123", "loc" => ["body", "account_id"], "msg" => "String should match pattern '^ACC-[0-9]{6}\$'", "type" => "string_pattern_mismatch"]], "status" => 422, "title" => "Request Validation Failed", "type" => "https://spikard.dev/errors/validation-error"], $response->body);
    }
    ...
    public function test_url_encoded_18_integer_minimum_validation_failure(): void
    {
        ...
        $this->assertSame(422, $response->statusCode);
        $this->assertEquals(["detail" => "1 validation error in request", "errors" => [["ctx" => ["ge" => 1], "input" => 0, "loc" => ["body", "quantity"], "msg" => "Input should be greater than or equal to 1", "type" => "greater_than_equal"]], "status" => 422, "title" => "Request Validation Failed", "type" => "https://spikard.dev/errors/validation-error"], $response->body);
    }
    ...
    public function test_url_encoded_19_array_minitems_validation_failure(): void
    {
        ...
        $this->assertSame(422, $response->statusCode);
        $this->assertEquals(["detail" => "1 validation error in request", "errors" => [["ctx" => ["min_length" => 2], "input" => ["single"], "loc" => ["body", "tags"], "msg" => "List should have at least 2 item after validation", "type" => "too_short"]], "status" => 422, "title" => "Request Validation Failed", "type" => "https://spikard.dev/errors/validation-error"], $response->body);
    }
    ...
    public function test_url_encoded_21_integer_type_coercion_failure(): void
    {
        ...
        $this->assertSame(422, $response->statusCode);
        $this->assertEquals(["detail" => "1 validation error in request", "errors" => [["input" => "not-a-number", "loc" => ["body", "price"], "msg" => "Input should be a valid integer, unable to parse string as an integer", "type" => "int_parsing"]], "status" => 422, "title" => "Request Validation Failed", "type" => "https://spikard.dev/errors/validation-error"], $response->body);
    }
    ...
    public function test_url_encoded_oauth2_password_grant_flow(): void
    {
        ...
        $client = TestClient::create($app);
        $response = $client->request('POST', '/token', ['headers' => ["Content-Type" => "application/x-www-form-urlencoded"], 'form_data' => ["grant_type" => "password", "password" => "secret", "scope" => "", "username" => "johndoe"]]);
    ...
    public function test_url_encoded_required_field_missing_validation_error(): void
    {
        ...
        $this->assertSame(422, $response->statusCode);
        $this->assertEquals(["detail" => "1 validation error in request", "errors" => [["input" => ["password" => "secret"], "loc" => ["body", "username"], "msg" => "Field required", "type" => "missing"]], "status" => 422, "title" => "Request Validation Failed", "type" => "https://spikard.dev/errors/validation-error"], $response->body);
    }
