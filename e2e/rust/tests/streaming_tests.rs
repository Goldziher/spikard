...
async fn test_streaming_binary_log_download() {
    ...
    let expected: Vec<u8> = vec![0x4cu8, 0x4fu8, 0x47u8, 0x3au8, 0x00u8, 0x01u8, 0x02u8, 0x03u8, 0x7cu8, 0x54u8, 0x41u8, 0x49u8, 0x4cu8, 0x7cu8, 0x07u8, 0x5cu8, 0x6eu8];
...
async fn test_streaming_chunked_csv_export() {
    ...
    let expected: Vec<u8> = vec![0x69u8, 0x64u8, 0x2cu8, 0x6eu8, 0x61u8, 0x6du8, 0x65u8, 0x2cu8, 0x76u8, 0x61u8, 0x6cu8, 0x75u8, 0x65u8, 0x5cu8, 0x6eu8, 0x31u8, 0x2cu8, 0x41u8, 0x6cu8, 0x69u8, 0x63u8, 0x65u8, 0x2cu8, 0x34u8, 0x32u8, 0x5cu8, 0x6eu8, 0x32u8, 0x2cu8, 0x42u8, 0x6fu8, 0x62u8, 0x2cu8, 0x37u8, 0x5cu8, 0x6eu8];
    assert_eq!(snapshot.body, expected);
    let headers = &snapshot.headers;
    if let Some(actual) = headers.get("content-type") {
...
async fn test_streaming_stream_json_lines() {
    ...
    let expected: Vec<u8> = vec![0x7bu8, 0x22u8, 0x69u8, 0x6eu8, 0x64u8, 0x65u8, 0x78u8, 0x22u8, 0x3au8, 0x30u8, 0x2cu8, 0x22u8, 0x70u8, 0x61u8, 0x79u8, 0x6cu8, 0x6fu8, 0x61u8, 0x64u8, 0x22u8, 0x3au8, 0x22u8, 0x61u8, 0x6cu8, 0x70u8, 0x68u8, 0x61u8, 0x22u8, 0x7du8, 0x5cu8, 0x6eu8, 0x7bu8, 0x22u8, 0x69u8, 0x6eu8, 0x64u8, 0x65u8, 0x78u8, 0x22u8, 0x3au8, 0x31u8, 0x2cu8, 0x22u8, 0x70u8, 0x61u8, 0x79u8, 0x6cu8, 0x6fu8, 0x61u8, 0x64u8, 0x22u8, 0x3au8, 0x22u8, 0x62u8, 0x65u8, 0x74u8, 0x61u8, 0x22u8, 0x7du8, 0x5cu8, 0x6eu8, 0x7bu8, 0x22u8, 0x69u8, 0x6eu8, 0x64u8, 0x65u8, 0x78u8, 0x22u8, 0x3au8, 0x32u8, 0x2cu8, 0x22u8, 0x70u8, 0x61u8, 0x79u8, 0x6cu8, 0x6fu8, 0x61u8, 0x64u8, 0x22u8, 0x3au8, 0x22u8, 0x67u8, 0x61u8, 0x6du8, 0x6du8, 0x61u8, 0x22u8, 0x7du8, 0x5cu8, 0x6eu8];
    assert_eq!(snapshot.body, expected);
    let headers = &snapshot.headers;
    if let Some(actual) = headers.get("content-type") {
