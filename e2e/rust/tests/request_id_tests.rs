...
mod request_id {
    ...
    #[tokio::test]
    async fn test_request_id_client_provided_request_id_propagated() {
        // Fixture: Client-provided request ID propagated
        // Description: Tests that client-provided request ID is propagated unchanged to response headers
        // Expected status: 200
        ...
        // Load fixture
        let fixture_json = std::fs::read_to_string("../../testing_data/request_id/02_request_id_client_provided.json")
        ...
        let app = spikard_e2e_app::create_app_request_id_Client_provided_request_ID_propagated();
    ...
    #[tokio::test]
    async fn test_request_id_custom_header_name_x_correlation_id() {
        // Fixture: Custom header name (X-Correlation-ID)
        // Description: Tests request ID generation with custom header name X-Correlation-ID instead of default X-Request-ID
        // Expected status: 200
        ...
        // Load fixture
        let fixture_json =
            std::fs::read_to_string("../../testing_data/request_id/04_request_id_custom_header_name.json")
                .expect("Failed to read fixture file");
        let fixture: Value = serde_json::from_str(&fixture_json).expect("Failed to parse fixture JSON");

        // Create app for this specific fixture
        let app = spikard_e2e_app::create_app_request_id_Custom_header_name__X_Correlation_ID();

        // Build request
        let mut uri = "/api/correlated".to_string();
    ...
    #[tokio::test]
    async fn test_request_id_invalid_request_id_format_handling() {
        // Fixture: Invalid request ID format handling
        // Description: Tests handling of malformed client-provided request ID when validation is enabled
        // Expected status: 400
        ...
        // Load fixture
        let fixture_json = std::fs::read_to_string("../../testing_data/request_id/08_request_id_invalid_format.json")
            .expect("Failed to read fixture file");
        let fixture: Value = serde_json::from_str(&fixture_json).expect("Failed to parse fixture JSON");

        // Create app for this specific fixture
        let app = spikard_e2e_app::create_app_request_id_Invalid_request_ID_format_handling();

        // Build request
        let mut uri = "/api/validated".to_string();
    ...
    #[tokio::test]
    async fn test_request_id_missing_request_id_when_required() {
        // Fixture: Missing request ID when required
        // Description: Tests error handling when request ID is required but not provided by client
        // Expected status: 400
        ...
        // Load fixture
        let fixture_json = std::fs::read_to_string("../../testing_data/request_id/09_request_id_missing_required.json")
            .expect("Failed to read fixture file");
        let fixture: Value = serde_json::from_str(&fixture_json).expect("Failed to parse fixture JSON");

        // Create app for this specific fixture
        let app = spikard_e2e_app::create_app_request_id_Missing_request_ID_when_required();

        // Build request
        let mut uri = "/api/require-id".to_string();
    ...
    #[tokio::test]
    async fn test_request_id_request_id_middleware_disabled() {
        // Fixture: Request ID middleware disabled
        // Description: Tests that no request ID is generated or propagated when middleware is disabled
        // Expected status: 200
        ...
        // Load fixture
        let fixture_json = std::fs::read_to_string("../../testing_data/request_id/06_request_id_disabled.json")
            .expect("Failed to read fixture file");
        let fixture: Value = serde_json::from_str(&fixture_json).expect("Failed to parse fixture JSON");

        // Create app for this specific fixture
        let app = spikard_e2e_app::create_app_request_id_Request_ID_middleware_disabled();

        // Build request
        let mut uri = "/api/no-tracking".to_string();
    ...
    #[tokio::test]
    async fn test_request_id_request_id_present_in_error_responses() {
        // Fixture: Request ID present in error responses
        // Description: Tests that request ID is included in response headers even for 4xx and 5xx error responses
        // Expected status: 422
        ...
        // Load fixture
        let fixture_json =
            std::fs::read_to_string("../../testing_data/request_id/10_request_id_in_error_responses.json")
                .expect("Failed to read fixture file");
        let fixture: Value = serde_json::from_str(&fixture_json).expect("Failed to parse fixture JSON");

        // Create app for this specific fixture
        let app = spikard_e2e_app::create_app_request_id_Request_ID_present_in_error_responses();

        // Build request
        let mut uri = "/api/error-endpoint".to_string();
    ...
    #[tokio::test]
    async fn test_request_id_request_id_present_in_request_and_response() {
        // Fixture: Request ID present in request and response
        // Description: Tests that request ID appears in both request and response headers with same value
        // Expected status: 200
        ...
        // Load fixture
        let fixture_json = std::fs::read_to_string("../../testing_data/request_id/03_request_id_both_headers.json")
            .expect("Failed to read fixture file");
        let fixture: Value = serde_json::from_str(&fixture_json).expect("Failed to parse fixture JSON");

        // Create app for this specific fixture
        let app = spikard_e2e_app::create_app_request_id_Request_ID_present_in_request_and_response();

        // Build request
        let mut uri = "/api/echo".to_string();
