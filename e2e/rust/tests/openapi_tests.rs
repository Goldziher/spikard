...
mod openapi {
    ...
    #[tokio::test]
    async fn test_openapi_openapi_generation_disabled() {
        // Fixture: OpenAPI generation disabled
        // Description: Tests that OpenAPI endpoints return 404 when documentation generation is disabled
        // Expected status: 404
        ...
        // Load fixture
        let fixture_json = std::fs::read_to_string("../../testing_data/openapi/14_openapi_disabled.json")
        ...
        let app = spikard_e2e_app::create_app_openapi_OpenAPI_generation_disabled();
    ...
    #[tokio::test]
    async fn test_openapi_openapi_with_oauth2_flows() {
        // Fixture: OpenAPI with OAuth2 flows
        ...
        // Load fixture
        let fixture_json = std::fs::read_to_string("../../testing_data/openapi/08_openapi_oauth2_flows.json")
            .expect("Failed to read fixture file");
        let fixture: Value = serde_json::from_str(&fixture_json).expect("Failed to parse fixture JSON");

        // Create app for this specific fixture
        let app = spikard_e2e_app::create_app_openapi_OpenAPI_with_OAuth2_flows();
    ...
    #[tokio::test]
    async fn test_openapi_openapi_with_multiple_security_schemes() {
        // Fixture: OpenAPI with multiple security schemes
        ...
        // Load fixture
        let fixture_json =
            std::fs::read_to_string("../../testing_data/openapi/07_openapi_multiple_security_schemes.json")
                .expect("Failed to read fixture file");
        let fixture: Value = serde_json::from_str(&fixture_json).expect("Failed to parse fixture JSON");

        // Create app for this specific fixture
        let app = spikard_e2e_app::create_app_openapi_OpenAPI_with_multiple_security_schemes();
    ...
    #[tokio::test]
    async fn test_openapi_openapi_with_multiple_server_configurations() {
        // Fixture: OpenAPI with multiple server configurations
        ...
        // Load fixture
        let fixture_json = std::fs::read_to_string("../../testing_data/openapi/09_openapi_servers_config.json")
            .expect("Failed to read fixture file");
        let fixture: Value = serde_json::from_str(&fixture_json).expect("Failed to parse fixture JSON");

        // Create app for this specific fixture
        let app = spikard_e2e_app::create_app_openapi_OpenAPI_with_multiple_server_configurations();
    ...
    #[tokio::test]
    async fn test_openapi_openapi_with_reusable_component_schemas() {
        // Fixture: OpenAPI with reusable component schemas
        ...
        // Load fixture
        let fixture_json = std::fs::read_to_string("../../testing_data/openapi/11_openapi_components_schemas.json")
            .expect("Failed to read fixture file");
        let fixture: Value = serde_json::from_str(&fixture_json).expect("Failed to parse fixture JSON");

        // Create app for this specific fixture
        let app = spikard_e2e_app::create_app_openapi_OpenAPI_with_reusable_component_schemas();
    ...
    #[tokio::test]
    async fn test_openapi_openapi_with_tags_and_external_documentation() {
        // Fixture: OpenAPI with tags and external documentation
        // Description: Tests OpenAPI spec generation with endpoint tags and external documentation links
        // Expected status: 200
        ...
        // Load fixture
        let fixture_json = std::fs::read_to_string("../../testing_data/openapi/10_openapi_tags_and_external_docs.json")
            .expect("Failed to read fixture file");
        let fixture: Value = serde_json::from_str(&fixture_json).expect("Failed to parse fixture JSON");

        // Create app for this specific fixture
        let app = spikard_e2e_app::create_app_openapi_OpenAPI_with_tags_and_external_documentation();
    ...
    #[tokio::test]
    async fn test_openapi_redoc_with_customization_options() {
        // Fixture: Redoc with customization options
        // Description: Tests Redoc serving with custom theme, layout options, and UI preferences
        // Expected status: 200
        ...
        // Load fixture
        let fixture_json = std::fs::read_to_string("../../testing_data/openapi/13_redoc_customization.json")
            .expect("Failed to read fixture file");
        let fixture: Value = serde_json::from_str(&fixture_json).expect("Failed to parse fixture JSON");

        // Create app for this specific fixture
        let app = spikard_e2e_app::create_app_openapi_Redoc_with_customization_options();
    ...
    #[tokio::test]
    async fn test_openapi_swagger_ui_with_customization_options() {
        // Fixture: Swagger UI with customization options
        // Description: Tests Swagger UI serving with custom CSS, query parameters, and persistence settings
        // Expected status: 200
        ...
        // Load fixture
        let fixture_json = std::fs::read_to_string("../../testing_data/openapi/12_swagger_ui_customization.json")
            .expect("Failed to read fixture file");
        let fixture: Value = serde_json::from_str(&fixture_json).expect("Failed to parse fixture JSON");

        // Create app for this specific fixture
        let app = spikard_e2e_app::create_app_openapi_Swagger_UI_with_customization_options();
