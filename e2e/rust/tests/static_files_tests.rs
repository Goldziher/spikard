...
mod static_files {
    ...
    async fn test_static_files_static_file_server_returns_text_file() {
        // Fixture: Static file server returns text file
        // Description: Tests serving a plain text file with Cache-Control headers.
        // Expected status: 200
    ...
    async fn test_static_files_static_server_returns_index_html_for_directory() {
        // Fixture: Static server returns index.html for directory
        // Description: When index files are enabled the server should serve index.html when the directory root is requested.
        // Expected status: 200
