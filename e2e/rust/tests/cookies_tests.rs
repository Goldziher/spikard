...
async fn test_cookies_24_cookie_samesite_strict() {
    ...
    let app = spikard_e2e_app::create_app_cookies_24_cookie_samesite_strict()
...
async fn test_cookies_25_cookie_samesite_lax() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_cookies_25_cookie_samesite_lax()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_cookies_26_cookie_secure_flag() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_cookies_26_cookie_secure_flag()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_cookies_27_cookie_httponly_flag() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_cookies_27_cookie_httponly_flag()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_cookies_cookie_regex_pattern_validation_fail() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/cookies/13_cookie_regex_pattern_validation.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_cookies_cookie_validation_max_length_constraint_fail() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/cookies/11_cookie_validation_max_length_fail.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_cookies_cookie_validation_min_length_constraint_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/cookies/12_cookie_validation_min_length_success.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_cookies_cookie_validation_min_length_failure() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/cookies/08_cookie_validation_min_length_fail.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_cookies_response_cookie_with_samesite_eq_strict() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/cookies/19_response_cookie_samesite_strict.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_cookies_response_cookie_with_attributes() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/cookies/10_response_cookie_with_attributes.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
