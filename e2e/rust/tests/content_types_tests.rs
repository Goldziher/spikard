...
async fn test_content_types_14_content_type_case_insensitive() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/content_types/14_content_type_case_insensitive.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_content_types_15_multipart_boundary_required() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/content_types/15_multipart_boundary_required.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_content_types_17_vendor_json_accepted() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_content_types_17_vendor_json_accepted()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_content_types_18_content_type_with_multiple_params() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/content_types/18_content_type_with_multiple_params.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_content_types_19_missing_content_type_default_json() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/content_types/19_missing_content_type_default_json.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_content_types_binary_response_application_octet_stream() {
    ...
    if let Some(actual) = headers.get("content-disposition") {
        assert_eq!(actual, "attachment; filename=file.bin", "Mismatched header 'content-disposition'");
    } else {
...
async fn test_content_types_content_negotiation_accept_header() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/content_types/11_accept_header_negotiation.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_content_types_json_with_utf_8_charset() {
    ...
    let headers = &snapshot.headers;
    if let Some(actual) = headers.get("content-type") {
        assert_eq!(actual, "application/json; charset=utf-8", "Mismatched header 'content-type'");
    } else {
        panic!("Expected header 'content-type' to be present");
    }
