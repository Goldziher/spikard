...
async fn test_json_bodies_29_nested_object_validation_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/json_bodies/29_nested_object_validation_success.json")
    ...
    let app = spikard_e2e_app::create_app_json_bodies_29_nested_object_validation_success()
...
async fn test_json_bodies_30_nested_object_missing_field() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/json_bodies/30_nested_object_missing_field.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_30_nested_object_missing_field()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_31_nullable_property_null_value() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/json_bodies/31_nullable_property_null_value.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_31_nullable_property_null_value()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_32_schema_ref_definitions() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_32_schema_ref_definitions()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_33_allof_schema_composition() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_33_allof_schema_composition()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_34_additional_properties_false() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/json_bodies/34_additional_properties_false.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_34_additional_properties_false()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_35_oneof_schema_success() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_35_oneof_schema_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_36_oneof_schema_multiple_match_failure() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/json_bodies/36_oneof_schema_multiple_match_failure.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_36_oneof_schema_multiple_match_failure()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_37_oneof_schema_no_match_failure() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/json_bodies/37_oneof_schema_no_match_failure.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_37_oneof_schema_no_match_failure()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_38_anyof_schema_success() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_38_anyof_schema_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_39_anyof_schema_multiple_match_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/json_bodies/39_anyof_schema_multiple_match_success.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_39_anyof_schema_multiple_match_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_40_anyof_schema_failure() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_40_anyof_schema_failure()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_41_not_schema_success() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_41_not_schema_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_42_not_schema_failure() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_42_not_schema_failure()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_43_const_validation_success() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_43_const_validation_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_44_const_validation_failure() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_44_const_validation_failure()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_45_minproperties_validation_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/json_bodies/45_minproperties_validation_success.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_45_minproperties_validation_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_46_minproperties_validation_failure() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/json_bodies/46_minproperties_validation_failure.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_46_minproperties_validation_failure()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_47_maxproperties_validation_failure() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/json_bodies/47_maxproperties_validation_failure.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_47_maxproperties_validation_failure()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_48_dependencies_validation_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/json_bodies/48_dependencies_validation_success.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_48_dependencies_validation_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_49_dependencies_validation_failure() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/json_bodies/49_dependencies_validation_failure.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_49_dependencies_validation_failure()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_50_deep_nesting_4_levels() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_50_deep_nesting_4_levels()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_array_of_objects_success() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_array_of_objects_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_array_of_primitive_values() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_array_of_primitive_values()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_body_with_query_parameters() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_body_with_query_parameters()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_boolean_field_success() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_boolean_field_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_date_field_success() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_date_field_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_datetime_field_success() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_datetime_field_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_deeply_nested_objects() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_deeply_nested_objects()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_empty_json_object() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_empty_json_object()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_empty_array_validation_fail() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/json_bodies/10_empty_array_validation_fail.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_empty_array_validation_fail()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_enum_field_invalid_value() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_enum_field_invalid_value()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_enum_field_success() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_enum_field_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_extra_fields_ignored_no_additionalproperties() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_extra_fields_ignored_no_additionalproperties()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_field_type_validation_invalid_type() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_field_type_validation_invalid_type()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_nested_object_success() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_nested_object_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_null_value_for_optional_field() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_null_value_for_optional_field()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_numeric_ge_validation_fail() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_numeric_ge_validation_fail()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_numeric_le_validation_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/json_bodies/12_numeric_le_validation_success.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_numeric_le_validation_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_optional_fields_omitted() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_optional_fields_omitted()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_patch_partial_update() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_patch_partial_update()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_required_field_missing_validation_error() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_required_field_missing_validation_error()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_simple_json_object_success() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_simple_json_object_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_string_max_length_validation_fail() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/json_bodies/08_string_maxlength_validation_fail.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_string_max_length_validation_fail()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_string_min_length_validation_fail() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/json_bodies/07_string_minlength_validation_fail.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_string_min_length_validation_fail()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_string_pattern_validation_fail() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/json_bodies/15_string_pattern_validation_fail.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_string_pattern_validation_fail()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_string_pattern_validation_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/json_bodies/16_string_pattern_validation_success.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_string_pattern_validation_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_uuid_field_invalid_format() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_uuid_field_invalid_format()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_json_bodies_uuid_field_success() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_json_bodies_uuid_field_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
