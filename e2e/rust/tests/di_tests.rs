...
async fn test_di_async_factory_dependency_success() {
    ...
    let app = spikard_e2e_app::create_app_di_async_factory_dependency_success()
...
async fn test_di_circular_dependency_detection_error() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_di_circular_dependency_detection_error()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_di_factory_dependency_success() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_di_factory_dependency_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_di_missing_dependency_error() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_di_missing_dependency_error()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_di_nested_dependencies_3_levels_success() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_di_nested_dependencies_3_levels_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_di_resource_cleanup_after_request_success() {
    ...
    let expected_state: Value = serde_json::from_str(r#"{"cleanup_events":["session_opened","session_closed"]}"#).unwrap();
    let mut actual_state = Value::Null;
    for _attempt in 0..5 {
        let state_request = Request::builder()
            .method("GET")
...
async fn test_di_singleton_dependency_caching_success() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_di_singleton_dependency_caching_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_di_value_dependency_injection_success() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_di_value_dependency_injection_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
