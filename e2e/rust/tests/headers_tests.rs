...
async fn test_headers_header_regex_validation_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/headers/22_header_regex_validation_success.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_headers_header_validation_max_length_constraint_fail() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/headers/24_header_maxlength_validation_fail.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
