...
async fn test_query_params_42_negative_integer_query_param() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/42_negative_integer_query_param.json")
    ...
    let app = spikard_e2e_app::create_app_query_params_42_negative_integer_query_param()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");

    // Build request
    let mut uri = "/items/negative".to_string();
...
async fn test_query_params_43_scientific_notation_float() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_43_scientific_notation_float()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_44_string_minlength_validation_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/44_string_minlength_validation_success.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_44_string_minlength_validation_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_45_string_minlength_validation_failure() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/45_string_minlength_validation_failure.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_45_string_minlength_validation_failure()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_46_string_maxlength_validation_failure() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/46_string_maxlength_validation_failure.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_46_string_maxlength_validation_failure()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_47_pattern_validation_email_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/47_pattern_validation_email_success.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_47_pattern_validation_email_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_48_pattern_validation_email_failure() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/48_pattern_validation_email_failure.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_48_pattern_validation_email_failure()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_49_integer_gt_constraint_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/49_integer_gt_constraint_success.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_49_integer_gt_constraint_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_50_integer_gt_constraint_failure() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/50_integer_gt_constraint_failure.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_50_integer_gt_constraint_failure()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_51_integer_ge_constraint_boundary() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/51_integer_ge_constraint_boundary.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_51_integer_ge_constraint_boundary()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_52_integer_le_constraint_boundary() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/52_integer_le_constraint_boundary.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_52_integer_le_constraint_boundary()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_53_integer_le_constraint_failure() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/53_integer_le_constraint_failure.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_53_integer_le_constraint_failure()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_54_array_minitems_constraint_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/54_array_minitems_constraint_success.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_54_array_minitems_constraint_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_55_array_minitems_constraint_failure() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/55_array_minitems_constraint_failure.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_55_array_minitems_constraint_failure()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_56_array_maxitems_constraint_failure() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/56_array_maxitems_constraint_failure.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_56_array_maxitems_constraint_failure()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_57_boolean_empty_string_coercion() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/57_boolean_empty_string_coercion.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_57_boolean_empty_string_coercion()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_58_format_email_success() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_58_format_email_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_59_format_email_failure() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_59_format_email_failure()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_60_format_ipv4_success() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_60_format_ipv4_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_61_format_ipv4_failure() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_61_format_ipv4_failure()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_62_format_ipv6_success() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_62_format_ipv6_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");

    // Build request
    let mut uri = "/network/ipv6".to_string();
...
async fn test_query_params_63_format_uri_success() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_63_format_uri_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_64_format_uri_failure() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_64_format_uri_failure()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_65_format_hostname_success() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_65_format_hostname_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_66_multipleof_constraint_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/66_multipleof_constraint_success.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_66_multipleof_constraint_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_67_multipleof_constraint_failure() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/67_multipleof_constraint_failure.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_67_multipleof_constraint_failure()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_68_array_uniqueitems_success() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_68_array_uniqueitems_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_69_array_uniqueitems_failure() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_69_array_uniqueitems_failure()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_70_array_separator_pipe() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_70_array_separator_pipe()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_71_array_separator_semicolon() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_71_array_separator_semicolon()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_72_array_separator_space() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_query_params_72_array_separator_space()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_query_params_datetime_query_parameter_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/30_datetime_query_param_success.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_query_params_float_query_param_with_ge_constraint_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/38_float_validation_ge_success.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_query_params_integer_query_param_with_ge_constraint_boundary() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/23_int_validation_ge_boundary.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_query_params_integer_query_param_with_gt_constraint_valid() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/26_int_validation_gt_boundary.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_query_params_integer_query_param_with_le_constraint_boundary() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/24_int_validation_le_boundary.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_query_params_integer_query_param_with_lt_constraint_valid() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/25_int_validation_lt_boundary.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_query_params_list_of_strings_multiple_values() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/15_list_string_multiple_values.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_query_params_string_query_param_with_max_length_constraint_fail() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/27_string_maxlength_validation_fail.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_query_params_string_query_param_with_min_length_constraint_fail() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/28_string_minlength_validation_fail.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_query_params_string_query_param_with_regex_pattern_fail() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/query_params/31_regex_pattern_validation_fail.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
