...
mod query_params {
    ...
    async fn test_query_params_58_format_email_success() {
        ...
        // Create app for this specific fixture
        let app =
            spikard_e2e_app::create_app_query_params_58_format_email_success().expect("Failed to build fixture app");
        let server = TestServer::from_app(app).expect("Failed to build server");
    ...
    async fn test_query_params_59_format_email_failure() {
        ...
        // Create app for this specific fixture
        let app =
            spikard_e2e_app::create_app_query_params_59_format_email_failure().expect("Failed to build fixture app");
        let server = TestServer::from_app(app).expect("Failed to build server");
    ...
    async fn test_query_params_60_format_ipv4_success() {
        ...
        // Create app for this specific fixture
        let app =
            spikard_e2e_app::create_app_query_params_60_format_ipv4_success().expect("Failed to build fixture app");
        let server = TestServer::from_app(app).expect("Failed to build server");
    ...
    async fn test_query_params_61_format_ipv4_failure() {
        ...
        // Create app for this specific fixture
        let app =
            spikard_e2e_app::create_app_query_params_61_format_ipv4_failure().expect("Failed to build fixture app");
        let server = TestServer::from_app(app).expect("Failed to build server");
    ...
    async fn test_query_params_62_format_ipv6_success() {
        ...
        // Create app for this specific fixture
        let app =
            spikard_e2e_app::create_app_query_params_62_format_ipv6_success().expect("Failed to build fixture app");
        let server = TestServer::from_app(app).expect("Failed to build server");
    ...
    async fn test_query_params_63_format_uri_success() {
        ...
        // Create app for this specific fixture
        let app =
            spikard_e2e_app::create_app_query_params_63_format_uri_success().expect("Failed to build fixture app");
        let server = TestServer::from_app(app).expect("Failed to build server");
    ...
    async fn test_query_params_64_format_uri_failure() {
        ...
        // Create app for this specific fixture
        let app =
            spikard_e2e_app::create_app_query_params_64_format_uri_failure().expect("Failed to build fixture app");
        let server = TestServer::from_app(app).expect("Failed to build server");
    ...
    async fn test_query_params_65_format_hostname_success() {
        ...
        // Create app for this specific fixture
        let app =
            spikard_e2e_app::create_app_query_params_65_format_hostname_success().expect("Failed to build fixture app");
        let server = TestServer::from_app(app).expect("Failed to build server");
    ...
    async fn test_query_params_70_array_separator_pipe() {
        ...
        // Create app for this specific fixture
        let app =
            spikard_e2e_app::create_app_query_params_70_array_separator_pipe().expect("Failed to build fixture app");
        let server = TestServer::from_app(app).expect("Failed to build server");
    ...
    async fn test_query_params_72_array_separator_space() {
        ...
        // Create app for this specific fixture
        let app =
            spikard_e2e_app::create_app_query_params_72_array_separator_space().expect("Failed to build fixture app");
        let server = TestServer::from_app(app).expect("Failed to build server");
