...
async fn test_validation_errors_09_multiple_validation_errors() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/validation_errors/09_multiple_validation_errors.json")
...
async fn test_validation_errors_array_item_validation_error() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/validation_errors/18_array_item_validation_error.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_validation_errors_array_max_items_constraint_violation() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/validation_errors/17_array_max_items_violation.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_validation_errors_array_min_items_constraint_violation() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/validation_errors/16_array_min_items_violation.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_validation_errors_body_field_type_error_string_for_float() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/validation_errors/03_body_field_type_error.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_validation_errors_header_validation_error() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/validation_errors/19_header_validation_error.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_validation_errors_invalid_datetime_format() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/validation_errors/12_datetime_invalid_format.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_validation_errors_missing_required_body_field() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/validation_errors/04_body_missing_required_field.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_validation_errors_missing_required_query_parameter() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/validation_errors/02_query_param_missing_required.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_validation_errors_multiple_validation_errors() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/validation_errors/14_multiple_validation_errors.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_validation_errors_nested_object_validation_error() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/validation_errors/15_nested_object_validation_error.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_validation_errors_numeric_constraint_violation_gt_greater_than() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/validation_errors/05_numeric_constraint_gt_violation.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_validation_errors_numeric_constraint_violation_le_less_than_or_equal() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/validation_errors/06_numeric_constraint_le_violation.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_validation_errors_query_param_type_error_string_provided_for_int() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/validation_errors/01_query_param_type_error_string_to_int.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_validation_errors_string_max_length_constraint_violation() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/validation_errors/08_string_max_length_violation.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_validation_errors_string_min_length_constraint_violation() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/validation_errors/07_string_min_length_violation.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_validation_errors_string_regex_pattern_mismatch() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/validation_errors/09_string_regex_pattern_mismatch.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
