...
async fn test_multipart_17_file_magic_number_png_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/multipart/17_file_magic_number_png_success.json")
...
async fn test_multipart_18_file_magic_number_jpeg_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/multipart/18_file_magic_number_jpeg_success.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_multipart_19_file_mime_spoofing_png_as_jpeg() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/multipart/19_file_mime_spoofing_png_as_jpeg.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_multipart_20_file_mime_spoofing_jpeg_as_png() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/multipart/20_file_mime_spoofing_jpeg_as_png.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_multipart_21_file_pdf_magic_number_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/multipart/21_file_pdf_magic_number_success.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_multipart_22_file_empty_buffer() {
    ...
    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_multipart_22_file_empty_buffer()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_multipart_optional_file_upload_provided() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/multipart/09_optional_file_upload_provided.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
