...
async fn test_path_params_24_date_format_path_param_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/path_params/24_date_format_path_param_success.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_path_params_25_date_format_invalid_failure() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/path_params/25_date_format_invalid_failure.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_path_params_27_datetime_format_path_param_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/path_params/27_datetime_format_path_param_success.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_path_params_28_duration_format_path_param_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/path_params/28_duration_format_path_param_success.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_path_params_30_string_minlength_path_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/path_params/30_string_minlength_path_success.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_path_params_31_string_minlength_path_failure() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/path_params/31_string_minlength_path_failure.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_path_params_32_string_maxlength_path_failure() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/path_params/32_string_maxlength_path_failure.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_path_params_33_string_pattern_path_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/path_params/33_string_pattern_path_success.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_path_params_34_string_pattern_path_failure() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/path_params/34_string_pattern_path_failure.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_path_params_35_negative_integer_path_param() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/path_params/35_negative_integer_path_param.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_path_params_integer_path_parameter_with_combined_lt_and_gt_constraints_success() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/path_params/18_int_validation_combined_lt_gt.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");

    // Create app for this specific fixture
    let app = spikard_e2e_app::create_app_path_params_integer_path_parameter_with_combined_lt_and_gt_constraints_success()
        .expect("Failed to build fixture app");
    let server = TestServer::from_app(app).expect("Failed to build server");
...
async fn test_path_params_path_parameter_type_syntax_invalid_uuid() {
    ...
    // Description: Tests that :uuid type syntax auto-generates validation that rejects invalid UUIDs
    // Expected status: 422
...
async fn test_path_params_path_parameter_type_syntax_with_override() {
    ...
    // Description: Tests that explicit parameter schema merges with auto-generated type syntax schema
    // Expected status: 200
...
async fn test_path_params_path_parameter_with_type_syntax_uuid() {
    ...
    // Description: Tests path parameter with :uuid type syntax auto-generates UUID validation
    // Expected status: 200
...
async fn test_path_params_path_parameter_with_type_syntax_integer() {
    ...
    // Description: Tests path parameter with :int type syntax auto-generates integer type
    // Expected status: 200
...
async fn test_path_params_string_path_parameter_with_max_length_failure() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/path_params/19_string_maxlength_validation_fail.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_path_params_string_path_parameter_with_min_length_failure() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/path_params/08_string_minlength_validation_fail.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
