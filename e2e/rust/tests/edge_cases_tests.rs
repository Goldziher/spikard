...
async fn test_edge_cases_12_percent_encoded_special_chars() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/edge_cases/12_percent_encoded_special_chars.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_edge_cases_13_empty_string_query_param_preserved() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/edge_cases/13_empty_string_query_param_preserved.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
...
async fn test_edge_cases_15_float_precision_preservation() {
    ...
    // Load fixture
    let fixture_json = std::fs::read_to_string("../../testing_data/edge_cases/15_float_precision_preservation.json")
        .expect("Failed to read fixture file");
    let fixture: Value = serde_json::from_str(&fixture_json)
        .expect("Failed to parse fixture JSON");
