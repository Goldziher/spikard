...
def compression_compression_wildcard_encoding() -> Any:
    """Handler for GET /api/data."""
    return Response(
        content={"data": "Large payload compressed with server's preferred algorithm", "message": "Success"},
        status_code=200,
    )


def create_app_compression_compression_wildcard_encoding() -> Spikard:
    """App factory for fixture: Compression - wildcard encoding"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/data", body_schema=None, parameter_schema=None, file_params=None)(
        compression_compression_wildcard_encoding
    )
    return app
...
def compression_compression_gzip_applied() -> Any:
    """Handler for GET /api/data."""
    return Response(
        content={"data": "Large payload that benefits from compression", "message": "Success"}, status_code=200
    )
...
def compression_compression_brotli_applied() -> Any:
    """Handler for GET /api/data."""
    return Response(
        content={"data": "Large payload that benefits from compression", "message": "Success"}, status_code=200
    )
...
def create_app_compression_compression_brotli_applied() -> Spikard:
    """App factory for fixture: Compression - brotli applied"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/data", body_schema=None, parameter_schema=None, file_params=None)(
        compression_compression_brotli_applied
    )
    return app


def compression_compression_minimum_size_threshold() -> Any:
    """Handler for GET /api/data."""
    return Response(
        content={"data": "Large payload exceeding minimum threshold", "message": "Success"}, status_code=200
    )


def create_app_compression_compression_minimum_size_threshold() -> Spikard:
    """App factory for fixture: Compression - minimum size threshold"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/data", body_schema=None, parameter_schema=None, file_params=None)(
        compression_compression_minimum_size_threshold
    )
    return app


def compression_compression_high_compression_level() -> Any:
    """Handler for GET /api/data."""
    return Response(
        content={"data": "Large payload compressed at maximum level", "message": "Success"}, status_code=200
    )


def create_app_compression_compression_high_compression_level() -> Spikard:
    """App factory for fixture: Compression - high compression level"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/data", body_schema=None, parameter_schema=None, file_params=None)(
        compression_compression_high_compression_level
    )
    return app


def compression_compression_client_prefers_gzip() -> Any:
    """Handler for GET /api/data."""
    return Response(content={"data": "Large payload compressed with gzip", "message": "Success"}, status_code=200)


def create_app_compression_compression_client_prefers_gzip() -> Spikard:
    """App factory for fixture: Compression - client prefers gzip"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/data", body_schema=None, parameter_schema=None, file_params=None)(
        compression_compression_client_prefers_gzip
    )
    return app


def compression_compression_client_prefers_brotli() -> Any:
    """Handler for GET /api/data."""
    return Response(content={"data": "Large payload compressed with brotli", "message": "Success"}, status_code=200)


def create_app_compression_compression_client_prefers_brotli() -> Spikard:
    """App factory for fixture: Compression - client prefers brotli"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/data", body_schema=None, parameter_schema=None, file_params=None)(
        compression_compression_client_prefers_brotli
    )
    return app


def compression_compression_large_json_response() -> Any:
    """Handler for GET /api/records."""
    return Response(
        content={"records": "Array of 1000+ JSON objects with repeated structure", "total": 1000}, status_code=200
    )


def create_app_compression_compression_large_json_response() -> Spikard:
    """App factory for fixture: Compression - large JSON response"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/records", body_schema=None, parameter_schema=None, file_params=None)(
        compression_compression_large_json_response
    )
    return app


def compression_compression_low_compression_level() -> Any:
    """Handler for GET /api/data."""
    return Response(content={"data": "Large payload compressed at low level", "message": "Success"}, status_code=200)


def create_app_compression_compression_low_compression_level() -> Spikard:
    """App factory for fixture: Compression - low compression level"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/data", body_schema=None, parameter_schema=None, file_params=None)(
        compression_compression_low_compression_level
    )
    return app


def compression_compression_multiple_acceptable_encodings() -> Any:
    """Handler for GET /api/data."""
    return Response(
        content={"data": "Large payload compressed with best algorithm", "message": "Success"}, status_code=200
    )


def create_app_compression_compression_multiple_acceptable_encodings() -> Spikard:
    """App factory for fixture: Compression - multiple acceptable encodings"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/data", body_schema=None, parameter_schema=None, file_params=None)(
        compression_compression_multiple_acceptable_encodings
    )
    return app
...
def auth_jwt_authentication_valid_token(
    ...
    return Response(content={"message": "Access granted", "user_id": "user123"}, status_code=200)
...
def auth_api_key_rotation_old_key_still_valid(
    ...
    """Handler for GET /api/data."""
    return Response(content={"data": "sensitive information", "message": "Access granted"}, status_code=200)
...
def auth_jwt_invalid_issuer(
    ...
    return Response(
        content={
            "detail": "JWT issuer 'https://evil.com' does not match expected issuer 'https://auth.example.com'",
            "status": 401,
            "title": "Unauthorized",
            "type": "https://spikard.dev/errors/unauthorized",
        },
...
def auth_multiple_authentication_schemes_jwt_precedence(
    ...
    """Handler for GET /api/data."""
    return Response(content={"auth_method": "jwt", "message": "Access granted", "user_id": "user123"}, status_code=200)
...
def auth_api_key_authentication_missing_header() -> Any:
    ...
    return Response(
        content={
            "detail": "Expected 'X-API-Key' header with valid API key",
            "status": 401,
...
def request_id_custom_header_name_x_correlation_id() -> Any:
    """Handler for GET /api/correlated."""
    return Response(content={"message": "success"}, status_code=200)


def create_app_request_id_custom_header_name_x_correlation_id() -> Spikard:
    """App factory for fixture: Custom header name (X-Correlation-ID)"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/correlated", body_schema=None, parameter_schema=None, file_params=None)(
        request_id_custom_header_name_x_correlation_id
    )
    return app


def request_id_request_id_middleware_disabled() -> Any:
    """Handler for GET /api/no-tracking."""
    return Response(content={"message": "success"}, status_code=200)


def create_app_request_id_request_id_middleware_disabled() -> Spikard:
    """App factory for fixture: Request ID middleware disabled"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/no-tracking", body_schema=None, parameter_schema=None, file_params=None)(
        request_id_request_id_middleware_disabled
    )
    return app


def request_id_missing_request_id_when_required() -> Any:
    """Handler for POST /api/require-id."""
    return Response(
        content={
...
def create_app_request_id_missing_request_id_when_required() -> Spikard:
    """App factory for fixture: Missing request ID when required"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("POST", "/api/require-id", body_schema=None, parameter_schema=None, file_params=None)(
        request_id_missing_request_id_when_required
    )
    return app


def request_id_request_id_present_in_request_and_response() -> Any:
    """Handler for POST /api/echo."""
    return Response(content={"message": "echoed", "received": {"data": "test"}}, status_code=200)


def create_app_request_id_request_id_present_in_request_and_response() -> Spikard:
    """App factory for fixture: Request ID present in request and response"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("POST", "/api/echo", body_schema=None, parameter_schema=None, file_params=None)(
        request_id_request_id_present_in_request_and_response
    )
    return app


def request_id_request_id_present_in_error_responses() -> Any:
    """Handler for POST /api/error-endpoint."""
    return Response(
        content={
            "detail": "Validation failed",
            "errors": [{"loc": ["body", "required_field"], "msg": "field required", "type": "value_error.missing"}],
            "status": 422,
...
def create_app_request_id_request_id_present_in_error_responses() -> Spikard:
    """App factory for fixture: Request ID present in error responses"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("POST", "/api/error-endpoint", body_schema=None, parameter_schema=None, file_params=None)(
        request_id_request_id_present_in_error_responses
    )
    return app


def request_id_invalid_request_id_format_handling() -> Any:
    """Handler for GET /api/validated."""
    return Response(
        content={
            "detail": "Invalid request ID format: expected UUID v4",
            "status": 400,
            "title": "Bad Request",
            "type": "about:blank",
        },
...
def create_app_request_id_invalid_request_id_format_handling() -> Spikard:
    """App factory for fixture: Invalid request ID format handling"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/validated", body_schema=None, parameter_schema=None, file_params=None)(
        request_id_invalid_request_id_format_handling
    )
    return app


def request_id_client_provided_request_id_propagated() -> Any:
    """Handler for GET /api/data."""
    return Response(content={"message": "success"}, status_code=200)


def create_app_request_id_client_provided_request_id_propagated() -> Spikard:
    """App factory for fixture: Client-provided request ID propagated"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/data", body_schema=None, parameter_schema=None, file_params=None)(
        request_id_client_provided_request_id_propagated
    )
    return app
...
def body_size_limit_multipart_file_upload_exceeds_limit() -> Any:
    """Handler for POST /api/upload/avatar."""
    return Response(
        content={
...
def create_app_body_size_limit_multipart_file_upload_exceeds_limit() -> Spikard:
    """App factory for fixture: Multipart file upload exceeds limit"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("POST", "/api/upload/avatar", body_schema=None, parameter_schema=None, file_params=None)(
        body_size_limit_multipart_file_upload_exceeds_limit
    )
    return app


def body_size_limit_form_data_exceeds_limit() -> Any:
    """Handler for POST /api/form."""
    return Response(
        content={
            "detail": "Request body size (4096 bytes) exceeds maximum allowed size (2048 bytes)",
            "status": 413,
            "title": "Payload Too Large",
            "type": "https://spikard.dev/errors/payload-too-large",
        },
...
def create_app_body_size_limit_form_data_exceeds_limit() -> Spikard:
    """App factory for fixture: Form data exceeds limit"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("POST", "/api/form", body_schema=None, parameter_schema=None, file_params=None)(
        body_size_limit_form_data_exceeds_limit
    )
    return app


def body_size_limit_json_body_exceeds_limit() -> Any:
    """Handler for POST /api/json."""
    return Response(
        content={
            "detail": "Request body size (10240 bytes) exceeds maximum allowed size (5120 bytes)",
            "status": 413,
            "title": "Payload Too Large",
            "type": "https://spikard.dev/errors/payload-too-large",
        },
...
def create_app_body_size_limit_json_body_exceeds_limit() -> Spikard:
    """App factory for fixture: JSON body exceeds limit"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("POST", "/api/json", body_schema=None, parameter_schema=None, file_params=None)(
        body_size_limit_json_body_exceeds_limit
    )
    return app


def body_size_limit_body_size_at_exact_boundary() -> Any:
    """Handler for POST /api/data."""
    return Response(content={"bytes_received": 10240, "message": "Data received successfully"}, status_code=200)


def create_app_body_size_limit_body_size_at_exact_boundary() -> Spikard:
    """App factory for fixture: Body size at exact boundary"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("POST", "/api/data", body_schema=None, parameter_schema=None, file_params=None)(
        body_size_limit_body_size_at_exact_boundary
    )
    return app


def body_size_limit_large_limit_for_file_upload_endpoint() -> Any:
    """Handler for POST /api/upload."""
    return Response(content={"bytes_received": 52428800, "message": "File uploaded successfully"}, status_code=200)


def create_app_body_size_limit_large_limit_for_file_upload_endpoint() -> Spikard:
    """App factory for fixture: Large limit for file upload endpoint"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("POST", "/api/upload", body_schema=None, parameter_schema=None, file_params=None)(
        body_size_limit_large_limit_for_file_upload_endpoint
    )
    return app


def body_size_limit_per_route_limit_override() -> Any:
    """Handler for POST /api/upload."""
    return Response(content={"bytes_received": 10485760, "message": "File uploaded successfully"}, status_code=200)


def create_app_body_size_limit_per_route_limit_override() -> Spikard:
    """App factory for fixture: Per-route limit override"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("POST", "/api/upload", body_schema=None, parameter_schema=None, file_params=None)(
        body_size_limit_per_route_limit_override
    )
    return app


def body_size_limit_body_size_exceeds_limit() -> Any:
    """Handler for POST /api/data."""
    return Response(
        content={
...
def create_app_body_size_limit_body_size_exceeds_limit() -> Spikard:
    """App factory for fixture: Body size exceeds limit"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("POST", "/api/data", body_schema=None, parameter_schema=None, file_params=None)(
        body_size_limit_body_size_exceeds_limit
    )
    return app


def body_size_limit_small_limit_for_text_endpoint() -> Any:
    """Handler for POST /api/text."""
    return Response(
        content={
            "detail": "Request body size (2048 bytes) exceeds maximum allowed size (1024 bytes)",
            "status": 413,
            "title": "Payload Too Large",
            "type": "https://spikard.dev/errors/payload-too-large",
        },
...
def create_app_body_size_limit_small_limit_for_text_endpoint() -> Spikard:
    """App factory for fixture: Small limit for text endpoint"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("POST", "/api/text", body_schema=None, parameter_schema=None, file_params=None)(
        body_size_limit_small_limit_for_text_endpoint
    )
    return app


def body_size_limit_streaming_body_exceeds_limit() -> Any:
    """Handler for POST /api/stream."""
    return Response(
        content={
            "detail": "Request body size (16384 bytes) exceeds maximum allowed size (8192 bytes)",
            "status": 413,
            "title": "Payload Too Large",
            "type": "https://spikard.dev/errors/payload-too-large",
        },
...
def create_app_body_size_limit_streaming_body_exceeds_limit() -> Spikard:
    """App factory for fixture: Streaming body exceeds limit"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("POST", "/api/stream", body_schema=None, parameter_schema=None, file_params=None)(
        body_size_limit_streaming_body_exceeds_limit
    )
    return app


def body_size_limit_body_size_within_limit() -> Any:
    """Handler for POST /api/data."""
    return Response(content={"bytes_received": 1024, "message": "Data received successfully"}, status_code=200)


def create_app_body_size_limit_body_size_within_limit() -> Spikard:
    """App factory for fixture: Body size within limit"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("POST", "/api/data", body_schema=None, parameter_schema=None, file_params=None)(
        body_size_limit_body_size_within_limit
    )
    return app
...
def cors_cors_vary_header_for_proper_caching() -> Any:
    ...
    return Response(content={"data": "cacheable resource"}, status_code=200)
...
def cors_cors_multiple_allowed_origins() -> Any:
    """Handler for GET /api/data."""
    return Response(content={"data": "resource data"}, status_code=200)
...
def cors_cors_safelisted_headers_without_preflight() -> Any:
    """Handler for POST /api/form."""
    return Response(content={"received": "plain text data"}, status_code=200)
...
def cors_cors_request_blocked(
    ...
    """Handler for GET /items/."""
    return Response(
        content={"detail": "CORS request from origin 'https://malicious-site.com' not allowed"}, status_code=403
    )
...
def content_types_13_json_with_charset_utf16(
    ...
    """Handler for POST /data."""
    return Response(
        content={"error": "Unsupported charset 'utf-16' for JSON. Only UTF-8 is supported."}, status_code=415
    )
...
def request_timeout_per_route_timeout_override() -> Any:
    """Handler for GET /api/custom-route."""
    return Response(
        content={
            "detail": "Request processing exceeded the configured timeout of 5 seconds",
            "status": 504,
            "title": "Gateway Timeout",
            "type": "https://spikard.dev/errors/request-timeout",
        },
        status_code=504,
    )


def create_app_request_timeout_per_route_timeout_override() -> Spikard:
    """App factory for fixture: Per-route timeout override"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/custom-route", body_schema=None, parameter_schema=None, file_params=None)(
        request_timeout_per_route_timeout_override
    )
    return app


def request_timeout_custom_long_timeout() -> Any:
    """Handler for POST /api/batch-process."""
    return Response(content={"delay_ms": 45000, "items_processed": 3, "message": "batch processed"}, status_code=200)


def create_app_request_timeout_custom_long_timeout() -> Spikard:
    """App factory for fixture: Custom long timeout"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("POST", "/api/batch-process", body_schema=None, parameter_schema=None, file_params=None)(
        request_timeout_custom_long_timeout
    )
    return app


def request_timeout_disabled_timeout() -> Any:
    """Handler for GET /api/no-timeout."""
    return Response(content={"delay_ms": 120000, "message": "completed without timeout"}, status_code=200)


def create_app_request_timeout_disabled_timeout() -> Spikard:
    """App factory for fixture: Disabled timeout"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/no-timeout", body_schema=None, parameter_schema=None, file_params=None)(
        request_timeout_disabled_timeout
    )
    return app


def request_timeout_request_at_exact_timeout_boundary() -> Any:
    """Handler for GET /api/boundary."""
    return Response(
        content={
            "detail": "Request processing exceeded the configured timeout of 3 seconds",
            "status": 504,
            "title": "Gateway Timeout",
            "type": "https://spikard.dev/errors/request-timeout",
        },
...
def create_app_request_timeout_request_at_exact_timeout_boundary() -> Spikard:
    """App factory for fixture: Request at exact timeout boundary"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/boundary", body_schema=None, parameter_schema=None, file_params=None)(
        request_timeout_request_at_exact_timeout_boundary
    )
    return app


def request_timeout_custom_short_timeout() -> Any:
    """Handler for GET /api/fast-only."""
    return Response(
        content={
            "detail": "Request processing exceeded the configured timeout of 1 seconds",
            "status": 504,
            "title": "Gateway Timeout",
            "type": "https://spikard.dev/errors/request-timeout",
        },
...
def create_app_request_timeout_custom_short_timeout() -> Spikard:
    """App factory for fixture: Custom short timeout"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/fast-only", body_schema=None, parameter_schema=None, file_params=None)(
        request_timeout_custom_short_timeout
    )
    return app


def request_timeout_timeout_during_slow_request_body_read() -> Any:
    """Handler for POST /api/upload."""
    return Response(
        content={
            "detail": "Request processing exceeded the configured timeout of 5 seconds",
...
def create_app_request_timeout_timeout_during_slow_request_body_read() -> Spikard:
    """App factory for fixture: Timeout during slow request body read"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("POST", "/api/upload", body_schema=None, parameter_schema=None, file_params=None)(
        request_timeout_timeout_during_slow_request_body_read
    )
    return app


def request_timeout_request_completes_within_timeout() -> Any:
    """Handler for GET /api/fast."""
    return Response(content={"delay_ms": 1000, "message": "success"}, status_code=200)


def create_app_request_timeout_request_completes_within_timeout() -> Spikard:
    """App factory for fixture: Request completes within timeout"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/fast", body_schema=None, parameter_schema=None, file_params=None)(
        request_timeout_request_completes_within_timeout
    )
    return app


def request_timeout_concurrent_requests_timing_out() -> Any:
    """Handler for GET /api/slow-concurrent."""
    return Response(
        content={
            "detail": "Request processing exceeded the configured timeout of 2 seconds",
            "status": 504,
            "title": "Gateway Timeout",
            "type": "https://spikard.dev/errors/request-timeout",
        },
...
def create_app_request_timeout_concurrent_requests_timing_out() -> Spikard:
    """App factory for fixture: Concurrent requests timing out"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/slow-concurrent", body_schema=None, parameter_schema=None, file_params=None)(
        request_timeout_concurrent_requests_timing_out
    )
    return app


def request_timeout_default_timeout_behavior() -> Any:
    """Handler for GET /api/default."""
    return Response(content={"delay_ms": 2000, "message": "success"}, status_code=200)


def create_app_request_timeout_default_timeout_behavior() -> Spikard:
    """App factory for fixture: Default timeout behavior"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/default", body_schema=None, parameter_schema=None, file_params=None)(
        request_timeout_default_timeout_behavior
    )
    return app


def request_timeout_streaming_response_timeout() -> Any:
    """Handler for GET /api/stream."""
    return Response(
        content={
            "detail": "Request processing exceeded the configured timeout of 3 seconds",
            "status": 504,
...
def create_app_request_timeout_streaming_response_timeout() -> Spikard:
    """App factory for fixture: Streaming response timeout"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/stream", body_schema=None, parameter_schema=None, file_params=None)(
        request_timeout_streaming_response_timeout
    )
    return app


def request_timeout_request_exceeds_timeout() -> Any:
    """Handler for GET /api/slow."""
    return Response(
        content={
            "detail": "Request processing exceeded the configured timeout of 2 seconds",
            "status": 504,
...
def create_app_request_timeout_request_exceeds_timeout() -> Spikard:
    ...
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/slow", body_schema=None, parameter_schema=None, file_params=None)(
        request_timeout_request_exceeds_timeout
    )
    return app


def request_timeout_timeout_with_partial_response() -> Any:
    """Handler for GET /api/partial."""
    return Response(
        content={
            "detail": "Request processing exceeded the configured timeout of 2 seconds",
            "status": 504,
...
def create_app_request_timeout_timeout_with_partial_response() -> Spikard:
    """App factory for fixture: Timeout with partial response"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/partial", body_schema=None, parameter_schema=None, file_params=None)(
        request_timeout_timeout_with_partial_response
    )
    return app


def openapi_redoc_with_customization_options() -> Any:
...
def create_app_openapi_redoc_with_customization_options() -> Spikard:
    """App factory for fixture: Redoc with customization options"""
    config = ServerConfig(
        openapi=OpenApiConfig(
            enabled=True,
            title="Customized Redoc API",
            version="1.0.0",
    ...
    app = Spikard(config=config)
    # Register handler with this app instance
    app.register_route("GET", "/api/products", body_schema=None, parameter_schema=None, file_params=None)(
        openapi_redoc_with_customization_options
    )
    return app


def openapi_redoc_serving() -> Any:
...
def create_app_openapi_redoc_serving() -> Spikard:
    """App factory for fixture: Redoc serving"""
    config = ServerConfig(
        openapi=OpenApiConfig(
            enabled=True,
            title="Status API",
    ...
    app = Spikard(config=config)
    # Register handler with this app instance
    app.register_route("GET", "/status", body_schema=None, parameter_schema=None, file_params=None)(
        openapi_redoc_serving
    )
    return app


def openapi_openapi_with_multiple_security_schemes(
    authorization: str,
    x_api_key: str,
) -> Any:
    """Handler for GET /protected/multi-auth."""
    # Echo back parameters for testing
    result: dict[str, Any] = {}
...
def create_app_openapi_openapi_with_multiple_security_schemes() -> Spikard:
    """App factory for fixture: OpenAPI with multiple security schemes"""
    config = ServerConfig(
        openapi=OpenApiConfig(
            enabled=True,
    ...
    app.register_route(
        ...
        file_params=None,
    )(openapi_openapi_with_multiple_security_schemes)
    return app


def openapi_openapi_spec_with_jwt_security_scheme(
    authorization: str,
) -> Any:
    """Handler for GET /protected/data."""
    # Echo back parameters for testing
    result: dict[str, Any] = {}
    if authorization is not None:
        result["authorization"] = authorization
...
def create_app_openapi_openapi_spec_with_jwt_security_scheme() -> Spikard:
    """App factory for fixture: OpenAPI spec with JWT security scheme"""
    config = ServerConfig(
        openapi=OpenApiConfig(
            enabled=True,
            title="Secure API",
    ...
    app.register_route(
        ...
        file_params=None,
    )(openapi_openapi_spec_with_jwt_security_scheme)
    return app


def openapi_swagger_ui_with_customization_options() -> Any:
...
def create_app_openapi_swagger_ui_with_customization_options() -> Spikard:
    """App factory for fixture: Swagger UI with customization options"""
    config = ServerConfig(
        openapi=OpenApiConfig(
            enabled=True,
            title="Customized Swagger UI API",
            version="1.0.0",
    ...
    app = Spikard(config=config)
    # Register handler with this app instance
    app.register_route("GET", "/api/info", body_schema=None, parameter_schema=None, file_params=None)(
        openapi_swagger_ui_with_customization_options
    )
    return app


def openapi_openapi_with_multiple_server_configurations() -> Any:
...
def create_app_openapi_openapi_with_multiple_server_configurations() -> Spikard:
    """App factory for fixture: OpenAPI with multiple server configurations"""
    config = ServerConfig(
        openapi=OpenApiConfig(
            enabled=True,
    ...
    app = Spikard(config=config)
    # Register handler with this app instance
    app.register_route("GET", "/api/status", body_schema=None, parameter_schema=None, file_params=None)(
        openapi_openapi_with_multiple_server_configurations
    )
    return app


def openapi_swagger_ui_serving() -> Any:
    """Handler for GET /health."""
    # Echo back parameters for testing
    result: dict[str, Any] = {}
    return result
...
def create_app_openapi_swagger_ui_serving() -> Spikard:
    """App factory for fixture: Swagger UI serving"""
    config = ServerConfig(
        openapi=OpenApiConfig(
            enabled=True,
            title="Health API",
    ...
    # Register handler with this app instance
    app.register_route("GET", "/health", body_schema=None, parameter_schema=None, file_params=None)(
        openapi_swagger_ui_serving
    )
    return app


def openapi_openapi_with_reusable_component_schemas() -> Any:
...
def create_app_openapi_openapi_with_reusable_component_schemas() -> Spikard:
    """App factory for fixture: OpenAPI with reusable component schemas"""
    config = ServerConfig(
        openapi=OpenApiConfig(
            enabled=True,
    ...
    app = Spikard(config=config)
    # Register handler with this app instance
    app.register_route("POST", "/api/posts", body_schema=None, parameter_schema=None, file_params=None)(
        openapi_openapi_with_reusable_component_schemas
    )
    app.register_route("GET", "/api/posts", body_schema=None, parameter_schema=None, file_params=None)(
        openapi_openapi_with_reusable_component_schemas
    )
    return app


def openapi_openapi_spec_with_api_key_security_scheme(
    x_api_key: str,
) -> Any:
    """Handler for GET /api/data."""
    # Echo back parameters for testing
...
def create_app_openapi_openapi_spec_with_api_key_security_scheme() -> Spikard:
    """App factory for fixture: OpenAPI spec with API key security scheme"""
    config = ServerConfig(
        openapi=OpenApiConfig(
            enabled=True,
    ...
    app.register_route(
        ...
        file_params=None,
    )(openapi_openapi_spec_with_api_key_security_scheme)
    return app


def openapi_openapi_with_oauth2_flows(
    authorization: str,
) -> Any:
    """Handler for GET /oauth/users."""
    # Echo back parameters for testing
    result: dict[str, Any] = {}
    if authorization is not None:
        result["authorization"] = authorization
...
def create_app_openapi_openapi_with_oauth2_flows() -> Spikard:
    """App factory for fixture: OpenAPI with OAuth2 flows"""
    config = ServerConfig(
        openapi=OpenApiConfig(
            enabled=True,
            title="OAuth2 API",
    ...
    app.register_route(
        ...
        file_params=None,
    )(openapi_openapi_with_oauth2_flows)
    return app


def openapi_openapi_with_tags_and_external_documentation() -> Any:
...
def create_app_openapi_openapi_with_tags_and_external_documentation() -> Spikard:
    """App factory for fixture: OpenAPI with tags and external documentation"""
    config = ServerConfig(
        openapi=OpenApiConfig(
            enabled=True,
            title="Tagged API",
            version="1.0.0",
            description="API with organized endpoint tags",
        ),
    )
    app = Spikard(config=config)
    # Register handler with this app instance
    app.register_route("GET", "/api/users", body_schema=None, parameter_schema=None, file_params=None)(
        openapi_openapi_with_tags_and_external_documentation
    )
    return app


def openapi_openapi_generation_disabled() -> Any:
    """Handler for GET /api/health."""
    return Response(
        content={
            "detail": "OpenAPI documentation is not enabled",
            "status": 404,
            "title": "Not Found",
...
def create_app_openapi_openapi_generation_disabled() -> Spikard:
    """App factory for fixture: OpenAPI generation disabled"""
    config = ServerConfig(
        openapi=OpenApiConfig(
            enabled=False,
        ),
    ...
    app = Spikard(config=config)
    # Register handler with this app instance
    app.register_route("GET", "/api/health", body_schema=None, parameter_schema=None, file_params=None)(
        openapi_openapi_generation_disabled
    )
    return app


def openapi_openapi_spec_with_custom_metadata() -> Any:
...
def create_app_openapi_openapi_spec_with_custom_metadata() -> Spikard:
    """App factory for fixture: OpenAPI spec with custom metadata"""
    config = ServerConfig(
        openapi=OpenApiConfig(
            enabled=True,
            title="Complete API",
    ...
    app = Spikard(config=config)
    # Register handler with this app instance
    app.register_route("GET", "/info", body_schema=None, parameter_schema=None, file_params=None)(
        openapi_openapi_spec_with_custom_metadata
    )
    return app


def openapi_openapi_spec_generation_basic(
    limit: int,
) -> Any:
...
def create_app_openapi_openapi_spec_generation_basic() -> Spikard:
    """App factory for fixture: OpenAPI spec generation - basic"""
    config = ServerConfig(
        openapi=OpenApiConfig(
            enabled=True,
            title="Test API",
    ...
    app.register_route(
        ...
        file_params=None,
    )(openapi_openapi_spec_generation_basic)
    return app
...
def headers_multiple_custom_headers(
    ...
    return Response(
        content={"x_client_version": "1.2.3", "x_request_id": "req-12345", "x_trace_id": "trace-abc"}, status_code=200
    )
...
def static_files_static_files_disabled_returns_404() -> Any:
    """Handler for GET /*filepath."""
    return Response(
        content={
...
def create_app_static_files_static_files_disabled_returns_404() -> Spikard:
    """App factory for fixture: Static files disabled returns 404"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/*filepath", body_schema=None, parameter_schema=None, file_params=None)(
        static_files_static_files_disabled_returns_404
    )
    return app


def static_files_multiple_ranges_not_supported() -> Any:
    """Handler for GET /*filepath."""
    return Response(content={"simulated_file": "documents/manual.pdf", "simulated_size_bytes": 524288}, status_code=200)


def create_app_static_files_multiple_ranges_not_supported() -> Spikard:
    """App factory for fixture: Multiple ranges not supported"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/*filepath", body_schema=None, parameter_schema=None, file_params=None)(
        static_files_multiple_ranges_not_supported
    )
    return app


def static_files_etag_validation_with_if_none_match() -> Any:
    """Handler for GET /*filepath."""
    return Response(status_code=304)


def create_app_static_files_etag_validation_with_if_none_match() -> Spikard:
    """App factory for fixture: ETag validation with If-None-Match"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/*filepath", body_schema=None, parameter_schema=None, file_params=None)(
        static_files_etag_validation_with_if_none_match
    )
    return app


def static_files_unknown_mime_type_fallback() -> Any:
    """Handler for GET /*filepath."""
    return Response(content={"simulated_file": "files/data.xyz", "simulated_size_bytes": 4096}, status_code=200)


def create_app_static_files_unknown_mime_type_fallback() -> Spikard:
    """App factory for fixture: Unknown MIME type fallback"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/*filepath", body_schema=None, parameter_schema=None, file_params=None)(
        static_files_unknown_mime_type_fallback
    )
    return app


def static_files_404_not_found_for_missing_file() -> Any:
    """Handler for GET /*filepath."""
    return Response(
        content={
            "detail": "The requested file '/missing.html' was not found",
            "status": 404,
            "title": "Not Found",
            "type": "https://spikard.dev/errors/not-found",
        },
...
def create_app_static_files_404_not_found_for_missing_file() -> Spikard:
    """App factory for fixture: 404 Not Found for missing file"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/*filepath", body_schema=None, parameter_schema=None, file_params=None)(
        static_files_404_not_found_for_missing_file
    )
    return app


def static_files_serve_json_file() -> Any:
    """Handler for GET /*filepath."""
    return Response(
        content={
            "simulated_content_sample": '{"version": "1.0.0"}',
            "simulated_file": "data/config.json",
            "simulated_size_bytes": 1024,
        },
        status_code=200,
    )


def create_app_static_files_serve_json_file() -> Spikard:
    """App factory for fixture: Serve JSON file"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/*filepath", body_schema=None, parameter_schema=None, file_params=None)(
        static_files_serve_json_file
    )
    return app


def static_files_serve_pre_compressed_gzip_file() -> Any:
    """Handler for GET /*filepath."""
    return Response(content={"simulated_file": "js/app.js.gz", "simulated_size_bytes": 2048}, status_code=200)


def create_app_static_files_serve_pre_compressed_gzip_file() -> Spikard:
    """App factory for fixture: Serve pre-compressed gzip file"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/*filepath", body_schema=None, parameter_schema=None, file_params=None)(
        static_files_serve_pre_compressed_gzip_file
    )
    return app


def static_files_last_modified_validation_with_if_modified_since() -> Any:
    """Handler for GET /*filepath."""
    return Response(status_code=304)


def create_app_static_files_last_modified_validation_with_if_modified_since() -> Spikard:
    """App factory for fixture: Last-Modified validation with If-Modified-Since"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/*filepath", body_schema=None, parameter_schema=None, file_params=None)(
        static_files_last_modified_validation_with_if_modified_since
    )
    return app


def static_files_serve_javascript_file() -> Any:
    """Handler for GET /*filepath."""
    return Response(
        content={
            "simulated_content_sample": "console.log('Hello, world!');",
            "simulated_file": "js/app.js",
            "simulated_size_bytes": 8192,
        },
        status_code=200,
    )


def create_app_static_files_serve_javascript_file() -> Spikard:
    """App factory for fixture: Serve JavaScript file"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/*filepath", body_schema=None, parameter_schema=None, file_params=None)(
        static_files_serve_javascript_file
    )
    return app


def static_files_serve_pre_compressed_brotli_file() -> Any:
    """Handler for GET /*filepath."""
    return Response(content={"simulated_file": "js/app.js.br", "simulated_size_bytes": 1536}, status_code=200)


def create_app_static_files_serve_pre_compressed_brotli_file() -> Spikard:
    """App factory for fixture: Serve pre-compressed Brotli file"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/*filepath", body_schema=None, parameter_schema=None, file_params=None)(
        static_files_serve_pre_compressed_brotli_file
    )
    return app


def static_files_directory_request_serves_index_html() -> Any:
    """Handler for GET /*filepath."""
    return Response(content={"simulated_file": "index.html", "simulated_size_bytes": 3072}, status_code=200)


def create_app_static_files_directory_request_serves_index_html() -> Spikard:
    """App factory for fixture: Directory request serves index.html"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/*filepath", body_schema=None, parameter_schema=None, file_params=None)(
        static_files_directory_request_serves_index_html
    )
    return app


def static_files_serve_css_file() -> Any:
    """Handler for GET /*filepath."""
    return Response(
        content={
            "simulated_content_sample": "body { font-family: sans-serif; }",
            "simulated_file": "styles/main.css",
            "simulated_size_bytes": 4096,
        },
        status_code=200,
    )


def create_app_static_files_serve_css_file() -> Spikard:
    """App factory for fixture: Serve CSS file"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/*filepath", body_schema=None, parameter_schema=None, file_params=None)(
        static_files_serve_css_file
    )
    return app


def static_files_403_forbidden_for_path_traversal_attempt() -> Any:
    """Handler for GET /*filepath."""
    return Response(
        content={
...
def create_app_static_files_403_forbidden_for_path_traversal_attempt() -> Spikard:
    """App factory for fixture: 403 Forbidden for path traversal attempt"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/*filepath", body_schema=None, parameter_schema=None, file_params=None)(
        static_files_403_forbidden_for_path_traversal_attempt
    )
    return app


def static_files_304_not_modified_with_complete_cache_headers() -> Any:
    """Handler for GET /*filepath."""
    return Response(status_code=304)


def create_app_static_files_304_not_modified_with_complete_cache_headers() -> Spikard:
    """App factory for fixture: 304 Not Modified with complete cache headers"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/*filepath", body_schema=None, parameter_schema=None, file_params=None)(
        static_files_304_not_modified_with_complete_cache_headers
    )
    return app


def static_files_custom_index_file_name() -> Any:
    """Handler for GET /*filepath."""
    return Response(content={"simulated_file": "home.html", "simulated_size_bytes": 2560}, status_code=200)


def create_app_static_files_custom_index_file_name() -> Spikard:
    """App factory for fixture: Custom index file name"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/*filepath", body_schema=None, parameter_schema=None, file_params=None)(
        static_files_custom_index_file_name
    )
    return app


def static_files_cache_control_with_max_age_for_static_assets() -> Any:
    """Handler for GET /*filepath."""
    return Response(
        content={"simulated_file": "assets/bundle-v1.2.3.js", "simulated_size_bytes": 102400}, status_code=200
    )


def create_app_static_files_cache_control_with_max_age_for_static_assets() -> Spikard:
    """App factory for fixture: Cache-Control with max-age for static assets"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/*filepath", body_schema=None, parameter_schema=None, file_params=None)(
        static_files_cache_control_with_max_age_for_static_assets
    )
    return app


def static_files_spa_fallback_for_client_side_routing() -> Any:
    """Handler for GET /*filepath."""
    return Response(content={"simulated_file": "index.html", "simulated_size_bytes": 3072}, status_code=200)


def create_app_static_files_spa_fallback_for_client_side_routing() -> Spikard:
    """App factory for fixture: SPA fallback for client-side routing"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/*filepath", body_schema=None, parameter_schema=None, file_params=None)(
        static_files_spa_fallback_for_client_side_routing
    )
    return app


def static_files_serve_html_file() -> Any:
    """Handler for GET /*filepath."""
    return Response(content={"simulated_file": "about.html", "simulated_size_bytes": 2048}, status_code=200)


def create_app_static_files_serve_html_file() -> Spikard:
    """App factory for fixture: Serve HTML file"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/*filepath", body_schema=None, parameter_schema=None, file_params=None)(
        static_files_serve_html_file
    )
    return app


def static_files_serve_png_image() -> Any:
    """Handler for GET /*filepath."""
    return Response(content={"simulated_file": "images/logo.png", "simulated_size_bytes": 15360}, status_code=200)


def create_app_static_files_serve_png_image() -> Spikard:
    """App factory for fixture: Serve PNG image"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/*filepath", body_schema=None, parameter_schema=None, file_params=None)(
        static_files_serve_png_image
    )
    return app


def static_files_partial_content_range_request() -> Any:
    """Handler for GET /*filepath."""
    return Response(content={"simulated_file": "videos/demo.mp4", "simulated_size_bytes": 1024}, status_code=206)


def create_app_static_files_partial_content_range_request() -> Spikard:
    """App factory for fixture: Partial content range request"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/*filepath", body_schema=None, parameter_schema=None, file_params=None)(
        static_files_partial_content_range_request
    )
    return app
...
def json_bodies_patch_partial_update(
    ...
    """Handler for PATCH /items/{id}."""
    return Response(
        content={"description": "Original description", "name": "Original Item", "price": 45.0}, status_code=200
    )
...
def json_bodies_simple_json_object_success(
    ...
    """Handler for POST /items/."""
    return Response(
        content={"description": "A very nice Item", "name": "Foo", "price": 35.4, "tax": 3.2}, status_code=200
    )
...
def rate_limit_rate_limit_ratelimit_limit_header() -> Any:
    """Handler for GET /api/rate-limited."""
    return Response(content={"message": "Success"}, status_code=200)


def create_app_rate_limit_rate_limit_ratelimit_limit_header() -> Spikard:
    """App factory for fixture: Rate limit - RateLimit-Limit header"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/rate-limited", body_schema=None, parameter_schema=None, file_params=None)(
        rate_limit_rate_limit_ratelimit_limit_header
    )
    return app


def rate_limit_rate_limit_high_limit_configuration() -> Any:
    """Handler for GET /api/rate-limited."""
    return Response(content={"message": "Success"}, status_code=200)


def create_app_rate_limit_rate_limit_high_limit_configuration() -> Spikard:
    """App factory for fixture: Rate limit - high limit configuration"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/rate-limited", body_schema=None, parameter_schema=None, file_params=None)(
        rate_limit_rate_limit_high_limit_configuration
    )
    return app


def rate_limit_rate_limit_concurrent_burst_requests() -> Any:
    """Handler for GET /api/rate-limited."""
    return Response(content={"message": "Success"}, status_code=200)


def create_app_rate_limit_rate_limit_concurrent_burst_requests() -> Spikard:
    """App factory for fixture: Rate limit - concurrent burst requests"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/rate-limited", body_schema=None, parameter_schema=None, file_params=None)(
        rate_limit_rate_limit_concurrent_burst_requests
    )
    return app


def rate_limit_rate_limit_burst_exceeded() -> Any:
    """Handler for GET /api/rate-limited."""
    return Response(
        content={
            ...
            "type": "https://spikard.dev/errors/rate-limit-exceeded",
        },
        status_code=429,
    )


def create_app_rate_limit_rate_limit_burst_exceeded() -> Spikard:
    """App factory for fixture: Rate limit - burst exceeded"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/rate-limited", body_schema=None, parameter_schema=None, file_params=None)(
        rate_limit_rate_limit_burst_exceeded
    )
    return app


def rate_limit_rate_limit_headers_present() -> Any:
    """Handler for GET /api/rate-limited."""
    return Response(content={"message": "Success"}, status_code=200)


def create_app_rate_limit_rate_limit_headers_present() -> Spikard:
    """App factory for fixture: Rate limit - headers present"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/rate-limited", body_schema=None, parameter_schema=None, file_params=None)(
        rate_limit_rate_limit_headers_present
    )
    return app


def rate_limit_rate_limit_token_bucket_refill() -> Any:
    """Handler for GET /api/rate-limited."""
    return Response(content={"message": "Success"}, status_code=200)


def create_app_rate_limit_rate_limit_token_bucket_refill() -> Spikard:
    """App factory for fixture: Rate limit - token bucket refill"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/rate-limited", body_schema=None, parameter_schema=None, file_params=None)(
        rate_limit_rate_limit_token_bucket_refill
    )
    return app


def rate_limit_rate_limit_multiple_endpoints_with_different_limits() -> Any:
    """Handler for GET /api/rate-limited."""
    return Response(content={"message": "Success"}, status_code=200)


def create_app_rate_limit_rate_limit_multiple_endpoints_with_different_limits() -> Spikard:
    """App factory for fixture: Rate limit - multiple endpoints with different limits"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/rate-limited", body_schema=None, parameter_schema=None, file_params=None)(
        rate_limit_rate_limit_multiple_endpoints_with_different_limits
    )
    return app


def rate_limit_rate_limit_ratelimit_remaining_decrements() -> Any:
    """Handler for GET /api/rate-limited."""
    return Response(content={"message": "Success"}, status_code=200)


def create_app_rate_limit_rate_limit_ratelimit_remaining_decrements() -> Spikard:
    """App factory for fixture: Rate limit - RateLimit-Remaining decrements"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/rate-limited", body_schema=None, parameter_schema=None, file_params=None)(
        rate_limit_rate_limit_ratelimit_remaining_decrements
    )
    return app


def rate_limit_rate_limit_low_limit_configuration() -> Any:
    """Handler for GET /api/rate-limited."""
    return Response(content={"message": "Success"}, status_code=200)


def create_app_rate_limit_rate_limit_low_limit_configuration() -> Spikard:
    """App factory for fixture: Rate limit - low limit configuration"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/rate-limited", body_schema=None, parameter_schema=None, file_params=None)(
        rate_limit_rate_limit_low_limit_configuration
    )
    return app


def rate_limit_rate_limit_rfc_9457_error_format() -> Any:
    """Handler for GET /api/rate-limited."""
    return Response(
        content={
            "detail": "Rate limit exceeded. Please retry after the specified time.",
...
def create_app_rate_limit_rate_limit_rfc_9457_error_format() -> Spikard:
    """App factory for fixture: Rate limit - RFC 9457 error format"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/rate-limited", body_schema=None, parameter_schema=None, file_params=None)(
        rate_limit_rate_limit_rfc_9457_error_format
    )
    return app


def rate_limit_rate_limit_under_limit() -> Any:
    """Handler for GET /api/rate-limited."""
    return Response(content={"message": "Success"}, status_code=200)


def create_app_rate_limit_rate_limit_under_limit() -> Spikard:
    """App factory for fixture: Rate limit - under limit"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/rate-limited", body_schema=None, parameter_schema=None, file_params=None)(
        rate_limit_rate_limit_under_limit
    )
    return app


def rate_limit_rate_limit_sequential_requests() -> Any:
    """Handler for GET /api/rate-limited."""
    return Response(content={"message": "Success"}, status_code=200)


def create_app_rate_limit_rate_limit_sequential_requests() -> Spikard:
    """App factory for fixture: Rate limit - sequential requests"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/rate-limited", body_schema=None, parameter_schema=None, file_params=None)(
        rate_limit_rate_limit_sequential_requests
    )
    return app


def rate_limit_rate_limit_disabled() -> Any:
    """Handler for GET /api/rate-limited."""
    return Response(content={"message": "Success"}, status_code=200)


def create_app_rate_limit_rate_limit_disabled() -> Spikard:
    """App factory for fixture: Rate limit - disabled"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/rate-limited", body_schema=None, parameter_schema=None, file_params=None)(
        rate_limit_rate_limit_disabled
    )
    return app


def rate_limit_rate_limit_exceeded() -> Any:
    """Handler for GET /api/rate-limited."""
    return Response(
        content={
            "detail": "Rate limit exceeded. Please retry after the specified time.",
...
def create_app_rate_limit_rate_limit_exceeded() -> Spikard:
    """App factory for fixture: Rate limit - exceeded"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/rate-limited", body_schema=None, parameter_schema=None, file_params=None)(
...
def rate_limit_rate_limit_retry_after_header() -> Any:
    """Handler for GET /api/rate-limited."""
    return Response(
        content={
            "detail": "Rate limit exceeded. Please retry after the specified time.",
...
def create_app_rate_limit_rate_limit_retry_after_header() -> Spikard:
    """App factory for fixture: Rate limit - Retry-After header"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/rate-limited", body_schema=None, parameter_schema=None, file_params=None)(
        rate_limit_rate_limit_retry_after_header
    )
    return app


def rate_limit_rate_limit_burst_allowed() -> Any:
    """Handler for GET /api/rate-limited."""
    return Response(content={"message": "Success"}, status_code=200)


def create_app_rate_limit_rate_limit_burst_allowed() -> Spikard:
    """App factory for fixture: Rate limit - burst allowed"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/rate-limited", body_schema=None, parameter_schema=None, file_params=None)(
        rate_limit_rate_limit_burst_allowed
    )
    return app


def rate_limit_rate_limit_zero_burst_allowance() -> Any:
    """Handler for GET /api/rate-limited."""
    return Response(content={"message": "Success"}, status_code=200)


def create_app_rate_limit_rate_limit_zero_burst_allowance() -> Spikard:
    """App factory for fixture: Rate limit - zero burst allowance"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/rate-limited", body_schema=None, parameter_schema=None, file_params=None)(
        rate_limit_rate_limit_zero_burst_allowance
    )
    return app


def rate_limit_rate_limit_reset_time_calculation() -> Any:
    """Handler for GET /api/rate-limited."""
    return Response(content={"message": "Success"}, status_code=200)


def create_app_rate_limit_rate_limit_reset_time_calculation() -> Spikard:
    """App factory for fixture: Rate limit - reset time calculation"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/rate-limited", body_schema=None, parameter_schema=None, file_params=None)(
        rate_limit_rate_limit_reset_time_calculation
    )
    return app


def rate_limit_rate_limit_ip_based_limiting_enabled() -> Any:
    """Handler for GET /api/rate-limited."""
    return Response(content={"message": "Success"}, status_code=200)


def create_app_rate_limit_rate_limit_ip_based_limiting_enabled() -> Spikard:
    """App factory for fixture: Rate limit - IP-based limiting enabled"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/rate-limited", body_schema=None, parameter_schema=None, file_params=None)(
        rate_limit_rate_limit_ip_based_limiting_enabled
    )
    return app


def rate_limit_rate_limit_high_burst_allowance() -> Any:
    """Handler for GET /api/rate-limited."""
    return Response(content={"message": "Success"}, status_code=200)


def create_app_rate_limit_rate_limit_high_burst_allowance() -> Spikard:
    """App factory for fixture: Rate limit - high burst allowance"""
    app = Spikard()
    # Register handler with this app instance
    app.register_route("GET", "/api/rate-limited", body_schema=None, parameter_schema=None, file_params=None)(
        rate_limit_rate_limit_high_burst_allowance
    )
    return app
...
# - create_app_compression_compression_wildcard_encoding() for compression / Compression - wildcard encoding
# - create_app_compression_compression_gzip_applied() for compression / Compression - gzip applied
# - create_app_compression_compression_brotli_applied() for compression / Compression - brotli applied
# - create_app_compression_compression_minimum_size_threshold() for compression / Compression - minimum size threshold
# - create_app_compression_compression_high_compression_level() for compression / Compression - high compression level
# - create_app_compression_compression_client_prefers_gzip() for compression / Compression - client prefers gzip
# - create_app_compression_compression_client_prefers_brotli() for compression / Compression - client prefers brotli
# - create_app_compression_compression_large_json_response() for compression / Compression - large JSON response
# - create_app_compression_compression_low_compression_level() for compression / Compression - low compression level
# - create_app_compression_compression_multiple_acceptable_encodings() for compression / Compression - multiple acceptable encodings
...
# - create_app_request_id_custom_header_name_x_correlation_id() for request_id / Custom header name (X-Correlation-ID)
# - create_app_request_id_request_id_middleware_disabled() for request_id / Request ID middleware disabled
# - create_app_request_id_missing_request_id_when_required() for request_id / Missing request ID when required
# - create_app_request_id_request_id_present_in_request_and_response() for request_id / Request ID present in request and response
# - create_app_request_id_request_id_present_in_error_responses() for request_id / Request ID present in error responses
# - create_app_request_id_invalid_request_id_format_handling() for request_id / Invalid request ID format handling
# - create_app_request_id_client_provided_request_id_propagated() for request_id / Client-provided request ID propagated
...
# - create_app_body_size_limit_multipart_file_upload_exceeds_limit() for body_size_limit / Multipart file upload exceeds limit
# - create_app_body_size_limit_form_data_exceeds_limit() for body_size_limit / Form data exceeds limit
# - create_app_body_size_limit_json_body_exceeds_limit() for body_size_limit / JSON body exceeds limit
# - create_app_body_size_limit_body_size_at_exact_boundary() for body_size_limit / Body size at exact boundary
# - create_app_body_size_limit_large_limit_for_file_upload_endpoint() for body_size_limit / Large limit for file upload endpoint
# - create_app_body_size_limit_per_route_limit_override() for body_size_limit / Per-route limit override
# - create_app_body_size_limit_body_size_exceeds_limit() for body_size_limit / Body size exceeds limit
# - create_app_body_size_limit_small_limit_for_text_endpoint() for body_size_limit / Small limit for text endpoint
# - create_app_body_size_limit_streaming_body_exceeds_limit() for body_size_limit / Streaming body exceeds limit
# - create_app_body_size_limit_body_size_within_limit() for body_size_limit / Body size within limit
...
# - create_app_request_timeout_per_route_timeout_override() for request_timeout / Per-route timeout override
# - create_app_request_timeout_custom_long_timeout() for request_timeout / Custom long timeout
# - create_app_request_timeout_disabled_timeout() for request_timeout / Disabled timeout
# - create_app_request_timeout_request_at_exact_timeout_boundary() for request_timeout / Request at exact timeout boundary
# - create_app_request_timeout_custom_short_timeout() for request_timeout / Custom short timeout
# - create_app_request_timeout_timeout_during_slow_request_body_read() for request_timeout / Timeout during slow request body read
# - create_app_request_timeout_request_completes_within_timeout() for request_timeout / Request completes within timeout
# - create_app_request_timeout_concurrent_requests_timing_out() for request_timeout / Concurrent requests timing out
# - create_app_request_timeout_default_timeout_behavior() for request_timeout / Default timeout behavior
# - create_app_request_timeout_streaming_response_timeout() for request_timeout / Streaming response timeout
# - create_app_request_timeout_request_exceeds_timeout() for request_timeout / Request exceeds timeout
# - create_app_request_timeout_timeout_with_partial_response() for request_timeout / Timeout with partial response
# - create_app_openapi_redoc_with_customization_options() for openapi / Redoc with customization options
# - create_app_openapi_redoc_serving() for openapi / Redoc serving
# - create_app_openapi_openapi_with_multiple_security_schemes() for openapi / OpenAPI with multiple security schemes
# - create_app_openapi_openapi_spec_with_jwt_security_scheme() for openapi / OpenAPI spec with JWT security scheme
# - create_app_openapi_swagger_ui_with_customization_options() for openapi / Swagger UI with customization options
# - create_app_openapi_openapi_with_multiple_server_configurations() for openapi / OpenAPI with multiple server configurations
# - create_app_openapi_swagger_ui_serving() for openapi / Swagger UI serving
# - create_app_openapi_openapi_with_reusable_component_schemas() for openapi / OpenAPI with reusable component schemas
# - create_app_openapi_openapi_spec_with_api_key_security_scheme() for openapi / OpenAPI spec with API key security scheme
# - create_app_openapi_openapi_with_oauth2_flows() for openapi / OpenAPI with OAuth2 flows
# - create_app_openapi_openapi_with_tags_and_external_documentation() for openapi / OpenAPI with tags and external documentation
# - create_app_openapi_openapi_generation_disabled() for openapi / OpenAPI generation disabled
# - create_app_openapi_openapi_spec_with_custom_metadata() for openapi / OpenAPI spec with custom metadata
# - create_app_openapi_openapi_spec_generation_basic() for openapi / OpenAPI spec generation - basic
...
# - create_app_static_files_static_files_disabled_returns_404() for static_files / Static files disabled returns 404
# - create_app_static_files_multiple_ranges_not_supported() for static_files / Multiple ranges not supported
# - create_app_static_files_etag_validation_with_if_none_match() for static_files / ETag validation with If-None-Match
# - create_app_static_files_unknown_mime_type_fallback() for static_files / Unknown MIME type fallback
# - create_app_static_files_404_not_found_for_missing_file() for static_files / 404 Not Found for missing file
# - create_app_static_files_serve_json_file() for static_files / Serve JSON file
# - create_app_static_files_serve_pre_compressed_gzip_file() for static_files / Serve pre-compressed gzip file
# - create_app_static_files_last_modified_validation_with_if_modified_since() for static_files / Last-Modified validation with If-Modified-Since
# - create_app_static_files_serve_javascript_file() for static_files / Serve JavaScript file
# - create_app_static_files_serve_pre_compressed_brotli_file() for static_files / Serve pre-compressed Brotli file
# - create_app_static_files_directory_request_serves_index_html() for static_files / Directory request serves index.html
# - create_app_static_files_serve_css_file() for static_files / Serve CSS file
# - create_app_static_files_403_forbidden_for_path_traversal_attempt() for static_files / 403 Forbidden for path traversal attempt
# - create_app_static_files_304_not_modified_with_complete_cache_headers() for static_files / 304 Not Modified with complete cache headers
# - create_app_static_files_custom_index_file_name() for static_files / Custom index file name
# - create_app_static_files_cache_control_with_max_age_for_static_assets() for static_files / Cache-Control with max-age for static assets
# - create_app_static_files_spa_fallback_for_client_side_routing() for static_files / SPA fallback for client-side routing
# - create_app_static_files_serve_html_file() for static_files / Serve HTML file
# - create_app_static_files_serve_png_image() for static_files / Serve PNG image
# - create_app_static_files_partial_content_range_request() for static_files / Partial content range request
...
# - create_app_rate_limit_rate_limit_ratelimit_limit_header() for rate_limit / Rate limit - RateLimit-Limit header
# - create_app_rate_limit_rate_limit_high_limit_configuration() for rate_limit / Rate limit - high limit configuration
# - create_app_rate_limit_rate_limit_concurrent_burst_requests() for rate_limit / Rate limit - concurrent burst requests
# - create_app_rate_limit_rate_limit_burst_exceeded() for rate_limit / Rate limit - burst exceeded
# - create_app_rate_limit_rate_limit_headers_present() for rate_limit / Rate limit - headers present
# - create_app_rate_limit_rate_limit_token_bucket_refill() for rate_limit / Rate limit - token bucket refill
# - create_app_rate_limit_rate_limit_multiple_endpoints_with_different_limits() for rate_limit / Rate limit - multiple endpoints with different limits
# - create_app_rate_limit_rate_limit_ratelimit_remaining_decrements() for rate_limit / Rate limit - RateLimit-Remaining decrements
# - create_app_rate_limit_rate_limit_low_limit_configuration() for rate_limit / Rate limit - low limit configuration
# - create_app_rate_limit_rate_limit_rfc_9457_error_format() for rate_limit / Rate limit - RFC 9457 error format
# - create_app_rate_limit_rate_limit_under_limit() for rate_limit / Rate limit - under limit
# - create_app_rate_limit_rate_limit_sequential_requests() for rate_limit / Rate limit - sequential requests
# - create_app_rate_limit_rate_limit_disabled() for rate_limit / Rate limit - disabled
# - create_app_rate_limit_rate_limit_exceeded() for rate_limit / Rate limit - exceeded
# - create_app_rate_limit_rate_limit_retry_after_header() for rate_limit / Rate limit - Retry-After header
# - create_app_rate_limit_rate_limit_burst_allowed() for rate_limit / Rate limit - burst allowed
# - create_app_rate_limit_rate_limit_zero_burst_allowance() for rate_limit / Rate limit - zero burst allowance
# - create_app_rate_limit_rate_limit_reset_time_calculation() for rate_limit / Rate limit - reset time calculation
# - create_app_rate_limit_rate_limit_ip_based_limiting_enabled() for rate_limit / Rate limit - IP-based limiting enabled
# - create_app_rate_limit_rate_limit_high_burst_allowance() for rate_limit / Rate limit - high burst allowance
