...
async def json_bodies_44_const_validation_failure(
    ...
    return Response(
        content={
            "detail": "1 validation error in request",
            "errors": [
                {"input": "2.0", "loc": ["body", "version"], "msg": '"1.0" was expected', "type": "validation_error"}
            ],
            "status": 422,
            "title": "Request Validation Failed",
            "type": "https://spikard.dev/errors/validation-error",
...
async def status_codes_206_partial_content() -> Any:
    ...
    return Response(
        ...
        status_code=206,
        headers={"Accept-Ranges": "bytes", "Content-Type": "application/pdf", "Content-Range": "bytes 0-21/5000"},
    )
...
async def di_value_dependency_injection_success(
    ...
    return Response(
        content={"app_name": "SpikardApp", "max_connections": 100, "version": "1.0.0"},
        status_code=200,
        headers={"Content-Type": "application/json"},
    )
...
async def di_nested_dependencies_3_levels_success(
    ...
    return Response(
        content={"auth_enabled": True, "has_cache": True, "has_db": True},
        status_code=200,
        headers={"Content-Type": "application/json"},
    )
...
async def di_python_parameter_name_based_injection_success(
    ...
    return Response(
        content={"cache_status": "ready", "db_status": "connected"},
        status_code=200,
        headers={"Content-Type": "application/json"},
    )
...
async def di_dependency_injection_in_lifecycle_hooks_success() -> Any:
    ...
    return Response(
        ...
        status_code=200,
        headers={"X-Auth-Mode": "strict", "X-Log-Level": "debug", "Content-Type": "application/json"},
    )
...
async def di_python_type_annotation_based_injection_success(
    ...
    return Response(
        content={"cache_type": "Redis", "pool_type": "PostgreSQL"},
        status_code=200,
        headers={"Content-Type": "application/json"},
    )
...
async def di_async_factory_dependency_success(
    ...
    return Response(
        content={"max_size": 10, "pool_status": "connected"},
        status_code=200,
        headers={"Content-Type": "application/json"},
    )
...
async def handle_grpc_client_streaming_rpc(request: GrpcRequest) -> GrpcResponse:
    ...
    response_payload: bytes = (
        b'{"checksum":"d8e8fca2dc0f896fd7cb4cb0031ba249","file_id":"file-12345","status":"COMPLETED","total_bytes":57}'  # type: ignore[assignment]
    )
    metadata: dict[str, str] = {}
...
async def handle_grpc_map_field_handling_map_string_message(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"id":"map-test-001","keys":["key1","key2","key3"],"map_count":3}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_well_known_wrapper_types_stringvalue_int32value_etc(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = (
        b'{"count_present":true,"count_value":42,"id":"wrapper-test-001","name_present":true,"name_value":"Test Name"}'  # type: ignore[assignment]
    )
    metadata: dict[str, str] = {}
...
async def handle_grpc_google_protobuf_any_type_usage(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"request_id":"any-test-001","success":true,"type_name":"example.v1.Container"}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_deeply_nested_large_structure(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = (
        b'{"person":{"address":{"city":"Springfield","street":"123 Main St"},"name":"John Doe"},"success":true}'  # type: ignore[assignment]
    )
    metadata: dict[str, str] = {}
...
async def handle_grpc_mutual_tls_metadata_simulation(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"client_cn":"client.example.com","verified":true}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_repeated_fields_arrays(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"categories":["tutorial","programming","networking"],"content":"This is a comprehensive guide to gRPC...","id":789,"tags":[{"id":1,"name":"gRPC"},{"id":2,"name":"Protocol Buffers"},{"id":3,"name":"RPC"}],"title":"Getting Started with gRPC"}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_proto3_default_value_behavior(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"active":false,"has_id":true,"id":1,"name":""}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_large_binary_data_in_bytes_field(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"bytes_received":512000,"file_id":"binary-large-001"}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_server_streaming_rpc(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'[{"description":"First item in category","id":101,"name":"Item 1","price":9.99},{"description":"Second item in category","id":102,"name":"Item 2","price":14.99},{"description":"Third item in category","id":103,"name":"Item 3","price":19.99}]'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_large_repeated_field_with_10_000_items(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = (
        b'{"max_value":99.9,"min_value":10.5,"point_count":10000,"series_id":"metrics-large-series"}'  # type: ignore[assignment]
    )
    metadata: dict[str, str] = {}
...
async def handle_grpc_simple_unary_rpc_getuser(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"email":"alice@example.com","id":123,"name":"Alice Johnson"}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_jwt_bearer_token_authentication(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"action":"read","user_id":"user-123"}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_bidirectional_streaming_ping_pong_pairs(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = (
        b'[{"response":"pong","sequence":1},{"response":"pong","sequence":2},{"response":"pong","sequence":3}]'  # type: ignore[assignment]
    )
    metadata: dict[str, str] = {}
...
async def handle_grpc_bidirectional_streaming_chat_conversation(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'[{"message":"Hello Bob","timestamp":1000,"user":"alice"},{"message":"How are you?","timestamp":1001,"user":"alice"},{"message":"I\'m doing great!","timestamp":1002,"user":"alice"}]'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_server_streaming_timeout_scenario(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = (
        b'[{"data":"Message 1","elapsed_ms":500,"sequence":1},{"data":"Message 2","elapsed_ms":1000,"sequence":2}]'  # type: ignore[assignment]
    )
    metadata: dict[str, str] = {}
...
async def handle_grpc_server_streaming_mid_stream_error(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'[{"payload":"Message 1","sequence":1},{"payload":"Message 2","sequence":2},{"payload":"Message 3","sequence":3},{"payload":"Message 4","sequence":4},{"payload":"Message 5","sequence":5}]'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_error_handling_stream_error_mid_transmission(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = (
        b'[{"data":"Message 1","index":1},{"data":"Message 2","index":2},{"data":"Message 3","index":3}]'  # type: ignore[assignment]
    )
    metadata: dict[str, str] = {}
...
async def handle_grpc_client_streaming_10_messages_sum(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"count":10,"sequence_id":"seq-001","status":"COMPLETE","sum":550}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_client_streaming_large_batch_100_messages(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = (
        b'{"average_value":50.5,"batch_id":"batch-large-001","status":"PROCESSED","total_items":100,"total_value":5050}'  # type: ignore[assignment]
    )
    metadata: dict[str, str] = {}
...
async def handle_grpc_client_streaming_early_stream_close(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = (
        b'{"expected_chunks":5,"received_chunks":3,"session_id":"sess-early-001","status":"INCOMPLETE"}'  # type: ignore[assignment]
    )
    metadata: dict[str, str] = {}
...
async def handle_grpc_client_streaming_message_size_limit_exceeded(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"error_detail":"Message payload size 10240 exceeds maximum allowed size 4096","message_id":"payload-002","processed_count":1,"status":"FAILED"}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_client_streaming_rapid_high_frequency_messages(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"avg_value":2.55,"event_count":50,"event_id":"rapid-batch-001","max_value":5.0,"min_value":0.1,"status":"PROCESSED","throughput_mps":500.0}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_client_streaming_unicode_string_aggregation(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"fragment_count":4,"fragment_id":"unicode-001","result":"Hello, \xe4\xb8\x96\xe7\x95\x8c! \xd0\x9f\xd1\x80\xd0\xb8\xd0\xb2\xd0\xb5\xd1\x82 \xf0\x9f\x8c\x8d","status":"CONCATENATED","total_length":26}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_client_streaming_metadata_preserved_in_response(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"message_count":3,"processed_by":"grpc-handler-1","received_user_id":"user-789","request_id":"req-meta-001","status":"COMPLETE_WITH_METADATA","trace_id":"trace-abc456"}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_client_streaming_single_message_aggregation(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"average":42.0,"count":1,"status":"AGGREGATED","total":42}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_client_streaming_validation_failure_mid_stream(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"error_message":"Invalid email format at message index 2: invalid-email","processed":2,"status":"VALIDATION_FAILED"}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_client_streaming_empty_stream_returns_default(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = (
        b'{"is_default":true,"message_count":0,"request_id":"empty-stream-req","result":"DEFAULT_RESULT"}'  # type: ignore[assignment]
    )
    metadata: dict[str, str] = {}
...
async def handle_grpc_optional_fields(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"bio":"Software engineer and gRPC enthusiast","updated_at":1704067200000,"user_id":42,"username":"charlie_dev"}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_all_fields_set_to_zero_false_empty_values(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"fields_received":5,"success":true}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_oneof_field_handling(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"data_present":true,"received_type":"text_data"}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_nested_messages(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"address":{"city":"Springfield","street":"123 Main St","zip_code":"12345"},"email":"bob@example.com","name":"Bob Smith","user_id":456}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_enum_types(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"id":1001,"priority":"HIGH","product_name":"Laptop","quantity":2,"status":"PENDING"}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_grpc_compression_test_gzip(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"compressed":true,"id":"compress-test-001"}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_large_1mb_message_payload(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"data_size":1048576,"request_id":"large-1mb-test-001"}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_api_key_authentication(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"client_id":"client-api-001","data":"resource_data"}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_grpc_metadata_headers(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"received_auth_header":"Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9","received_custom_header":"custom-value","received_trace_id":"trace-abc123def456","request_id":"req-987654321","response_time_ms":45}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_bidirectional_streaming_with_large_payloads(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"direction":"server-to-client","message_id":"bi-large-001","sequence":1}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
...
async def handle_grpc_server_streaming_with_large_response_data(request: GrpcRequest) -> GrpcResponse:
    ...
    # Build response from fixture
    response_payload: bytes = b'{"chunk_number":1,"is_final":false,"stream_id":"stream-large-001"}'  # type: ignore[assignment]
    metadata: dict[str, str] = {}
