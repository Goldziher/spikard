...
async def edge_cases_23_deeply_nested_json_limit(
...
async def lifecycle_hooks_onresponse_response_timing() -> Any:
    ...
    return Response(
        ...
        status_code=200,
        headers={"X-Response-Time": ".*ms", "Content-Type": "application/json"},
    )
...
async def multipart_optional_file_upload_missing(
    body: dict[str, Any],
) -> Any:
    """Handler for POST /files/optional."""
...
async def status_codes_307_temporary_redirect_method_preserved(
    body: dict[str, Any],
) -> Any:
...
async def json_bodies_47_maxproperties_validation_failure(
...
async def json_bodies_46_minproperties_validation_failure(
...
async def json_bodies_empty_json_object(
    body: dict[str, Any],
) -> Any:
...
async def json_bodies_45_minproperties_validation_success(
