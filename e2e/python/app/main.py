...
async def status_codes_206_partial_content() -> Any:
    ...
    content_value = "binary_data_1024_bytes"
    content_bytes = content_value.encode("utf-8")
    if len(content_bytes) < 1024:
        padding = b" " * (1024 - len(content_bytes))
...
async def handle_user_create(request: dict) -> Response:
    ...
    try:
        params = msgspec.convert(request.get("params", {}), UserCreateParams)
        # Echo back the params as the result for testing
        result = UserCreateResult(**msgspec.to_builtins(params))
        return Response(
            status_code=200,
            body=json.dumps({{"jsonrpc": "2.0", "result": msgspec.to_builtins(result), "id": request.get("id")}}),
            headers={{"Content-Type": "application/json"}},
        )
...
def create_app_user_create() -> Spikard:
    app = Spikard()
    app.add_route(handle_user_create)
    return app
...
async def handle_user_delete(request: dict) -> Response:
    ...
    try:
        params = msgspec.convert(request.get("params", {}), UserDeleteParams)
        # Echo back the params as the result for testing
        result = UserDeleteResult(**msgspec.to_builtins(params))
        return Response(
            status_code=200,
            body=json.dumps({{"jsonrpc": "2.0", "result": msgspec.to_builtins(result), "id": request.get("id")}}),
            headers={{"Content-Type": "application/json"}},
...
def create_app_user_delete() -> Spikard:
    app = Spikard()
    app.add_route(handle_user_delete)
    return app
...
async def handle_user_getbyid(request: dict) -> Response:
    ...
    try:
        params = msgspec.convert(request.get("params", {}), UserGetByIdParams)
        # Echo back the params as the result for testing
        result = UserGetByIdResult(**msgspec.to_builtins(params))
        return Response(
            status_code=200,
            body=json.dumps({{"jsonrpc": "2.0", "result": msgspec.to_builtins(result), "id": request.get("id")}}),
            headers={{"Content-Type": "application/json"}},
...
def create_app_user_getbyid() -> Spikard:
    app = Spikard()
    app.add_route(handle_user_getbyid)
    return app
...
async def handle_user_list(request: dict) -> Response:
    ...
    try:
        params = msgspec.convert(request.get("params", {}), UserListParams)
        # Echo back the params as the result for testing
        result = UserListResult(**msgspec.to_builtins(params))
        return Response(
            status_code=200,
            body=json.dumps({{"jsonrpc": "2.0", "result": msgspec.to_builtins(result), "id": request.get("id")}}),
            headers={{"Content-Type": "application/json"}},
...
def create_app_user_list() -> Spikard:
    app = Spikard()
    app.add_route(handle_user_list)
    return app
...
async def handle_user_update(request: dict) -> Response:
    ...
    try:
        params = msgspec.convert(request.get("params", {}), UserUpdateParams)
        # Echo back the params as the result for testing
        result = UserUpdateResult(**msgspec.to_builtins(params))
        return Response(
            status_code=200,
            body=json.dumps({{"jsonrpc": "2.0", "result": msgspec.to_builtins(result), "id": request.get("id")}}),
            headers={{"Content-Type": "application/json"}},
...
def create_app_user_update() -> Spikard:
    app = Spikard()
    app.add_route(handle_user_update)
    return app
