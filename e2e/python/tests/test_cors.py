...
# alef:hash:bad12e39ad6efff1ed8007cc99af122104e2fbbe5ded6f882a477337b3419b47
...
def test_cors_preflight_method_not_allowed(mock_server: str) -> None:
...
def test_cors_preflight_header_not_allowed(mock_server: str) -> None:
...
def test_cors_max_age(mock_server: str) -> None:
...
def test_cors_expose_headers(mock_server: str) -> None:
...
def test_cors_origin_null(mock_server: str) -> None:
