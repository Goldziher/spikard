...
async def test_compression_payload_below_min_size_is_not_compressed() -> None:
    ...
    async with TestClient(create_app_compression_compression_payload_below_min_size_is_not_compressed()) as client:
        headers = {
...
async def test_compression_gzip_applied() -> None:
    ...
    async with TestClient(create_app_compression_compression_gzip_applied()) as client:
        headers = {
            "Accept-Encoding": "gzip",
        }
