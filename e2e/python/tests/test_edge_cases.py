...
async def test_19_emoji_in_strings() -> None:
    ...
    async with TestClient(create_app_edge_cases_19_emoji_in_strings()) as client:
...
async def test_12_percent_encoded_special_chars() -> None:
    ...
    async with TestClient(create_app_edge_cases_12_percent_encoded_special_chars()) as client:
        params = {
            "term": "hi there",
        }
        response = await client.get("/search?term=hi%20there", params=params)
...
async def test_special_string_values_and_escaping() -> None:
    ...
    async with TestClient(create_app_edge_cases_special_string_values_and_escaping()) as client:
        headers = {
...
async def test_15_float_precision_preservation() -> None:
    ...
    async with TestClient(create_app_edge_cases_15_float_precision_preservation()) as client:
...
async def test_13_empty_string_query_param_preserved() -> None:
    ...
    async with TestClient(create_app_edge_cases_13_empty_string_query_param_preserved()) as client:
        params = {
            "filter": "",
        }
        response = await client.get("/items?filter=", params=params)
...
async def test_24_array_with_holes() -> None:
    ...
    async with TestClient(create_app_edge_cases_24_array_with_holes()) as client:
        headers = {
        ...
        assert response_data["error"] == "Failed to parse URL-encoded form data: missing index, expected: 1 got 2"


async def test_21_scientific_notation_number() -> None:
    """Numbers in scientific notation should be parsed correctly."""

    async with TestClient(create_app_edge_cases_21_scientific_notation_number()) as client:
...
async def test_float_precision_and_rounding() -> None:
    ...
    async with TestClient(create_app_edge_cases_float_precision_and_rounding()) as client:
        headers = {
            "Content-Type": "application/json",
        }
        json_data = {
...
async def test_unicode_and_emoji_handling() -> None:
    ...
    async with TestClient(create_app_edge_cases_unicode_and_emoji_handling()) as client:
        headers = {
...
async def test_17_extremely_long_string() -> None:
    ...
    async with TestClient(create_app_edge_cases_17_extremely_long_string()) as client:
        json_data = {
...
async def test_11_utf8_query_parameter() -> None:
    ...
    async with TestClient(create_app_edge_cases_11_utf8_query_parameter()) as client:
        params = {
            "term": "café",
        }
...
async def test_18_unicode_normalization() -> None:
    ...
    async with TestClient(create_app_edge_cases_18_unicode_normalization()) as client:
        json_data = {"name": "café"}
...
async def test_20_null_byte_in_string() -> None:
    ...
    async with TestClient(create_app_edge_cases_20_null_byte_in_string()) as client:
...
async def test_23_deeply_nested_json_limit() -> None:
    ...
    async with TestClient(create_app_edge_cases_23_deeply_nested_json_limit()) as client:
        json_data = {
            "nested": {
                "nested": {
                    "nested": {
...
async def test_14_large_integer_boundary() -> None:
    ...
    async with TestClient(create_app_edge_cases_14_large_integer_boundary()) as client:
        params = {
            "id": "9007199254740991",
        }
...
async def test_22_leading_zeros_integer() -> None:
    ...
    async with TestClient(create_app_edge_cases_22_leading_zeros_integer()) as client:
        params = {
            "value": "0123",
        }
...
async def test_large_integer_boundary_values() -> None:
    ...
    async with TestClient(create_app_edge_cases_large_integer_boundary_values()) as client:
        headers = {
            "Content-Type": "application/json",
        }
        json_data = {
...
async def test_deeply_nested_structure_10_levels() -> None:
    ...
    async with TestClient(create_app_edge_cases_deeply_nested_structure_10_levels()) as client:
        headers = {
            "Content-Type": "application/json",
        }
        json_data = {
...
async def test_empty_and_null_value_handling() -> None:
    ...
    async with TestClient(create_app_edge_cases_empty_and_null_value_handling()) as client:
        headers = {
            "Content-Type": "application/json",
        }
        json_data = {
...
async def test_16_negative_zero_handling() -> None:
    ...
    async with TestClient(create_app_edge_cases_16_negative_zero_handling()) as client:
