...
# alef:hash:1869b9ea29cfb3706fe3078a3b28f1fb9135b4c906c92848b89f297e9bbc592a
...
def test_array_field_success(mock_server: str) -> None:
...
def test_nested_object_bracket_notation(mock_server: str) -> None:
...
def test_special_characters_field_names(mock_server: str) -> None:
...
def test_minlength_validation_failure(mock_server: str) -> None:
...
def test_pattern_validation_failure(mock_server: str) -> None:
...
def test_integer_minimum_validation_failure(mock_server: str) -> None:
...
def test_array_minitems_validation_failure(mock_server: str) -> None:
...
def test_format_email_validation_failure(mock_server: str) -> None:
...
def test_integer_type_coercion_failure(mock_server: str) -> None:
...
def test_additional_properties_strict_failure(mock_server: str) -> None:
