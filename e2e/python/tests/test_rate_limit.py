...
async def test_rate_limit_below_threshold_succeeds() -> None:
    ...
    async with TestClient(create_app_rate_limit_rate_limit_below_threshold_succeeds()) as client:
...
async def test_rate_limit_exceeded_returns_429() -> None:
    ...
    async with TestClient(create_app_rate_limit_rate_limit_exceeded_returns_429()) as client:
        for _ in range(1):
