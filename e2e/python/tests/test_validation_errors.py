...
async def test_invalid_uuid_format() -> None:
    ...
    async with TestClient(create_app_validation_errors_invalid_uuid_format()) as client:
...
async def test_invalid_boolean_value() -> None:
    ...
    async with TestClient(create_app_validation_errors_invalid_boolean_value()) as client:
        headers = {
            "x-token": "test-token",
        }
...
async def test_missing_required_query_parameter() -> None:
    ...
    async with TestClient(create_app_validation_errors_missing_required_query_parameter()) as client:
        headers = {
            "x-token": "test-token",
        }
...
async def test_array_max_items_constraint_violation() -> None:
    ...
    async with TestClient(create_app_validation_errors_array_max_items_constraint_violation()) as client:
        headers = {
...
async def test_numeric_constraint_violation_gt_greater_than() -> None:
    ...
    async with TestClient(create_app_validation_errors_numeric_constraint_violation_gt_greater_than()) as client:
        headers = {
            "x-token": "test-token",
        }
...
async def test_string_regex_pattern_mismatch() -> None:
    ...
    async with TestClient(create_app_validation_errors_string_regex_pattern_mismatch()) as client:
        headers = {
            "x-token": "test-token",
        }
...
async def test_invalid_enum_value() -> None:
    ...
    async with TestClient(create_app_validation_errors_invalid_enum_value()) as client:
...
async def test_string_min_length_constraint_violation() -> None:
    ...
    async with TestClient(create_app_validation_errors_string_min_length_constraint_violation()) as client:
        headers = {
            "x-token": "test-token",
        }
...
async def test_multiple_validation_errors() -> None:
    ...
    async with TestClient(create_app_validation_errors_multiple_validation_errors()) as client:
        headers = {
            "Content-Type": "application/json",
        }
...
async def test_string_max_length_constraint_violation() -> None:
    ...
    async with TestClient(create_app_validation_errors_string_max_length_constraint_violation()) as client:
        headers = {
            "x-token": "test-token",
        }
...
async def test_nested_object_validation_error() -> None:
    ...
    async with TestClient(create_app_validation_errors_nested_object_validation_error()) as client:
        headers = {
            "Content-Type": "application/json",
        }
        json_data = {
...
async def test_10_nested_error_path() -> None:
    ...
    async with TestClient(create_app_validation_errors_10_nested_error_path()) as client:
...
async def test_invalid_datetime_format() -> None:
    ...
    async with TestClient(create_app_validation_errors_invalid_datetime_format()) as client:
        headers = {
            "Content-Type": "application/json",
        }
...
async def test_array_item_validation_error() -> None:
    ...
    async with TestClient(create_app_validation_errors_array_item_validation_error()) as client:
        headers = {
            "Content-Type": "application/json",
        }
...
async def test_missing_required_body_field() -> None:
    ...
    async with TestClient(create_app_validation_errors_missing_required_body_field()) as client:
        headers = {
            "Content-Type": "application/json",
        }
        json_data = {"name": "Item"}
...
async def test_body_field_type_error_string_for_float() -> None:
    ...
    async with TestClient(create_app_validation_errors_body_field_type_error_string_for_float()) as client:
        headers = {
            "Content-Type": "application/json",
        }
...
async def test_malformed_json_body() -> None:
    ...
    async with TestClient(create_app_validation_errors_malformed_json_body()) as client:
        headers = {
            "Content-Type": "application/json",
        }
...
async def test_query_param_type_error_string_provided_for_int() -> None:
    ...
    async with TestClient(create_app_validation_errors_query_param_type_error_string_provided_for_int()) as client:
        headers = {
            "x-token": "test-token",
        }
...
async def test_header_validation_error() -> None:
    ...
    async with TestClient(create_app_validation_errors_header_validation_error()) as client:
...
async def test_numeric_constraint_violation_le_less_than_or_equal() -> None:
    ...
    async with TestClient(create_app_validation_errors_numeric_constraint_violation_le_less_than_or_equal()) as client:
        headers = {
            "x-token": "test-token",
        }
...
async def test_array_min_items_constraint_violation() -> None:
    ...
    async with TestClient(create_app_validation_errors_array_min_items_constraint_violation()) as client:
        headers = {
            "Content-Type": "application/json",
        }
