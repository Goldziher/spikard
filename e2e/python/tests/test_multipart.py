...
async def test_multiple_values_for_same_field_name(client: Any) -> None:
...
async def test_19_file_mime_spoofing_png_as_jpeg(client: Any) -> None:
    ...
    assert response_data["errors"][0]["msg"] == "File type mismatch: MIME type is image/jpeg but magic numbers indicate image/png"
...
async def test_20_file_mime_spoofing_jpeg_as_png(client: Any) -> None:
    ...
    assert response_data["errors"][0]["loc"][1] == "image"
    assert "msg" in response_data["errors"][0]
    assert response_data["errors"][0]["msg"] == "File type mismatch: MIME type is image/png but magic numbers indicate image/jpeg"
    assert "type" in response_data["errors"][0]
    assert response_data["errors"][0]["type"] == "validation_error"
    assert "status" in response_data
    assert response_data["status"] == 422
...
async def test_21_file_pdf_magic_number_success(client: Any) -> None:
...
async def test_content_type_validation__invalid_type(client: Any) -> None:
...
async def test_pdf_file_upload(client: Any) -> None:
...
async def test_file_list_upload_array_of_files(client: Any) -> None:
...
async def test_optional_file_upload__provided(client: Any) -> None:
...
async def test_file_size_validation__too_large(client: Any) -> None:
...
async def test_mixed_files_and_form_data(client: Any) -> None:
...
async def test_simple_file_upload(client: Any) -> None:
...
async def test_empty_file_upload(client: Any) -> None:
...
async def test_optional_file_upload__missing(client: Any) -> None:
...
async def test_file_upload_without_filename(client: Any) -> None:
...
async def test_18_file_magic_number_jpeg_success(client: Any) -> None:
...
async def test_22_file_empty_buffer(client: Any) -> None:
...
async def test_17_file_magic_number_png_success(client: Any) -> None:
...
async def test_form_data_without_files(client: Any) -> None:
...
async def test_multiple_file_uploads(client: Any) -> None:
...
async def test_file_upload_with_custom_headers(client: Any) -> None:
...
async def test_required_file_upload__missing(client: Any) -> None:
...
async def test_image_file_upload(client: Any) -> None:
