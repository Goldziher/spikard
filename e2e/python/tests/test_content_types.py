...
async def test_415_unsupported_media_type() -> None:
    ...
    async with TestClient(create_app_content_types_415_unsupported_media_type()) as client:
        headers = {
...
async def test_xml_response_application_xml() -> None:
    ...
    async with TestClient(create_app_content_types_xml_response_application_xml()) as client:
...
async def test_14_content_type_case_insensitive() -> None:
    ...
    async with TestClient(create_app_content_types_14_content_type_case_insensitive()) as client:
        headers = {
...
async def test_json_with_utf_8_charset() -> None:
    ...
    async with TestClient(create_app_content_types_json_with_utf_8_charset()) as client:
...
async def test_16_text_plain_not_accepted() -> None:
    ...
    async with TestClient(create_app_content_types_16_text_plain_not_accepted()) as client:
        headers = {
...
async def test_pdf_response_application_pdf() -> None:
    ...
    async with TestClient(create_app_content_types_pdf_response_application_pdf()) as client:
...
async def test_17_vendor_json_accepted() -> None:
    ...
    async with TestClient(create_app_content_types_17_vendor_json_accepted()) as client:
        headers = {
...
async def test_13_json_with_charset_utf16() -> None:
    ...
    async with TestClient(create_app_content_types_13_json_with_charset_utf16()) as client:
        headers = {
...
async def test_json_response_application_json() -> None:
    ...
    async with TestClient(create_app_content_types_json_response_application_json()) as client:
...
async def test_15_multipart_boundary_required() -> None:
    ...
    async with TestClient(create_app_content_types_15_multipart_boundary_required()) as client:
        headers = {
...
async def test_content_negotiation_accept_header() -> None:
    ...
    async with TestClient(create_app_content_types_content_negotiation_accept_header()) as client:
        headers = {
...
async def test_html_response_text_html() -> None:
    ...
    async with TestClient(create_app_content_types_html_response_text_html()) as client:
...
async def test_jpeg_image_response_image_jpeg() -> None:
    ...
    async with TestClient(create_app_content_types_jpeg_image_response_image_jpeg()) as client:
...
async def test_19_missing_content_type_default_json() -> None:
    ...
    async with TestClient(create_app_content_types_19_missing_content_type_default_json()) as client:
        json_data = {"name": "test"}
...
async def test_png_image_response_image_png() -> None:
    ...
    async with TestClient(create_app_content_types_png_image_response_image_png()) as client:
...
async def test_plain_text_response_text_plain() -> None:
    ...
    async with TestClient(create_app_content_types_plain_text_response_text_plain()) as client:
...
async def test_18_content_type_with_multiple_params() -> None:
    ...
    async with TestClient(create_app_content_types_18_content_type_with_multiple_params()) as client:
        headers = {
...
async def test_csv_response_text_csv() -> None:
    ...
    async with TestClient(create_app_content_types_csv_response_text_csv()) as client:
...
async def test_binary_response_application_octet_stream() -> None:
    ...
    async with TestClient(create_app_content_types_binary_response_application_octet_stream()) as client:
