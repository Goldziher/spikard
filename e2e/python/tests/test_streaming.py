...
async def test_stream_json_lines() -> None:
    ...
    async with TestClient(create_app_streaming_stream_json_lines()) as client:
...
async def test_binary_log_download() -> None:
    ...
    async with TestClient(create_app_streaming_binary_log_download()) as client:
...
async def test_chunked_csv_export() -> None:
    ...
    async with TestClient(create_app_streaming_chunked_csv_export()) as client:
