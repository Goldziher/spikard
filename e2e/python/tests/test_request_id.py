...
async def test_request_id_header_is_preserved() -> None:
    ...
    app = create_app_request_id_request_id_header_is_preserved()
...
async def test_request_id_middleware_can_be_disabled() -> None:
    ...
    app = create_app_request_id_request_id_middleware_can_be_disabled()
    client = TestClient(app)
...
async def test_request_id_is_generated_when_not_provided() -> None:
    ...
    app = create_app_request_id_request_id_is_generated_when_not_provided()
    client = TestClient(app)
