 ...
 */
@get("/stream/numbers")
async function streamNumbers(req: Request) {
 ...
 */
@get("/stream/events")
async function streamEvents(req: Request) {
	const durationSeconds =
		(req.query?.duration as string | undefined) ?
 ...
 */
@get("/stream/csv")
async function streamCsv(req: Request) {
...
app.registerHandler(streamNumbers);
app.registerHandler(streamEvents);
app.registerHandler(streamCsv);
