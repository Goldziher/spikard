# JSON-RPC 2.0 Ruby Example

This example demonstrates how to build a JSON-RPC 2.0 server using Spikard's Ruby bindings.
...
```json
{
  ...
  "result": {
    ...
    "email": "john@example.com",
    "name": "John Doe",
    "created_at": "2024-12-10T15:30:45Z"
  },
  "id": 2
}
```
...
Define metadata for a JSON-RPC method using a hash:
...
```ruby
app.post('/rpc', jsonrpc_method: method_info) do |email:, name:|
