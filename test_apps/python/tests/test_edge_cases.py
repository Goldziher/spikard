...
# alef:hash:3240343ce9cfd30c6e102229a862a0787471406d02c6289be7e78eb21b54368e
...
def test_array_with_holes() -> None:
    ...
    import json as _json  # noqa: PLC0415
    data = _json.loads(resp_body)
    assert data == {"detail": "Invalid form body: missing index, expected: 1 got 2", "status": 400, "title": "Bad Request", "type": "https://spikard.dev/errors/bad-request"}  # noqa: S101
