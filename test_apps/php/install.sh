...
# Installs the goldziher/spikard extension via PIE before `composer install` runs.
...
"$PIE" install --version "$VERSION" "goldziher/spikard" --skip-enable-extension
...
echo "spikard_php extension installed and loaded"
