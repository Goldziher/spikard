...
final class AuthTest extends TestCase
{
    ...
    public function test_api_key_authentication_invalid_key(): void
    {
        $response = $this->httpClient->request(
            'GET',
            '/fixtures/api_key_authentication_invalid_key/api/data',
    ...
    public function test_api_key_authentication_valid_key(): void
    {
        $response = $this->httpClient->request(
            'GET',
            '/fixtures/api_key_authentication_valid_key/api/data',
    ...
    public function test_api_key_custom_header_x_api_token(): void
    {
        $response = $this->httpClient->request(
            'GET',
            '/fixtures/api_key_custom_header_x_api_token/api/resource',
    ...
    public function test_api_key_multiple_valid_keys(): void
    {
        $response = $this->httpClient->request(
            'GET',
            '/fixtures/api_key_multiple_valid_keys/api/endpoint',
    ...
    public function test_api_key_rotation_old_key_still_valid(): void
    {
        $response = $this->httpClient->request(
            'GET',
            '/fixtures/api_key_rotation_old_key_still_valid/api/data',
    ...
    public function test_api_key_with_custom_header_name(): void
    {
        $response = $this->httpClient->request(
            'GET',
            '/fixtures/api_key_with_custom_header_name/api/data',
    ...
    public function test_bearer_token_without_prefix(): void
    {
        $response = $this->httpClient->request(
            'GET',
            '/fixtures/bearer_token_without_prefix/api/protected',
            ['headers' => [
    ...
    public function test_jwt_audience_claim_aud_field(): void
    {
        $response = $this->httpClient->request(
            'GET',
            '/fixtures/jwt_audience_claim_aud_field/api/protected',
            ['headers' => [
    ...
    public function test_jwt_authentication_valid_token(): void
    {
        $response = $this->httpClient->request(
            'GET',
            '/fixtures/jwt_authentication_valid_token/protected/user',
            ['headers' => [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/jwt_config_algorithm_rs256/api/secure', ['headers' => [
    ...
    public function test_jwt_config_leeway_seconds(): void
    {
        $response = $this->httpClient->request(
            'GET',
            '/fixtures/jwt_config_leeway_seconds/api/protected',
            ['headers' => [
    ...
    public function test_jwt_expiration_claim_exp_field(): void
    {
        $response = $this->httpClient->request(
            'GET',
            '/fixtures/jwt_expiration_claim_exp_field/api/protected',
            ['headers' => [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/jwt_invalid_issuer/api/protected', ['headers' => [
    ...
    public function test_jwt_issuer_claim_iss_field(): void
    {
        $response = $this->httpClient->request(
            'GET',
            '/fixtures/jwt_issuer_claim_iss_field/api/protected',
            ['headers' => [
    ...
    public function test_jwt_malformed_token_format(): void
    {
        $response = $this->httpClient->request(
            'GET',
            '/fixtures/jwt_malformed_token_format/api/protected',
    ...
    public function test_jwt_missing_required_custom_claims(): void
    {
        $response = $this->httpClient->request(
            'GET',
            '/fixtures/jwt_missing_required_custom_claims/api/admin',
            ['headers' => [
                'Authorization' => 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1c2VyMTIzIiwiZXhwIjoyNjI2NzgzOTQ2LCJpYXQiOjE3NjI3ODM5NDYsImF1ZCI6WyJodHRwczovL2FwaS5leGFtcGxlLmNvbSJdLCJpc3MiOiJodHRwczovL2F1dGguZXhhbXBsZS5jb20ifQ.TpRpCJeXROQ12-ehRCVZm6EgN7Dn6QpfoekxJvnzgQg',
            ]],
        );
    ...
    public function test_jwt_not_before_claim_in_future(): void
    {
        $response = $this->httpClient->request(
            'GET',
            '/fixtures/jwt_not_before_claim_in_future/api/protected',
            ['headers' => [
    ...
    {
        $response = $this->httpClient->request('GET', '/fixtures/jwt_subject_claim_sub_field/api/user', ['headers' => [
    ...
    public function test_jwt_with_multiple_audiences(): void
    {
        $response = $this->httpClient->request(
            'GET',
            '/fixtures/jwt_with_multiple_audiences/api/protected',
            ['headers' => [
