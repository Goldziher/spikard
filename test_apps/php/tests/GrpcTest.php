...
final class GrpcTest extends TestCase
{
    ...
    {
        $response = $this->httpClient->request('POST', '/fixtures/grpc_call_with_metadata/api.Service/GetData', [
            'json' => ['id' => 'resource-1'],
            'headers' => [
    ...
    public function test_grpc_config_compression_enabled(): void
    {
        $response = $this->httpClient->request(
            'POST',
            '/fixtures/grpc_config_compression_enabled/api.Service/GetCompressedData',
            [
    ...
    public function test_grpc_config_max_message_size(): void
    {
        $response = $this->httpClient->request(
            'POST',
            '/fixtures/grpc_config_max_message_size/api.Service/SendLargeMessage',
            [
    ...
    {
        $response = $this->httpClient->request('POST', '/fixtures/grpc_deadline_exceeded/api.Service/SlowOperation', [
    ...
    public function test_grpc_error_invalid_argument(): void
    {
        $response = $this->httpClient->request(
            ...
            ['json' => ['value' => -100], 'headers' => ['Content-Type' => 'application/grpc', 'te' => 'trailers']],
        );
        $this->assertEquals(200, $response->getStatusCode());
        $this->assertEquals('application/grpc', $response->getHeaderLine('content-type'));
    ...
    {
        $response = $this->httpClient->request('POST', '/fixtures/grpc_error_not_found/api.Service/GetItem', [
    ...
    {
        $response = $this->httpClient->request('POST', '/fixtures/grpc_request_method_name_field/api.Service/GetData', [
            'json' => ['id' => 'resource-1'],
            'headers' => ['Content-Type' => 'application/grpc', 'te' => 'trailers'],
        ]);
        $this->assertEquals(200, $response->getStatusCode());
    ...
    public function test_grpc_request_service_name_field(): void
    {
        $response = $this->httpClient->request(
            'POST',
            '/fixtures/grpc_request_service_name_field/helloworld.Greeter/SayHello',
            ['json' => ['name' => 'World'], 'headers' => ['Content-Type' => 'application/grpc', 'te' => 'trailers']],
        );
        $this->assertEquals(200, $response->getStatusCode());
        $this->assertEquals('application/grpc', $response->getHeaderLine('content-type'));
        $this->assertEquals('0', $response->getHeaderLine('grpc-status'));
    ...
    public function test_grpc_request_with_custom_metadata(): void
    {
        $response = $this->httpClient->request(
            'POST',
            '/fixtures/grpc_request_with_custom_metadata/api.Service/ProcessWithMetadata',
            [
    ...
    public function test_grpc_response_with_metadata_trailers(): void
    {
        $response = $this->httpClient->request(
            'POST',
            '/fixtures/grpc_response_with_metadata_trailers/api.Service/MetadataResponse',
            ['json' => ['request' => 'test'], 'headers' => ['Content-Type' => 'application/grpc', 'te' => 'trailers']],
        );
        $this->assertEquals(200, $response->getStatusCode());
        $this->assertEquals('application/grpc', $response->getHeaderLine('content-type'));
        $this->assertEquals('0', $response->getHeaderLine('grpc-status'));
