...
// alef:hash:fc445bcf4e9f31af7841872e4c46ef29e402e70e66b8d087a9f6edaa09d68a9b
...
{    private Client $httpClient;
    ...
    {        $response = $this->httpClient->request('GET', "/fixtures/compression_brotli_only", [            'headers' => ["Accept-Encoding" => "br"],        ]);        $this->assertEquals(200, $response->getStatusCode());        $this->assertEquals("Accept-Encoding", $response->getHeaderLine("vary"));        $body = json_decode((string) $response->getBody(), true, 512, JSON_THROW_ON_ERROR);
    ...
    {        $response = $this->httpClient->request('GET', "/fixtures/compression_gzip_applied", [            'headers' => ["Accept-Encoding" => "gzip"],        ]);        $this->assertEquals(200, $response->getStatusCode());        $this->assertEquals("Accept-Encoding", $response->getHeaderLine("vary"));        $body = json_decode((string) $response->getBody(), true, 512, JSON_THROW_ON_ERROR);
    ...
    {        $response = $this->httpClient->request('GET', "/fixtures/compression_min_size_threshold_exact_boundary", [            'headers' => ["Accept-Encoding" => "gzip"],        ]);        $this->assertEquals(200, $response->getStatusCode());        $body = json_decode((string) $response->getBody(), true, 512, JSON_THROW_ON_ERROR);
    ...
    {        $response = $this->httpClient->request('GET', "/fixtures/compression_payload_below_min_size_is_not_compressed", [            'headers' => ["Accept-Encoding" => "gzip"],        ]);        $this->assertEquals(200, $response->getStatusCode());        $body = json_decode((string) $response->getBody(), true, 512, JSON_THROW_ON_ERROR);
    ...
    {        $response = $this->httpClient->request('GET', "/fixtures/compression_quality_level_9", [            'headers' => ["Accept-Encoding" => "gzip"],        ]);        $this->assertEquals(200, $response->getStatusCode());        $body = json_decode((string) $response->getBody(), true, 512, JSON_THROW_ON_ERROR);
