...
ARTIFACT_URL="https://github.com/Goldziher/spikard/releases/download/v0.15.6-rc.9/Spikard-rs.artifactbundle.zip"
ARTIFACT_FILE="Spikard-rs.artifactbundle.zip"
