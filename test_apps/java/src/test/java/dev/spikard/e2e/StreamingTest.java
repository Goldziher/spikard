...
public class StreamingTest {
  ...
  void testBinaryLogDownload() throws Exception {
    ...
    java.net.URI uri = java.net.URI.create(
        baseUrl + "/fixtures/binary_log_download/stream/logfile");
  ...
  void testChunkedCsvExport() throws Exception {
    ...
    if (baseUrl == null)
      baseUrl = "http://localhost:8000";
    java.net.URI uri = java.net.URI.create(
        baseUrl + "/fixtures/chunked_csv_export/stream/csv-report");
    var builder = java.net.http.HttpRequest.newBuilder(uri).method(
        "GET", java.net.http.HttpRequest.BodyPublishers.noBody());
    var response = java.net.http.HttpClient.newHttpClient().send(
        builder.build(), java.net.http.HttpResponse.BodyHandlers.ofString());
  ...
  void testStreamJsonLines() throws Exception {
    ...
    if (baseUrl == null)
      baseUrl = "http://localhost:8000";
    java.net.URI uri = java.net.URI.create(
        baseUrl + "/fixtures/stream_json_lines/stream/json-lines");
    var builder = java.net.http.HttpRequest.newBuilder(uri).method(
        "GET", java.net.http.HttpRequest.BodyPublishers.noBody());
    var response = java.net.http.HttpClient.newHttpClient().send(
        builder.build(), java.net.http.HttpResponse.BodyHandlers.ofString());
