...
// alef:hash:d5a9c156eac762976e3d7cac94cc762eea83cc8d76eb21d9e797976e27df7762
...
public class RequestIdTest {
    ...
    void testRequestIdHeaderIsPreserved() throws Exception {
        ...
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/request_id_header_is_preserved/request-id/preserved");
    ...
    void testRequestIdIsGeneratedWhenNotProvided() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/request_id_is_generated_when_not_provided/request-id/generated");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
            .method("GET", java.net.http.HttpRequest.BodyPublishers.noBody());
        var response = java.net.http.HttpClient.newHttpClient()
            .send(builder.build(), java.net.http.HttpResponse.BodyHandlers.ofString());
    ...
    void testRequestIdMiddlewareCanBeDisabled() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/request_id_middleware_can_be_disabled/request-id/disabled");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
            .method("GET", java.net.http.HttpRequest.BodyPublishers.noBody());
