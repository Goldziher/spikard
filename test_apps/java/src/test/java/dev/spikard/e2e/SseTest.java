...
// alef:hash:590849cf6e4d4b0c38c21e2e760cb7a1358a04dac4422fb6edd44c5a86877fc2
...
public class SseTest {
    ...
    void testSseEventRetry5000Milliseconds() throws Exception {
        ...
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/sse_event_retry_5000_milliseconds/events/retry-5s");
    ...
    void testSseEventWithAllFields() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/sse_event_with_all_fields/events/complete");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
            .method("GET", java.net.http.HttpRequest.BodyPublishers.noBody());
        builder = builder.header("Accept", "text/event-stream");
        var response = java.net.http.HttpClient.newHttpClient()
    ...
    void testSseEventWithDataAndMetadata() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/sse_event_with_data_and_metadata/events/data");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
            .method("GET", java.net.http.HttpRequest.BodyPublishers.noBody());
        builder = builder.header("Accept", "text/event-stream");
        var response = java.net.http.HttpClient.newHttpClient()
    ...
    void testSseEventWithIdField() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/sse_event_with_id_field/events/with-id");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
            .method("GET", java.net.http.HttpRequest.BodyPublishers.noBody());
        builder = builder.header("Accept", "text/event-stream");
        var response = java.net.http.HttpClient.newHttpClient()
    ...
    void testSseEventWithRetryField() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/sse_event_with_retry_field/events/with-retry");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
            .method("GET", java.net.http.HttpRequest.BodyPublishers.noBody());
        builder = builder.header("Accept", "text/event-stream");
        var response = java.net.http.HttpClient.newHttpClient()
    ...
    void testSseEventWithTypeField() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/sse_event_with_type_field/events/typed");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
            .method("GET", java.net.http.HttpRequest.BodyPublishers.noBody());
        builder = builder.header("Accept", "text/event-stream");
        var response = java.net.http.HttpClient.newHttpClient()
    ...
    void testSseMultipleEventsStream() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/sse_multiple_events_stream/events/multi");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
            .method("GET", java.net.http.HttpRequest.BodyPublishers.noBody());
        builder = builder.header("Accept", "text/event-stream");
        var response = java.net.http.HttpClient.newHttpClient()
    ...
    void testSseSimpleEventStream() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/sse_simple_event_stream/events");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
            .method("GET", java.net.http.HttpRequest.BodyPublishers.noBody());
        builder = builder.header("Accept", "text/event-stream");
        var response = java.net.http.HttpClient.newHttpClient()
