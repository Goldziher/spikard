...
// alef:hash:787a5303efa04ee046369cf1b1eb27019198c282ef79d2061c2fe9c850abfdae
...
public class RequestTimeoutTest {
    ...
    void testRequestCompletesBeforeTimeout() throws Exception {
        ...
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/request_completes_before_timeout/timeouts/fast");
    ...
    void testRequestExceedsTimeout() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/request_exceeds_timeout/timeouts/slow");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
            .method("GET", java.net.http.HttpRequest.BodyPublishers.noBody());
        var response = java.net.http.HttpClient.newHttpClient()
            .send(builder.build(), java.net.http.HttpResponse.BodyHandlers.ofString());
