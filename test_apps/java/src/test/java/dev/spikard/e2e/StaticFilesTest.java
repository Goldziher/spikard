...
// alef:hash:6bb2e8510062445a4554ca0039142b450f611c3bacad790c72b90728102f18e5
...
public class StaticFilesTest {
    ...
    void testStaticFileServerReturnsTextFile() throws Exception {
        ...
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/static_file_server_returns_text_file/public/hello.txt");
    ...
    void testStaticServerReturnsIndexHtmlForDirectory() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/static_server_returns_index_html_for_directory/app/");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
            .method("GET", java.net.http.HttpRequest.BodyPublishers.noBody());
        var response = java.net.http.HttpClient.newHttpClient()
            .send(builder.build(), java.net.http.HttpResponse.BodyHandlers.ofString());
