...
// alef:hash:5b37046ffc51e3d5e387f29532883f23c248fca2fe84e560acedd16941c10e2d
...
public class BackgroundTasksTest {
    ...
    void testBackgroundTaskCancellation() throws Exception {
        ...
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/background_task_cancellation/background/cancel/task-001");
    ...
    void testBackgroundTaskCustomMaxConcurrent() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/background_task_custom_max_concurrent/background/process");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    void testBackgroundTaskCustomTimeout() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/background_task_custom_timeout/background/slow-task");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
    ...
    void testBackgroundTaskErrorHandling() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/background_task_error_handling/background/may-fail");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
        ...
        assertEquals(202, response.statusCode(), "status code mismatch");
        var bodyJson = MAPPER.readTree(response.body());
        var expectedJson = MAPPER.readTree("{\"status\":\"queued\"}");
        assertEquals(expectedJson, bodyJson, "body mismatch");
    }
    ...
    void testBackgroundTaskMultipleConcurrent() throws Exception {
        ...
        String baseUrl = System.getenv("SUT_URL");
        if (baseUrl == null) baseUrl = "http://localhost:8000";
        java.net.URI uri = java.net.URI.create(baseUrl + "/fixtures/background_task_multiple_concurrent/background/batch");
        var builder = java.net.http.HttpRequest.newBuilder(uri)
