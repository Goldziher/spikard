...
public class BodyLimitsTest {
  ...
  void testBodyOverLimitReturns413() throws Exception {
    // Requests that exceed the configured max body size should be rejected with
    // Payload Too Large.
    String baseUrl = System.getenv("SUT_URL");
    if (baseUrl == null)
      baseUrl = "http://localhost:8000";
    java.net.URI uri = java.net.URI.create(
        baseUrl + "/fixtures/body_over_limit_returns_413/body-limit/over");
  ...
  void testBodyUnderLimitSucceeds() throws Exception {
    ...
    if (baseUrl == null)
      baseUrl = "http://localhost:8000";
    java.net.URI uri = java.net.URI.create(
        baseUrl + "/fixtures/body_under_limit_succeeds/body-limit/under");
    var builder = java.net.http.HttpRequest.newBuilder(uri).method(
        "POST", java.net.http.HttpRequest.BodyPublishers.ofString(
                    "{\"note\":\"small\"}"));
    builder = builder.header("Content-Type", "application/json");
    ...
    var expectedJson =
        MAPPER.readTree("{\"accepted\":true,\"note\":\"small\"}");
