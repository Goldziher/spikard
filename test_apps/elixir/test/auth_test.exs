...
defmodule E2e.AuthTest do
  ...
  describe "api_key_authentication_invalid_key" do
    test "Tests API key authentication failure when provided key is not in the valid keys list" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/api_key_authentication_invalid_key",
          finch: AlefE2EFinch,
  ...
  describe "api_key_authentication_missing_header" do
    test "Tests API key authentication failure when required header is not provided" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/api_key_authentication_missing_header",
          finch: AlefE2EFinch
        )
  ...
  describe "api_key_authentication_valid_key" do
    test "Tests API key authentication with a valid API key in custom header" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/api_key_authentication_valid_key",
          finch: AlefE2EFinch,
  ...
  describe "api_key_custom_header_x_api_token" do
    test "Tests API key authentication with custom X-API-Token header" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/api_key_custom_header_x_api_token",
          finch: AlefE2EFinch,
  ...
  describe "api_key_in_query_parameter" do
    test "Tests API key authentication when key is provided as query parameter instead of header" do
      {:ok, response} =
        Req.get(url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/api_key_in_query_parameter", finch: AlefE2EFinch)
  ...
  describe "api_key_multiple_valid_keys" do
    test "Tests API key authentication accepts multiple valid keys" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/api_key_multiple_valid_keys",
          finch: AlefE2EFinch,
  ...
  describe "api_key_rotation_old_key_still_valid" do
    test "Tests API key authentication during rotation period when old key remains valid alongside new key" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/api_key_rotation_old_key_still_valid",
          finch: AlefE2EFinch,
      ...
      assert Enum.find_value(response.headers, fn {k, v} ->
               if String.downcase(k) == "x-api-key-deprecated", do: List.first(List.wrap(v))
             end) == "true"
  ...
  describe "api_key_with_custom_header_name" do
    test "Tests API key authentication with a custom header name (X-API-Token instead of X-API-Key)" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/api_key_with_custom_header_name",
          finch: AlefE2EFinch,
  ...
  describe "bearer_token_without_prefix" do
    test "Tests JWT rejection when token is provided without 'Bearer ' prefix in Authorization header" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/bearer_token_without_prefix",
          finch: AlefE2EFinch,
          headers: [
            {"Authorization",
  ...
  describe "jwt_audience_claim_aud_field" do
    test "Tests JWT validation of audience (aud) claim" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jwt_audience_claim_aud_field",
          finch: AlefE2EFinch,
          headers: [
            {"Authorization",
  ...
  describe "jwt_authentication_expired_token" do
    test "Tests JWT authentication failure when token has expired (exp claim in the past)" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jwt_authentication_expired_token",
          finch: AlefE2EFinch,
          headers: [
            {"Authorization",
  ...
  describe "jwt_authentication_invalid_audience" do
    test "Tests JWT authentication failure when token audience claim does not match required audience" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jwt_authentication_invalid_audience",
          finch: AlefE2EFinch,
          headers: [
            {"Authorization",
  ...
  describe "jwt_authentication_invalid_signature" do
    test "Tests JWT authentication failure when token signature does not match the secret" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jwt_authentication_invalid_signature",
          finch: AlefE2EFinch,
          headers: [
            {"Authorization",
  ...
  describe "jwt_authentication_missing_authorization_header" do
    test "Tests JWT authentication failure when Authorization header is not provided" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jwt_authentication_missing_authorization_header",
          finch: AlefE2EFinch
        )
  ...
  describe "jwt_authentication_valid_token" do
    test "Tests JWT authentication with a valid token containing correct signature and claims" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jwt_authentication_valid_token",
          finch: AlefE2EFinch,
          headers: [
            {"Authorization",
  ...
  describe "jwt_config_algorithm_rs256" do
    test "Tests JWT validation with RS256 asymmetric algorithm" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jwt_config_algorithm_rs256",
          finch: AlefE2EFinch,
          headers: [
            {"Authorization",
  ...
  describe "jwt_config_leeway_seconds" do
    test "Tests JWT validation with leeway for clock skew" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jwt_config_leeway_seconds",
          finch: AlefE2EFinch,
          headers: [
            {"Authorization",
  ...
  describe "jwt_expiration_claim_exp_field" do
    test "Tests JWT validation of expiration (exp) claim" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jwt_expiration_claim_exp_field",
          finch: AlefE2EFinch,
          headers: [
            {"Authorization",
  ...
  describe "jwt_invalid_issuer" do
    test "Tests JWT rejection when issuer claim doesn't match expected value" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jwt_invalid_issuer",
          finch: AlefE2EFinch,
          headers: [
            {"Authorization",
  ...
  describe "jwt_issuer_claim_iss_field" do
    test "Tests JWT validation of issuer (iss) claim" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jwt_issuer_claim_iss_field",
          finch: AlefE2EFinch,
          headers: [
            {"Authorization",
  ...
  describe "jwt_malformed_token_format" do
    test "Tests JWT rejection when token doesn't have the required 3-part structure (header.payload.signature)" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jwt_malformed_token_format",
          finch: AlefE2EFinch,
  ...
  describe "jwt_missing_required_custom_claims" do
    test "Tests JWT rejection when required custom claims (role, permissions) are missing" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jwt_missing_required_custom_claims",
          finch: AlefE2EFinch,
          headers: [
            {"Authorization",
             "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1c2VyMTIzIiwiZXhwIjoyNjI2NzgzOTQ2LCJpYXQiOjE3NjI3ODM5NDYsImF1ZCI6WyJodHRwczovL2FwaS5leGFtcGxlLmNvbSJdLCJpc3MiOiJodHRwczovL2F1dGguZXhhbXBsZS5jb20ifQ.TpRpCJeXROQ12-ehRCVZm6EgN7Dn6QpfoekxJvnzgQg"}
  ...
  describe "jwt_not_before_claim_in_future" do
    test "Tests JWT rejection when nbf (not before) claim is in the future" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jwt_not_before_claim_in_future",
          finch: AlefE2EFinch,
          headers: [
            {"Authorization",
  ...
  describe "jwt_subject_claim_sub_field" do
    test "Tests JWT validation with subject (sub) claim" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jwt_subject_claim_sub_field",
          finch: AlefE2EFinch,
          headers: [
            {"Authorization",
  ...
  describe "jwt_with_multiple_audiences" do
    test "Tests JWT validation when token has multiple audiences and one must match" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/jwt_with_multiple_audiences",
          finch: AlefE2EFinch,
          headers: [
            {"Authorization",
  ...
  describe "multiple_authentication_schemes_jwt_precedence" do
    test "Tests authentication when both JWT and API key are provided, JWT takes precedence" do
      {:ok, response} =
        Req.get(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/multiple_authentication_schemes_jwt_precedence",
          finch: AlefE2EFinch,
          headers: [
            {"Authorization",
             "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1c2VyMTIzIiwiZXhwIjoyNjI2NzgzOTQ2LCJpYXQiOjE3NjI3ODM5NDYsImF1ZCI6WyJodHRwczovL2FwaS5leGFtcGxlLmNvbSJdLCJpc3MiOiJodHRwczovL2F1dGguZXhhbXBsZS5jb20ifQ.TpRpCJeXROQ12-ehRCVZm6EgN7Dn6QpfoekxJvnzgQg"},
