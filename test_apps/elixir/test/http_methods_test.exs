...
# alef:hash:9a5f7047907f5047f26576dae9d7bdc4bbd86cb195f453463b1ff32281fff992
...
defmodule E2e.HttpMethodsTest do
  ...
  describe "delete_remove_resource" do
    test "Tests DELETE method to remove a resource" do
      {:ok, response} =
        Req.delete(url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/delete_remove_resource", finch: AlefE2EFinch)
  ...
  describe "delete_resource_not_found" do
    test "Tests DELETE on non-existent resource returns 404" do
      {:ok, response} =
        Req.delete(url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/delete_resource_not_found", finch: AlefE2EFinch)
  ...
  describe "delete_with_response_body" do
    test "Tests DELETE returning deleted resource data" do
      {:ok, response} =
        Req.delete(url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/delete_with_response_body", finch: AlefE2EFinch)
  ...
  describe "head_get_metadata_without_body" do
    test "Tests HEAD method returns headers without response body" do
      {:ok, response} =
        Req.head(url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/head_get_metadata_without_body", finch: AlefE2EFinch)

      assert response.status == 200

      assert Enum.find_value(response.headers, fn {k, v} -> if String.downcase(k) == "content-length", do: List.first(List.wrap(v)) end) ==
               "85"
  ...
  describe "patch_partial_update" do
    test "Tests PATCH method for partial resource updates" do
      {:ok, response} =
        Req.patch(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/patch_partial_update",
          finch: AlefE2EFinch,
          json: %{"price" => 79.99},
  ...
  describe "patch_update_multiple_fields" do
    test "Tests PATCH updating multiple fields at once" do
      {:ok, response} =
        Req.patch(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/patch_update_multiple_fields",
          finch: AlefE2EFinch,
  ...
  describe "put_complete_resource_replacement" do
    test "Tests PUT method for complete resource replacement" do
      {:ok, response} =
        Req.put(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/put_complete_resource_replacement",
          finch: AlefE2EFinch,
  ...
  describe "put_create_resource_if_doesn_t_exist" do
    test "Tests PUT creating new resource at specific URI" do
      {:ok, response} =
        Req.put(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/put_create_resource_if_doesn_t_exist",
          finch: AlefE2EFinch,
  ...
  describe "put_idempotent_operation" do
    test "Tests PUT idempotency - repeated calls produce same result" do
      {:ok, response} =
        Req.put(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/put_idempotent_operation",
          finch: AlefE2EFinch,
  ...
  describe "put_missing_required_field" do
    test "Tests PUT with missing required fields returns 422" do
      {:ok, response} =
        Req.put(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/put_missing_required_field",
          finch: AlefE2EFinch,
  ...
  describe "put_validation_error" do
    test "Tests PUT with invalid data returns 422" do
      {:ok, response} =
        Req.put(
          url: (System.get_env("SUT_URL") || mock_server_url()) <> "/fixtures/put_validation_error",
          finch: AlefE2EFinch,
