...
# alef:hash:239d8021d9de7a346e0c66b22816fee4c7e1a757151c4066c990970ecaf53e97
...
defmodule E2e.HttpMethodsTest do
  ...
  describe "delete_remove_resource" do
    test "Tests DELETE method to remove a resource" do
      {:ok, response} = Req.delete(url: "#{mock_server_url()}/fixtures/delete_remove_resource", connect_options: [protocols: [:http1]])
  ...
  describe "delete_resource_not_found" do
    test "Tests DELETE on non-existent resource returns 404" do
      {:ok, response} = Req.delete(url: "#{mock_server_url()}/fixtures/delete_resource_not_found", connect_options: [protocols: [:http1]])
      assert response.status == 200
      body_decoded = if is_binary(response.body), do: Jason.decode!(response.body), else: response.body
      assert body_decoded == %{}
    end
  ...
  describe "delete_with_response_body" do
    test "Tests DELETE returning deleted resource data" do
      {:ok, response} = Req.delete(url: "#{mock_server_url()}/fixtures/delete_with_response_body", connect_options: [protocols: [:http1]])
      assert response.status == 200
      body_decoded = if is_binary(response.body), do: Jason.decode!(response.body), else: response.body
  ...
  describe "head_get_metadata_without_body" do
    test "Tests HEAD method returns headers without response body" do
      {:ok, response} = Req.head(url: "#{mock_server_url()}/fixtures/head_get_metadata_without_body", connect_options: [protocols: [:http1]])
      assert response.status == 200
  ...
  describe "patch_partial_update" do
    test "Tests PATCH method for partial resource updates" do
      {:ok, response} = Req.patch(url: "#{mock_server_url()}/fixtures/patch_partial_update", connect_options: [protocols: [:http1]], json: %{"price" => 79.99}, headers: [{"Content-Type", "application/json"}])
      assert response.status == 200
      body_decoded = if is_binary(response.body), do: Jason.decode!(response.body), else: response.body
  ...
  describe "patch_update_multiple_fields" do
    test "Tests PATCH updating multiple fields at once" do
      {:ok, response} = Req.patch(url: "#{mock_server_url()}/fixtures/patch_update_multiple_fields", connect_options: [protocols: [:http1]], json: %{"in_stock" => false, "name" => "Updated Name", "price" => 89.99}, headers: [{"Content-Type", "application/json"}])
      assert response.status == 200
      body_decoded = if is_binary(response.body), do: Jason.decode!(response.body), else: response.body
  ...
  describe "put_complete_resource_replacement" do
    test "Tests PUT method for complete resource replacement" do
      {:ok, response} = Req.put(url: "#{mock_server_url()}/fixtures/put_complete_resource_replacement", connect_options: [protocols: [:http1]], json: %{"description" => "Completely replaced", "id" => 1, "in_stock" => true, "name" => "Updated Item", "price" => 99.99}, headers: [{"Content-Type", "application/json"}])
      assert response.status == 200
      body_decoded = if is_binary(response.body), do: Jason.decode!(response.body), else: response.body
  ...
  describe "put_create_resource_if_doesn_t_exist" do
    test "Tests PUT creating new resource at specific URI" do
      {:ok, response} = Req.put(url: "#{mock_server_url()}/fixtures/put_create_resource_if_doesn_t_exist", connect_options: [protocols: [:http1]], json: %{"id" => 999, "name" => "New Item", "price" => 49.99}, headers: [{"Content-Type", "application/json"}])
      assert response.status == 200
      body_decoded = if is_binary(response.body), do: Jason.decode!(response.body), else: response.body
  ...
  describe "put_idempotent_operation" do
    test "Tests PUT idempotency - repeated calls produce same result" do
      {:ok, response} = Req.put(url: "#{mock_server_url()}/fixtures/put_idempotent_operation", connect_options: [protocols: [:http1]], json: %{"id" => 1, "name" => "Fixed Name", "price" => 50.0}, headers: [{"Content-Type", "application/json"}])
      assert response.status == 200
      body_decoded = if is_binary(response.body), do: Jason.decode!(response.body), else: response.body
  ...
  describe "put_missing_required_field" do
    test "Tests PUT with missing required fields returns 422" do
      {:ok, response} = Req.put(url: "#{mock_server_url()}/fixtures/put_missing_required_field", connect_options: [protocols: [:http1]], json: %{"id" => 1, "name" => "Item Name"}, headers: [{"Content-Type", "application/json"}])
  ...
  describe "put_validation_error" do
    test "Tests PUT with invalid data returns 422" do
      {:ok, response} = Req.put(url: "#{mock_server_url()}/fixtures/put_validation_error", connect_options: [protocols: [:http1]], json: %{"id" => 1, "name" => "X", "price" => -10}, headers: [{"Content-Type", "application/json"}])
      assert response.status == 422
      body_decoded = if is_binary(response.body), do: Jason.decode!(response.body), else: response.body
