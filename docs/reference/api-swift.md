...
## Swift API Reference <span class="version-badge">v0.15.6-rc.9</span>
...
```swift
public static func handlerResultFromResponse(outcome: Response) -> String
```
...
```swift
public func config(config: ServerConfig) -> App
```
...
```swift
public func route(builder: RouteBuilder, handler: H) throws -> App
```
...
```swift
public func onDisconnect() -> Future
```
