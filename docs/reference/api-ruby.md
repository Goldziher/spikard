...
<!-- alef:hash:0cfe45e331efc176339c6020e640249d1cc438aeff934b655e38e6afc3671b06 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Ruby API Reference <span class="version-badge">v0.17.0-rc.11</span>
...
| `order` | `Integer?` | `nil` | Explicit execution order within the phase, where the corpus states one (`fixtures/lifecycle_hooks.json`'s `hook_execution_order`). Array position already implies an order, so this exists to let a fixture assert ordering rather than rely on it. ~keep |
