...
<!-- alef:hash:e28477ea0aca1c30691b4f00d08445349186bdc7fda6db3ea4c94fff11c60211 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Python API Reference <span class="version-badge">v0.17.0-rc.11</span>
...
| `order` | `int \| None` | `None` | Explicit execution order within the phase, where the corpus states one (`fixtures/lifecycle_hooks.json`'s `hook_execution_order`). Array position already implies an order, so this exists to let a fixture assert ordering rather than rely on it. ~keep |
