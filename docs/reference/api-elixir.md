...
<!-- alef:hash:301f29573b12790e9441e7aa947a5277fd1a66db735b2ebac5b493e0eec00c47 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Elixir API Reference <span class="version-badge">v0.17.0-rc.11</span>
...
| `order` | `integer() \| nil` | `nil` | Explicit execution order within the phase, where the corpus states one (`fixtures/lifecycle_hooks.json`'s `hook_execution_order`). Array position already implies an order, so this exists to let a fixture assert ordering rather than rely on it. ~keep |
