...
## Gleam API Reference <span class="version-badge">v0.14.0</span>
...
| `securitySchemes` | `Dict(String, SecuritySchemeInfo)` | `{}` | Security schemes (auto-detected from middleware if not provided) |
...
| `extensions` | `Dict(String, String)` | — | Extension members - problem-type-specific data. For validation errors, this typically contains an "errors" array. |
...
| `content` | `BitArray` | — | File content (may be base64 encoded) |
