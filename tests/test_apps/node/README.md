...
Test application that validates the published `@spikard/node` npm package (v0.11.0) works correctly in a real Node.js environment.
...
### Package not found
- Verify `@spikard/node@0.11.0` is published to npm
