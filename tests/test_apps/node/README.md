...
Test application that validates the published `@spikard/node` npm package (v0.6.0) works correctly in a real Node.js environment.
...
### Package not found
- Verify `@spikard/node@0.6.0` is published to npm
