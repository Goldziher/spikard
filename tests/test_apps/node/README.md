...
Test application that validates the published `@spikard/node` npm package (v0.10.1) works correctly in a real Node.js environment.
...
### Package not found
- Verify `@spikard/node@0.10.1` is published to npm
