...
Test application that validates the published `@spikard/wasm` npm package (v0.6.0) works correctly in a WebAssembly environment.
...
### Package not found
- Verify `@spikard/wasm@0.6.0` is published to npm
