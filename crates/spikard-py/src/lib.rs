...
// alef:hash:47ee5d346a82de74097ea72f8155b2a987e50e64ad8569fdfa10e3936f69f002
...
impl ServerConfig {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (host=None, port=None, workers=None, enable_request_id=None, static_files=None, graceful_shutdown=None, shutdown_timeout=None, max_body_size=None, request_timeout=None, compression=None, rate_limit=None, jwt_auth=None, api_key_auth=None, openapi=None, jsonrpc=None, lifecycle_hooks=None, di_container=None))]
    #[new]
    pub fn new(
        host: Option<String>,
        port: Option<u16>,
