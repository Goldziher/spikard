...
// alef:hash:19a4edd6f50ff9ecf0f69a4bf1053c7c198d8faa59180144ba3b9d2567ad0761
...
impl CorsConfig {
    ...
    #[must_use]
    #[pyo3(signature = (allowed_origins=None, allowed_methods=None, allowed_headers=None, expose_headers=None, max_age=None, allow_credentials=None))]
    #[new]
    pub fn new(
...
impl AsyncApiConfig {
    #[must_use]
    #[pyo3(signature = (enabled=None, spec=None))]
    #[new]
    pub fn new(enabled: Option<bool>, spec: Option<String>) -> Self {
        Self {
...
impl ServerConfig {
    ...
    pub fn new(
        ...
        Self {
            ...
            enable_http_trace: enable_http_trace.unwrap_or_default(),
        }
    }
