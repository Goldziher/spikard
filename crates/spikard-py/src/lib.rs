...
// alef:hash:1aff968c0e35290208cab4b128813867f634b30e444b90a0597085282b825cae
...
pub struct SnapshotError {
    pub(crate) inner: spikard::SnapshotError,
}
...
impl SnapshotError {
    ...
    fn new(py: Python<'_>, value: &Bound<'_, pyo3::types::PyAny>) -> PyResult<Self> {
        ...
        let inner: spikard::SnapshotError = serde_json::from_str(&json_str)
            .map_err(|e| pyo3::exceptions::PyValueError::new_err(format!("Invalid SnapshotError: {e}")))?;
        Ok(Self { inner })
    }
...
impl From<SnapshotError> for spikard::SnapshotError {
...
impl<'de> serde::Deserialize<'de> for SnapshotError {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let inner = spikard::SnapshotError::deserialize(deserializer)?;
        Ok(Self { inner })
    }
}
...
pub struct WebSocketMessage {
    pub(crate) inner: spikard::WebSocketMessage,
}
...
impl WebSocketMessage {
    ...
    fn new(py: Python<'_>, value: &Bound<'_, pyo3::types::PyAny>) -> PyResult<Self> {
        ...
        let inner: spikard::WebSocketMessage = serde_json::from_str(&json_str)
            .map_err(|e| pyo3::exceptions::PyValueError::new_err(format!("Invalid WebSocketMessage: {e}")))?;
        Ok(Self { inner })
    }
...
impl From<WebSocketMessage> for spikard::WebSocketMessage {
...
impl<'de> serde::Deserialize<'de> for WebSocketMessage {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let inner = spikard::WebSocketMessage::deserialize(deserializer)?;
        Ok(Self { inner })
    }
}
