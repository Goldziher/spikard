...
// TEMP-N+4: `pub mod service;` declaration intentionally omitted until alef's
// napi verb-decorator codegen emits methods inside an `impl JsApp` block
// instead of top-level `&mut self` free functions. See alef commit 4d4526bfe
// for the mod-service emission; matching codegen restructure pending.
