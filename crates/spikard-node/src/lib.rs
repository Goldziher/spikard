...
pub struct JsRouteMetadata {
    ...
    #[napi(js_name = "requestSchema")]
    pub request_schema: Option<String>,
    #[napi(js_name = "responseSchema")]
    pub response_schema: Option<String>,
    #[napi(js_name = "parameterSchema")]
    pub parameter_schema: Option<String>,
    #[napi(js_name = "fileParams")]
    pub file_params: Option<String>,
    #[napi(js_name = "isAsync")]
    pub is_async: Option<bool>,
    pub cors: Option<JsCorsConfig>,
    #[napi(js_name = "bodyParamName")]
...
pub struct JsRoute {
    ...
    #[napi(js_name = "handlerName")]
    pub handler_name: Option<String>,
    #[napi(js_name = "requestValidator")]
    pub request_validator: Option<String>,
    #[napi(js_name = "responseValidator")]
    pub response_validator: Option<String>,
    #[napi(js_name = "parameterValidator")]
    ...
    pub is_async: Option<bool>,
    pub cors: Option<JsCorsConfig>,
    #[napi(js_name = "expectsJsonBody")]
    pub expects_json_body: Option<bool>,
    #[napi(js_name = "handlerDependencies")]
    pub handler_dependencies: Option<Vec<String>>,
    #[napi(js_name = "jsonrpcMethod")]
...
#[allow(clippy::derivable_impls)]
impl Default for JsJsonRpcResponseType {
    fn default() -> Self {
        Self::Success
    }
}
...
#[allow(clippy::derivable_impls)]
impl Default for JsJsonRpcRequestOrBatch {
    fn default() -> Self {
        Self::Single
    }
}
...
impl From<JsBackgroundJobError> for spikard_http::BackgroundJobError {
    fn from(val: JsBackgroundJobError) -> Self {
...
impl From<spikard_http::GrpcRequestData> for JsGrpcRequestData {
...
impl From<spikard_http::GrpcResponseData> for JsGrpcResponseData {
...
impl From<spikard_http::ValidatedParams> for JsValidatedParams {
...
impl From<spikard_http::jsonrpc::JsonRpcResponseType> for JsJsonRpcResponseType {
...
impl From<spikard_http::jsonrpc::JsonRpcRequestOrBatch> for JsJsonRpcRequestOrBatch {
