...
function requireNative() {
	if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
		...
		if (process.arch === "arm64") {
			try {
				return require("./spikard-node.android-arm64.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
			...
			try {
				return require("./spikard-node.android-arm-eabi.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
		...
		if (process.arch === "x64") {
			if (
				...
				try {
					return require("./spikard-node.win32-x64-gnu.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
				...
				try {
					return require("./spikard-node.win32-x64-msvc.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
			...
			try {
				return require("./spikard-node.win32-ia32-msvc.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
			...
			try {
				return require("./spikard-node.win32-arm64-msvc.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
		...
		try {
			return require("./spikard-node.darwin-universal.node");
		} catch (e) {
			loadErrors.push(e);
		}
		try {
		...
		if (process.arch === "x64") {
			try {
				return require("./spikard-node.darwin-x64.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
			...
			try {
				return require("./spikard-node.darwin-arm64.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
		...
		if (process.arch === "x64") {
			try {
				return require("./spikard-node.freebsd-x64.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
			...
			try {
				return require("./spikard-node.freebsd-arm64.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
		...
		if (process.arch === "x64") {
			if (isMusl()) {
				try {
					return require("./spikard-node.linux-x64-musl.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
				...
				try {
					return require("./spikard-node.linux-x64-gnu.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
			...
			if (isMusl()) {
				try {
					return require("./spikard-node.linux-arm64-musl.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
				...
				try {
					return require("./spikard-node.linux-arm64-gnu.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
			...
			if (isMusl()) {
				try {
					return require("./spikard-node.linux-arm-musleabihf.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
				...
				try {
					return require("./spikard-node.linux-arm-gnueabihf.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
			...
			if (isMusl()) {
				try {
					return require("./spikard-node.linux-loong64-musl.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
				...
				try {
					return require("./spikard-node.linux-loong64-gnu.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
			...
			if (isMusl()) {
				try {
					return require("./spikard-node.linux-riscv64-musl.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
				...
				try {
					return require("./spikard-node.linux-riscv64-gnu.node");
				} catch (e) {
					loadErrors.push(e);
				}
				try {
			...
			try {
				return require("./spikard-node.linux-ppc64-gnu.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
			...
			try {
				return require("./spikard-node.linux-s390x-gnu.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
		...
		if (process.arch === "arm64") {
			try {
				return require("./spikard-node.openharmony-arm64.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
			...
			try {
				return require("./spikard-node.openharmony-x64.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
			...
			try {
				return require("./spikard-node.openharmony-arm.node");
			} catch (e) {
				loadErrors.push(e);
			}
			try {
...
if (!nativeBinding || process.env.NAPI_RS_FORCE_WASI) {
	...
	try {
		wasiBinding = require("./spikard-node.wasi.cjs");
