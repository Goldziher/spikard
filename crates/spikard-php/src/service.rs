...
// alef:hash:6ce0b64c8062dfafdfa4ce4e861c0dcfeb0e2585ab77ead89d64cf15d699c7e4
    ...
    fn call(
        ...
        Box::pin(async move {
            ...
            let outcome: Result<spikard::Response, Box<dyn std::error::Error + Send + Sync>> = (async {
                ...
                .map_err(|_| {
                    Box::new(std::io::Error::other("PHP handler panicked")) as Box<dyn std::error::Error + Send + Sync>
                })?
