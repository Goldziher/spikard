...
impl Response {
    ...
    #[php(constructor)]
    pub fn new(content: Option<String>, statusCode: u16) -> Self {
        Self {
            content,
...
impl SseEvent {
    #[php(constructor)]
    pub fn new(eventType: Option<String>, data: String, id: Option<String>, retry: Option<i64>) -> Self {
        Self {
...
impl App {
    ...
    pub fn config(&self, config: &ServerConfig) -> App {
        Self {
            inner: Arc::new(std::sync::Mutex::new(
                (*self.inner).clone().config(config.clone().into()),
            )),
        }
    }
     ...
     * @throws SpikardException Returns an error if route construction fails or if the handler registration fails.
     */
    pub fn route(&self, builder: &RouteBuilder, handler: &H) -> PhpResult<App> {
        let handler_core: spikard::H = handler.clone().into();
        let result = self
            .inner
            .lock()
            .unwrap()
            .route(&builder.inner, handler_core)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(Self {
            inner: Arc::new(std::sync::Mutex::new(result.clone())),
        })
    }
...
impl RouteBuilder {
    ...
    pub fn request_schema_json(&self, schema: String) -> RouteBuilder {
        Self {
            inner: Arc::new(self.inner.request_schema_json(schema)),
        }
    }
    ...
    pub fn response_schema_json(&self, schema: String) -> RouteBuilder {
        Self {
            inner: Arc::new(self.inner.response_schema_json(schema)),
        }
    }
    ...
    pub fn params_schema_json(&self, schema: String) -> RouteBuilder {
        Self {
            inner: Arc::new(self.inner.params_schema_json(schema)),
        }
    }
    ...
    pub fn file_params_json(&self, schema: String) -> RouteBuilder {
        Self {
            inner: Arc::new(self.inner.file_params_json(schema)),
        }
    }
...
pub struct JsonRpcMethodInfo {
    ...
    #[php(prop, name = "paramsSchema")]
    #[serde(skip)]
    pub params_schema: Option<String>,
    /// Optional JSON Schema for the result
    #[php(prop, name = "resultSchema")]
    #[serde(skip)]
