...
pub struct OpenApiConfig {
    ...
    #[doc = "PHP: read-only via get_security_schemes() — this field's value type cannot cross the ext-php-rs FFI boundary as a settable property, so it is omitted from the constructor and has no setter."]
...
impl OpenApiConfig {
    ...
    pub fn set_contact(&mut self, value: Option<ContactInfo>) {
        self.contact = value.map(Into::into);
    }
    ...
    pub fn set_license(&mut self, value: Option<LicenseInfo>) {
        self.license = value.map(Into::into);
    }
...
impl ServerConfig {
    ...
    pub fn set_compression(&mut self, value: Option<CompressionConfig>) {
        self.compression = value.map(Into::into);
    }
    ...
    pub fn set_rate_limit(&mut self, value: Option<RateLimitConfig>) {
        self.rate_limit = value.map(Into::into);
    }
    ...
    pub fn set_jwt_auth(&mut self, value: Option<JwtConfig>) {
        self.jwt_auth = value.map(Into::into);
    }
    ...
    pub fn set_api_key_auth(&mut self, value: Option<ApiKeyConfig>) {
        self.api_key_auth = value.map(Into::into);
    }
    ...
    pub fn set_asyncapi(&mut self, value: Option<AsyncApiConfig>) {
        self.asyncapi = value.map(Into::into);
    }
    ...
    pub fn set_openapi(&mut self, value: Option<OpenApiConfig>) {
        self.openapi = value.map(Into::into);
    }
    ...
    pub fn set_jsonrpc(&mut self, value: Option<JsonRpcConfig>) {
        self.jsonrpc = value.map(Into::into);
    }
...
pub struct ProblemDetails {
    ...
    #[doc = "PHP: read-only via get_extensions() — this field's value type cannot cross the ext-php-rs FFI boundary as a settable property, so it is omitted from the constructor and has no setter."]
