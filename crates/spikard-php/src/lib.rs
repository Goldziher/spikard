...
// alef:hash:eb5919f6aab4b1886a695cd07ce89655ee805d9b9d851e98a7c081afc352a2fb
...
#[php_class]
#[php(name = "Spikard\\Php\\ApiKeyAuthConfig")]
#[serde(default)]
...
impl ApiKeyAuthConfig {
    ...
    #[php(constructor)]
    pub fn new(enabled: bool, keys: Vec<String>, headerName: String) -> Self {
        Self {
            enabled,
            keys,
...
impl App {
    ...
    pub fn register_graphql_route(
        ...
        let method_core: spikard::Method =
            serde_json::from_str(&serde_json::to_string(&method).unwrap_or_default()).unwrap_or_default();
        let config_core: spikard::SchemaConfig = config.clone().into();
        self.inner
            .lock()
            .unwrap()
            .register_graphql_route(path, method_core, &schemaType, &config_core)
    ...
    pub fn register_graphql_sdl_route(
        ...
        let method_core: spikard::Method =
            serde_json::from_str(&serde_json::to_string(&method).unwrap_or_default()).unwrap_or_default();
        let config_core: spikard::DynamicSchemaConfig = config.clone().into();
        self.inner
            .lock()
            .unwrap()
            .register_graphql_sdl_route(
                ...
                method_core,
                &sdl,
                serde_json::from_str(&responseData).unwrap_or_default(),
                &config_core,
            )
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(Self {
...
impl Default for AsyncApiConfig {
    fn default() -> Self {
        <spikard::AsyncApiConfig as Default>::default().into()
    }
}
...
impl AsyncApiConfig {
    ...
    #[php(constructor)]
    pub fn new(enabled: bool, spec: Option<String>) -> PhpResult<Self> {
        Ok(Self {
            enabled,
            spec: spec
...
#[derive(Clone, serde::Serialize, serde::Deserialize)]
#[php_class]
#[php(name = "Spikard\\Php\\AuthorizationConfig")]
#[serde(default)]
pub struct AuthorizationConfig {
    /// Roles the authenticated caller must have
    #[php(prop, name = "requiredRoles")]
    #[serde(alias = "requiredRoles")]
    pub required_roles: Vec<String>,
    /// OAuth-style scopes the authenticated caller must have
    #[php(prop, name = "requiredScopes")]
    #[serde(alias = "requiredScopes")]
    pub required_scopes: Vec<String>,
    /// Fine-grained permissions the authenticated caller must have
    #[php(prop, name = "requiredPermissions")]
    #[serde(alias = "requiredPermissions")]
    ...
    #[php(prop, name = "requireAll")]
    #[serde(default = "crate::serde_defaults::authorization_config_require_all")]
    #[serde(alias = "requireAll")]
    pub require_all: bool,
}

impl Default for AuthorizationConfig {
    fn default() -> Self {
        <spikard::AuthorizationConfig as Default>::default().into()
    }
}
...
impl AuthorizationConfig {
    ...
    #[php(constructor)]
    pub fn new(
        requiredRoles: Vec<String>,
        requiredScopes: Vec<String>,
        requiredPermissions: Vec<String>,
        requireAll: bool,
    ) -> Self {
        Self {
    ...
    pub fn get_required_scopes(&self) -> Vec<String> {
    ...
    pub fn get_require_all(&self) -> bool {
        self.require_all.clone()
    }

    #[allow(clippy::should_implement_trait)]
    #[php(name = "default")]
    pub fn default() -> AuthorizationConfig {
...
pub struct BackgroundJobMetadata {
    #[php(prop, name = "name")]
    #[serde(default = "crate::serde_defaults::background_job_metadata_name")]
    pub name: String,
...
pub struct BackgroundTaskConfig {
    ...
    #[php(prop, name = "enabled")]
    #[serde(default = "crate::serde_defaults::background_task_config_enabled")]
    pub enabled: bool,
...
impl BackgroundTaskConfig {
    ...
    #[php(constructor)]
    pub fn new(enabled: bool, maxQueueSize: i64, maxConcurrentTasks: i64, drainTimeoutSecs: i64) -> Self {
        Self {
            enabled,
...
pub struct CompressionConfig {
    ...
    #[serde(default = "crate::serde_defaults::compression_config_min_size")]
    #[serde(alias = "minSize")]
    pub min_size: i64,
    /// Compression quality (0-11 for brotli, 0-9 for gzip)
    #[php(prop, name = "quality")]
    #[serde(default = "crate::serde_defaults::compression_config_quality")]
    pub quality: u32,
}
...
#[derive(Clone, serde::Serialize, serde::Deserialize)]
#[php_class]
#[php(name = "Spikard\\Php\\DynamicSchemaConfig")]
#[serde(default)]
pub struct DynamicSchemaConfig {
    ...
    #[serde(alias = "introspectionEnabled")]
    pub introspection_enabled: bool,
    /// Maximum query complexity (`None` = unlimited).
    #[php(prop, name = "maxComplexity")]
    #[serde(alias = "maxComplexity")]
    ...
    #[serde(alias = "fieldErrors")]
    pub field_errors: Vec<FieldErrorSpec>,
}

impl Default for DynamicSchemaConfig {
    fn default() -> Self {
        <spikard::DynamicSchemaConfig as Default>::default().into()
    }
}
...
impl DynamicSchemaConfig {
    ...
    pub fn new(
        ...
        fieldErrors: &ext_php_rs::types::ZendHashTable,
        maxComplexity: Option<i64>,
        maxDepth: Option<i64>,
    ) -> PhpResult<Self> {
        let mut fieldErrors_core_result: Vec<FieldErrorSpec> = Vec::new();
        for (_, item) in fieldErrors.iter() {
            if let Some(parsed) = <&FieldErrorSpec as ext_php_rs::convert::FromZval>::from_zval(item) {
                fieldErrors_core_result.push(parsed.clone());
            } else {
                return Err(ext_php_rs::exception::PhpException::default(
                    "Failed to convert array element to FieldErrorSpec".to_string(),
                ));
            }
        }
        let fieldErrors_core: Vec<FieldErrorSpec> = fieldErrors_core_result;
        Ok(Self {
            introspection_enabled: introspectionEnabled,
            max_complexity: maxComplexity,
            max_depth: maxDepth,
            field_errors: fieldErrors_core,
        })
    }
    ...
    pub fn get_max_complexity(&self) -> Option<i64> {
        self.max_complexity.clone()
    }
    ...
    pub fn get_field_errors(&self) -> Vec<FieldErrorSpec> {
...
#[derive(Clone, serde::Serialize, serde::Deserialize, Default)]
#[php_class]
#[php(name = "Spikard\\Php\\FieldErrorSpec")]
#[serde(default)]
...
pub struct GraphQLSubscriptionSnapshot {
    ...
    #[serde(alias = "completeReceived")]
    pub complete_received: bool,
}

impl Default for GraphQLSubscriptionSnapshot {
    fn default() -> Self {
        <spikard_http::testing::test_client::GraphQLSubscriptionSnapshot as Default>::default().into()
    }
}
...
pub struct GrpcConfig {
    ...
    #[serde(default = "crate::serde_defaults::grpc_config_max_message_size")]
    ...
    #[serde(default = "crate::serde_defaults::grpc_config_max_concurrent_streams")]
    ...
    #[serde(alias = "enableKeepalive")]
    pub enable_keepalive: bool,
    /// HTTP/2 keepalive interval in seconds
    #[php(prop, name = "keepaliveInterval")]
    #[serde(default = "crate::serde_defaults::grpc_config_keepalive_interval")]
    #[serde(alias = "keepaliveInterval")]
    pub keepalive_interval: i64,
    /// HTTP/2 keepalive timeout in seconds
    #[php(prop, name = "keepaliveTimeout")]
    #[serde(default = "crate::serde_defaults::grpc_config_keepalive_timeout")]
    ...
    #[serde(alias = "maxStreamResponseBytes")]
    #[serde(default)]
...
pub struct JsonRpcConfig {
    ...
    #[serde(default = "crate::serde_defaults::json_rpc_config_endpoint_path")]
    #[serde(alias = "endpointPath")]
    pub endpoint_path: String,
    /// Enable batch request processing (default: true)
    #[php(prop, name = "enableBatch")]
    #[serde(default = "crate::serde_defaults::json_rpc_config_enable_batch")]
    #[serde(alias = "enableBatch")]
    pub enable_batch: bool,
    /// Maximum number of requests in a batch (default: 100)
    #[php(prop, name = "maxBatchSize")]
    #[serde(default = "crate::serde_defaults::json_rpc_config_max_batch_size")]
    #[serde(alias = "maxBatchSize")]
...
impl JsonRpcMethodInfo {
    ...
    pub fn new(
        ...
        paramsSchema: Option<String>,
        resultSchema: Option<String>,
    ) -> PhpResult<Self> {
        Ok(Self {
...
#[derive(Clone, serde::Serialize, serde::Deserialize, Default)]
#[php_class]
#[php(name = "Spikard\\Php\\JwtAuthConfig")]
#[serde(default)]
...
#[derive(Clone, serde::Serialize, serde::Deserialize)]
#[php_class]
#[php(name = "Spikard\\Php\\LifecycleHookRef")]
#[serde(default)]
...
impl Default for LifecycleHookRef {
    fn default() -> Self {
        <spikard::LifecycleHookRef as Default>::default().into()
    }
}
...
impl LifecycleHookRef {
    ...
    pub fn get_config(&self) -> Option<String> {
        self.config.as_ref().and_then(|v| serde_json::to_string(v).ok())
    }
...
impl Default for LifecycleHooksConfig {
    fn default() -> Self {
        <spikard::LifecycleHooksConfig as Default>::default().into()
    }
}
...
impl LifecycleHooksConfig {
    ...
    #[php(constructor)]
    pub fn new(
        onRequest: &ext_php_rs::types::ZendHashTable,
        preValidation: &ext_php_rs::types::ZendHashTable,
        preHandler: &ext_php_rs::types::ZendHashTable,
        onResponse: &ext_php_rs::types::ZendHashTable,
        onError: &ext_php_rs::types::ZendHashTable,
    ) -> PhpResult<Self> {
        let mut onRequest_core_result: Vec<LifecycleHookRef> = Vec::new();
        for (_, item) in onRequest.iter() {
            if let Some(parsed) = <&LifecycleHookRef as ext_php_rs::convert::FromZval>::from_zval(item) {
                onRequest_core_result.push(parsed.clone());
            } else {
                return Err(ext_php_rs::exception::PhpException::default(
                    "Failed to convert array element to LifecycleHookRef".to_string(),
                ));
            }
        }
        let onRequest_core: Vec<LifecycleHookRef> = onRequest_core_result;
        let mut preValidation_core_result: Vec<LifecycleHookRef> = Vec::new();
        for (_, item) in preValidation.iter() {
            if let Some(parsed) = <&LifecycleHookRef as ext_php_rs::convert::FromZval>::from_zval(item) {
                preValidation_core_result.push(parsed.clone());
            } else {
                return Err(ext_php_rs::exception::PhpException::default(
                    "Failed to convert array element to LifecycleHookRef".to_string(),
                ));
        ...
        let preValidation_core: Vec<LifecycleHookRef> = preValidation_core_result;
        let mut preHandler_core_result: Vec<LifecycleHookRef> = Vec::new();
        for (_, item) in preHandler.iter() {
            if let Some(parsed) = <&LifecycleHookRef as ext_php_rs::convert::FromZval>::from_zval(item) {
                preHandler_core_result.push(parsed.clone());
            } else {
                return Err(ext_php_rs::exception::PhpException::default(
                    "Failed to convert array element to LifecycleHookRef".to_string(),
                ));
        ...
        let preHandler_core: Vec<LifecycleHookRef> = preHandler_core_result;
        let mut onResponse_core_result: Vec<LifecycleHookRef> = Vec::new();
        for (_, item) in onResponse.iter() {
            if let Some(parsed) = <&LifecycleHookRef as ext_php_rs::convert::FromZval>::from_zval(item) {
                onResponse_core_result.push(parsed.clone());
            } else {
                return Err(ext_php_rs::exception::PhpException::default(
                    "Failed to convert array element to LifecycleHookRef".to_string(),
                ));
        ...
        let onResponse_core: Vec<LifecycleHookRef> = onResponse_core_result;
        let mut onError_core_result: Vec<LifecycleHookRef> = Vec::new();
        for (_, item) in onError.iter() {
            if let Some(parsed) = <&LifecycleHookRef as ext_php_rs::convert::FromZval>::from_zval(item) {
                onError_core_result.push(parsed.clone());
            } else {
                return Err(ext_php_rs::exception::PhpException::default(
                    "Failed to convert array element to LifecycleHookRef".to_string(),
                ));
        ...
        let onError_core: Vec<LifecycleHookRef> = onError_core_result;
        Ok(Self {
            on_request: onRequest_core,
            pre_validation: preValidation_core,
            pre_handler: preHandler_core,
            on_response: onResponse_core,
            on_error: onError_core,
        })
    }

    pub fn get_on_request(&self) -> Vec<LifecycleHookRef> {
        self.on_request.clone()
    }

    pub fn get_pre_validation(&self) -> Vec<LifecycleHookRef> {
        self.pre_validation.clone()
    }

    pub fn get_pre_handler(&self) -> Vec<LifecycleHookRef> {
        self.pre_handler.clone()
    }

    pub fn get_on_response(&self) -> Vec<LifecycleHookRef> {
        self.on_response.clone()
    }

    pub fn get_on_error(&self) -> Vec<LifecycleHookRef> {
        self.on_error.clone()
    }
}
...
pub struct OpenApiConfig {
    ...
    #[serde(default = "crate::serde_defaults::open_api_config_swagger_ui_path")]
    #[serde(alias = "swaggerUiPath")]
    pub swagger_ui_path: String,
    /// Path to serve Redoc (default: "/redoc")
    #[php(prop, name = "redocPath")]
    #[serde(default = "crate::serde_defaults::open_api_config_redoc_path")]
    #[serde(alias = "redocPath")]
    pub redoc_path: String,
    /// Path to serve OpenAPI JSON spec (default: "/openapi.json")
    #[php(prop, name = "openapiJsonPath")]
    #[serde(default = "crate::serde_defaults::open_api_config_openapi_json_path")]
    #[serde(alias = "openapiJsonPath")]
    ...
    #[doc = "PHP: initialize this field through fromJson() and read it via get_security_schemes(); its value type cannot be
exposed as a directly settable ext-php-rs property."]
    #[serde(alias = "securitySchemes")]
    #[serde(default)]
...
impl OpenApiConfig {
    ...
    pub fn new(
        ...
        servers: &ext_php_rs::types::ZendHashTable,
        description: Option<String>,
        contact: Option<&ContactInfo>,
        license: Option<&LicenseInfo>,
    ) -> PhpResult<Self> {
        let mut servers_core_result: Vec<ServerInfo> = Vec::new();
        for (_, item) in servers.iter() {
            if let Some(parsed) = <&ServerInfo as ext_php_rs::convert::FromZval>::from_zval(item) {
                servers_core_result.push(parsed.clone());
            } else {
                return Err(ext_php_rs::exception::PhpException::default(
                    "Failed to convert array element to ServerInfo".to_string(),
                ));
            }
        }
        let servers_core: Vec<ServerInfo> = servers_core_result;
        Ok(Self {
            enabled,
            title,
            version,
    ...
    pub fn set_contact(&mut self, value: Option<&ContactInfo>) {
        self.contact = value.map(|value| value.clone().into());
    }
    ...
    pub fn set_license(&mut self, value: Option<&LicenseInfo>) {
        self.license = value.map(|value| value.clone().into());
    }
...
impl ParseRequest {
    ...
    #[php(constructor)]
    pub fn new(spec: String) -> PhpResult<Self> {
        Ok(Self {
            spec: serde_json::from_str(&spec).map_err(|e| PhpException::default(e.to_string()))?,
        })
    }
...
impl ParseResult {
    ...
    pub fn new(
        ...
        title: String,
        apiVersion: String,
        channels: &ext_php_rs::types::ZendHashTable,
        operations: &ext_php_rs::types::ZendHashTable,
        messages: &ext_php_rs::types::ZendHashTable,
    ) -> PhpResult<Self> {
        let mut channels_core_result: Vec<ParsedChannel> = Vec::new();
        for (_, item) in channels.iter() {
            if let Some(parsed) = <&ParsedChannel as ext_php_rs::convert::FromZval>::from_zval(item) {
                channels_core_result.push(parsed.clone());
            } else {
                return Err(ext_php_rs::exception::PhpException::default(
                    "Failed to convert array element to ParsedChannel".to_string(),
                ));
            }
        }
        let channels_core: Vec<ParsedChannel> = channels_core_result;
        let mut operations_core_result: Vec<ParsedOperation> = Vec::new();
        for (_, item) in operations.iter() {
            if let Some(parsed) = <&ParsedOperation as ext_php_rs::convert::FromZval>::from_zval(item) {
                operations_core_result.push(parsed.clone());
            } else {
                return Err(ext_php_rs::exception::PhpException::default(
                    "Failed to convert array element to ParsedOperation".to_string(),
                ));
            }
        }
        let operations_core: Vec<ParsedOperation> = operations_core_result;
        let mut messages_core_result: Vec<ParsedMessage> = Vec::new();
        for (_, item) in messages.iter() {
            if let Some(parsed) = <&ParsedMessage as ext_php_rs::convert::FromZval>::from_zval(item) {
                messages_core_result.push(parsed.clone());
            } else {
                return Err(ext_php_rs::exception::PhpException::default(
                    "Failed to convert array element to ParsedMessage".to_string(),
                ));
            }
        }
        let messages_core: Vec<ParsedMessage> = messages_core_result;
        Ok(Self {
            spec_version: specVersion,
            title,
            api_version: apiVersion,
            channels: channels_core,
...
impl ParsedChannel {
    ...
    #[php(constructor)]
    pub fn new(name: String, address: String, messages: Vec<String>, bindings: Option<String>) -> PhpResult<Self> {
        Ok(Self {
            name,
            address,
            messages,
...
impl ParsedMessage {
    ...
    #[php(constructor)]
    pub fn new(name: String, schema: Option<String>) -> PhpResult<Self> {
        Ok(Self {
            name,
            schema: schema
                .map(|s| serde_json::from_str(&s))
...
pub struct ProblemDetails {
    ...
    #[serde(default = "crate::serde_defaults::problem_details_type_uri")]
    #[serde(alias = "typeUri")]
    pub type_uri: String,
    /// A short, human-readable summary of the problem type.
    /// Should not change from occurrence to occurrence of the problem.
    #[php(prop, name = "title")]
    #[serde(default = "crate::serde_defaults::problem_details_title")]
    pub title: String,
    /// The HTTP status code generated by the origin server.
    /// This is advisory; the actual HTTP status code takes precedence.
    #[php(prop, name = "status")]
    #[serde(default = "crate::serde_defaults::problem_details_status")]
    pub status: u16,
    ...
    #[doc = "PHP: initialize this field through fromJson() and read it via get_extensions(); its value type cannot be
exposed as a directly settable ext-php-rs property."]
...
impl Default for ProblemDetails {
    fn default() -> Self {
        <spikard_core::ProblemDetails as Default>::default().into()
    }
}
...
#[derive(Clone, serde::Serialize, serde::Deserialize, Default)]
#[php_class]
#[php(name = "Spikard\\Php\\RequestIdConfig")]
#[serde(default)]
...
pub struct Response {
    ...
    #[serde(default = "crate::serde_defaults::response_status_code")]
...
impl Response {
    ...
    #[php(constructor)]
    pub fn new(statusCode: u16, headers: HashMap<String, String>, content: Option<String>) -> PhpResult<Self> {
        Ok(Self {
            content: content
                .map(|s| serde_json::from_str(&s))
                .transpose()
...
impl ResponseSnapshot {
    ...
    #[php(constructor)]
    pub fn new(status: u16, headers: HashMap<String, String>, body: PhpBytes) -> Self {
        Self {
            status,
            headers,
            body: body.0,
...
impl RouteBuilder {
    ...
    pub fn body_limit(&self, maxBytes: i64) -> RouteBuilder {
        Self {
            inner: Arc::new((*self.inner).clone().body_limit(maxBytes as usize)),
        }
    }

    /// Attach a per-route request timeout in seconds, overriding the server-global default.
    pub fn request_timeout(&self, seconds: i64) -> RouteBuilder {
        Self {
    ...
    pub fn rate_limit(&self, rateLimit: &RateLimitConfig) -> RouteBuilder {
        Self {
            inner: Arc::new((*self.inner).clone().rate_limit(rateLimit.clone().into())),
        }
    }
    ...
    pub fn request_id(&self, enabled: bool) -> RouteBuilder {
        Self {
    ...
    pub fn jwt_auth(&self, config: &JwtAuthConfig) -> RouteBuilder {
        Self {
            inner: Arc::new((*self.inner).clone().jwt_auth(config.clone().into())),
        }
    }

    /// Require API key authentication for this route.
    pub fn api_key_auth(&self, config: &ApiKeyAuthConfig) -> RouteBuilder {
        Self {
            inner: Arc::new((*self.inner).clone().api_key_auth(config.clone().into())),
        }
    }

    /// Attach a roles/scopes/permissions authorization requirement for this route.
    pub fn authorization(&self, config: &AuthorizationConfig) -> RouteBuilder {
        Self {
            inner: Arc::new((*self.inner).clone().authorization(config.clone().into())),
        }
    }

    /// Select registered lifecycle hooks to run for this route.
    pub fn lifecycle_hooks(&self, hooks: &LifecycleHooksConfig) -> RouteBuilder {
        Self {
            inner: Arc::new((*self.inner).clone().lifecycle_hooks(hooks.clone().into())),
        }
    }

    /// Expose this route as a JSON-RPC method.
    pub fn jsonrpc_method(&self, info: &JsonRpcMethodInfo) -> RouteBuilder {
        Self {
            inner: Arc::new((*self.inner).clone().jsonrpc_method(info.clone().into())),
        }
    }
    ...
    pub fn openrpc_spec(&self, spec: String) -> RouteBuilder {
        Self {
            inner: Arc::new(
                (*self.inner)
                    .clone()
    ...
    pub fn new(method: String, path: String) -> Self {
        Self {
            inner: std::sync::Arc::new(spikard::RouteBuilder::new(
                serde_json::from_str(&serde_json::to_string(&method).unwrap_or_default()).unwrap_or_default(),
                path,
            )),
        }
...
pub struct ServerConfig {
    ...
    #[serde(alias = "apiKeyAuth")]
    pub api_key_auth: Option<ApiKeyConfig>,
    /// Static file serving configuration
    #[serde(alias = "staticFiles")]
...
impl ServerConfig {
    ...
    pub fn new(
        ...
        staticFiles: &ext_php_rs::types::ZendHashTable,
        ...
        jwtAuth: Option<&JwtConfig>,
        apiKeyAuth: Option<&ApiKeyConfig>,
        asyncapi: Option<&AsyncApiConfig>,
        openapi: Option<&OpenApiConfig>,
        jsonrpc: Option<&JsonRpcConfig>,
    ) -> PhpResult<Self> {
        let mut staticFiles_core_result: Vec<StaticFilesConfig> = Vec::new();
        for (_, item) in staticFiles.iter() {
            if let Some(parsed) = <&StaticFilesConfig as ext_php_rs::convert::FromZval>::from_zval(item) {
                staticFiles_core_result.push(parsed.clone());
            } else {
                return Err(ext_php_rs::exception::PhpException::default(
                    "Failed to convert array element to StaticFilesConfig".to_string(),
                ));
            }
        }
        let staticFiles_core: Vec<StaticFilesConfig> = staticFiles_core_result;
        Ok(Self {
            host,
            port,
            workers,
            ...
            jwt_auth: jwtAuth.cloned(),
            api_key_auth: apiKeyAuth.cloned(),
            static_files: staticFiles_core,
            graceful_shutdown: gracefulShutdown,
            shutdown_timeout: shutdownTimeout,
            asyncapi: asyncapi.cloned(),
            openapi: openapi.cloned(),
            jsonrpc: jsonrpc.cloned(),
    ...
    pub fn set_compression(&mut self, value: Option<&CompressionConfig>) {
        self.compression = value.map(|value| value.clone().into());
    }
    ...
    pub fn set_rate_limit(&mut self, value: Option<&RateLimitConfig>) {
    ...
    pub fn set_jwt_auth(&mut self, value: Option<&JwtConfig>) {
        self.jwt_auth = value.map(|value| value.clone().into());
    }
    ...
    pub fn set_api_key_auth(&mut self, value: Option<&ApiKeyConfig>) {
        self.api_key_auth = value.map(|value| value.clone().into());
    }
    ...
    pub fn set_asyncapi(&mut self, value: Option<&AsyncApiConfig>) {
        self.asyncapi = value.map(|value| value.clone().into());
    }
    ...
    pub fn set_openapi(&mut self, value: Option<&OpenApiConfig>) {
        self.openapi = value.map(|value| value.clone().into());
    }
    ...
    pub fn set_jsonrpc(&mut self, value: Option<&JsonRpcConfig>) {
        self.jsonrpc = value.map(|value| value.clone().into());
    }
    ...
    pub fn set_grpc(&mut self, value: Option<&GrpcConfig>) {
        self.grpc = value.map(|value| value.clone().into());
    }
...
impl SseEvent {
    ...
    #[php(constructor)]
    pub fn new(data: String, eventType: Option<String>, id: Option<String>, retry: Option<i64>) -> PhpResult<Self> {
        Ok(Self {
            event_type: eventType,
            data: serde_json::from_str(&data).map_err(|e| PhpException::default(e.to_string()))?,
            id,
            retry,
        })
    }
...
impl UploadFile {
    ...
    pub fn as_bytes(&self) -> String {
        ...
        String::from_utf8_lossy(&core_self.as_bytes()[..]).into_owned()
    }
...
impl ValidateRequest {
    ...
    #[php(constructor)]
    pub fn new(spec: String, channel: String, message: String, payload: String) -> PhpResult<Self> {
        Ok(Self {
            spec: serde_json::from_str(&spec).map_err(|e| PhpException::default(e.to_string()))?,
            channel,
            message,
            payload: serde_json::from_str(&payload).map_err(|e| PhpException::default(e.to_string()))?,
        })
    }
...
#[php_class]
#[php(name = "Spikard\\Php\\LifecycleHookPhase")]
pub struct LifecycleHookPhase {}

#[php_impl]
impl LifecycleHookPhase {
    pub const ONREQUEST: &str = "OnRequest";
    pub const PREVALIDATION: &str = "PreValidation";
    pub const PREHANDLER: &str = "PreHandler";
    pub const ONRESPONSE: &str = "OnResponse";
    pub const ONERROR: &str = "OnError";
}
...
impl SecuritySchemeInfo {
    ...
    pub fn from_json(json: String) -> PhpResult<Self> {
        ...
        if !matches!(value.type_tag.as_str(), "http" | "apiKey") {
            return Err(PhpException::default(format!(
                "Invalid SecuritySchemeInfo tag: {}",
                value.type_tag,
            )));
        }
        Ok(value)
    ...
    #[php(name = "http")]
    pub fn _factory_http(scheme: String, bearerFormat: Option<String>) -> Self {
        spikard_http::SecuritySchemeInfo::Http {
            scheme,
    ...
    pub fn _factory_api_key(location: String, name: String) -> Self {
        spikard_http::SecuritySchemeInfo::ApiKey { location, name }.into()
    }
...
impl From<DynamicSchemaConfig> for spikard::DynamicSchemaConfig {
    fn from(val: DynamicSchemaConfig) -> Self {
        Self {
            ...
            max_complexity: val.max_complexity.map(|v| v as usize),
...
impl From<RequestIdConfig> for spikard::RequestIdConfig {
    fn from(val: RequestIdConfig) -> Self {
        Self { enabled: val.enabled }
    }
}
...
fn app_error_to_php_err(e: spikard::AppError) -> ext_php_rs::exception::PhpException {
    ...
    match &e {
        ...
        spikard::AppError::GraphQL(..) => ext_php_rs::exception::PhpException::default(format!("[GraphQL] {}", msg)),
...
#[allow(dead_code)]
fn graph_ql_error_to_php_err(e: spikard_graphql::error::GraphQLError) -> ext_php_rs::exception::PhpException {
    let msg = e.to_string();
    #[allow(unreachable_patterns)]
    match &e {
        ...
        spikard_graphql::error::GraphQLError::IntrospectionDisabled => {
            ext_php_rs::exception::PhpException::default(format!("[IntrospectionDisabled] {}", msg))
        }
...
mod serde_defaults {
    pub fn authorization_config_require_all() -> bool {
        true
    }
    pub fn background_job_metadata_name() -> String {
        "background_task".to_string()
    }
    pub fn background_task_config_enabled() -> bool {
        false
    }
    ...
    pub fn compression_config_min_size() -> i64 {
        1024
    }
    pub fn compression_config_quality() -> u32 {
        6
    }
    ...
    pub fn grpc_config_max_message_size() -> i64 {
        4194304
    }
    pub fn grpc_config_enable_compression() -> bool {
        true
    }
    pub fn grpc_config_max_concurrent_streams() -> u32 {
        100
    }
    pub fn grpc_config_enable_keepalive() -> bool {
        true
    }
    pub fn grpc_config_keepalive_interval() -> i64 {
        75
    }
    pub fn grpc_config_keepalive_timeout() -> i64 {
        20
    }
    pub fn json_rpc_config_enabled() -> bool {
        true
    }
    pub fn json_rpc_config_endpoint_path() -> String {
        "/rpc".to_string()
    }
    pub fn json_rpc_config_enable_batch() -> bool {
        true
    }
    pub fn json_rpc_config_max_batch_size() -> i64 {
        100
    }
    ...
    pub fn open_api_config_swagger_ui_path() -> String {
        "/docs".to_string()
    }
    pub fn open_api_config_redoc_path() -> String {
        "/redoc".to_string()
    }
    pub fn open_api_config_openapi_json_path() -> String {
        "/openapi.json".to_string()
    }
    pub fn problem_details_type_uri() -> String {
        "about:blank".to_string()
    }
    pub fn problem_details_title() -> String {
        "".to_string()
    }
    pub fn problem_details_status() -> u16 {
        500
    }
    ...
    pub fn response_status_code() -> u16 {
        200
    }
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("spikard_php", "0.17.0")
