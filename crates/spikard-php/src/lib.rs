...
impl App {
    ...
    pub fn on_request(&self, hook: String) -> App {
        self.inner.lock().unwrap().on_request(hook);
        Self {
    ...
    pub fn pre_validation(&self, hook: String) -> App {
        self.inner.lock().unwrap().pre_validation(hook);
        Self {
            inner: self.inner.clone(),
        }
    }
    ...
    pub fn pre_handler(&self, hook: String) -> App {
        self.inner.lock().unwrap().pre_handler(hook);
        Self {
            inner: self.inner.clone(),
        }
    }
    ...
    pub fn on_response(&self, hook: String) -> App {
        self.inner.lock().unwrap().on_response(hook);
        Self {
            inner: self.inner.clone(),
        }
    }
    ...
    pub fn on_error(&self, hook: String) -> App {
        self.inner.lock().unwrap().on_error(hook);
        Self {
            inner: self.inner.clone(),
        }
    }
    ...
    pub fn register_graphql_route(
        ...
        let method_core: spikard::Method = method.clone().into();
    ...
    pub fn register_graphql_sdl_route(
        ...
        self.inner
            .lock()
            .unwrap()
            .register_graphql_sdl_route(path, method_core, &sdl, responseData_json, &config_core)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(Self {
            inner: self.inner.clone(),
        })
    ...
    pub fn attach_axum_router(&self, router: String) -> App {
        self.inner.lock().unwrap().attach_axum_router(router);
        Self {
            inner: self.inner.clone(),
        }
    }
...
impl RouteBuilder {
    ...
    pub fn request_schema_json(&self, schema: String) -> RouteBuilder {
        Self {
            inner: Arc::new((*self.inner).clone().request_schema_json(schema_json)),
        }
    }
    ...
    pub fn response_schema_json(&self, schema: String) -> RouteBuilder {
        Self {
            inner: Arc::new((*self.inner).clone().response_schema_json(schema_json)),
        }
    }
    ...
    pub fn params_schema_json(&self, schema: String) -> RouteBuilder {
        Self {
            inner: Arc::new((*self.inner).clone().params_schema_json(schema_json)),
        }
    }
    ...
    pub fn file_params_json(&self, schema: String) -> RouteBuilder {
        Self {
            inner: Arc::new((*self.inner).clone().file_params_json(schema_json)),
        }
    }
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("spikard_php", "0.17.0-rc.2")
