...
// alef:hash:02ad9524115e11753d64568d8249b4c9307151cc0d11454781efdde4ae7dfb63
    ...
    fn from(val: SecuritySchemeInfo) -> Self {
        match val.type_tag.as_str() {
            "http" => spikard_http::SecuritySchemeInfo::Http {
                scheme: val.scheme.map(Into::into).unwrap_or_default(),
                bearer_format: val.bearer_format.map(Into::into),
            },
            "apiKey" => spikard_http::SecuritySchemeInfo::ApiKey {
                location: val.location.map(Into::into).unwrap_or_default(),
