...
// alef:hash:b687f7df4eba1bd6eb6f110a3789664c7a74d1e9fecc70944317e2c5d2d190e1
...
impl DynamicSchemaConfig {
    ...
    #[php(constructor)]
    pub fn new(introspectionEnabled: bool, maxComplexity: Option<i64>, maxDepth: Option<i64>) -> Self {
        Self {
...
impl Response {
    ...
    #[php(constructor)]
    pub fn new(statusCode: u16, headers: HashMap<String, String>) -> Self {
        Self {
...
impl LifecycleHookRef {
    ...
    #[php(constructor)]
    pub fn new(name: String, handler: String, dependencies: Vec<String>, order: Option<u32>) -> Self {
        Self {
            name,
            handler,
            dependencies,
...
impl SecuritySchemeInfo {
    ...
    pub fn _factory_api_key(location: String, name: String) -> Self {
        spikard_http::SecuritySchemeInfo::ApiKey {
            location: location,
            name: name,
        }
        .into()
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("spikard_php", "0.17.0-rc.11")
