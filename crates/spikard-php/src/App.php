...
// alef:hash:2df40efb55cdffacf9d56cd056dba5408480c60a5b12be54142253d887ae617b
...
final class App
{
     ...
     */
    public function registerGraphqlSdlRoute(string $path, Method $method, string $sdl, string $response_data, DynamicSchemaConfig $config): App
    {
        throw new \RuntimeException('Not implemented — provided by the native extension.');
    }
    /**
