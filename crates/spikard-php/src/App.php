...
// alef:hash:c59c38f0624d10aca3a9ed871c388611e4ebfddd4bcf25e000433969beb79a43
...
final class App
{
     ...
     */
    public function registerGraphqlRoute(string $path, string $method, string $schema_type, SchemaConfig $config): App
    {
        throw new \RuntimeException('Not implemented — provided by the native extension.');
    }
