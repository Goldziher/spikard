...
// alef:hash:9e90d0902d651082fc305d51c20313697bb3d36e554b2c8e530c9c5160a7ccce
...
namespace Spikard\Php {
    ...
    final class AuthorizationConfig
    {
        ...
        public static function default(): AuthorizationConfig
        {
            throw new \RuntimeException('Not implemented — provided by the native extension.');
        }
    }
    ...
    final class ProblemDetails
    {
        ...
        public static function default(): ProblemDetails
        {
            throw new \RuntimeException('Not implemented — provided by the native extension.');
        }
    ...
    final class ServerConfig
    {
        public function __construct(
            ...
            ?JwtConfig $jwtAuth = null,
            ?ApiKeyConfig $apiKeyAuth = null,
    ...
    final class LifecycleHookPhase
    {
        public const ONREQUEST = 'OnRequest';
        public const PREVALIDATION = 'PreValidation';
        public const PREHANDLER = 'PreHandler';
    ...
    final class SecuritySchemeInfo
    {
        ...
        /** @var ?string */
        public readonly ?string $bearer_format;
        /** @var ?string */
        ...
        public static function http(string $scheme, ?string $bearerFormat = null): SecuritySchemeInfo
        {
            throw new \RuntimeException('Not implemented — provided by the native extension.');
        }

        public static function apiKey(string $location, string $name): SecuritySchemeInfo
        {
            throw new \RuntimeException('Not implemented — provided by the native extension.');
        }
    }

    final class SnapshotError
    {
        public const INVALIDHEADER = 'InvalidHeader';
        public const DECOMPRESSION = 'Decompression';
    }
