...
// alef:hash:9b0b8fdac343b34da07e71b6786c0c295e99415a6bf03152ea124a71033d63c7
...
impl ProblemDetails {
    ...
    fn with_detail(&self, detail: String) -> ProblemDetails {
        let core_self = spikard_core::ProblemDetails {
            ...
            extensions: self.extensions.clone().into_iter().collect(),
        };
...
impl From<ProblemDetails> for spikard_core::ProblemDetails {
    fn from(val: ProblemDetails) -> Self {
        Self {
            ...
            extensions: val.extensions.into_iter().collect(),
        }
    }
}
