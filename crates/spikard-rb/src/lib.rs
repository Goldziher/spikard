...
// alef:hash:676ac502000cfa30c22e6179722649d12b95763e935d12d9860e86d1839470ee
...
impl magnus::TryConvert for ResponseSnapshot {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        let r: &ResponseSnapshot = magnus::TryConvert::try_convert(val)?;
        Ok(r.clone())
    }
}
...
impl magnus::TryConvert for AsyncApiConfig {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        let r: &AsyncApiConfig = magnus::TryConvert::try_convert(val)?;
        Ok(r.clone())
    }
}
...
impl AsyncApiConfig {
    fn new(enabled: Option<bool>, spec: Option<String>) -> Self {
        Self {
...
impl magnus::TryConvert for ParsedChannel {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        let r: &ParsedChannel = magnus::TryConvert::try_convert(val)?;
        Ok(r.clone())
    }
}
...
impl ParsedChannel {
    fn new(name: String, address: String, messages: Vec<String>, bindings: Option<String>) -> Self {
        Self {
            name,
            address,
            messages,
...
impl magnus::TryConvert for ParsedOperation {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        let r: &ParsedOperation = magnus::TryConvert::try_convert(val)?;
        Ok(r.clone())
    }
}
...
impl ParsedOperation {
    fn new(name: String, action: String, channel: String) -> Self {
...
impl magnus::TryConvert for ParsedMessage {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        let r: &ParsedMessage = magnus::TryConvert::try_convert(val)?;
        Ok(r.clone())
    }
}
...
impl ParsedMessage {
    fn new(name: String, schema: Option<String>) -> Self {
        Self { name, schema }
    }
...
impl magnus::TryConvert for ParseResult {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        let r: &ParseResult = magnus::TryConvert::try_convert(val)?;
        Ok(r.clone())
    }
}
...
impl magnus::TryConvert for ParseRequest {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        let r: &ParseRequest = magnus::TryConvert::try_convert(val)?;
        Ok(r.clone())
    }
}
...
impl magnus::TryConvert for ValidationResponse {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        let r: &ValidationResponse = magnus::TryConvert::try_convert(val)?;
        Ok(r.clone())
    }
}
...
impl magnus::TryConvert for ValidateRequest {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        let r: &ValidateRequest = magnus::TryConvert::try_convert(val)?;
        Ok(r.clone())
    }
}
...
impl ValidateRequest {
    fn new(spec: String, channel: String, message: String, payload: String) -> Self {
        Self {
            spec,
            channel,
            message,
...
impl magnus::TryConvert for GraphQLSubscriptionSnapshot {
    fn try_convert(val: magnus::Value) -> Result<Self, magnus::Error> {
        let r: &GraphQLSubscriptionSnapshot = magnus::TryConvert::try_convert(val)?;
        Ok(r.clone())
    }
}
...
impl From<spikard::WebSocketMessage> for WebSocketMessage {
    fn from(val: spikard::WebSocketMessage) -> Self {
        match val {
            ...
            spikard::WebSocketMessage::Binary(_0) => Self::Binary { _0: _0.to_vec() },
            spikard::WebSocketMessage::Close { code, reason } => Self::Close { code, reason },
            spikard::WebSocketMessage::Ping(_0) => Self::Ping { _0: _0.to_vec() },
            spikard::WebSocketMessage::Pong(_0) => Self::Pong { _0: _0.to_vec() },
        }
    }
}
...
fn init(ruby: &Ruby) -> Result<(), Error> {
    ...
    class.define_singleton_method("new", function!(ResponseSnapshot::new, 3))?;
    ...
    class.define_singleton_method("new", function!(AsyncApiConfig::new, 2))?;
    ...
    class.define_singleton_method("new", function!(ParsedChannel::new, 4))?;
    ...
    class.define_singleton_method("new", function!(ParsedOperation::new, 3))?;
    ...
    class.define_singleton_method("new", function!(ParsedMessage::new, 2))?;
    ...
    class.define_singleton_method("new", function!(ParseResult::new, 6))?;
    ...
    class.define_singleton_method("new", function!(ValidationResponse::new, 2))?;
    ...
    class.define_singleton_method("new", function!(ValidateRequest::new, 4))?;
    ...
    class.define_singleton_method("new", function!(GraphQLSubscriptionSnapshot::new, 5))?;
