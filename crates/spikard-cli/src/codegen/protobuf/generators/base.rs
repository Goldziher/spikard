...
pub fn generate_file_header(comment_style: CommentStyle, additional_lines: &[&str]) -> String {
    ...
    header.push_str(&format!("{} This file was automatically generated from your Protobuf schema.\n", comment));
    header.push_str(&format!("{} Any manual changes will be overwritten on the next generation.\n", comment));
