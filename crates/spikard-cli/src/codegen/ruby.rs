...
"#,
    ...
    fn schema_to_ruby_type(&self, schema: &Schema, optional: bool) -> String {
    ...
    fn schema_to_ruby_return_type(&self, schema: &Schema) -> String {
        match &schema.schema_kind {
    ...
    fn generate_route_handler(&self, path: &str, method: &str, operation: &Operation) -> Result<String> {
        ...
        if body_type.is_some() {
            ...
            output.push_str("    # TODO: Validate against schema\n");
            output.push_str("    # body = ");
            output.push_str(&body_type.unwrap());
...
if __FILE__ == $PROGRAM_NAME
  API.run! host: '0.0.0.0', port: 4567
end
