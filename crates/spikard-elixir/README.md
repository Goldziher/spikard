...
> **User-facing documentation:** See [Spikard Elixir](../../packages/elixir/README.md) for the full API, examples, and usage guide.
...
```bash
cd packages/elixir && mix compile
```
...
- [Rust API Documentation](https://docs.rs/spikard-elixir)
