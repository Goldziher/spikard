...
pub unsafe extern "C" fn spikard_route_builder_request_schema_json(
    _this: *mut spikard::RouteBuilder,
    _schema: *const std::ffi::c_char,
) -> *mut spikard::RouteBuilder {
    clear_last_error();
    set_last_error(99, "Not implemented: RouteBuilder::request_schema_json");
    std::ptr::null_mut()
}
...
pub unsafe extern "C" fn spikard_route_builder_response_schema_json(
    ...
    clear_last_error();
    set_last_error(99, "Not implemented: RouteBuilder::response_schema_json");
    std::ptr::null_mut()
}
...
pub unsafe extern "C" fn spikard_route_builder_params_schema_json(
    ...
    clear_last_error();
    set_last_error(99, "Not implemented: RouteBuilder::params_schema_json");
    std::ptr::null_mut()
}
...
pub unsafe extern "C" fn spikard_route_builder_file_params_json(
    ...
    clear_last_error();
    set_last_error(99, "Not implemented: RouteBuilder::file_params_json");
    std::ptr::null_mut()
}
