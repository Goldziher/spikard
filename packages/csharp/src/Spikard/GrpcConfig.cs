...
// alef:hash:a68974d843452700c8f4f9d122825dee0e678ead0a0e0537606389a6463c12c7
...
public sealed record GrpcConfig
{
    ...
    public ulong MaxMessageSize { get; init; } = 4194304;
    ...
    public uint MaxConcurrentStreams { get; init; } = 100;
    ...
    public ulong KeepaliveInterval { get; init; } = 75;

    /// <summary>
    /// HTTP/2 keepalive timeout in seconds
    /// </summary>
    [JsonPropertyName("keepalive_timeout")]
    public ulong KeepaliveTimeout { get; init; } = 20;
