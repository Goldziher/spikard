...
// alef:hash:187e0c75f5e360d7916b9801fbd51b075c5c7fe67481e668e459e5954c647ce1
...
public abstract record SecuritySchemeInfo
{
    public sealed record Http(
        ...
        [property: JsonPropertyName("bearerFormat")] string? BearerFormat
    ) : SecuritySchemeInfo;

    public sealed record ApiKey(
        [property: JsonPropertyName("in")] string Location,
...
public sealed class SecuritySchemeInfoJsonConverter : JsonConverter<SecuritySchemeInfo>
{
    public override SecuritySchemeInfo Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        {
            "http" =>
                JsonSerializer.Deserialize<SecuritySchemeInfo.Http>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "apiKey" =>
                JsonSerializer.Deserialize<SecuritySchemeInfo.ApiKey>(flatJson, options) ?? throw new JsonException("Failed to deserialize variant"),
