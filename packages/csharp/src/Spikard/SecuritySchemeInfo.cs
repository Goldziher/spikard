...
// alef:hash:6f02ac703ad35e46842ab5ecc85d1b08349deba920e264ddb218a46fee79e5de
...
/// <summary>
/// Custom converter for SecuritySchemeInfo sealed union with flattened variant
/// fields.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed class SecuritySchemeInfoJsonConverter
    : JsonConverter<SecuritySchemeInfo> {
  public override SecuritySchemeInfo Read(ref Utf8JsonReader reader,
                                          Type typeToConvert,
    ...
    return tagValue switch {
      "http" => JsonSerializer.Deserialize<SecuritySchemeInfo.Http>(flatJson,
                                                                    options) ??
                throw new JsonException("Failed to deserialize variant"),
      "apiKey" => JsonSerializer.Deserialize<SecuritySchemeInfo.ApiKey>(
                      flatJson, options) ??
                  throw new JsonException("Failed to deserialize variant"),
      // Unknown discriminator: forward compatibility for unknown variants
      _ => throw new JsonException(
          $"Unknown SecuritySchemeInfo discriminator: {tagValue}")
    };
  }

  public override void Write(Utf8JsonWriter writer, SecuritySchemeInfo value,
                             JsonSerializerOptions options) {
    ...
    default:
      throw new JsonException(
          $"Unknown SecuritySchemeInfo variant: {value.GetType().Name}");
    }
