...
// alef:hash:9b5f74e9e54e474682d97eff4172d47e828fc0bd0801525206040a0e31176bc8
    ...
    public static RequestIdConfig FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<RequestIdConfig>(json, JsonOptions)
                ?? throw new SpikardException($"Failed to parse RequestIdConfig from JSON: deserializer returned null");
        }
        ...
        {
            throw new SpikardException($"Failed to parse RequestIdConfig from JSON: {e.Message}", e);
        }
    }
