...
// alef:hash:337b35afdcf13e24249d1840571d1d975fe8beffa507416992c45da29a8208e4
...
public sealed record ServerConfig {
  ...
  /// <summary>
  /// Number of Tokio runtime worker threads used by binding-managed server
  /// runtimes
  /// </summary>
  ...
  public List<StaticFilesConfig> StaticFiles {
    get; init;
  } = [];
  ...
  public BackgroundTaskConfig BackgroundTasks {
    get; init;
  } = new BackgroundTaskConfig();

  /// <summary>
  /// Enable per-request HTTP tracing (tower-http `TraceLayer`)
  /// </summary>
  [JsonPropertyName("enable_http_trace")]
  public bool EnableHttpTrace {
    get; init;
  } = false;
