...
// alef:hash:55c555adfa0de557018526eeb43269c3e4d03f0d031c67f4db3bf7740542636c
...
public sealed record ProblemDetails
{
    ...
    public string TypeUri { get; init; } = "about:blank";
    ...
    public ushort Status { get; init; } = 500;
    ...
    public Dictionary<string, JsonElement> Extensions { get; init; } = new Dictionary<string, JsonElement>();
    ...
    public static ProblemDetails Default()
    {
        var nativeResult = NativeMethods.ProblemDetailsDefault();
