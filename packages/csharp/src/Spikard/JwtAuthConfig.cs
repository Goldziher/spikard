...
// alef:hash:b08980753c9a33ddc3ae7a84337bc76a5b59f93f7245a12ec6bd603cf5110704
    ...
    public static JwtAuthConfig FromJson(string json)
    {
        try
        {
            return JsonSerializer.Deserialize<JwtAuthConfig>(json, JsonOptions)
                ?? throw new SpikardException($"Failed to parse JwtAuthConfig from JSON: deserializer returned null");
        }
        ...
        {
            throw new SpikardException($"Failed to parse JwtAuthConfig from JSON: {e.Message}", e);
        }
    }
