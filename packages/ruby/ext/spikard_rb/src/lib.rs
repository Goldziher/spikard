...
// alef:hash:85e370c778faef9ca43b1c7d0ce22cc9276a7444757276aceec4c2cbe7257727
...
impl From<spikard::SnapshotError> for SnapshotError {
    fn from(val: spikard::SnapshotError) -> Self {
        match val {
            spikard::SnapshotError::InvalidHeader(_0) => Self::InvalidHeader { _0 },
            spikard::SnapshotError::Decompression(_0) => Self::Decompression { _0 },
        }
    }
}
