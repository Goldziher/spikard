...
// alef:hash:ce9e3e6d5459cb550b14dfaad2eba6a433d58ad80e661c8703d0ed6e25c48f3e
...
impl ResponseSnapshot {
    ...
    #[allow(unused_variables)]
    fn graphql_data(&self) -> Result<String, Error> {
        Err(magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            "Not implemented: graphql_data",
        ))
    }

    #[allow(unused_variables)]
    fn graphql_errors(&self) -> Result<Vec<String>, Error> {
        Err(magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            "Not implemented: graphql_errors",
        ))
    }
}
...
fn ruby_init(ruby: &Ruby) -> Result<(), Error> {
    ...
    class.define_method("json", method!(ResponseSnapshot::json, 0))?;

    class.define_method("header", method!(ResponseSnapshot::header, 1))?;

    class.define_method("graphql_data", method!(ResponseSnapshot::graphql_data, 0))?;

    class.define_method("graphql_errors", method!(ResponseSnapshot::graphql_errors, 0))?;
