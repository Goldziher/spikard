...
module Spikard
  ...
  module Introspection
    ...
    #
    # Returns nil if body_type is not a Dry::Struct. Otherwise builds a JSON Schema
    # object by iterating the struct's schema attributes.
    ...
    #
    # The handler receives the hydrated body DTO (if body_type provided) as its
    # FIRST POSITIONAL parameter, and remaining keyword-arg bindings by name.
    ...
    BODYLESS_METHODS = Set.new(%w[GET HEAD OPTIONS TRACE CONNECT]).freeze
