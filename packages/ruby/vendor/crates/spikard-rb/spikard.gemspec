...
Gem::Specification.new do |spec|
  ...
  spec.description = 'High-performance Ruby web framework with a Rust core. ' \
                     'Build REST APIs with Sinatra-style blocks backed by Axum and Tower-HTTP. ' \
                     'Features type-safe routing, validation, WebSocket/SSE support, and lifecycle hooks.'
