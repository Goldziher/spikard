...
class TestBodySchemaOverrides:
    """Test lines 76, 105, 130 - body_schema overrides and file_params handling."""

    def test_explicit_body_schema_overrides_extraction(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_file_params_included_in_route(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_multiple_non_body_params_fallback_to_dependencies(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_body_schema_none_for_no_body_methods(self, monkeypatch: pytest.MonkeyPatch) -> None:
...
class TestAsyncHandlerDefaults:
    """Test lines 141-148 - async_wrapper parameter default injection."""

    def test_async_handler_with_query_default_injection(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_handler_without_param_defaults_not_wrapped(self, monkeypatch: pytest.MonkeyPatch) -> None:
...
class TestRunConfigMerging:
    """Test lines 235-244 - config precedence in run()."""
    ...
    def test_run_explicit_config_takes_precedence(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_run_individual_params_override_defaults(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_run_default_config_when_none_provided(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_run_app_config_used_when_no_explicit_config(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_run_config_precedence_order(self, monkeypatch: pytest.MonkeyPatch) -> None:
...
class TestHttpMethodDecorators:
    """Test lines 289, 301, 313, 325, 337, 349, 364 - all HTTP verb decorators."""

    def test_put_decorator(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_patch_decorator(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_delete_decorator(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_head_decorator(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_options_decorator(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_trace_decorator(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_generic_route_decorator_with_method(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_all_http_methods_with_kwargs(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_multiple_routes_different_methods(self, monkeypatch: pytest.MonkeyPatch) -> None:
