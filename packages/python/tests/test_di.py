...
class TestProvideAutoDetection:
    """Test suite for Provide auto-detection of dependencies."""
    ...
    def test_auto_detect_filters_cls(self) -> None:
    ...
    def test_auto_detect_filters_request(self) -> None:
    ...
    def test_auto_detect_filters_response(self) -> None:
    ...
    def test_auto_detect_empty_for_no_params(self) -> None:
    ...
    def test_auto_detect_filters_all_standard_params(self) -> None:
    ...
    def test_auto_detect_with_defaults(self) -> None:
    ...
    def test_auto_detect_with_annotations(self) -> None:
    ...
    def test_auto_detect_mixed_filtered_and_real_deps(self) -> None:
    ...
    def test_auto_detect_use_cache_flag_preserved(self) -> None:
    ...
    def test_provide_repr_with_auto_detected_deps(self) -> None:
    ...
    def test_auto_detect_with_positional_only(self) -> None:
    ...
    def test_auto_detect_complex_signature(self) -> None:
    ...
    def test_cacheable_parameter_precedence(self) -> None:
...
__all__ = ["TestProvideAutoDetection"]
