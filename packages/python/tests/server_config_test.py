...
def test_compression_config_default() -> None:
...
def test_compression_config_custom() -> None:
...
def test_compression_config_quality_validation() -> None:
...
def test_compression_config_min_size_validation() -> None:
...
def test_rate_limit_config_default() -> None:
...
def test_jwt_config_default() -> None:
...
def test_jwt_config_custom() -> None:
...
def test_jwt_config_algorithm_validation() -> None:
...
def test_jwt_config_leeway_validation() -> None:
...
def test_api_key_config_default() -> None:
...
def test_api_key_config_custom() -> None:
...
def test_api_key_config_validation() -> None:
...
def test_static_files_config_default() -> None:
...
def test_static_files_config_custom() -> None:
...
def test_server_config_workers_validation() -> None:
...
def test_server_config_timeout_validation() -> None:
...
def test_server_config_body_size_validation() -> None:
...
def test_server_config_model_copy() -> None:
...
def test_server_config_multiple_static_files() -> None:
...
def test_server_config_disable_compression() -> None:
    """Test disabling compression."""
    config = ServerConfig(compression=None)
    assert config.compression is None


def test_server_config_partial_compression() -> None:
...
def test_server_config_json_serialization() -> None:
