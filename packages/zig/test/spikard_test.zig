...
// `schema_query_only` isn't a zero-arg, primitive-returning function this seed can safely call
...
test "spikard.schema_query_only symbol resolves" {
    _ = &spikard.schema_query_only;
}
