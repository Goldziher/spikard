...
// alef:hash:4cd608bc63aaec3fa673fa3aa853a66bdc0066362da38f07785f76a3076555ac
...
impl From<spikard_http::SecuritySchemeInfo> for SecuritySchemeInfo {
    fn from(v: spikard_http::SecuritySchemeInfo) -> Self {
        match v {
            ...
            spikard_http::SecuritySchemeInfo::ApiKey { location, name } => SecuritySchemeInfo::ApiKey {
                location: location,
                name: name,
            },
        }
...
impl From<SecuritySchemeInfo> for spikard_http::SecuritySchemeInfo {
    fn from(v: SecuritySchemeInfo) -> Self {
        match v {
            ...
            SecuritySchemeInfo::ApiKey { location, name } => spikard_http::SecuritySchemeInfo::ApiKey {
                location: location,
                name: name,
            },
        }
