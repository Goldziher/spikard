...
// alef:hash:7f878cf09a59237bb836b4feab2365b430bf0992432e240c6a35bba8fe2d695a
...
#[frb(mirror(DynamicSchemaConfig))]
...
#[frb(mirror(AuthorizationConfig))]
...
#[frb(mirror(LifecycleHooksConfig))]
...
impl GraphQLRouteConfig {
    ...
    pub fn new() -> GraphQLRouteConfig {
        {
            let v = spikard::GraphQLRouteConfig::new();
            GraphQLRouteConfig::from(v)
        }
    }
    #[frb]
    pub fn path(self, path: String) -> GraphQLRouteConfig {
        {
            let v = self.inner.path(path);
            GraphQLRouteConfig::from(v)
        }
    }
    #[frb]
    pub fn method(self, method: String) -> GraphQLRouteConfig {
        {
            let v = self.inner.method(method);
            GraphQLRouteConfig::from(v)
        }
    }
    #[frb]
    pub fn enable_playground(self, enable: bool) -> GraphQLRouteConfig {
        {
            let v = self.inner.enable_playground(enable);
            GraphQLRouteConfig::from(v)
        }
    }
    #[frb]
    pub fn description(self, description: String) -> GraphQLRouteConfig {
        {
            let v = self.inner.description(description);
            GraphQLRouteConfig::from(v)
        }
    }
    #[frb]
    ...
    pub fn get_description(&self) -> Option<String> {
        {
            let v = self.inner.get_description();
            v.map(|s| s.to_string())
        }
    }
    #[frb]
    pub fn default() -> GraphQLRouteConfig {
        {
            let v = spikard::GraphQLRouteConfig::default();
            GraphQLRouteConfig::from(v)
        }
    }
}
...
impl RouteBuilder {
    ...
    pub fn new(method: Method, path: String) -> RouteBuilder {
        {
            let v = spikard::RouteBuilder::new(
    ...
    pub fn handler_name(self, name: String) -> RouteBuilder {
        {
            let v = self.inner.handler_name(name);
            RouteBuilder::from(v)
        }
    }
    #[frb]
    ...
    pub fn cors(self, cors: CorsConfig) -> RouteBuilder {
        {
            let v = self.inner.cors(spikard::CorsConfig::from(cors));
            RouteBuilder::from(v)
        }
    }
    #[frb]
    pub fn compression(self, compression: CompressionConfig) -> RouteBuilder {
        {
            let v = self.inner.compression(spikard::CompressionConfig::from(compression));
            RouteBuilder::from(v)
        }
    }
    #[frb]
    pub fn body_limit(self, max_bytes: i64) -> RouteBuilder {
        {
            let v = self.inner.body_limit(max_bytes as usize);
            RouteBuilder::from(v)
        }
    }
    #[frb]
    pub fn request_timeout(self, seconds: i64) -> RouteBuilder {
        {
            let v = self.inner.request_timeout(seconds as u64);
            RouteBuilder::from(v)
        }
    }
    #[frb]
    pub fn rate_limit(self, rate_limit: RateLimitConfig) -> RouteBuilder {
        {
            let v = self.inner.rate_limit(spikard::RateLimitConfig::from(rate_limit));
            RouteBuilder::from(v)
        }
    }
    #[frb]
    pub fn request_id(self, enabled: bool) -> RouteBuilder {
        {
            let v = self.inner.request_id(enabled);
            RouteBuilder::from(v)
        }
    }
    #[frb]
    pub fn jwt_auth(self, config: JwtAuthConfig) -> RouteBuilder {
        {
            let v = self.inner.jwt_auth(spikard::JwtAuthConfig::from(config));
            RouteBuilder::from(v)
        }
    }
    #[frb]
    pub fn api_key_auth(self, config: ApiKeyAuthConfig) -> RouteBuilder {
        {
            let v = self
                .inner
                .api_key_auth(unsafe { ::std::mem::transmute::<ApiKeyAuthConfig, spikard::ApiKeyAuthConfig>(config) });
            RouteBuilder::from(v)
        }
    }
    #[frb]
    pub fn authorization(self, config: AuthorizationConfig) -> RouteBuilder {
        {
            let v = self.inner.authorization(unsafe {
                ::std::mem::transmute::<AuthorizationConfig, spikard::AuthorizationConfig>(config)
            });
            RouteBuilder::from(v)
        }
    }
    ...
    pub fn lifecycle_hooks(self, hooks: LifecycleHooksConfig) -> RouteBuilder {
        {
            let v = self.inner.lifecycle_hooks(spikard::LifecycleHooksConfig::from(hooks));
            RouteBuilder::from(v)
        }
    }
    #[frb]
    pub fn jsonrpc_method(self, info: JsonRpcMethodInfo) -> RouteBuilder {
        {
            let v = self.inner.jsonrpc_method(spikard::JsonRpcMethodInfo::from(info));
            RouteBuilder::from(v)
        }
    }
    #[frb]
    pub fn openrpc_spec(self, spec: String) -> RouteBuilder {
        {
            let v = self
                .inner
                .openrpc_spec(serde_json::from_str(&spec).unwrap_or(serde_json::Value::Null));
            RouteBuilder::from(v)
        }
    }
    #[frb]
    ...
    pub fn handler_dependencies(self, dependencies: Vec<String>) -> RouteBuilder {
        {
            let v = self.inner.handler_dependencies(dependencies);
            RouteBuilder::from(v)
        }
    }
}
...
#[frb(mirror(LifecycleHookPhase), unignore)]
...
impl From<&GraphQLError> for spikard_graphql::error::GraphQLError {
    fn from(m: &GraphQLError) -> Self {
        match m {
            ...
            GraphQLError::IntrospectionDisabled => Self::IntrospectionDisabled,
...
impl From<spikard::FieldErrorSpec> for FieldErrorSpec {
    fn from(v: spikard::FieldErrorSpec) -> Self {
        FieldErrorSpec {
            path: v.path.into(),
...
impl From<spikard::DynamicSchemaConfig> for DynamicSchemaConfig {
    fn from(v: spikard::DynamicSchemaConfig) -> Self {
        DynamicSchemaConfig {
            introspection_enabled: v.introspection_enabled as _,
            max_complexity: v.max_complexity.map(|x| x as _),
            max_depth: v.max_depth.map(|x| x as _),
            field_errors: v.field_errors.into_iter().map(FieldErrorSpec::from).collect::<Vec<_>>(),
        }
    }
}
...
impl From<spikard::AsyncApiConfig> for AsyncApiConfig {
    fn from(v: spikard::AsyncApiConfig) -> Self {
        AsyncApiConfig {
...
impl From<spikard::RequestIdConfig> for RequestIdConfig {
    fn from(v: spikard::RequestIdConfig) -> Self {
        RequestIdConfig {
            enabled: v.enabled as _,
        }
    }
...
impl From<spikard::JwtAuthConfig> for JwtAuthConfig {
    fn from(v: spikard::JwtAuthConfig) -> Self {
        JwtAuthConfig {
            enabled: v.enabled as _,
            secret: v.secret.map(|s| s.into()),
            public_key: v.public_key.map(|s| s.into()),
            algorithm: v.algorithm.into(),
            audience: v
                .audience
                .map(|vec| vec.into_iter().map(|s| s.into()).collect::<Vec<_>>()),
...
impl From<spikard::ApiKeyAuthConfig> for ApiKeyAuthConfig {
    fn from(v: spikard::ApiKeyAuthConfig) -> Self {
        ApiKeyAuthConfig {
            enabled: v.enabled as _,
            keys: v.keys.into_iter().map(|s| s.into()).collect::<Vec<_>>(),
            header_name: v.header_name.into(),
...
impl From<spikard::AuthorizationConfig> for AuthorizationConfig {
    fn from(v: spikard::AuthorizationConfig) -> Self {
        AuthorizationConfig {
            required_roles: v.required_roles.into_iter().map(|s| s.into()).collect::<Vec<_>>(),
            required_scopes: v.required_scopes.into_iter().map(|s| s.into()).collect::<Vec<_>>(),
            required_permissions: v.required_permissions.into_iter().map(|s| s.into()).collect::<Vec<_>>(),
            require_all: v.require_all as _,
        }
    }
}

impl From<spikard::LifecycleHookRef> for LifecycleHookRef {
    fn from(v: spikard::LifecycleHookRef) -> Self {
        LifecycleHookRef {
            name: v.name.into(),
            handler: v.handler.into(),
            dependencies: v.dependencies.into_iter().map(|s| s.into()).collect::<Vec<_>>(),
            config: v.config.map(|j| serde_json::to_string(&j).unwrap_or_default()),
            order: v.order.map(|x| x as _),
        }
    }
}

impl From<spikard::LifecycleHooksConfig> for LifecycleHooksConfig {
    fn from(v: spikard::LifecycleHooksConfig) -> Self {
        LifecycleHooksConfig {
            on_request: v.on_request.into_iter().map(LifecycleHookRef::from).collect::<Vec<_>>(),
            pre_validation: v
                .pre_validation
                .into_iter()
            ...
            on_response: v
                ...
                .map(LifecycleHookRef::from)
                .collect::<Vec<_>>(),
            on_error: v.on_error.into_iter().map(LifecycleHookRef::from).collect::<Vec<_>>(),
        }
    }
}
...
fn try_convert_method_from_core(value: spikard::Method) -> Result<Method, String> {
    let representable = match &value {
        spikard::Method::Get => true,
        spikard::Method::Post => true,
        spikard::Method::Put => true,
        spikard::Method::Patch => true,
        spikard::Method::Delete => true,
        spikard::Method::Head => true,
        spikard::Method::Options => true,
        spikard::Method::Connect => true,
        spikard::Method::Trace => true,
    };
    if !representable {
        return Err("Method contains a variant unavailable in the Dart binding".to_string());
    }
    Ok(Method::from(value))
}

impl From<spikard_core::LifecycleHookPhase> for LifecycleHookPhase {
    fn from(v: spikard_core::LifecycleHookPhase) -> Self {
        match v {
            spikard_core::LifecycleHookPhase::OnRequest => LifecycleHookPhase::OnRequest,
            spikard_core::LifecycleHookPhase::PreValidation => LifecycleHookPhase::PreValidation,
            spikard_core::LifecycleHookPhase::PreHandler => LifecycleHookPhase::PreHandler,
            spikard_core::LifecycleHookPhase::OnResponse => LifecycleHookPhase::OnResponse,
            spikard_core::LifecycleHookPhase::OnError => LifecycleHookPhase::OnError,
        }
    }
}
...
fn try_convert_security_scheme_info_from_core(
    value: spikard_http::SecuritySchemeInfo,
) -> Result<SecuritySchemeInfo, String> {
    let representable = match &value {
        spikard_http::SecuritySchemeInfo::Http { .. } => true,
        spikard_http::SecuritySchemeInfo::ApiKey { .. } => true,
    };
    if !representable {
        return Err("SecuritySchemeInfo contains a variant unavailable in the Dart binding".to_string());
    }
    Ok(SecuritySchemeInfo::from(value))
}
...
#[cfg(not(target_arch = "wasm32"))]
fn try_convert_snapshot_error_from_core(value: spikard_http::SnapshotError) -> Result<SnapshotError, String> {
    let representable = match &value {
        spikard_http::SnapshotError::InvalidHeader(..) => true,
        spikard_http::SnapshotError::Decompression(..) => true,
    };
    if !representable {
        return Err("SnapshotError contains a variant unavailable in the Dart binding".to_string());
    }
    Ok(SnapshotError::from(value))
}
...
#[cfg(not(target_arch = "wasm32"))]
fn try_convert_web_socket_message_from_core(
    value: spikard_http::testing::WebSocketMessage,
) -> Result<WebSocketMessage, String> {
    let representable = match &value {
        spikard_http::testing::WebSocketMessage::Text(..) => true,
        spikard_http::testing::WebSocketMessage::Binary(..) => true,
        spikard_http::testing::WebSocketMessage::Close { .. } => true,
        spikard_http::testing::WebSocketMessage::Ping(..) => true,
        spikard_http::testing::WebSocketMessage::Pong(..) => true,
    };
    if !representable {
        return Err("WebSocketMessage contains a variant unavailable in the Dart binding".to_string());
    }
    Ok(WebSocketMessage::from(value))
}
...
impl From<DynamicSchemaConfig> for spikard::DynamicSchemaConfig {
    fn from(v: DynamicSchemaConfig) -> Self {
        spikard::DynamicSchemaConfig {
            introspection_enabled: v.introspection_enabled as _,
            max_complexity: v.max_complexity.map(|x| x as _),
            max_depth: v.max_depth.map(|x| x as _),
            field_errors: v.field_errors.into_iter().map(Into::into).collect(),
            ..Default::default()
        }
    }
}
...
impl From<JwtAuthConfig> for spikard::JwtAuthConfig {
    fn from(v: JwtAuthConfig) -> Self {
        spikard::JwtAuthConfig {
            enabled: v.enabled as _,
            secret: v.secret.map(Into::into),
            public_key: v.public_key.map(Into::into),
            algorithm: v.algorithm.into(),
...
impl From<LifecycleHookRef> for spikard::LifecycleHookRef {
    fn from(v: LifecycleHookRef) -> Self {
        spikard::LifecycleHookRef {
            name: v.name.into(),
            handler: v.handler.into(),
            dependencies: v.dependencies.into_iter().map(Into::into).collect(),
            config: v.config.as_deref().and_then(|s| serde_json::from_str(s).ok()),
            order: v.order.map(|x| x as _),
            ..Default::default()
        }
    }
...
impl From<LifecycleHooksConfig> for spikard::LifecycleHooksConfig {
    fn from(v: LifecycleHooksConfig) -> Self {
        spikard::LifecycleHooksConfig {
            on_request: v.on_request.into_iter().map(Into::into).collect(),
            pre_validation: v.pre_validation.into_iter().map(Into::into).collect(),
            pre_handler: v.pre_handler.into_iter().map(Into::into).collect(),
            on_response: v.on_response.into_iter().map(Into::into).collect(),
            on_error: v.on_error.into_iter().map(Into::into).collect(),
            ..Default::default()
        }
    }
}
...
impl From<JsonRpcMethodInfo> for spikard_core::JsonRpcMethodInfo {
    fn from(v: JsonRpcMethodInfo) -> Self {
        spikard_core::JsonRpcMethodInfo {
            method_name: v.method_name.into(),
            description: v.description.map(Into::into),
            params_schema: v.params_schema.as_deref().and_then(|s| serde_json::from_str(s).ok()),
            result_schema: v.result_schema.as_deref().and_then(|s| serde_json::from_str(s).ok()),
            deprecated: v.deprecated as _,
...
pub fn schema_query_only() -> QueryOnlyConfig {
    QueryOnlyConfig::from(spikard::schema_query_only())
}
...
pub fn schema_query_mutation() -> QueryMutationConfig {
    QueryMutationConfig::from(spikard::schema_query_mutation())
}
...
pub fn schema_full() -> FullSchemaConfig {
    FullSchemaConfig::from(spikard::schema_full())
}
...
pub fn create_upload_file_from_json(json: String) -> Result<UploadFile, String> {
    serde_json::from_str::<spikard::UploadFile>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(UploadFile::from(value)))
}

#[frb]
pub fn create_field_error_spec_from_json(json: String) -> Result<FieldErrorSpec, String> {
    serde_json::from_str::<spikard::FieldErrorSpec>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(FieldErrorSpec::from(value)))
}

#[frb]
pub fn create_dynamic_schema_config_from_json(json: String) -> Result<DynamicSchemaConfig, String> {
    serde_json::from_str::<spikard::DynamicSchemaConfig>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(DynamicSchemaConfig::from(value)))
}
...
pub fn create_schema_config_from_json(json: String) -> Result<SchemaConfig, String> {
    serde_json::from_str::<spikard::SchemaConfig>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(SchemaConfig::from(value)))
}
...
pub fn create_query_only_config_from_json(json: String) -> Result<QueryOnlyConfig, String> {
    serde_json::from_str::<spikard::QueryOnlyConfig>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(QueryOnlyConfig::from(value)))
}
...
pub fn create_query_mutation_config_from_json(json: String) -> Result<QueryMutationConfig, String> {
    serde_json::from_str::<spikard::QueryMutationConfig>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(QueryMutationConfig::from(value)))
}
...
pub fn create_full_schema_config_from_json(json: String) -> Result<FullSchemaConfig, String> {
    serde_json::from_str::<spikard::FullSchemaConfig>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(FullSchemaConfig::from(value)))
}
...
pub fn create_async_api_config_from_json(json: String) -> Result<AsyncApiConfig, String> {
    serde_json::from_str::<spikard::AsyncApiConfig>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(AsyncApiConfig::from(value)))
}
...
pub fn create_background_task_config_from_json(json: String) -> Result<BackgroundTaskConfig, String> {
    serde_json::from_str::<spikard::BackgroundTaskConfig>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(BackgroundTaskConfig::from(value)))
}
...
pub fn create_background_job_metadata_from_json(json: String) -> Result<BackgroundJobMetadata, String> {
    serde_json::from_str::<spikard::BackgroundJobMetadata>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(BackgroundJobMetadata::from(value)))
}
...
pub fn create_cors_config_from_json(json: String) -> Result<CorsConfig, String> {
    serde_json::from_str::<spikard::CorsConfig>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(CorsConfig::from(value)))
}
...
pub fn create_compression_config_from_json(json: String) -> Result<CompressionConfig, String> {
    serde_json::from_str::<spikard::CompressionConfig>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(CompressionConfig::from(value)))
}
...
pub fn create_grpc_config_from_json(json: String) -> Result<GrpcConfig, String> {
    serde_json::from_str::<spikard::GrpcConfig>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(GrpcConfig::from(value)))
}
...
pub fn create_json_rpc_config_from_json(json: String) -> Result<JsonRpcConfig, String> {
    serde_json::from_str::<spikard::JsonRpcConfig>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(JsonRpcConfig::from(value)))
}
...
pub fn create_open_api_config_from_json(json: String) -> Result<OpenApiConfig, String> {
    serde_json::from_str::<spikard::OpenApiConfig>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(OpenApiConfig::from(value)))
}
...
pub fn create_response_from_json(json: String) -> Result<Response, String> {
    serde_json::from_str::<spikard::Response>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(Response::from(value)))
}
...
pub fn create_sse_event_from_json(json: String) -> Result<SseEvent, String> {
    serde_json::from_str::<spikard::SseEvent>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(SseEvent::from(value)))
}
...
pub fn create_jwt_config_from_json(json: String) -> Result<JwtConfig, String> {
    serde_json::from_str::<spikard::JwtConfig>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(JwtConfig::from(value)))
}
...
pub fn create_api_key_config_from_json(json: String) -> Result<ApiKeyConfig, String> {
    serde_json::from_str::<spikard::ApiKeyConfig>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(ApiKeyConfig::from(value)))
}
...
pub fn create_static_files_config_from_json(json: String) -> Result<StaticFilesConfig, String> {
    serde_json::from_str::<spikard::StaticFilesConfig>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(StaticFilesConfig::from(value)))
}
...
#[frb]
pub fn create_request_id_config_from_json(json: String) -> Result<RequestIdConfig, String> {
    serde_json::from_str::<spikard::RequestIdConfig>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(RequestIdConfig::from(value)))
}

#[frb]
pub fn create_jwt_auth_config_from_json(json: String) -> Result<JwtAuthConfig, String> {
    serde_json::from_str::<spikard::JwtAuthConfig>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(JwtAuthConfig::from(value)))
}

#[frb]
pub fn create_api_key_auth_config_from_json(json: String) -> Result<ApiKeyAuthConfig, String> {
    serde_json::from_str::<spikard::ApiKeyAuthConfig>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(ApiKeyAuthConfig::from(value)))
}

#[frb]
pub fn create_authorization_config_from_json(json: String) -> Result<AuthorizationConfig, String> {
    serde_json::from_str::<spikard::AuthorizationConfig>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(AuthorizationConfig::from(value)))
}

#[frb]
pub fn create_lifecycle_hook_ref_from_json(json: String) -> Result<LifecycleHookRef, String> {
    serde_json::from_str::<spikard::LifecycleHookRef>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(LifecycleHookRef::from(value)))
}

#[frb]
pub fn create_lifecycle_hooks_config_from_json(json: String) -> Result<LifecycleHooksConfig, String> {
    serde_json::from_str::<spikard::LifecycleHooksConfig>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(LifecycleHooksConfig::from(value)))
}
...
pub fn create_json_rpc_method_info_from_json(json: String) -> Result<JsonRpcMethodInfo, String> {
    serde_json::from_str::<spikard_core::JsonRpcMethodInfo>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(JsonRpcMethodInfo::from(value)))
}
...
pub fn create_problem_details_from_json(json: String) -> Result<ProblemDetails, String> {
    serde_json::from_str::<spikard_core::ProblemDetails>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(ProblemDetails::from(value)))
}
...
pub fn create_parsed_channel_from_json(json: String) -> Result<ParsedChannel, String> {
    serde_json::from_str::<spikard_http::ParsedChannel>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(ParsedChannel::from(value)))
}
...
pub fn create_parsed_operation_from_json(json: String) -> Result<ParsedOperation, String> {
    serde_json::from_str::<spikard_http::ParsedOperation>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(ParsedOperation::from(value)))
}
...
pub fn create_parsed_message_from_json(json: String) -> Result<ParsedMessage, String> {
    serde_json::from_str::<spikard_http::ParsedMessage>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(ParsedMessage::from(value)))
}
...
pub fn create_parse_result_from_json(json: String) -> Result<ParseResult, String> {
    serde_json::from_str::<spikard_http::ParseResult>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(ParseResult::from(value)))
}
...
pub fn create_contact_info_from_json(json: String) -> Result<ContactInfo, String> {
    serde_json::from_str::<spikard_http::ContactInfo>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(ContactInfo::from(value)))
}
...
pub fn create_license_info_from_json(json: String) -> Result<LicenseInfo, String> {
    serde_json::from_str::<spikard_http::LicenseInfo>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(LicenseInfo::from(value)))
}
...
pub fn create_server_info_from_json(json: String) -> Result<ServerInfo, String> {
    serde_json::from_str::<spikard_http::ServerInfo>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(ServerInfo::from(value)))
}
...
pub fn create_response_snapshot_from_json(json: String) -> Result<ResponseSnapshot, String> {
    serde_json::from_str::<spikard_http::ResponseSnapshot>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(ResponseSnapshot::from(value)))
}

#[frb]
pub fn create_method_from_json(json: String) -> Result<Method, String> {
    serde_json::from_str::<spikard::Method>(&json)
        .map_err(|e| e.to_string())
        .and_then(try_convert_method_from_core)
}

#[frb]
pub fn create_security_scheme_info_from_json(json: String) -> Result<SecuritySchemeInfo, String> {
    serde_json::from_str::<spikard_http::SecuritySchemeInfo>(&json)
        .map_err(|e| e.to_string())
        .and_then(try_convert_security_scheme_info_from_core)
}

#[cfg(not(target_arch = "wasm32"))]
#[frb]
pub fn create_snapshot_error_from_json(json: String) -> Result<SnapshotError, String> {
    serde_json::from_str::<spikard_http::SnapshotError>(&json)
        .map_err(|e| e.to_string())
        .and_then(try_convert_snapshot_error_from_core)
}

#[cfg(not(target_arch = "wasm32"))]
#[frb]
pub fn create_web_socket_message_from_json(json: String) -> Result<WebSocketMessage, String> {
    serde_json::from_str::<spikard_http::testing::WebSocketMessage>(&json)
        .map_err(|e| e.to_string())
        .and_then(try_convert_web_socket_message_from_core)
}
