...
Future<FieldErrorSpec>  createFieldErrorSpecFromJson({required String json }) => RustLib.instance.api.crateCreateFieldErrorSpecFromJson(json: json);

Future<DynamicSchemaConfig>  createDynamicSchemaConfigFromJson({required String json }) => RustLib.instance.api.crateCreateDynamicSchemaConfigFromJson(json: json);
...
final PlatformInt64? maxComplexity;
/// Maximum query depth (`None` = unlimited).
final PlatformInt64? maxDepth;
/// Field-level errors to inject at specific response paths.
final List<FieldErrorSpec> fieldErrors;

                const DynamicSchemaConfig({required this.introspectionEnabled ,this.maxComplexity ,this.maxDepth ,required this.fieldErrors ,});
        ...
        @override
        int get hashCode => introspectionEnabled.hashCode^maxComplexity.hashCode^maxDepth.hashCode^fieldErrors.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is DynamicSchemaConfig &&
                runtimeType == other.runtimeType
                && introspectionEnabled == other.introspectionEnabled&& maxComplexity == other.maxComplexity&& maxDepth == other.maxDepth&& fieldErrors == other.fieldErrors;
...
final String message;
                ...
                const FieldErrorSpec({required this.path ,required this.message ,});
        ...
        bool operator ==(Object other) =>
            ...
            other is FieldErrorSpec &&
                runtimeType == other.runtimeType
                && path == other.path&& message == other.message;
...
const factory GraphQLError.introspectionDisabled() = GraphQLError_IntrospectionDisabled;
