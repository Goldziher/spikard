...
Future<AuthorizationConfig> createAuthorizationConfigFromJson({
  required String json,
}) => RustLib.instance.api.crateCreateAuthorizationConfigFromJson(json: json);
...
Future<WebSocketMessage> createWebSocketMessageFromJson({
  required String json,
}) => RustLib.instance.api.crateCreateWebSocketMessageFromJson(json: json);
