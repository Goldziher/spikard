...
public func graphQlRouteConfigPath<GenericIntoRustString: IntoRustString>(
  _ client: GraphQLRouteConfigRef, _ path: GenericIntoRustString
) -> GraphQLRouteConfig {
  GraphQLRouteConfig(
    ptr: __swift_bridge__$graph_ql_route_config_path(
      client.ptr,
      {
...
public func graphQlRouteConfigMethod<GenericIntoRustString: IntoRustString>(
  _ client: GraphQLRouteConfigRef, _ method: GenericIntoRustString
) -> GraphQLRouteConfig {
  GraphQLRouteConfig(
    ptr: __swift_bridge__$graph_ql_route_config_method(
      client.ptr,
      {
...
public func graphQlRouteConfigEnablePlayground(_ client: GraphQLRouteConfigRef, _ enable: Bool)
  -> GraphQLRouteConfig
{
  GraphQLRouteConfig(
    ptr: __swift_bridge__$graph_ql_route_config_enable_playground(client.ptr, enable))
}
public func graphQlRouteConfigDescription<GenericIntoRustString: IntoRustString>(
  _ client: GraphQLRouteConfigRef, _ description: GenericIntoRustString
) -> GraphQLRouteConfig {
  GraphQLRouteConfig(
    ptr: __swift_bridge__$graph_ql_route_config_description(
      client.ptr,
      {
        let rustString = description.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
      }()))
}
...
public func routeBuilderHandlerName<GenericIntoRustString: IntoRustString>(
  _ client: RouteBuilderRef, _ name: GenericIntoRustString
) -> RouteBuilder {
  RouteBuilder(
    ptr: __swift_bridge__$route_builder_handler_name(
      client.ptr,
      {
...
public func routeBuilderRequestSchemaJson<GenericIntoRustString: IntoRustString>(
  _ client: RouteBuilderRef, _ schema: GenericIntoRustString
) -> RouteBuilder {
  RouteBuilder(
    ptr: __swift_bridge__$route_builder_request_schema_json(
      client.ptr,
      {
...
public func routeBuilderResponseSchemaJson<GenericIntoRustString: IntoRustString>(
  _ client: RouteBuilderRef, _ schema: GenericIntoRustString
) -> RouteBuilder {
  RouteBuilder(
    ptr: __swift_bridge__$route_builder_response_schema_json(
      client.ptr,
      {
        let rustString = schema.intoRustString()
        rustString.isOwned = false
...
public func routeBuilderParamsSchemaJson<GenericIntoRustString: IntoRustString>(
  _ client: RouteBuilderRef, _ schema: GenericIntoRustString
) -> RouteBuilder {
  RouteBuilder(
    ptr: __swift_bridge__$route_builder_params_schema_json(
      client.ptr,
      {
        let rustString = schema.intoRustString()
        rustString.isOwned = false
...
public func routeBuilderFileParamsJson<GenericIntoRustString: IntoRustString>(
  _ client: RouteBuilderRef, _ schema: GenericIntoRustString
) -> RouteBuilder {
  RouteBuilder(
    ptr: __swift_bridge__$route_builder_file_params_json(
      client.ptr,
      {
        let rustString = schema.intoRustString()
        rustString.isOwned = false
...
public func routeBuilderCors(_ client: RouteBuilderRef, _ cors: CorsConfig) -> RouteBuilder {
  RouteBuilder(
    ptr: __swift_bridge__$route_builder_cors(
      client.ptr,
      {
        cors.isOwned = false
        return cors.ptr
...
public func routeBuilderHandlerDependencies<GenericIntoRustString: IntoRustString>(
  _ client: RouteBuilderRef, _ dependencies: RustVec<GenericIntoRustString>
) -> RouteBuilder {
  RouteBuilder(
    ptr: __swift_bridge__$route_builder_handler_dependencies(
      client.ptr,
      {
...
public func routeBuilderNew<GenericIntoRustString: IntoRustString>(
  _ method: MethodRef, _ path: GenericIntoRustString
) -> RouteBuilder {
  RouteBuilder(
    ptr: __swift_bridge__$route_builder_new(
      method.ptr,
      {
        let rustString = path.intoRustString()
        rustString.isOwned = false
...
public func corsConfigFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> CorsConfig
{
  try {
    let val = __swift_bridge__$cors_config_from_json(
      {
    ...
    if val.is_ok {
      return CorsConfig(ptr: val.ok_or_err!)
    } else {
...
public func uploadFileFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> UploadFile
{
  try {
    let val = __swift_bridge__$upload_file_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return UploadFile(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func schemaConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> SchemaConfig {
  try {
    let val = __swift_bridge__$schema_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return SchemaConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func queryOnlyConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> QueryOnlyConfig {
  try {
    let val = __swift_bridge__$query_only_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return QueryOnlyConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func queryMutationConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> QueryMutationConfig {
  try {
    let val = __swift_bridge__$query_mutation_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return QueryMutationConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func fullSchemaConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> FullSchemaConfig {
  try {
    let val = __swift_bridge__$full_schema_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return FullSchemaConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func backgroundTaskConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> BackgroundTaskConfig {
  try {
    let val = __swift_bridge__$background_task_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return BackgroundTaskConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func backgroundJobMetadataFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> BackgroundJobMetadata {
  try {
    let val = __swift_bridge__$background_job_metadata_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return BackgroundJobMetadata(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func compressionConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> CompressionConfig {
  try {
    let val = __swift_bridge__$compression_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return CompressionConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func rateLimitConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> RateLimitConfig {
  try {
    let val = __swift_bridge__$rate_limit_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return RateLimitConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func grpcConfigFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> GrpcConfig
{
  try {
    let val = __swift_bridge__$grpc_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return GrpcConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func jsonRpcConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> JsonRpcConfig {
  try {
    let val = __swift_bridge__$json_rpc_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return JsonRpcConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func openApiConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> OpenApiConfig {
  try {
    let val = __swift_bridge__$open_api_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return OpenApiConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func responseFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> Response
{
  try {
    let val = __swift_bridge__$response_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return Response(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func sseEventFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> SseEvent
{
  try {
    let val = __swift_bridge__$sse_event_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return SseEvent(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func jwtConfigFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> JwtConfig
{
  try {
    let val = __swift_bridge__$jwt_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return JwtConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func apiKeyConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ApiKeyConfig {
  try {
    let val = __swift_bridge__$api_key_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ApiKeyConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func staticFilesConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> StaticFilesConfig {
  try {
    let val = __swift_bridge__$static_files_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return StaticFilesConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func jsonRpcMethodInfoFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> JsonRpcMethodInfo {
  try {
    let val = __swift_bridge__$json_rpc_method_info_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return JsonRpcMethodInfo(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func problemDetailsFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ProblemDetails {
  try {
    let val = __swift_bridge__$problem_details_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ProblemDetails(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func asyncApiConfigFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> AsyncApiConfig {
  try {
    let val = __swift_bridge__$async_api_config_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return AsyncApiConfig(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func parsedChannelFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ParsedChannel {
  try {
    let val = __swift_bridge__$parsed_channel_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ParsedChannel(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func parsedOperationFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ParsedOperation {
  try {
    let val = __swift_bridge__$parsed_operation_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ParsedOperation(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func parsedMessageFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ParsedMessage {
  try {
    let val = __swift_bridge__$parsed_message_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ParsedMessage(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func parseResultFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ParseResult {
  try {
    let val = __swift_bridge__$parse_result_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ParseResult(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func contactInfoFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> ContactInfo {
  try {
    let val = __swift_bridge__$contact_info_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ContactInfo(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func licenseInfoFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> LicenseInfo {
  try {
    let val = __swift_bridge__$license_info_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return LicenseInfo(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func serverInfoFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> ServerInfo
{
  try {
    let val = __swift_bridge__$server_info_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return ServerInfo(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func methodFromJson<GenericIntoRustString: IntoRustString>(_ json: GenericIntoRustString)
  throws -> Method
{
  try {
    let val = __swift_bridge__$method_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return Method(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
}
public func securitySchemeInfoFromJson<GenericIntoRustString: IntoRustString>(
  _ json: GenericIntoRustString
) throws -> SecuritySchemeInfo {
  try {
    let val = __swift_bridge__$security_scheme_info_from_json(
      {
        let rustString = json.intoRustString()
        rustString.isOwned = false
        return rustString.ptr
    ...
    if val.is_ok {
      return SecuritySchemeInfo(ptr: val.ok_or_err!)
    } else {
      throw RustString(ptr: val.ok_or_err!)
    }
  }()
...
extension UploadFileRef {
  ...
  public func contentType() -> RustString? {
    {
      let val = __swift_bridge__$UploadFile$content_type(ptr)
  ...
  public func contentEncoding() -> RustString? {
    {
      let val = __swift_bridge__$UploadFile$content_encoding(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }
}
extension UploadFile: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: UploadFile) {
    __swift_bridge__$Vec_UploadFile$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> UploadFileRef? {
...
extension GraphQLRouteConfig: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: GraphQLRouteConfig) {
    __swift_bridge__$Vec_GraphQLRouteConfig$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    GraphQLRouteConfigRef
  > {
    UnsafePointer<GraphQLRouteConfigRef>(
      OpaquePointer(__swift_bridge__$Vec_GraphQLRouteConfig$as_ptr(vecPtr)))
  }
...
extension SchemaConfig {
  public convenience init(
    _ introspection_enabled: Bool, _ complexity_limit: UInt?, _ depth_limit: UInt?
  ) {
    self.init(
      ptr: __swift_bridge__$SchemaConfig$new(
        introspection_enabled, complexity_limit.intoFfiRepr(), depth_limit.intoFfiRepr()))
  }
}
...
extension SchemaConfig: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: SchemaConfig) {
    __swift_bridge__$Vec_SchemaConfig$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> SchemaConfigRef?
  {
...
extension QueryOnlyConfig {
  public convenience init(
    ...
    self.init(
      ptr: __swift_bridge__$QueryOnlyConfig$new(
        introspection_enabled, complexity_limit.intoFfiRepr(), depth_limit.intoFfiRepr()))
  }
}
...
extension QueryOnlyConfig: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: QueryOnlyConfig) {
    __swift_bridge__$Vec_QueryOnlyConfig$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    QueryOnlyConfigRef
  > {
    UnsafePointer<QueryOnlyConfigRef>(
      OpaquePointer(__swift_bridge__$Vec_QueryOnlyConfig$as_ptr(vecPtr)))
  }
...
extension QueryMutationConfig {
  public convenience init(
    ...
    self.init(
      ptr: __swift_bridge__$QueryMutationConfig$new(
        introspection_enabled, complexity_limit.intoFfiRepr(), depth_limit.intoFfiRepr()))
  }
}
...
extension QueryMutationConfig: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: QueryMutationConfig) {
    __swift_bridge__$Vec_QueryMutationConfig$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    QueryMutationConfigRef
  > {
    UnsafePointer<QueryMutationConfigRef>(
      OpaquePointer(__swift_bridge__$Vec_QueryMutationConfig$as_ptr(vecPtr)))
  }
...
extension FullSchemaConfig {
  public convenience init(
    ...
    self.init(
      ptr: __swift_bridge__$FullSchemaConfig$new(
        introspection_enabled, complexity_limit.intoFfiRepr(), depth_limit.intoFfiRepr()))
  }
}
...
extension FullSchemaConfig: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: FullSchemaConfig) {
    __swift_bridge__$Vec_FullSchemaConfig$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    FullSchemaConfigRef
  > {
    UnsafePointer<FullSchemaConfigRef>(
      OpaquePointer(__swift_bridge__$Vec_FullSchemaConfig$as_ptr(vecPtr)))
  }
...
extension BackgroundTaskConfig {
  public convenience init(
    _ max_queue_size: UInt, _ max_concurrent_tasks: UInt, _ drain_timeout_secs: UInt64
  ) {
    self.init(
      ptr: __swift_bridge__$BackgroundTaskConfig$new(
        max_queue_size, max_concurrent_tasks, drain_timeout_secs))
  }
}
...
extension BackgroundTaskConfig: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: BackgroundTaskConfig) {
    __swift_bridge__$Vec_BackgroundTaskConfig$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    BackgroundTaskConfigRef
  > {
    UnsafePointer<BackgroundTaskConfigRef>(
      OpaquePointer(__swift_bridge__$Vec_BackgroundTaskConfig$as_ptr(vecPtr)))
  }
...
extension BackgroundJobMetadata {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ name: GenericIntoRustString, _ request_id: GenericIntoRustString?
  ) {
    self.init(
      ptr: __swift_bridge__$BackgroundJobMetadata$new(
        {
          let rustString = name.intoRustString()
          rustString.isOwned = false
          return rustString.ptr
        ...
        {
          if let rustString = optionalStringIntoRustString(request_id) {
            rustString.isOwned = false
            return rustString.ptr
          } else {
            return nil
...
extension BackgroundJobMetadataRef {
  ...
  public func requestId() -> RustString? {
    {
      let val = __swift_bridge__$BackgroundJobMetadata$request_id(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }
}
extension BackgroundJobMetadata: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: BackgroundJobMetadata) {
    __swift_bridge__$Vec_BackgroundJobMetadata$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    BackgroundJobMetadataRef
  > {
    UnsafePointer<BackgroundJobMetadataRef>(
      OpaquePointer(__swift_bridge__$Vec_BackgroundJobMetadata$as_ptr(vecPtr)))
  }
...
extension CorsConfig {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ allowed_origins: RustVec<GenericIntoRustString>,
    _ allowed_methods: RustVec<GenericIntoRustString>,
    _ allowed_headers: RustVec<GenericIntoRustString>,
    _ expose_headers: RustVec<GenericIntoRustString>?, _ max_age: UInt32?,
    _ allow_credentials: Bool?
  ) {
    self.init(
      ptr: __swift_bridge__$CorsConfig$new(
        {
          let val = allowed_origins
          val.isOwned = false
          return val.ptr
        }(),
        {
          let val = allowed_methods
          val.isOwned = false
          return val.ptr
        }(),
        {
          let val = allowed_headers
          val.isOwned = false
          return val.ptr
        }(),
        {
          if let val = expose_headers {
            val.isOwned = false
            return val.ptr
          } else {
            return nil
          }
        }(), max_age.intoFfiRepr(), allow_credentials.intoFfiRepr()))
  }
}
...
extension CorsConfigRef {
  ...
  public func exposeHeaders() -> RustVec<RustString>? {
    {
      let val = __swift_bridge__$CorsConfig$expose_headers(ptr)
      if val != nil { return RustVec(ptr: val!) } else { return nil }
    }()
  }

  public func maxAge() -> UInt32? {
    __swift_bridge__$CorsConfig$max_age(ptr).intoSwiftRepr()
  }

  public func allowCredentials() -> Bool? {
...
extension CorsConfig: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: CorsConfig) {
    __swift_bridge__$Vec_CorsConfig$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> CorsConfigRef? {
...
extension CompressionConfig: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: CompressionConfig) {
    __swift_bridge__$Vec_CompressionConfig$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    CompressionConfigRef
  > {
    UnsafePointer<CompressionConfigRef>(
      OpaquePointer(__swift_bridge__$Vec_CompressionConfig$as_ptr(vecPtr)))
  }
...
extension GrpcConfig {
  public convenience init(
    _ enabled: Bool, _ max_message_size: UInt, _ enable_compression: Bool,
    _ request_timeout: UInt64?, _ max_concurrent_streams: UInt32, _ enable_keepalive: Bool,
    _ keepalive_interval: UInt64, _ keepalive_timeout: UInt64, _ max_stream_response_bytes: UInt?
  ) {
    self.init(
      ptr: __swift_bridge__$GrpcConfig$new(
        enabled, max_message_size, enable_compression, request_timeout.intoFfiRepr(),
        max_concurrent_streams, enable_keepalive, keepalive_interval, keepalive_timeout,
        max_stream_response_bytes.intoFfiRepr()))
  }
}
...
extension GrpcConfigRef {
  ...
  public func maxStreamResponseBytes() -> UInt? {
...
extension GrpcConfig: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: GrpcConfig) {
    __swift_bridge__$Vec_GrpcConfig$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> GrpcConfigRef? {
...
extension JsonRpcConfig {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ enabled: Bool, _ endpoint_path: GenericIntoRustString, _ enable_batch: Bool,
    _ max_batch_size: UInt
  ) {
    self.init(
      ptr: __swift_bridge__$JsonRpcConfig$new(
        enabled,
        {
          let rustString = endpoint_path.intoRustString()
          rustString.isOwned = false
          return rustString.ptr
        }(), enable_batch, max_batch_size))
  }
}
...
extension JsonRpcConfig: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: JsonRpcConfig) {
    __swift_bridge__$Vec_JsonRpcConfig$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> JsonRpcConfigRef?
  {
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    JsonRpcConfigRef
  > {
    UnsafePointer<JsonRpcConfigRef>(
      OpaquePointer(__swift_bridge__$Vec_JsonRpcConfig$as_ptr(vecPtr)))
  }
...
extension OpenApiConfig {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ enabled: Bool, _ title: GenericIntoRustString, _ version: GenericIntoRustString,
    _ description: GenericIntoRustString?, _ swagger_ui_path: GenericIntoRustString,
    _ redoc_path: GenericIntoRustString, _ openapi_json_path: GenericIntoRustString,
    _ contact: ContactInfo?, _ license: LicenseInfo?, _ servers: RustVec<ServerInfo>,
    _ security_schemes: GenericIntoRustString
  ) {
    self.init(
      ptr: __swift_bridge__$OpenApiConfig$new(
        enabled,
        {
          let rustString = title.intoRustString()
          rustString.isOwned = false
          return rustString.ptr
        }(),
        {
        ...
        {
          let rustString = swagger_ui_path.intoRustString()
          rustString.isOwned = false
          return rustString.ptr
        }(),
        {
          let rustString = redoc_path.intoRustString()
          rustString.isOwned = false
          return rustString.ptr
        }(),
        {
          let rustString = openapi_json_path.intoRustString()
          rustString.isOwned = false
          return rustString.ptr
        }(),
        {
        ...
        {
          let rustString = security_schemes.intoRustString()
          rustString.isOwned = false
          return rustString.ptr
        }()))
  }
...
extension OpenApiConfigRef {
  ...
  public func description() -> RustString? {
    {
      let val = __swift_bridge__$OpenApiConfig$description(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }
  ...
  public func contact() -> ContactInfo? {
    {
      let val = __swift_bridge__$OpenApiConfig$contact(ptr)
      if val != nil { return ContactInfo(ptr: val!) } else { return nil }
    }()
  }

  public func license() -> LicenseInfo? {
    {
      let val = __swift_bridge__$OpenApiConfig$license(ptr)
      if val != nil { return LicenseInfo(ptr: val!) } else { return nil }
    }()
  }
...
extension OpenApiConfig: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: OpenApiConfig) {
    __swift_bridge__$Vec_OpenApiConfig$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> OpenApiConfigRef?
  {
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    OpenApiConfigRef
  > {
    UnsafePointer<OpenApiConfigRef>(
      OpaquePointer(__swift_bridge__$Vec_OpenApiConfig$as_ptr(vecPtr)))
  }
...
extension Response {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ content: GenericIntoRustString?, _ status_code: UInt16, _ headers: GenericIntoRustString
  ) {
    self.init(
      ptr: __swift_bridge__$Response$new(
        {
...
extension ResponseRef {
  public func content() -> RustString? {
    {
      let val = __swift_bridge__$Response$content(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }
...
extension Response: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: Response) {
    __swift_bridge__$Vec_Response$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> ResponseRef? {
...
extension SseEventRef {
  public func eventType() -> RustString? {
    {
      let val = __swift_bridge__$SseEvent$event_type(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }
  ...
  public func id() -> RustString? {
    {
      let val = __swift_bridge__$SseEvent$id(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }

  public func retry() -> UInt64? {
...
extension SseEvent: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: SseEvent) {
    __swift_bridge__$Vec_SseEvent$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> SseEventRef? {
...
extension JwtConfigRef {
  ...
  public func audience() -> RustVec<RustString>? {
    {
      let val = __swift_bridge__$JwtConfig$audience(ptr)
      if val != nil { return RustVec(ptr: val!) } else { return nil }
    }()
  }

  public func issuer() -> RustString? {
    {
      let val = __swift_bridge__$JwtConfig$issuer(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }
...
extension JwtConfig: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: JwtConfig) {
    __swift_bridge__$Vec_JwtConfig$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> JwtConfigRef? {
...
extension ApiKeyConfig: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: ApiKeyConfig) {
    __swift_bridge__$Vec_ApiKeyConfig$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> ApiKeyConfigRef?
  {
...
extension StaticFilesConfigRef {
  ...
  public func cacheControl() -> RustString? {
    {
      let val = __swift_bridge__$StaticFilesConfig$cache_control(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }
}
extension StaticFilesConfig: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: StaticFilesConfig) {
    __swift_bridge__$Vec_StaticFilesConfig$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    StaticFilesConfigRef
  > {
    UnsafePointer<StaticFilesConfigRef>(
      OpaquePointer(__swift_bridge__$Vec_StaticFilesConfig$as_ptr(vecPtr)))
  }
...
extension ServerConfig {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ host: GenericIntoRustString, _ port: UInt16, _ workers: UInt, _ enable_request_id: Bool,
    _ max_body_size: UInt?, _ request_timeout: UInt64?, _ compression: CompressionConfig?,
    _ rate_limit: RateLimitConfig?, _ jwt_auth: JwtConfig?, _ api_key_auth: ApiKeyConfig?,
    _ static_files: RustVec<StaticFilesConfig>, _ graceful_shutdown: Bool,
    _ shutdown_timeout: UInt64, _ asyncapi: AsyncApiConfig?, _ openapi: OpenApiConfig?,
    _ jsonrpc: JsonRpcConfig?, _ grpc: GrpcConfig?, _ background_tasks: BackgroundTaskConfig,
      ...
      ptr: __swift_bridge__$ServerConfig$new(
        {
          ...
          rustString.isOwned = false
          return rustString.ptr
        }(), port, workers, enable_request_id, max_body_size.intoFfiRepr(),
        request_timeout.intoFfiRepr(),
        {
          if let val = compression {
            val.isOwned = false
            return val.ptr
          } else {
            return nil
        ...
        {
          background_tasks.isOwned = false
          return background_tasks.ptr
        }(), enable_http_trace))
  }
}
...
extension ServerConfigRef {
  ...
  public func compression() -> CompressionConfig? {
    {
      let val = __swift_bridge__$ServerConfig$compression(ptr)
      if val != nil { return CompressionConfig(ptr: val!) } else { return nil }
    }()
  }

  public func rateLimit() -> RateLimitConfig? {
    {
      let val = __swift_bridge__$ServerConfig$rate_limit(ptr)
      if val != nil { return RateLimitConfig(ptr: val!) } else { return nil }
    }()
  }

  public func jwtAuth() -> JwtConfig? {
    {
      let val = __swift_bridge__$ServerConfig$jwt_auth(ptr)
      if val != nil { return JwtConfig(ptr: val!) } else { return nil }
    }()
  }

  public func apiKeyAuth() -> ApiKeyConfig? {
    {
      let val = __swift_bridge__$ServerConfig$api_key_auth(ptr)
      if val != nil { return ApiKeyConfig(ptr: val!) } else { return nil }
    }()
  }
  ...
  public func asyncapi() -> AsyncApiConfig? {
    {
      let val = __swift_bridge__$ServerConfig$asyncapi(ptr)
      if val != nil { return AsyncApiConfig(ptr: val!) } else { return nil }
    }()
  }

  public func openapi() -> OpenApiConfig? {
    {
      let val = __swift_bridge__$ServerConfig$openapi(ptr)
      if val != nil { return OpenApiConfig(ptr: val!) } else { return nil }
    }()
  }

  public func jsonrpc() -> JsonRpcConfig? {
    {
      let val = __swift_bridge__$ServerConfig$jsonrpc(ptr)
      if val != nil { return JsonRpcConfig(ptr: val!) } else { return nil }
    }()
  }

  public func grpc() -> GrpcConfig? {
    {
      let val = __swift_bridge__$ServerConfig$grpc(ptr)
      if val != nil { return GrpcConfig(ptr: val!) } else { return nil }
    }()
  }
...
extension RouteBuilder: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: RouteBuilder) {
    __swift_bridge__$Vec_RouteBuilder$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> RouteBuilderRef?
  {
...
extension JsonRpcMethodInfoRef {
  ...
  public func description() -> RustString? {
    {
      let val = __swift_bridge__$JsonRpcMethodInfo$description(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }

  public func paramsSchema() -> RustString? {
    {
      let val = __swift_bridge__$JsonRpcMethodInfo$params_schema(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }

  public func resultSchema() -> RustString? {
    {
      let val = __swift_bridge__$JsonRpcMethodInfo$result_schema(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }
...
extension JsonRpcMethodInfo: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: JsonRpcMethodInfo) {
    __swift_bridge__$Vec_JsonRpcMethodInfo$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    JsonRpcMethodInfoRef
  > {
    UnsafePointer<JsonRpcMethodInfoRef>(
      OpaquePointer(__swift_bridge__$Vec_JsonRpcMethodInfo$as_ptr(vecPtr)))
  }
...
extension ProblemDetailsRef {
  ...
  public func detail() -> RustString? {
    {
      let val = __swift_bridge__$ProblemDetails$detail(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }

  public func instance() -> RustString? {
    {
      let val = __swift_bridge__$ProblemDetails$instance(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }
...
extension ProblemDetails: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: ProblemDetails) {
    __swift_bridge__$Vec_ProblemDetails$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    ProblemDetailsRef
  > {
    UnsafePointer<ProblemDetailsRef>(
      OpaquePointer(__swift_bridge__$Vec_ProblemDetails$as_ptr(vecPtr)))
  }
...
extension AsyncApiConfig {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ enabled: Bool, _ spec: GenericIntoRustString?
  ) {
    self.init(
      ptr: __swift_bridge__$AsyncApiConfig$new(
        enabled,
        {
          if let rustString = optionalStringIntoRustString(spec) {
            rustString.isOwned = false
            return rustString.ptr
          } else {
            return nil
...
extension AsyncApiConfigRef {
  ...
  public func spec() -> RustString? {
    {
      let val = __swift_bridge__$AsyncApiConfig$spec(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }
}
extension AsyncApiConfig: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: AsyncApiConfig) {
    __swift_bridge__$Vec_AsyncApiConfig$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    AsyncApiConfigRef
  > {
    UnsafePointer<AsyncApiConfigRef>(
      OpaquePointer(__swift_bridge__$Vec_AsyncApiConfig$as_ptr(vecPtr)))
  }
...
extension ParsedChannelRef {
  ...
  public func bindings() -> RustString? {
    {
      let val = __swift_bridge__$ParsedChannel$bindings(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }
}
extension ParsedChannel: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: ParsedChannel) {
    __swift_bridge__$Vec_ParsedChannel$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> ParsedChannelRef?
  {
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    ParsedChannelRef
  > {
    UnsafePointer<ParsedChannelRef>(
      OpaquePointer(__swift_bridge__$Vec_ParsedChannel$as_ptr(vecPtr)))
  }
...
extension ParsedOperation: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: ParsedOperation) {
    __swift_bridge__$Vec_ParsedOperation$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    ParsedOperationRef
  > {
    UnsafePointer<ParsedOperationRef>(
      OpaquePointer(__swift_bridge__$Vec_ParsedOperation$as_ptr(vecPtr)))
  }
...
extension ParsedMessageRef {
  ...
  public func schema() -> RustString? {
    {
      let val = __swift_bridge__$ParsedMessage$schema(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }
}
extension ParsedMessage: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: ParsedMessage) {
    __swift_bridge__$Vec_ParsedMessage$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> ParsedMessageRef?
  {
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    ParsedMessageRef
  > {
    UnsafePointer<ParsedMessageRef>(
      OpaquePointer(__swift_bridge__$Vec_ParsedMessage$as_ptr(vecPtr)))
  }
...
extension ParseResult: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: ParseResult) {
    __swift_bridge__$Vec_ParseResult$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> ParseResultRef? {
...
extension ParseRequest: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: ParseRequest) {
    __swift_bridge__$Vec_ParseRequest$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> ParseRequestRef?
  {
...
extension ValidationResponse: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: ValidationResponse) {
    __swift_bridge__$Vec_ValidationResponse$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    ValidationResponseRef
  > {
    UnsafePointer<ValidationResponseRef>(
      OpaquePointer(__swift_bridge__$Vec_ValidationResponse$as_ptr(vecPtr)))
  }
...
extension ValidateRequest: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: ValidateRequest) {
    __swift_bridge__$Vec_ValidateRequest$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    ValidateRequestRef
  > {
    UnsafePointer<ValidateRequestRef>(
      OpaquePointer(__swift_bridge__$Vec_ValidateRequest$as_ptr(vecPtr)))
  }
...
extension ContactInfoRef {
  public func name() -> RustString? {
    {
      let val = __swift_bridge__$ContactInfo$name(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }

  public func email() -> RustString? {
    {
      let val = __swift_bridge__$ContactInfo$email(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }
  ...
  public func url() -> RustString? {
    {
      let val = __swift_bridge__$ContactInfo$url(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }
}
extension ContactInfo: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: ContactInfo) {
    __swift_bridge__$Vec_ContactInfo$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> ContactInfoRef? {
...
extension LicenseInfoRef {
  ...
  public func url() -> RustString? {
    {
      let val = __swift_bridge__$LicenseInfo$url(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }
}
extension LicenseInfo: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: LicenseInfo) {
    __swift_bridge__$Vec_LicenseInfo$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> LicenseInfoRef? {
...
extension ServerInfoRef {
  ...
  public func description() -> RustString? {
    {
      let val = __swift_bridge__$ServerInfo$description(ptr)
      if val != nil { return RustString(ptr: val!) } else { return nil }
    }()
  }
}
extension ServerInfo: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: ServerInfo) {
    __swift_bridge__$Vec_ServerInfo$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> ServerInfoRef? {
...
extension TestingSseEvent: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: TestingSseEvent) {
    __swift_bridge__$Vec_TestingSseEvent$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    TestingSseEventRef
  > {
    UnsafePointer<TestingSseEventRef>(
      OpaquePointer(__swift_bridge__$Vec_TestingSseEvent$as_ptr(vecPtr)))
  }
...
extension Method: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: Method) {
    __swift_bridge__$Vec_Method$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> MethodRef? {
  ...
  public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt) -> MethodRefMut?
  {
...
extension SecuritySchemeInfo: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: SecuritySchemeInfo) {
    __swift_bridge__$Vec_SecuritySchemeInfo$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfAsPtr(vecPtr: UnsafeMutableRawPointer) -> UnsafePointer<
    SecuritySchemeInfoRef
  > {
    UnsafePointer<SecuritySchemeInfoRef>(
      OpaquePointer(__swift_bridge__$Vec_SecuritySchemeInfo$as_ptr(vecPtr)))
  }
...
extension App: Vectorizable {
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> AppRef? {
  ...
  public static func vecOfSelfGetMut(vecPtr: UnsafeMutableRawPointer, index: UInt) -> AppRefMut? {
