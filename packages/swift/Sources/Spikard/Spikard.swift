...
// alef:hash:c9fe4c6ba74614bca50d86a584095a2af830009026ea739b348d3346db3aa320
// swift-format-ignore-file

import Foundation
import RustBridge
public typealias GraphQLRouteConfig = RustBridge.GraphQLRouteConfig
public typealias RouteBuilder = RustBridge.RouteBuilder
...
public struct ApiKeyAuthConfig: Codable, Sendable, Hashable {
    ...
    public init(enabled: Bool = true, keys: [String], headerName: String = "X-API-Key") {
...
// MARK: - Internal FFI conversions for ApiKeyAuthConfig
internal extension ApiKeyAuthConfig {
    init(_ rb: RustBridge.ApiKeyAuthConfigRef) throws {
        self.enabled = rb.enabled()
        self.keys = rb.keys().map { $0.as_str().toString() }
        self.headerName = rb.headerName().toString()
    }

    func intoRust() throws -> RustBridge.ApiKeyAuthConfig {
        let data = try JSONEncoder().encode(self)
        let json = String(data: data, encoding: .utf8) ?? "{}"
        return try RustBridge.apiKeyAuthConfigFromJson(json)
    }
}
...
public struct ApiKeyConfig: Codable, Sendable, Hashable {
    ...
    /// Header name to check (e.g., "X-API-Key")
    public let headerName: String
    public init(keys: [String], headerName: String = "X-API-Key") {
        self.keys = keys
        self.headerName = headerName
    }
    private enum CodingKeys: String, CodingKey {
...
public struct AuthorizationConfig: Codable, Sendable, Hashable {
    ...
    public init(requiredRoles: [String], requiredScopes: [String], requiredPermissions: [String], requireAll: Bool = true) {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        self.requireAll = try container.decodeIfPresent(Bool.self, forKey: .requireAll) ?? true
    }
}

// MARK: - Internal FFI conversions for AuthorizationConfig
internal extension AuthorizationConfig {
    init(_ rb: RustBridge.AuthorizationConfigRef) throws {
        self.requiredRoles = rb.requiredRoles().map { $0.as_str().toString() }
        self.requiredScopes = rb.requiredScopes().map { $0.as_str().toString() }
        self.requiredPermissions = rb.requiredPermissions().map { $0.as_str().toString() }
        self.requireAll = rb.requireAll()
    }

    func intoRust() throws -> RustBridge.AuthorizationConfig {
        let __requiredRoles = RustVec<RustString>()
        for __elem in self.requiredRoles { __requiredRoles.push(value: RustString(__elem)) }
        let __requiredScopes = RustVec<RustString>()
        for __elem in self.requiredScopes { __requiredScopes.push(value: RustString(__elem)) }
        let __requiredPermissions = RustVec<RustString>()
        for __elem in self.requiredPermissions { __requiredPermissions.push(value: RustString(__elem)) }
        return RustBridge.AuthorizationConfig(__requiredRoles, __requiredScopes, __requiredPermissions, self.requireAll)
    }
}
...
public struct BackgroundJobMetadata: Codable, Sendable, Hashable {
    ...
    public init(name: String = "background_task", requestId: String? = nil) {
        self.name = name
    ...
    public init(from decoder: any Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.name = try container.decodeIfPresent(String.self, forKey: .name) ?? "background_task"
...
public struct BackgroundTaskConfig: Codable, Sendable, Hashable {
    ...
    public init(enabled: Bool = false, maxQueueSize: UInt = 1024, maxConcurrentTasks: UInt = 128, drainTimeoutSecs: UInt64 = 30) {
        self.enabled = enabled
...
internal extension BackgroundTaskConfig {
    ...
    func intoRust() throws -> RustBridge.BackgroundTaskConfig {
        return RustBridge.BackgroundTaskConfig(self.enabled, self.maxQueueSize, self.maxConcurrentTasks, self.drainTimeoutSecs)
    }
}
...
public struct CompressionConfig: Codable, Sendable, Hashable {
    ...
    public init(gzip: Bool = true, brotli: Bool = true, minSize: UInt = 1024, quality: UInt32 = 6) {
        self.gzip = gzip
        self.brotli = brotli
    ...
    public init(from decoder: any Decoder) throws {
        ...
        self.minSize = try container.decodeIfPresent(UInt.self, forKey: .minSize) ?? 1024
        self.quality = try container.decodeIfPresent(UInt32.self, forKey: .quality) ?? 6
    }
}
...
public struct CorsConfig: Codable, Sendable, Hashable {
    ...
    public func allowedMethodsJoined() throws  -> String {
        let jsonSelf = try JSONEncoder().encode(self)
        let selfString = String(data: jsonSelf, encoding: .utf8) ?? "{}"
        let resultJson = try RustBridge.corsConfigAllowedMethodsJoinedFromJson(selfString).toString()
        let data = resultJson.data(using: .utf8) ?? Data()
        return try JSONDecoder().decode(String.self, from: data)
    }

    public func allowedHeadersJoined() throws  -> String {
        let jsonSelf = try JSONEncoder().encode(self)
        let selfString = String(data: jsonSelf, encoding: .utf8) ?? "{}"
        let resultJson = try RustBridge.corsConfigAllowedHeadersJoinedFromJson(selfString).toString()
        let data = resultJson.data(using: .utf8) ?? Data()
        return try JSONDecoder().decode(String.self, from: data)
    }
    ...
    public func isOriginAllowed(origin: String) throws  -> Bool {
        let jsonSelf = try JSONEncoder().encode(self)
        let selfString = String(data: jsonSelf, encoding: .utf8) ?? "{}"
        let resultJson = try RustBridge.corsConfigIsOriginAllowedFromJson(selfString, origin).toString()
        let data = resultJson.data(using: .utf8) ?? Data()
        return try JSONDecoder().decode(Bool.self, from: data)
    }

    public func isMethodAllowed(method: String) throws  -> Bool {
        let jsonSelf = try JSONEncoder().encode(self)
        let selfString = String(data: jsonSelf, encoding: .utf8) ?? "{}"
        let resultJson = try RustBridge.corsConfigIsMethodAllowedFromJson(selfString, method).toString()
        let data = resultJson.data(using: .utf8) ?? Data()
        return try JSONDecoder().decode(Bool.self, from: data)
    }
...
internal extension CorsConfig {
    init(_ rb: RustBridge.CorsConfigRef) throws {
        ...
        self.exposeHeaders = try JSONDecoder().decode([String]?.self, from: ((rb.exposeHeaders().toString()).data(using: .utf8) ?? Data("null".utf8)))
...
public struct DynamicSchemaConfig: Codable, Sendable, Hashable {
    ...
    public let maxComplexity: UInt?
    /// Maximum query depth (`None` = unlimited).
    public let maxDepth: UInt?
    /// Field-level errors to inject at specific response paths.
    public let fieldErrors: [FieldErrorSpec]
    public init(introspectionEnabled: Bool, maxComplexity: UInt? = nil, maxDepth: UInt? = nil, fieldErrors: [FieldErrorSpec]) {
    ...
    public init(from decoder: any Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.introspectionEnabled = try container.decodeIfPresent(Bool.self, forKey: .introspectionEnabled) ?? false
        self.maxComplexity = try container.decodeIfPresent(UInt.self, forKey: .maxComplexity) ?? nil
        self.maxDepth = try container.decodeIfPresent(UInt.self, forKey: .maxDepth) ?? nil
        self.fieldErrors = try container.decodeIfPresent([FieldErrorSpec].self, forKey: .fieldErrors) ?? []
    }
}

// MARK: - Internal FFI conversions for DynamicSchemaConfig
internal extension DynamicSchemaConfig {
    init(_ rb: RustBridge.DynamicSchemaConfigRef) throws {
        self.introspectionEnabled = rb.introspectionEnabled()
        self.maxComplexity = rb.maxComplexity()
        self.maxDepth = rb.maxDepth()
        self.fieldErrors = try rb.fieldErrors().map { (s: RustStringRef) -> FieldErrorSpec in let d = s.as_str().toString().data(using: .utf8) ?? Data(); return try JSONDecoder().decode(FieldErrorSpec.self, from: d) }
    }

    func intoRust() throws -> RustBridge.DynamicSchemaConfig {
        let __fieldErrors = RustVec<RustBridge.FieldErrorSpec>()
        for __elem in self.fieldErrors { __fieldErrors.push(value: try __elem.intoRust()) }
        return RustBridge.DynamicSchemaConfig(self.introspectionEnabled, self.maxComplexity, self.maxDepth, __fieldErrors)
    }
}
...
public struct FieldErrorSpec: Codable, Sendable, Hashable {
...
// MARK: - Internal FFI conversions for FieldErrorSpec
internal extension FieldErrorSpec {
    init(_ rb: RustBridge.FieldErrorSpecRef) throws {
        self.path = rb.path().toString()
        self.message = rb.message().toString()
    }

    func intoRust() throws -> RustBridge.FieldErrorSpec {
        let data = try JSONEncoder().encode(self)
        let json = String(data: data, encoding: .utf8) ?? "{}"
        return try RustBridge.fieldErrorSpecFromJson(json)
    }
}
...
public struct FullSchemaConfig: Codable, Sendable, Hashable {
    ...
    public init(introspectionEnabled: Bool = true, complexityLimit: UInt? = nil, depthLimit: UInt? = nil) {
        self.introspectionEnabled = introspectionEnabled
...
public struct GrpcConfig: Codable, Sendable, Hashable {
    ...
    public init(enabled: Bool = true, maxMessageSize: UInt = 4194304, enableCompression: Bool = true, requestTimeout: UInt64? = nil, maxConcurrentStreams: UInt32 = 100, enableKeepalive: Bool = true, keepaliveInterval: UInt64 = 75, keepaliveTimeout: UInt64 = 20, maxStreamResponseBytes: UInt? = nil) {
        self.enabled = enabled
    ...
    public init(from decoder: any Decoder) throws {
        ...
        self.maxMessageSize = try container.decodeIfPresent(UInt.self, forKey: .maxMessageSize) ?? 4194304
        ...
        self.maxConcurrentStreams = try container.decodeIfPresent(UInt32.self, forKey: .maxConcurrentStreams) ?? 100
        self.enableKeepalive = try container.decodeIfPresent(Bool.self, forKey: .enableKeepalive) ?? true
        self.keepaliveInterval = try container.decodeIfPresent(UInt64.self, forKey: .keepaliveInterval) ?? 75
        self.keepaliveTimeout = try container.decodeIfPresent(UInt64.self, forKey: .keepaliveTimeout) ?? 20
...
public struct JsonRpcConfig: Codable, Sendable, Hashable {
    ...
    public init(enabled: Bool = true, endpointPath: String = "/rpc", enableBatch: Bool = true, maxBatchSize: UInt = 100) {
        self.enabled = enabled
    ...
    public init(from decoder: any Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.enabled = try container.decodeIfPresent(Bool.self, forKey: .enabled) ?? true
        self.endpointPath = try container.decodeIfPresent(String.self, forKey: .endpointPath) ?? "/rpc"
        self.enableBatch = try container.decodeIfPresent(Bool.self, forKey: .enableBatch) ?? true
        self.maxBatchSize = try container.decodeIfPresent(UInt.self, forKey: .maxBatchSize) ?? 100
    }
}
...
public struct JwtAuthConfig: Codable, Sendable, Hashable {
    ...
    public init(enabled: Bool = true, secret: String? = nil, publicKey: String? = nil, algorithm: String = "HS256", audience: [String]? = nil, issuer: String? = nil, leeway: UInt64) {
        self.enabled = enabled
        self.secret = secret
...
// MARK: - Internal FFI conversions for JwtAuthConfig
internal extension JwtAuthConfig {
    init(_ rb: RustBridge.JwtAuthConfigRef) throws {
        self.enabled = rb.enabled()
        self.secret = rb.secret()?.toString()
        self.publicKey = rb.publicKey()?.toString()
        self.algorithm = rb.algorithm().toString()
        self.audience = try JSONDecoder().decode([String]?.self, from: ((rb.audience().toString()).data(using: .utf8) ?? Data("null".utf8)))
        self.issuer = rb.issuer()?.toString()
        self.leeway = rb.leeway()
    }

    func intoRust() throws -> RustBridge.JwtAuthConfig {
        let data = try JSONEncoder().encode(self)
        let json = String(data: data, encoding: .utf8) ?? "{}"
        return try RustBridge.jwtAuthConfigFromJson(json)
    }
}
...
public struct JwtConfig: Codable, Sendable, Hashable {
    ...
    /// Leeway for expiration checks (seconds)
    public let leeway: UInt64
    public init(secret: String, algorithm: String = "HS256", audience: [String]? = nil, issuer: String? = nil, leeway: UInt64) {
        self.secret = secret
        self.algorithm = algorithm
        self.audience = audience
        self.issuer = issuer
...
public typealias LifecycleHookRef = RustBridge.LifecycleHookRef
...
public typealias LifecycleHooksConfig = RustBridge.LifecycleHooksConfig
...
public struct RateLimitConfig: Codable, Sendable, Hashable {
    ...
    public init(perSecond: UInt64 = 100, burst: UInt32 = 200, ipBased: Bool = true) {
...
public typealias Request = RustBridge.Request
...
public struct RequestIdConfig: Codable, Sendable, Hashable {
...
// MARK: - Internal FFI conversions for RequestIdConfig
internal extension RequestIdConfig {
    init(_ rb: RustBridge.RequestIdConfigRef) throws {
        self.enabled = rb.enabled()
    }

    func intoRust() throws -> RustBridge.RequestIdConfig {
        return RustBridge.RequestIdConfig(self.enabled)
    }
}
...
public struct StaticFilesConfig: Codable, Sendable, Hashable {
    ...
    public init(directory: String, routePrefix: String, indexFile: Bool = true, cacheControl: String? = nil) {
...
public typealias ApiKeyAuthConfigRef = RustBridge.ApiKeyAuthConfigRef

public typealias ApiKeyAuthConfigRefMut = RustBridge.ApiKeyAuthConfigRefMut

public typealias ApiKeyConfigRef = RustBridge.ApiKeyConfigRef

public typealias ApiKeyConfigRefMut = RustBridge.ApiKeyConfigRefMut

public typealias AuthorizationConfigRef = RustBridge.AuthorizationConfigRef

public typealias AuthorizationConfigRefMut = RustBridge.AuthorizationConfigRefMut

public typealias BackgroundJobMetadataRef = RustBridge.BackgroundJobMetadataRef

public typealias BackgroundJobMetadataRefMut = RustBridge.BackgroundJobMetadataRefMut

public typealias BackgroundTaskConfigRef = RustBridge.BackgroundTaskConfigRef

public typealias BackgroundTaskConfigRefMut = RustBridge.BackgroundTaskConfigRefMut

public typealias CompressionConfigRef = RustBridge.CompressionConfigRef

public typealias CompressionConfigRefMut = RustBridge.CompressionConfigRefMut

public typealias ContactInfoRef = RustBridge.ContactInfoRef

public typealias ContactInfoRefMut = RustBridge.ContactInfoRefMut

public typealias CorsConfigRef = RustBridge.CorsConfigRef

public typealias CorsConfigRefMut = RustBridge.CorsConfigRefMut

public typealias DynamicSchemaConfigRef = RustBridge.DynamicSchemaConfigRef

public typealias DynamicSchemaConfigRefMut = RustBridge.DynamicSchemaConfigRefMut

public typealias FieldErrorSpecRef = RustBridge.FieldErrorSpecRef

public typealias FieldErrorSpecRefMut = RustBridge.FieldErrorSpecRefMut

public typealias FullSchemaConfigRef = RustBridge.FullSchemaConfigRef

public typealias FullSchemaConfigRefMut = RustBridge.FullSchemaConfigRefMut

public typealias GrpcConfigRef = RustBridge.GrpcConfigRef

public typealias GrpcConfigRefMut = RustBridge.GrpcConfigRefMut

public typealias JsonRpcConfigRef = RustBridge.JsonRpcConfigRef

public typealias JsonRpcConfigRefMut = RustBridge.JsonRpcConfigRefMut

public typealias JwtAuthConfigRef = RustBridge.JwtAuthConfigRef

public typealias JwtAuthConfigRefMut = RustBridge.JwtAuthConfigRefMut

public typealias JwtConfigRef = RustBridge.JwtConfigRef

public typealias JwtConfigRefMut = RustBridge.JwtConfigRefMut

public typealias LicenseInfoRef = RustBridge.LicenseInfoRef

public typealias LicenseInfoRefMut = RustBridge.LicenseInfoRefMut

public typealias ParsedOperationRef = RustBridge.ParsedOperationRef

public typealias ParsedOperationRefMut = RustBridge.ParsedOperationRefMut

public typealias QueryMutationConfigRef = RustBridge.QueryMutationConfigRef

public typealias QueryMutationConfigRefMut = RustBridge.QueryMutationConfigRefMut

public typealias QueryOnlyConfigRef = RustBridge.QueryOnlyConfigRef

public typealias QueryOnlyConfigRefMut = RustBridge.QueryOnlyConfigRefMut

public typealias RateLimitConfigRef = RustBridge.RateLimitConfigRef

public typealias RateLimitConfigRefMut = RustBridge.RateLimitConfigRefMut

public typealias RequestIdConfigRef = RustBridge.RequestIdConfigRef

public typealias RequestIdConfigRefMut = RustBridge.RequestIdConfigRefMut

public typealias SchemaConfigRef = RustBridge.SchemaConfigRef

public typealias SchemaConfigRefMut = RustBridge.SchemaConfigRefMut

public typealias ServerInfoRef = RustBridge.ServerInfoRef

public typealias ServerInfoRefMut = RustBridge.ServerInfoRefMut

public typealias StaticFilesConfigRef = RustBridge.StaticFilesConfigRef

public typealias StaticFilesConfigRefMut = RustBridge.StaticFilesConfigRefMut
...
public typealias LifecycleHookPhase = RustBridge.LifecycleHookPhase
...
public enum AppError: Swift.Error {
    ...
    case graphQl(message: String, field0: String)
...
extension GraphQLError {
    public var statusCode: UInt16 {
        ...
        case .introspectionDisabled: return 0
    ...
    public var isTransient: Bool {
        ...
        case .introspectionDisabled: return false
    ...
    public var errorType: String {
        ...
        case .introspectionDisabled: return ""
...
public func apiKeyAuthConfigFromJson(_ json: String) throws -> ApiKeyAuthConfig {
    let data = json.data(using: .utf8) ?? Data()
    return try JSONDecoder().decode(ApiKeyAuthConfig.self, from: data)
}
...
public func authorizationConfigFromJson(_ json: String) throws -> AuthorizationConfig {
    let data = json.data(using: .utf8) ?? Data()
    return try JSONDecoder().decode(AuthorizationConfig.self, from: data)
}
...
public func dynamicSchemaConfigFromJson(_ json: String) throws -> DynamicSchemaConfig {
    let data = json.data(using: .utf8) ?? Data()
    return try JSONDecoder().decode(DynamicSchemaConfig.self, from: data)
}
public func fieldErrorSpecFromJson(_ json: String) throws -> FieldErrorSpec {
    let data = json.data(using: .utf8) ?? Data()
    return try JSONDecoder().decode(FieldErrorSpec.self, from: data)
}
...
public func graphQlRouteConfigFromJson(_ json: String) throws -> GraphQLRouteConfig {
    return try RustBridge.graphQlRouteConfigFromJson(json)
}
...
public func jwtAuthConfigFromJson(_ json: String) throws -> JwtAuthConfig {
    let data = json.data(using: .utf8) ?? Data()
    return try JSONDecoder().decode(JwtAuthConfig.self, from: data)
}
...
public func lifecycleHookRefFromJson(_ json: String) throws -> LifecycleHookRef {
    return try RustBridge.lifecycleHookRefFromJson(json)
}
public func lifecycleHooksConfigFromJson(_ json: String) throws -> LifecycleHooksConfig {
    return try RustBridge.lifecycleHooksConfigFromJson(json)
}
...
public func requestIdConfigFromJson(_ json: String) throws -> RequestIdConfig {
    let data = json.data(using: .utf8) ?? Data()
    return try JSONDecoder().decode(RequestIdConfig.self, from: data)
}
...
extension RustBridge.ApiKeyAuthConfig: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.ApiKeyConfig: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.AsyncApiConfig: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.AuthorizationConfig: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
...
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.DynamicSchemaConfig: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.FieldErrorSpec: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
...
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.JwtAuthConfig: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.JwtConfig: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.LicenseInfo: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.LifecycleHookRef: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.LifecycleHooksConfig: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
...
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.Request: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.RequestIdConfig: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
