...
// alef:hash:e87479771cbb6aae0dd852fbe401e9971a575e26f5c37a28db9aa0f87978c89e
...
public struct JwtAuthConfig: Codable, Sendable, Hashable {
    ...
    /// Leeway for expiration checks (seconds)
    public let leeway: UInt64
    public init(enabled: Bool, secret: String? = nil, publicKey: String? = nil, algorithm: String, audience: [String]? = nil, issuer: String? = nil, leeway: UInt64) {
        self.enabled = enabled
        self.secret = secret
...
public struct ApiKeyAuthConfig: Codable, Sendable, Hashable {
    ...
    /// Header name to check (e.g., "X-API-Key")
    public let headerName: String
    public init(enabled: Bool, keys: [String], headerName: String) {
        self.enabled = enabled
        self.keys = keys
        self.headerName = headerName
    }
...
public typealias AuthorizationConfig = RustBridge.AuthorizationConfig
