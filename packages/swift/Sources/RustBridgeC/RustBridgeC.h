...
struct __private__ResultPtrAndPtr __swift_bridge__$cors_config_allowed_methods_joined_from_json(void* json);
struct __private__ResultPtrAndPtr __swift_bridge__$cors_config_allowed_headers_joined_from_json(void* json);
struct __private__ResultPtrAndPtr __swift_bridge__$cors_config_is_origin_allowed_from_json(void* json, void* origin);
struct __private__ResultPtrAndPtr __swift_bridge__$cors_config_is_method_allowed_from_json(void* json, void* method);
...
struct __private__ResultPtrAndPtr __swift_bridge__$response_set_header_from_json(void* json, void* key, void* value);
struct __private__ResultPtrAndPtr __swift_bridge__$response_set_cookie_from_json(void* json, void* key, void* value, bool secure, bool http_only, struct __private__OptionI64 max_age, void* domain, void* path, void* same_site);
...
struct __private__ResultPtrAndPtr __swift_bridge__$sse_event_with_id_from_json(void* json, void* id);
struct __private__ResultPtrAndPtr __swift_bridge__$sse_event_with_retry_from_json(void* json, uint64_t retry_ms);
...
void* __swift_bridge__$route_builder_body_limit(void* client, uintptr_t max_bytes);
void* __swift_bridge__$route_builder_request_timeout(void* client, uint64_t seconds);
...
struct __private__ResultPtrAndPtr __swift_bridge__$problem_details_with_detail_from_json(void* json, void* detail);
struct __private__ResultPtrAndPtr __swift_bridge__$problem_details_with_instance_from_json(void* json, void* instance);
struct __private__ResultPtrAndPtr __swift_bridge__$problem_details_to_json_from_json(void* json);
struct __private__ResultPtrAndPtr __swift_bridge__$problem_details_to_json_pretty_from_json(void* json);
...
struct __private__ResultPtrAndPtr __swift_bridge__$dynamic_schema_config_from_json(void* json);
...
struct __private__ResultPtrAndPtr __swift_bridge__$field_error_spec_from_json(void* json);
