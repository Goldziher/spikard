...
// alef:hash:70cb1ac233a667c89af1d2883e087c87cf6080b46f938339fc526b867934d986
...
impl AuthorizationConfig {
    pub fn new(
        ...
        // alef: required_roles — Vec field type may differ from IR in non-serde struct, left at default
        // alef: required_scopes — Vec field type may differ from IR in non-serde struct, left at default
        // alef: required_permissions — Vec field type may differ from IR in non-serde struct, left at default
        __target.require_all = require_all;
        AuthorizationConfig(__target)
    }
    // alef: skipped getter `required_roles` — type cannot be bridged through swift-bridge
    // alef: skipped getter `required_scopes` — type cannot be bridged through swift-bridge
    // alef: skipped getter `required_permissions` — type cannot be bridged through swift-bridge
    pub fn require_all(&self) -> bool {
        self.0.require_all.clone()
    }
}
