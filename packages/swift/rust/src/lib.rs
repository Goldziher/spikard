...
// alef:hash:798892172a4e3395a9d2fe9f76d9369f4d0dda339e0c75e3caef97abf3211f78
...
#[used]
static __ALEF_KEEP_FFI_LINKED: unsafe extern "C" fn() -> *const ::std::ffi::c_char = spikard_ffi::spikard_version;
...
mod ffi {
    ...
    extern "Rust" {
        ...
        #[swift_bridge(swift_name = "requiredRoles")]
        fn required_roles(&self) -> Vec<String>;
        #[swift_bridge(swift_name = "requiredScopes")]
        fn required_scopes(&self) -> Vec<String>;
        #[swift_bridge(swift_name = "requiredPermissions")]
        fn required_permissions(&self) -> Vec<String>;
        #[swift_bridge(swift_name = "requireAll")]
    ...
    extern "Rust" {
        #[swift_bridge(swift_name = "corsConfigAllowedMethodsJoinedFromJson")]
        fn cors_config_allowed_methods_joined_from_json(json: String) -> Result<String, String>;
        #[swift_bridge(swift_name = "corsConfigAllowedHeadersJoinedFromJson")]
        fn cors_config_allowed_headers_joined_from_json(json: String) -> Result<String, String>;
        #[swift_bridge(swift_name = "corsConfigIsOriginAllowedFromJson")]
        fn cors_config_is_origin_allowed_from_json(json: String, origin: String) -> Result<String, String>;
        #[swift_bridge(swift_name = "corsConfigIsMethodAllowedFromJson")]
        fn cors_config_is_method_allowed_from_json(json: String, method: String) -> Result<String, String>;
    }

    extern "Rust" {
        type DynamicSchemaConfig;
        #[swift_bridge(init)]
        fn new(
    ...
    extern "Rust" {
        ...
        #[swift_bridge(swift_name = "publicKey")]
    ...
    extern "Rust" {
        ...
        #[swift_bridge(swift_name = "onRequest")]
        fn on_request(&self) -> Vec<LifecycleHookRef>;
        #[swift_bridge(swift_name = "preValidation")]
        fn pre_validation(&self) -> Vec<LifecycleHookRef>;
        #[swift_bridge(swift_name = "preHandler")]
        fn pre_handler(&self) -> Vec<LifecycleHookRef>;
        #[swift_bridge(swift_name = "onResponse")]
    ...
    extern "Rust" {
        #[swift_bridge(swift_name = "problemDetailsWithDetailFromJson")]
        fn problem_details_with_detail_from_json(json: String, detail: String) -> Result<String, String>;
        #[swift_bridge(swift_name = "problemDetailsWithInstanceFromJson")]
        fn problem_details_with_instance_from_json(json: String, instance: String) -> Result<String, String>;
        #[swift_bridge(swift_name = "problemDetailsToJsonFromJson")]
        fn problem_details_to_json_from_json(json: String) -> Result<String, String>;
        #[swift_bridge(swift_name = "problemDetailsToJsonPrettyFromJson")]
        fn problem_details_to_json_pretty_from_json(json: String) -> Result<String, String>;
    }
    ...
    extern "Rust" {
        type Request;
        fn request_noop(client: &Request);
    }

    extern "Rust" {
        type RequestData;
        fn request_data_noop(client: &RequestData);
    }

    extern "Rust" {
        type RequestIdConfig;
        #[swift_bridge(init)]
        fn new(enabled: bool) -> RequestIdConfig;
        fn enabled(&self) -> bool;
    }
    ...
    extern "Rust" {
        #[swift_bridge(swift_name = "responseSetHeaderFromJson")]
        fn response_set_header_from_json(json: String, key: String, value: String) -> Result<String, String>;
        #[swift_bridge(swift_name = "responseSetCookieFromJson")]
        fn response_set_cookie_from_json(
            json: String,
            key: String,
            value: String,
            secure: bool,
    ...
    extern "Rust" {
        ...
        #[swift_bridge(swift_name = "routeBuilderBodyLimit")]
        fn route_builder_body_limit(client: &RouteBuilder, max_bytes: usize) -> RouteBuilder;
        #[swift_bridge(swift_name = "routeBuilderRequestTimeout")]
        fn route_builder_request_timeout(client: &RouteBuilder, seconds: u64) -> RouteBuilder;
        #[swift_bridge(swift_name = "routeBuilderRateLimit")]
        fn route_builder_rate_limit(client: &RouteBuilder, rate_limit: RateLimitConfig) -> RouteBuilder;
        #[swift_bridge(swift_name = "routeBuilderRequestId")]
        fn route_builder_request_id(client: &RouteBuilder, enabled: bool) -> RouteBuilder;
        #[swift_bridge(swift_name = "routeBuilderJwtAuth")]
        fn route_builder_jwt_auth(client: &RouteBuilder, config: JwtAuthConfig) -> RouteBuilder;
        #[swift_bridge(swift_name = "routeBuilderApiKeyAuth")]
        fn route_builder_api_key_auth(client: &RouteBuilder, config: ApiKeyAuthConfig) -> RouteBuilder;
        #[swift_bridge(swift_name = "routeBuilderAuthorization")]
        fn route_builder_authorization(client: &RouteBuilder, config: AuthorizationConfig) -> RouteBuilder;
        #[swift_bridge(swift_name = "routeBuilderLifecycleHooks")]
        fn route_builder_lifecycle_hooks(client: &RouteBuilder, hooks: LifecycleHooksConfig) -> RouteBuilder;
        #[swift_bridge(swift_name = "routeBuilderJsonrpcMethod")]
        fn route_builder_jsonrpc_method(client: &RouteBuilder, info: JsonRpcMethodInfo) -> RouteBuilder;
        #[swift_bridge(swift_name = "routeBuilderOpenrpcSpec")]
        fn route_builder_openrpc_spec(client: &RouteBuilder, spec: String) -> RouteBuilder;
    ...
    extern "Rust" {
        #[swift_bridge(swift_name = "sseEventWithIdFromJson")]
        fn sse_event_with_id_from_json(json: String, id: String) -> Result<String, String>;
        #[swift_bridge(swift_name = "sseEventWithRetryFromJson")]
        fn sse_event_with_retry_from_json(json: String, retry_ms: u64) -> Result<String, String>;
    }
    ...
    extern "Rust" {
        #[swift_bridge(swift_name = "uploadFileAsBytesFromJson")]
        fn upload_file_as_bytes_from_json(json: String) -> Result<String, String>;
        #[swift_bridge(swift_name = "uploadFileReadToStringFromJson")]
        fn upload_file_read_to_string_from_json(json: String) -> Result<String, String>;
        #[swift_bridge(swift_name = "uploadFileContentTypeOrDefaultFromJson")]
        fn upload_file_content_type_or_default_from_json(json: String) -> Result<String, String>;
    }
    ...
    extern "Rust" {
        type HandlerResult;
        fn handler_result_noop(client: &HandlerResult);
    ...
    extern "Rust" {
        ...
        // Expose the wrapper's heap address as a usize so Swift can hand it, as an
        // OpaquePointer, to the plain `extern "C"` callback-registration function
        // (which takes `*mut RouteBuilder` — swift-bridge's own opaque-class
        // passing convention does not apply to manually declared `extern "C"` functions).
        #[swift_bridge(swift_name = "routeBuilderRawPtr")]
        fn route_builder_raw_ptr(client: &mut RouteBuilder) -> usize;
    }
    extern "Rust" {
        #[swift_bridge(swift_name = "apiKeyAuthConfigFromJson")]
        fn api_key_auth_config_from_json(json: String) -> Result<ApiKeyAuthConfig, String>;
        ...
        #[swift_bridge(swift_name = "authorizationConfigFromJson")]
        fn authorization_config_from_json(json: String) -> Result<AuthorizationConfig, String>;
        ...
        #[swift_bridge(swift_name = "fieldErrorSpecFromJson")]
        fn field_error_spec_from_json(json: String) -> Result<FieldErrorSpec, String>;
        ...
        #[swift_bridge(swift_name = "graphQlRouteConfigFromJson")]
        fn graph_ql_route_config_from_json(json: String) -> Result<GraphQLRouteConfig, String>;
        ...
        #[swift_bridge(swift_name = "jwtAuthConfigFromJson")]
        fn jwt_auth_config_from_json(json: String) -> Result<JwtAuthConfig, String>;
        ...
        #[swift_bridge(swift_name = "lifecycleHookRefFromJson")]
        fn lifecycle_hook_ref_from_json(json: String) -> Result<LifecycleHookRef, String>;
        #[swift_bridge(swift_name = "lifecycleHooksConfigFromJson")]
        fn lifecycle_hooks_config_from_json(json: String) -> Result<LifecycleHooksConfig, String>;
    ...
    extern "Rust" {
        #[swift_bridge(swift_name = "dynamicSchemaConfigFromJson")]
        fn dynamic_schema_config_from_json(json: String) -> Result<DynamicSchemaConfig, String>;
        #[swift_bridge(swift_name = "parseResultFromJson")]
        fn parse_result_from_json(json: String) -> Result<ParseResult, String>;
        #[swift_bridge(swift_name = "requestIdConfigFromJson")]
        fn request_id_config_from_json(json: String) -> Result<RequestIdConfig, String>;
    ...
    extern "Rust" {
        ...
        fn __alef_phantom_vec_api_key_auth_config() -> Vec<ApiKeyAuthConfig>;
        fn __alef_phantom_vec_api_key_config() -> Vec<ApiKeyConfig>;
        fn __alef_phantom_vec_async_api_config() -> Vec<AsyncApiConfig>;
        fn __alef_phantom_vec_authorization_config() -> Vec<AuthorizationConfig>;
        ...
        fn __alef_phantom_vec_dynamic_schema_config() -> Vec<DynamicSchemaConfig>;
        fn __alef_phantom_vec_field_error_spec() -> Vec<FieldErrorSpec>;
        ...
        fn __alef_phantom_vec_jwt_auth_config() -> Vec<JwtAuthConfig>;
        fn __alef_phantom_vec_jwt_config() -> Vec<JwtConfig>;
        fn __alef_phantom_vec_license_info() -> Vec<LicenseInfo>;
        fn __alef_phantom_vec_lifecycle_hook_ref() -> Vec<LifecycleHookRef>;
        fn __alef_phantom_vec_lifecycle_hooks_config() -> Vec<LifecycleHooksConfig>;
        ...
        fn __alef_phantom_vec_request_id_config() -> Vec<RequestIdConfig>;
        ...
        fn __alef_phantom_vec_lifecycle_hook_phase() -> Vec<LifecycleHookPhase>;
...
#[doc(hidden)]
pub fn __alef_phantom_vec_api_key_auth_config() -> Vec<ApiKeyAuthConfig> {
    Vec::new()
}
#[doc(hidden)]
...
#[doc(hidden)]
pub fn __alef_phantom_vec_authorization_config() -> Vec<AuthorizationConfig> {
    Vec::new()
}
#[doc(hidden)]
...
#[doc(hidden)]
pub fn __alef_phantom_vec_dynamic_schema_config() -> Vec<DynamicSchemaConfig> {
    Vec::new()
}
#[doc(hidden)]
pub fn __alef_phantom_vec_field_error_spec() -> Vec<FieldErrorSpec> {
    Vec::new()
}
#[doc(hidden)]
...
#[doc(hidden)]
pub fn __alef_phantom_vec_jwt_auth_config() -> Vec<JwtAuthConfig> {
    Vec::new()
}
#[doc(hidden)]
...
#[doc(hidden)]
pub fn __alef_phantom_vec_lifecycle_hook_ref() -> Vec<LifecycleHookRef> {
    Vec::new()
}
#[doc(hidden)]
pub fn __alef_phantom_vec_lifecycle_hooks_config() -> Vec<LifecycleHooksConfig> {
    Vec::new()
}
#[doc(hidden)]
...
#[doc(hidden)]
pub fn __alef_phantom_vec_request_id_config() -> Vec<RequestIdConfig> {
    Vec::new()
}
#[doc(hidden)]
...
#[doc(hidden)]
pub fn __alef_phantom_vec_lifecycle_hook_phase() -> Vec<LifecycleHookPhase> {
    Vec::new()
}
#[doc(hidden)]
...
/// takes `*mut RouteBuilder` because swift-bridge's opaque-class passing
/// convention only applies to functions inside the `#[swift_bridge::bridge]` module.
pub fn route_builder_raw_ptr(client: &mut RouteBuilder) -> usize {
    client as *mut RouteBuilder as usize
}

mod extern_callbacks;

pub struct ApiKeyAuthConfig(pub spikard::ApiKeyAuthConfig);
...
pub struct AsyncApiConfig(pub spikard::AsyncApiConfig);
impl AsyncApiConfig {
    pub fn new(enabled: bool, spec: Option<String>) -> AsyncApiConfig {
        let mut __target: spikard::AsyncApiConfig = ::std::default::Default::default();
...
pub struct AuthorizationConfig(pub spikard::AuthorizationConfig);
impl AuthorizationConfig {
    pub fn new(
        ...
        let mut __target: spikard::AuthorizationConfig = ::std::default::Default::default();
        if let Ok(__v) = ::serde_json::to_value(required_roles) {
            if let Ok(t) = ::serde_json::from_value(__v) {
                __target.required_roles = t;
            }
        }
        if let Ok(__v) = ::serde_json::to_value(required_scopes) {
            if let Ok(t) = ::serde_json::from_value(__v) {
                __target.required_scopes = t;
            }
        }
        if let Ok(__v) = ::serde_json::to_value(required_permissions) {
            if let Ok(t) = ::serde_json::from_value(__v) {
                __target.required_permissions = t;
            }
        }
        __target.require_all = require_all;
        AuthorizationConfig(__target)
    }
    pub fn required_roles(&self) -> Vec<String> {
        ::serde_json::to_value(&self.0.required_roles)
            .ok()
            .and_then(|j| ::serde_json::from_value(j).ok())
            .unwrap_or_default()
    }
    pub fn required_scopes(&self) -> Vec<String> {
        ::serde_json::to_value(&self.0.required_scopes)
            .ok()
            .and_then(|j| ::serde_json::from_value(j).ok())
            .unwrap_or_default()
    }
    pub fn required_permissions(&self) -> Vec<String> {
        ::serde_json::to_value(&self.0.required_permissions)
            .ok()
            .and_then(|j| ::serde_json::from_value(j).ok())
            .unwrap_or_default()
    }
    pub fn require_all(&self) -> bool {
        ::serde_json::to_value(&self.0.require_all)
            .ok()
            .and_then(|j| ::serde_json::from_value(j).ok())
            .unwrap_or_default()
    }
...
impl CorsConfig {
    ...
    pub fn expose_headers(&self) -> String {
        serde_json::to_string(&self.0.expose_headers).expect("serializable expose_headers")
    }
...
pub fn cors_config_allowed_methods_joined_from_json(json: String) -> Result<String, String> {
    let __self: spikard::CorsConfig =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize CorsConfig: {}", e))?;
    let __result = __self.allowed_methods_joined();
    serde_json::to_string(&__result).map_err(|e| format!("Failed to serialize result: {}", e))
}

pub fn cors_config_allowed_headers_joined_from_json(json: String) -> Result<String, String> {
    let __self: spikard::CorsConfig =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize CorsConfig: {}", e))?;
    let __result = __self.allowed_headers_joined();
    serde_json::to_string(&__result).map_err(|e| format!("Failed to serialize result: {}", e))
}

pub fn cors_config_is_origin_allowed_from_json(json: String, origin: String) -> Result<String, String> {
    let __self: spikard::CorsConfig =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize CorsConfig: {}", e))?;
...
pub fn cors_config_is_method_allowed_from_json(json: String, method: String) -> Result<String, String> {
    let __self: spikard::CorsConfig =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize CorsConfig: {}", e))?;
    let __result = __self.is_method_allowed(&method);
    serde_json::to_string(&__result).map_err(|e| format!("Failed to serialize result: {}", e))
}

pub struct DynamicSchemaConfig(pub spikard::DynamicSchemaConfig);
impl DynamicSchemaConfig {
    pub fn new(
        ...
        let mut __target: spikard::DynamicSchemaConfig = ::std::default::Default::default();
        __target.introspection_enabled = introspection_enabled;
        __target.max_complexity = max_complexity;
        __target.max_depth = max_depth;
        __target.field_errors = field_errors.into_iter().map(|w| w.0).collect();
        DynamicSchemaConfig(__target)
    }
    ...
    pub fn max_complexity(&self) -> Option<usize> {
        self.0.max_complexity.as_ref().and_then(|v| {
            ::serde_json::to_value(v)
                .ok()
                .and_then(|j| ::serde_json::from_value(j).ok())
        })
...
pub struct FieldErrorSpec(pub spikard::FieldErrorSpec);
impl FieldErrorSpec {
...
pub struct JwtAuthConfig(pub spikard::JwtAuthConfig);
impl JwtAuthConfig {
    pub fn enabled(&self) -> bool {
        ::serde_json::to_value(&self.0.enabled)
            .ok()
    ...
    pub fn audience(&self) -> String {
        serde_json::to_string(&self.0.audience).expect("serializable audience")
    }
...
pub struct LifecycleHookRef(pub spikard::LifecycleHookRef);
impl LifecycleHookRef {
    pub fn new(
        ...
        let mut __target: spikard::LifecycleHookRef = ::std::default::Default::default();
        {
            // Try JSON parse first (handles enum/object values); on parse failure
            // treat the raw input as a JSON string scalar so plain `String` /
            // string-like enum fields don't end up empty for inputs that aren't
        ...
        }
        {
            ...
            // string-like enum fields don't end up empty for inputs that aren't
            // valid JSON tokens (e.g. `tts-1`).
            let __v = ::serde_json::from_str::<::serde_json::Value>(&handler)
                .unwrap_or(::serde_json::Value::String(handler.clone()));
            if let Ok(t) = ::serde_json::from_value(__v) {
                __target.handler = t;
            }
        }
        if let Ok(__v) = ::serde_json::to_value(dependencies) {
            if let Ok(t) = ::serde_json::from_value(__v) {
                __target.dependencies = t;
            }
        }
        if let Some(s) = config {
            ...
            let __v = ::serde_json::from_str::<::serde_json::Value>(&s).unwrap_or(::serde_json::Value::String(s));
            if let Ok(t) = ::serde_json::from_value(__v) {
                __target.config = Some(t);
            }
        }
        __target.order = order;
        LifecycleHookRef(__target)
    }
    pub fn name(&self) -> String {
        self.0.name.clone()
    }
    ...
    pub fn dependencies(&self) -> Vec<String> {
        ::serde_json::to_value(&self.0.dependencies)
            .ok()
            .and_then(|j| ::serde_json::from_value(j).ok())
            .unwrap_or_default()
    }
    ...
    pub fn order(&self) -> Option<u32> {
        self.0.order.as_ref().and_then(|v| {
            ::serde_json::to_value(v)
                .ok()
                .and_then(|j| ::serde_json::from_value(j).ok())
        })
...
pub struct LifecycleHooksConfig(pub spikard::LifecycleHooksConfig);
impl LifecycleHooksConfig {
    pub fn new(
        ...
        let mut __target: spikard::LifecycleHooksConfig = ::std::default::Default::default();
        __target.on_request = on_request.into_iter().map(|w| w.0).collect();
        __target.pre_validation = pre_validation.into_iter().map(|w| w.0).collect();
        __target.pre_handler = pre_handler.into_iter().map(|w| w.0).collect();
        __target.on_response = on_response.into_iter().map(|w| w.0).collect();
        __target.on_error = on_error.into_iter().map(|w| w.0).collect();
        LifecycleHooksConfig(__target)
    }
    pub fn on_request(&self) -> Vec<LifecycleHookRef> {
        self.0
            .on_request
            .iter()
            .map(|elem| LifecycleHookRef(elem.clone()))
            .collect()
    }
    pub fn pre_validation(&self) -> Vec<LifecycleHookRef> {
        self.0
            .pre_validation
            .iter()
            .map(|elem| LifecycleHookRef(elem.clone()))
    ...
    pub fn pre_handler(&self) -> Vec<LifecycleHookRef> {
        self.0
            .pre_handler
            .iter()
            .map(|elem| LifecycleHookRef(elem.clone()))
    ...
    pub fn on_response(&self) -> Vec<LifecycleHookRef> {
        self.0
            .on_response
            .iter()
            .map(|elem| LifecycleHookRef(elem.clone()))
    ...
    pub fn on_error(&self) -> Vec<LifecycleHookRef> {
        self.0
            .on_error
            .iter()
            .map(|elem| LifecycleHookRef(elem.clone()))
...
pub fn problem_details_with_detail_from_json(json: String, detail: String) -> Result<String, String> {
    let __self: spikard_core::ProblemDetails =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize ProblemDetails: {}", e))?;
    let __result = __self.with_detail(detail);
    serde_json::to_string(&__result).map_err(|e| format!("Failed to serialize result: {}", e))
}

pub fn problem_details_with_instance_from_json(json: String, instance: String) -> Result<String, String> {
    let __self: spikard_core::ProblemDetails =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize ProblemDetails: {}", e))?;
    let __result = __self.with_instance(instance);
    serde_json::to_string(&__result).map_err(|e| format!("Failed to serialize result: {}", e))
}

pub fn problem_details_to_json_from_json(json: String) -> Result<String, String> {
    let __self: spikard_core::ProblemDetails =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize ProblemDetails: {}", e))?;
    let __result = __self.to_json();
    let __value = __result.map_err(|e| e.to_string())?;
    serde_json::to_string(&__value).map_err(|e| format!("Failed to serialize result: {}", e))
}

pub fn problem_details_to_json_pretty_from_json(json: String) -> Result<String, String> {
    let __self: spikard_core::ProblemDetails =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize ProblemDetails: {}", e))?;
    let __result = __self.to_json_pretty();
    let __value = __result.map_err(|e| e.to_string())?;
    serde_json::to_string(&__value).map_err(|e| format!("Failed to serialize result: {}", e))
}
...
pub struct RequestIdConfig(pub spikard::RequestIdConfig);
impl RequestIdConfig {
    pub fn new(enabled: bool) -> RequestIdConfig {
        RequestIdConfig(spikard::RequestIdConfig { enabled })
    }
    pub fn enabled(&self) -> bool {
        ::serde_json::to_value(&self.0.enabled)
            .ok()
...
pub fn response_set_header_from_json(json: String, key: String, value: String) -> Result<String, String> {
    let mut __self: spikard::Response =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize Response: {}", e))?;
    __self.set_header(key, value);
    Ok("{}".to_string())
}

pub fn response_set_cookie_from_json(
    json: String,
    key: String,
    value: String,
    secure: bool,
    ...
    let mut __self: spikard::Response =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize Response: {}", e))?;
    __self.set_cookie(key, value, secure, http_only, max_age, domain, path, same_site);
    Ok("{}".to_string())
}
...
pub fn route_builder_body_limit(client: &RouteBuilder, max_bytes: usize) -> RouteBuilder {
    RouteBuilder(client.0.clone().body_limit(max_bytes))
}
pub fn route_builder_request_timeout(client: &RouteBuilder, seconds: u64) -> RouteBuilder {
    RouteBuilder(client.0.clone().request_timeout(seconds))
}
pub fn route_builder_rate_limit(client: &RouteBuilder, rate_limit: RateLimitConfig) -> RouteBuilder {
    RouteBuilder(client.0.clone().rate_limit(rate_limit.0))
}
pub fn route_builder_request_id(client: &RouteBuilder, enabled: bool) -> RouteBuilder {
    RouteBuilder(client.0.clone().request_id(enabled))
}
pub fn route_builder_jwt_auth(client: &RouteBuilder, config: JwtAuthConfig) -> RouteBuilder {
    RouteBuilder(client.0.clone().jwt_auth(config.0))
}
pub fn route_builder_api_key_auth(client: &RouteBuilder, config: ApiKeyAuthConfig) -> RouteBuilder {
    RouteBuilder(client.0.clone().api_key_auth(config.0))
}
pub fn route_builder_authorization(client: &RouteBuilder, config: AuthorizationConfig) -> RouteBuilder {
    RouteBuilder(client.0.clone().authorization(config.0))
}
pub fn route_builder_lifecycle_hooks(client: &RouteBuilder, hooks: LifecycleHooksConfig) -> RouteBuilder {
    RouteBuilder(client.0.clone().lifecycle_hooks(hooks.0))
}
pub fn route_builder_jsonrpc_method(client: &RouteBuilder, info: JsonRpcMethodInfo) -> RouteBuilder {
    RouteBuilder(client.0.clone().jsonrpc_method(info.0))
}
pub fn route_builder_openrpc_spec(client: &RouteBuilder, spec: String) -> RouteBuilder {
    RouteBuilder(
        client
            .0
            .clone()
            .openrpc_spec(serde_json::from_str::<serde_json::Value>(&spec).unwrap_or(serde_json::Value::Null)),
    )
}
...
pub fn sse_event_with_id_from_json(json: String, id: String) -> Result<String, String> {
    let __self: spikard::SseEvent =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize SseEvent: {}", e))?;
    let __result = __self.with_id(id);
    serde_json::to_string(&__result).map_err(|e| format!("Failed to serialize result: {}", e))
}

pub fn sse_event_with_retry_from_json(json: String, retry_ms: u64) -> Result<String, String> {
    let __self: spikard::SseEvent =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize SseEvent: {}", e))?;
    let __result = __self.with_retry(retry_ms);
    serde_json::to_string(&__result).map_err(|e| format!("Failed to serialize result: {}", e))
}
...
pub fn upload_file_as_bytes_from_json(json: String) -> Result<String, String> {
    let __self: spikard::UploadFile =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize UploadFile: {}", e))?;
    let __result = __self.as_bytes();
    serde_json::to_string(&__result).map_err(|e| format!("Failed to serialize result: {}", e))
}

pub fn upload_file_read_to_string_from_json(json: String) -> Result<String, String> {
    let __self: spikard::UploadFile =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize UploadFile: {}", e))?;
    let __result = __self.read_to_string();
    let __value = __result.map_err(|e| e.to_string())?;
    serde_json::to_string(&__value).map_err(|e| format!("Failed to serialize result: {}", e))
}

pub fn upload_file_content_type_or_default_from_json(json: String) -> Result<String, String> {
    let __self: spikard::UploadFile =
        serde_json::from_str(&json).map_err(|e| format!("Failed to deserialize UploadFile: {}", e))?;
    let __result = __self.content_type_or_default();
    serde_json::to_string(&__result).map_err(|e| format!("Failed to serialize result: {}", e))
}
...
pub fn request_noop(client: &Request) {
    // No-op method for swift-bridge destructor synthesis
}
...
impl LifecycleHookPhase {
    pub fn to_string(&self) -> String {
        match self {
            Self::OnRequest => "OnRequest".to_string(),
            Self::PreValidation => "PreValidation".to_string(),
            Self::PreHandler => "PreHandler".to_string(),
            Self::OnResponse => "OnResponse".to_string(),
            Self::OnError => "OnError".to_string(),
        }
    }
}
#[allow(dead_code)]
fn __alef_lifecycle_hook_phase_from_swift_string(value: &str) -> Result<spikard_core::LifecycleHookPhase, String> {
    match value {
        "OnRequest" => Ok(spikard_core::LifecycleHookPhase::OnRequest),
        "PreValidation" => Ok(spikard_core::LifecycleHookPhase::PreValidation),
        "PreHandler" => Ok(spikard_core::LifecycleHookPhase::PreHandler),
        "OnResponse" => Ok(spikard_core::LifecycleHookPhase::OnResponse),
        "OnError" => Ok(spikard_core::LifecycleHookPhase::OnError),
        _ => Err(format!("unknown LifecycleHookPhase variant: {:?}", value)),
    }
}
...
#[allow(dead_code)]
fn __alef_method_from_swift_string(value: &str) -> Result<spikard::Method, String> {
    match value {
        "Get" => Ok(spikard::Method::Get),
        "Post" => Ok(spikard::Method::Post),
        "Put" => Ok(spikard::Method::Put),
        "Patch" => Ok(spikard::Method::Patch),
        "Delete" => Ok(spikard::Method::Delete),
        "Head" => Ok(spikard::Method::Head),
        "Options" => Ok(spikard::Method::Options),
        "Connect" => Ok(spikard::Method::Connect),
        "Trace" => Ok(spikard::Method::Trace),
        _ => Err(format!("unknown Method variant: {:?}", value)),
    }
}
...
pub fn schema_full() -> FullSchemaConfig {
    FullSchemaConfig(spikard::schema_full())
}

pub fn schema_query_mutation() -> QueryMutationConfig {
    QueryMutationConfig(spikard::schema_query_mutation())
}

pub fn schema_query_only() -> QueryOnlyConfig {
    QueryOnlyConfig(spikard::schema_query_only())
}
...
pub fn graph_ql_route_config_from_json(json: String) -> Result<GraphQLRouteConfig, String> {
    serde_json::from_str::<spikard::GraphQLRouteConfig>(&json)
        .map(GraphQLRouteConfig)
        .map_err(|e| e.to_string())
}
...
pub fn request_id_config_from_json(json: String) -> Result<RequestIdConfig, String> {
    serde_json::from_str::<spikard::RequestIdConfig>(&json)
        .map(RequestIdConfig)
        .map_err(|e| e.to_string())
}
