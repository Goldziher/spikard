...
impl DynamicSchemaConfig {
    ...
    pub fn introspection_enabled(&self) -> bool {
        self.0.introspection_enabled.clone()
    }
    pub fn max_complexity(&self) -> Option<usize> {
        self.0.max_complexity.clone()
    }
    pub fn max_depth(&self) -> Option<usize> {
        self.0.max_depth.clone()
    }
    // alef: skipped getter `field_errors` — type cannot be bridged through swift-bridge
}
