 ...
 * Per RFC 9457, all fields are optional. The {@code type} field defaults to
...
public record
ProblemDetails(@JsonProperty("type") String typeUri,
  ...
  public static final class Builder {
    ...
    @JsonProperty("type") private String typeUri;
    ...
    public ProblemDetails build() {
      return new ProblemDetails(typeUri, title, status, detail, instance,
                                extensions);
    }
  }
  // CPD-ON
