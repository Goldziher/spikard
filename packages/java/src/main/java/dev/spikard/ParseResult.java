...
public record
ParseResult(@JsonProperty("spec_version") String specVersion,
  ...
  public static final class Builder {
    ...
    @JsonProperty("spec_version") private String specVersion;
    ...
    public ParseResult build() {
      return new ParseResult(specVersion, title, apiVersion, channels,
                             operations, messages);
    }
  }
  // CPD-ON
