...
public class App implements AutoCloseable {
  ...
  private static MemorySegment
  invokeHandlerWithMarshal(MemorySegment contextPtr, MemorySegment requestPtr,
                           Callable handler, Arena arena) throws Throwable {
    ...
    // block exit — safe because the bytes are copied into malloc'd memory
    // first.
    try (Arena scratchArena = Arena.ofConfined()) {
      ...
      MemorySegment mallocAddr =
          (MemorySegment)mallocHandle.invoke(responseLen);
   ...
   *
   * @param handler functional interface receiving JSON request, returning JSON
   *     response
  ...
  public int registerAppRoute(Callable handler, RouteBuilder builder) {
    try {
      ...
      MethodHandle mh =
          lookup.findVirtual(Callable.class, "handle",
      ...
      // Create adapter: (context_ptr: ADDRESS, request_ptr: ADDRESS) ->
      // response_ptr: ADDRESS Marshals C pointers <-> Java strings via Arena
      MethodHandle baseMh = lookup.findStatic(
          App.class, "invokeHandlerWithMarshal",
          MethodType.methodType(MemorySegment.class, MemorySegment.class,
                                MemorySegment.class, Callable.class,
                                Arena.class));
      MethodHandle adapter =
          MethodHandles.insertArguments(baseMh, 2, handler, arena);

      MemorySegment upcallStub = LINKER.upcallStub(adapter, upcallDesc, arena);

      // Get register downcall handle
      MemorySegment regAddr =
          LOOKUP.find("spikard_app_register_route")
  ...
  public int get(String path, Callable handler) {
    try {
      ...
      // response_ptr: ADDRESS Marshals C pointers <-> Java strings via Arena
      MethodHandle baseMh = lookup.findStatic(
          this.getClass(), "invokeHandlerWithMarshal",
          MethodType.methodType(MemorySegment.class, MemorySegment.class,
                                MemorySegment.class, Callable.class,
                                Arena.class));
      MethodHandle adapter =
      ...
      MemorySegment varAddr =
          LOOKUP.find("spikard_app_register_route_get")
              .or(() -> LOOKUP.find("_spikard_app_register_route_get"))
              .orElseThrow();

      FunctionDescriptor varDesc =
  ...
  public int post(String path, Callable handler) {
    try {
      ...
      // Get variant registration downcall handle
      MemorySegment varAddr =
          LOOKUP.find("spikard_app_register_route_post")
  ...
  public int put(String path, Callable handler) {
    try {
      ...
      // Get variant registration downcall handle
      MemorySegment varAddr =
          LOOKUP.find("spikard_app_register_route_put")
  ...
  public int patch(String path, Callable handler) {
    try {
      ...
      // Get variant registration downcall handle
      MemorySegment varAddr =
          LOOKUP.find("spikard_app_register_route_patch")
  ...
  public int delete(String path, Callable handler) {
    try {
      ...
      // Get variant registration downcall handle
      MemorySegment varAddr =
          LOOKUP.find("spikard_app_register_route_delete")
  ...
  public int head(String path, Callable handler) {
    try {
      ...
      // Get variant registration downcall handle
      MemorySegment varAddr =
          LOOKUP.find("spikard_app_register_route_head")
  ...
  public int options(String path, Callable handler) {
    try {
      ...
      // Get variant registration downcall handle
      MemorySegment varAddr =
          LOOKUP.find("spikard_app_register_route_options")
  ...
  public int connect(String path, Callable handler) {
    try {
      ...
      // Get variant registration downcall handle
      MemorySegment varAddr =
          LOOKUP.find("spikard_app_register_route_connect")
  ...
  public int trace(String path, Callable handler) {
    try {
      ...
      // Get variant registration downcall handle
      MemorySegment varAddr =
          LOOKUP.find("spikard_app_register_route_trace")
  ...
  public void run() {
    try {
      MemorySegment epAddr = LOOKUP.find("spikard_app_ep_run")
                                 ...
                                 .orElseThrow();
      FunctionDescriptor epDesc =
          FunctionDescriptor.of(ValueLayout.JAVA_INT, // return int (status)
                                ValueLayout.ADDRESS   // owner: *mut opaque
          );
  ...
  public long into_router() {
    try {
      MemorySegment epAddr =
          LOOKUP.find("spikard_app_ep_into_router")
  ...
  public void config(String host, int port) {
    try {
      ...
      String configJson = String.format("{\"host\": \"%s\", \"port\": %d}",
                                        host.replace("\"", "\\\""), port);
      ...
      MemorySegment createAddr =
          LOOKUP.find("spikard_server_config_from_json")
              .or(() -> LOOKUP.find("_spikard_server_config_from_json"))
              .orElseThrow();
      FunctionDescriptor createDesc =
          FunctionDescriptor.of(ValueLayout.ADDRESS // return: ServerConfig*
                                ,
      ...
      MemorySegment configHandle =
          (MemorySegment)createHandle.invoke(configSegment);
      ...
      MemorySegment applyAddr =
          LOOKUP.find("spikard_app_config")
      ...
      ownerHandle =
          (MemorySegment)applyHandle.invoke(ownerHandle, configHandle);

      // Free the ServerConfig handle
      MemorySegment freeAddr =
          LOOKUP.find("spikard_server_config_free")
              .or(() -> LOOKUP.find("_spikard_server_config_free"))
              .orElseThrow();
      FunctionDescriptor freeDesc =
