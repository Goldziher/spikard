...
public record
CompressionConfig(@Nullable @JsonProperty("gzip") Boolean gzip,
  ...
  public static final class Builder {
    ...
    @JsonProperty("min_size") @Nullable private Long minSize;
    ...
    /**
     * Constructs a CompressionConfig instance from the builder's current
     * state.
     */
