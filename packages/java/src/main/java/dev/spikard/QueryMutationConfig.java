...
public record QueryMutationConfig(
  ...
  public static final class Builder {
    ...
    @JsonProperty("complexity_limit") @Nullable private Long complexityLimit;
    @JsonProperty("depth_limit") @Nullable private Long depthLimit;
    ...
    /**
     * Constructs a QueryMutationConfig instance from the builder's current
     * state.
     */
    public QueryMutationConfig build() {
      return new QueryMutationConfig(introspectionEnabled, complexityLimit,
                                     depthLimit);
    }
  }
  // CPD-ON
