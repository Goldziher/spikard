...
// alef:hash:7e25ea8c30ba0c76995e6f1f0735401e36e6d632d96ccbbbe5abfd7e18c5304d
...
public record JsonRpcConfig(
    ...
    public JsonRpcConfig{
        ...
        if (enableBatch == null) { enableBatch = true; }
        if (maxBatchSize == null) { maxBatchSize = 100L; }
    }
    ...
    public static final class Builder {
        ...
        @Nullable private String endpointPath;
        @JsonProperty("enable_batch")
        @Nullable private Boolean enableBatch;
        @JsonProperty("max_batch_size")
        @Nullable private Long maxBatchSize;
