...
public record ServerConfig(
    @JsonProperty("host") String host, @JsonProperty("port") short port,
  ...
  public static final class Builder {
    ...
    @JsonProperty("enable_request_id") private boolean enableRequestId;
    ...
    @JsonProperty("rate_limit") @Nullable private RateLimitConfig rateLimit;
    @JsonProperty("jwt_auth") @Nullable private JwtConfig jwtAuth;
    @JsonProperty("api_key_auth") @Nullable private ApiKeyConfig apiKeyAuth;
    @JsonProperty("static_files")
    private List<StaticFilesConfig> staticFiles = List.of();
    @JsonProperty("graceful_shutdown") private boolean gracefulShutdown = true;
    @JsonProperty("shutdown_timeout") private long shutdownTimeout;
    ...
    @JsonProperty("enable_http_trace") private boolean enableHttpTrace;
    ...
    public ServerConfig build() {
      return new ServerConfig(host, port, workers, enableRequestId, maxBodySize,
                              requestTimeout, compression, rateLimit, jwtAuth,
                              apiKeyAuth, staticFiles, gracefulShutdown,
                              shutdownTimeout, asyncapi, openapi, jsonrpc, grpc,
                              backgroundTasks, enableHttpTrace);
    }
  }
  // CPD-ON
}
