...
// alef:hash:d2272dfddf889cc459df634816946f8b681dd1929eda45e6b6e357c6ab12faf2
@file:Suppress(
...
data class GrpcConfig(
     ...
     */
    val maxMessageSize: Long = 4194304L,
    ...
    val keepaliveInterval: Long = 75L,
    /** HTTP/2 keepalive timeout in seconds */
    val keepaliveTimeout: Long = 20L,
    /**
