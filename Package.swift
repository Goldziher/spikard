...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/Goldziher/spikard/releases/download/v0.17.0/Spikard-rs.artifactbundle.zip",
      checksum: "186635770d564564851e65fa00776feb8045b4de81b8aa9b375dd98ff96e053d"
    ),
