...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/Goldziher/spikard/releases/download/v0.17.0-rc.8/Spikard-rs.artifactbundle.zip",
      checksum: "c20bef8b12c9e46063bbb1e488be96778ab6d530aee1d1e4b1c4f40fa78c9275"
    ),
