...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/Goldziher/spikard/releases/download/v0.17.0-rc.7/Spikard-rs.artifactbundle.zip",
      checksum: "1a9fbd3cb922d5d9d7e93f6992d65bc7992f072093fd38e7e5a7034f2e7d8b40"
    ),
