...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/Goldziher/spikard/releases/download/v0.17.0-rc.11/Spikard-rs.artifactbundle.zip",
      checksum: "f39528ed97003cd1078890e72e4bd89095677f7c8fdd74b512a183a3a948751b"
    ),
