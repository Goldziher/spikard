...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/Goldziher/spikard/releases/download/v0.16.0-rc.4/Spikard-rs.artifactbundle.zip",
      checksum: "614a2e2a5e0acab220288e7a081d024dba737aadabbd8b434aa92a826b06e86e"
    ),
