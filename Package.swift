...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/Goldziher/spikard/releases/download/v0.17.0-rc.5/Spikard-rs.artifactbundle.zip",
      checksum: "f00a82fe0a416cca3afd5ffa72600b803e149fd2eb12d8bc515f582c1a4acc82"
    ),
