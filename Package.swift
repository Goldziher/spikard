...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/Goldziher/spikard/releases/download/v0.17.0-rc.3/Spikard-rs.artifactbundle.zip",
      checksum: "458ba9e2b057b7123301b8feafe280a062b52a21650a4ac55160b01c64410e00"
    ),
