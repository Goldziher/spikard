...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/Goldziher/spikard/releases/download/v0.17.0-rc.1/Spikard-rs.artifactbundle.zip",
      checksum: "037621d0773021e1f2596a4147e3ce46f672858806b8795a52765091ee62b032"
    ),
