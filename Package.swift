...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/Goldziher/spikard/releases/download/v0.17.0-rc.10/Spikard-rs.artifactbundle.zip",
      checksum: "7e8a3ec415d9f4899a2bc43b2464f5899b15ce526ebd33021b359941b327d422"
    ),
