...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/Goldziher/spikard/releases/download/v0.17.1/Spikard-rs.artifactbundle.zip",
      checksum: "7c096574c661717ae8704e5e41cf414037c1541dfc7d22a0d90b2ced7d5e3b09"
    ),
