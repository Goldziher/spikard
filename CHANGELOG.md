...
- **JSON-RPC OpenRPC docs**: Removed stale claims that `/openrpc.json` is currently served automatically; the runtime still exposes only the implemented JSON-RPC HTTP endpoint.
