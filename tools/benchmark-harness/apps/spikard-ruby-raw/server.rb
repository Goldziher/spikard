...
app.post '/json/small', handler_name: 'post_json_small' do |payload = {}|
  extract_body(payload)
end

app.post '/json/medium', handler_name: 'post_json_medium' do |payload = {}|
  extract_body(payload)
end

app.post '/json/large', handler_name: 'post_json_large' do |payload = {}|
  extract_body(payload)
end

app.post '/json/very-large', handler_name: 'post_json_very_large' do |payload = {}|
  extract_body(payload)
end
...
app.post '/urlencoded/simple', handler_name: 'post_urlencoded_simple' do |payload = {}|
  extract_body(payload)
end

app.post '/urlencoded/complex', handler_name: 'post_urlencoded_complex' do |payload = {}|
  extract_body(payload)
end
