...
app.post '/json/small', request_schema: SMALL_PAYLOAD_SCHEMA do |body|
  body
end

app.post '/json/medium', request_schema: MEDIUM_PAYLOAD_SCHEMA do |body|
  body
end

app.post '/json/large', request_schema: LARGE_PAYLOAD_SCHEMA do |body|
  body
end

app.post '/json/very-large', request_schema: VERY_LARGE_PAYLOAD_SCHEMA do |body|
  body
end
...
app.post '/multipart/small', request_schema: MULTIPART_SCHEMA do |body|
  { files_received: 1, total_bytes: 1024 }
end

app.post '/multipart/medium', request_schema: MULTIPART_SCHEMA do |body|
  { files_received: 2, total_bytes: 10240 }
end

app.post '/multipart/large', request_schema: MULTIPART_SCHEMA do |body|
...
app.post '/urlencoded/simple', request_schema: URLENCODED_SIMPLE_SCHEMA do |body|
  body
end

app.post '/urlencoded/complex', request_schema: URLENCODED_COMPLEX_SCHEMA do |body|
  body
end
...
app.get '/path/simple/:id', parameter_schema: PATH_SIMPLE_PARAM_SCHEMA do |params|
  { id: params[:id] }
end

app.get '/path/multiple/:user_id/:post_id', parameter_schema: PATH_MULTIPLE_PARAM_SCHEMA do |params|
  { user_id: params[:user_id], post_id: params[:post_id] }
end

app.get '/path/deep/:org/:team/:project/:resource/:id', parameter_schema: PATH_DEEP_PARAM_SCHEMA do |params|
  {
    org: params[:org],
    team: params[:team],
...
app.get '/path/int/:id', parameter_schema: PATH_INT_PARAM_SCHEMA do |params|
  { id: params[:id].to_i }
end

app.get '/path/uuid/:uuid', parameter_schema: PATH_UUID_PARAM_SCHEMA do |params|
  { uuid: params[:uuid] }
end

app.get '/path/date/:date', parameter_schema: PATH_DATE_PARAM_SCHEMA do |params|
  { date: params[:date] }
end
...
app.get '/query/few', parameter_schema: QUERY_FEW_PARAM_SCHEMA do |query|
  query
end

app.get '/query/medium', parameter_schema: QUERY_MEDIUM_PARAM_SCHEMA do |query|
  query
end

app.get '/query/many', parameter_schema: QUERY_MANY_PARAM_SCHEMA do |query|
  query
end
