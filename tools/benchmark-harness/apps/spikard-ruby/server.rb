...
app.post '/json/small', handler_name: 'post_json_small', request_schema: SMALL_PAYLOAD_SCHEMA do |request = {}|
  body = request.is_a?(Hash) ? (request[:body] || request['body'] || {}) : {}
  body
end

app.post '/json/medium', handler_name: 'post_json_medium', request_schema: MEDIUM_PAYLOAD_SCHEMA do |request = {}|
  body = request.is_a?(Hash) ? (request[:body] || request['body'] || {}) : {}
  body
end

app.post '/json/large', handler_name: 'post_json_large', request_schema: LARGE_PAYLOAD_SCHEMA do |request = {}|
  body = request.is_a?(Hash) ? (request[:body] || request['body'] || {}) : {}
  body
end

app.post '/json/very-large', handler_name: 'post_json_very_large', request_schema: VERY_LARGE_PAYLOAD_SCHEMA do |request = {}|
  body = request.is_a?(Hash) ? (request[:body] || request['body'] || {}) : {}
  body
end
...
app.post '/multipart/small', handler_name: 'post_multipart_small', request_schema: MULTIPART_SCHEMA do |request|
  { files_received: 1, total_bytes: 1024 }
end

app.post '/multipart/medium', handler_name: 'post_multipart_medium', request_schema: MULTIPART_SCHEMA do |request|
  { files_received: 2, total_bytes: 10240 }
end

app.post '/multipart/large', handler_name: 'post_multipart_large', request_schema: MULTIPART_SCHEMA do |request|
...
app.post '/urlencoded/simple', handler_name: 'post_urlencoded_simple', request_schema: URLENCODED_SIMPLE_SCHEMA do |request|
  request.is_a?(Hash) ? (request[:body] || request['body'] || {}) : {}
end

app.post '/urlencoded/complex', handler_name: 'post_urlencoded_complex', request_schema: URLENCODED_COMPLEX_SCHEMA do |request|
  request.is_a?(Hash) ? (request[:body] || request['body'] || {}) : {}
end
...
app.get '/path/simple/{id}', handler_name: 'get_path_simple', parameter_schema: PATH_SIMPLE_PARAM_SCHEMA do |request|
  { id: request[:path_params][:id] }
end

app.get '/path/multiple/{user_id}/{post_id}', handler_name: 'get_path_multiple', parameter_schema: PATH_MULTIPLE_PARAM_SCHEMA do |request|
  {
...
app.get '/path/deep/{org}/{team}/{project}/{resource}/{id}', handler_name: 'get_path_deep', parameter_schema: PATH_DEEP_PARAM_SCHEMA do |request|
  {
...
app.get '/path/int/{id}', handler_name: 'get_path_int', parameter_schema: PATH_INT_PARAM_SCHEMA do |request|
  { id: request[:path_params][:id].to_i }
end

app.get '/path/uuid/{uuid}', handler_name: 'get_path_uuid', parameter_schema: PATH_UUID_PARAM_SCHEMA do |request|
  { uuid: request[:path_params][:uuid] }
end

app.get '/path/date/{date}', handler_name: 'get_path_date', parameter_schema: PATH_DATE_PARAM_SCHEMA do |request|
...
app.get '/query/few', handler_name: 'get_query_few', parameter_schema: QUERY_FEW_PARAM_SCHEMA do |request|
  request[:query] || {}
end

app.get '/query/medium', handler_name: 'get_query_medium', parameter_schema: QUERY_MEDIUM_PARAM_SCHEMA do |request|
  request[:query] || {}
end

app.get '/query/many', handler_name: 'get_query_many', parameter_schema: QUERY_MANY_PARAM_SCHEMA do |request|
  request[:query] || {}
end
